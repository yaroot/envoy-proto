...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'grafeas.v1.package_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n\rio.grafeas.v1P\001Z8google.golang.org/genproto/googleapis/grafeas/v1;grafeas\242\002\003GRA'
  _DISTRIBUTION.fields_by_name['cpe_uri']._options = None
  _DISTRIBUTION.fields_by_name['cpe_uri']._serialized_options = b'\340A\002'
  _PACKAGENOTE.fields_by_name['name']._options = None
  _PACKAGENOTE.fields_by_name['name']._serialized_options = b'\340A\002\340A\005'
  _PACKAGEOCCURRENCE.fields_by_name['name']._options = None
  _PACKAGEOCCURRENCE.fields_by_name['name']._serialized_options = b'\340A\002\340A\003'
  _PACKAGEOCCURRENCE.fields_by_name['package_type']._options = None
  _PACKAGEOCCURRENCE.fields_by_name['package_type']._serialized_options = b'\340A\003'
  _PACKAGEOCCURRENCE.fields_by_name['cpe_uri']._options = None
  _PACKAGEOCCURRENCE.fields_by_name['cpe_uri']._serialized_options = b'\340A\003'
  _PACKAGEOCCURRENCE.fields_by_name['architecture']._options = None
  _PACKAGEOCCURRENCE.fields_by_name['architecture']._serialized_options = b'\340A\003'
  _PACKAGEOCCURRENCE.fields_by_name['version']._options = None
  _PACKAGEOCCURRENCE.fields_by_name['version']._serialized_options = b'\340A\003'
  _ARCHITECTURE._serialized_start=1198
  _ARCHITECTURE._serialized_end=1260
  _DISTRIBUTION._serialized_start=99
  _DISTRIBUTION._serialized_end=282
  _LOCATION._serialized_start=284
  _LOCATION._serialized_end=363
  _PACKAGENOTE._serialized_start=366
  _PACKAGENOTE._serialized_end=702
  _PACKAGEOCCURRENCE._serialized_start=705
  _PACKAGEOCCURRENCE._serialized_end=969
  _VERSION._serialized_start=972
  _VERSION._serialized_end=1196
  _VERSION_VERSIONKIND._serialized_start=1115
  _VERSION_VERSIONKIND._serialized_end=1196
