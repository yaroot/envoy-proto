...
_CLUSTERSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='observability_name', full_name='envoy.admin.v4alpha.ClusterStatus.observability_name', index=6,
...
_HOSTHEALTHSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='excluded_via_immediate_hc_fail', full_name='envoy.admin.v4alpha.HostHealthStatus.excluded_via_immediate_hc_fail', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='active_hc_timeout', full_name='envoy.admin.v4alpha.HostHealthStatus.active_hc_timeout', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='eds_health_status', full_name='envoy.admin.v4alpha.HostHealthStatus.eds_health_status', index=7,
