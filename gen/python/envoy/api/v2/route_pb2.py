...
_ROUTECONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='vhds', full_name='envoy.api.v2.RouteConfiguration.vhds', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='internal_only_headers', full_name='envoy.api.v2.RouteConfiguration.internal_only_headers', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='response_headers_to_add', full_name='envoy.api.v2.RouteConfiguration.response_headers_to_add', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='response_headers_to_remove', full_name='envoy.api.v2.RouteConfiguration.response_headers_to_remove', index=5,
      ...
      serialized_options=b'\372B\r\222\001\n\"\010r\006\300\001\001\310\001\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='request_headers_to_add', full_name='envoy.api.v2.RouteConfiguration.request_headers_to_add', index=6,
      ...
      serialized_options=b'\372B\006\222\001\003\020\350\007', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='request_headers_to_remove', full_name='envoy.api.v2.RouteConfiguration.request_headers_to_remove', index=7,
      ...
      serialized_options=b'\372B\r\222\001\n\"\010r\006\300\001\001\310\001\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='most_specific_header_mutations_wins', full_name='envoy.api.v2.RouteConfiguration.most_specific_header_mutations_wins', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='validate_clusters', full_name='envoy.api.v2.RouteConfiguration.validate_clusters', index=9,
...
_VHDS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='config_source', full_name='envoy.api.v2.Vhds.config_source', index=0,
...
_ROUTECONFIGURATION.fields_by_name['virtual_hosts'].message_type = envoy_dot_api_dot_v2_dot_route_dot_route__components__pb2._VIRTUALHOST
...
_VHDS.fields_by_name['config_source'].message_type = envoy_dot_api_dot_v2_dot_core_dot_config__source__pb2._CONFIGSOURCE
