...
_UPSTREAMLOCALITYSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_issued_requests', full_name='envoy.api.v2.endpoint.UpstreamLocalityStats.total_issued_requests', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='load_metric_stats', full_name='envoy.api.v2.endpoint.UpstreamLocalityStats.load_metric_stats', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='upstream_endpoint_stats', full_name='envoy.api.v2.endpoint.UpstreamLocalityStats.upstream_endpoint_stats', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='priority', full_name='envoy.api.v2.endpoint.UpstreamLocalityStats.priority', index=7,
...
_UPSTREAMENDPOINTSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_issued_requests', full_name='envoy.api.v2.endpoint.UpstreamEndpointStats.total_issued_requests', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='load_metric_stats', full_name='envoy.api.v2.endpoint.UpstreamEndpointStats.load_metric_stats', index=6,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
