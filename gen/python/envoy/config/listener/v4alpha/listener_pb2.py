...
_LISTENER_INTERNALLISTENERCONFIG = _descriptor.Descriptor(
  name='InternalListenerConfig',
  full_name='envoy.config.listener.v4alpha.Listener.InternalListenerConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_LISTENER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='stat_prefix', full_name='envoy.config.listener.v4alpha.Listener.stat_prefix', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='filter_chains', full_name='envoy.config.listener.v4alpha.Listener.filter_chains', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_original_dst', full_name='envoy.config.listener.v4alpha.Listener.use_original_dst', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='default_filter_chain', full_name='envoy.config.listener.v4alpha.Listener.default_filter_chain', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='per_connection_buffer_limit_bytes', full_name='envoy.config.listener.v4alpha.Listener.per_connection_buffer_limit_bytes', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='metadata', full_name='envoy.config.listener.v4alpha.Listener.metadata', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='drain_type', full_name='envoy.config.listener.v4alpha.Listener.drain_type', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='listener_filters', full_name='envoy.config.listener.v4alpha.Listener.listener_filters', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='listener_filters_timeout', full_name='envoy.config.listener.v4alpha.Listener.listener_filters_timeout', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='continue_on_listener_filters_timeout', full_name='envoy.config.listener.v4alpha.Listener.continue_on_listener_filters_timeout', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='transparent', full_name='envoy.config.listener.v4alpha.Listener.transparent', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='freebind', full_name='envoy.config.listener.v4alpha.Listener.freebind', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='socket_options', full_name='envoy.config.listener.v4alpha.Listener.socket_options', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tcp_fast_open_queue_length', full_name='envoy.config.listener.v4alpha.Listener.tcp_fast_open_queue_length', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='traffic_direction', full_name='envoy.config.listener.v4alpha.Listener.traffic_direction', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='udp_listener_config', full_name='envoy.config.listener.v4alpha.Listener.udp_listener_config', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='api_listener', full_name='envoy.config.listener.v4alpha.Listener.api_listener', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connection_balance_config', full_name='envoy.config.listener.v4alpha.Listener.connection_balance_config', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reuse_port', full_name='envoy.config.listener.v4alpha.Listener.reuse_port', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='access_log', full_name='envoy.config.listener.v4alpha.Listener.access_log', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tcp_backlog_size', full_name='envoy.config.listener.v4alpha.Listener.tcp_backlog_size', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bind_to_port', full_name='envoy.config.listener.v4alpha.Listener.bind_to_port', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='internal_listener', full_name='envoy.config.listener.v4alpha.Listener.internal_listener', index=24,
  ...
  nested_types=[_LISTENER_DEPRECATEDV1, _LISTENER_CONNECTIONBALANCECONFIG, _LISTENER_INTERNALLISTENERCONFIG, ],
  enum_types=[
    _LISTENER_DRAINTYPE,
  ],
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='listener_specifier', full_name='envoy.config.listener.v4alpha.Listener.listener_specifier',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_LISTENER_INTERNALLISTENERCONFIG.containing_type = _LISTENER
...
_LISTENER.fields_by_name['default_filter_chain'].message_type = envoy_dot_config_dot_listener_dot_v4alpha_dot_listener__components__pb2._FILTERCHAIN
...
_LISTENER.fields_by_name['internal_listener'].message_type = _LISTENER_INTERNALLISTENERCONFIG
_LISTENER_DRAINTYPE.containing_type = _LISTENER
_LISTENER.oneofs_by_name['listener_specifier'].fields.append(
  _LISTENER.fields_by_name['internal_listener'])
_LISTENER.fields_by_name['internal_listener'].containing_oneof = _LISTENER.oneofs_by_name['listener_specifier']
...
Listener = _reflection.GeneratedProtocolMessageType('Listener', (_message.Message,), {
  ...
  'InternalListenerConfig' : _reflection.GeneratedProtocolMessageType('InternalListenerConfig', (_message.Message,), {
    ...
    '__module__' : 'envoy.config.listener.v4alpha.listener_pb2'
    # @@protoc_insertion_point(class_scope:envoy.config.listener.v4alpha.Listener.InternalListenerConfig)
    })
  ,
...
_LISTENER_INTERNALLISTENERCONFIG._options = None
