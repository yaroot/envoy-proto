...
_LISTENERCOLLECTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='entries', full_name='envoy.config.listener.v3.ListenerCollection.entries', index=0,
...
_LISTENER_DEPRECATEDV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bind_to_port', full_name='envoy.config.listener.v3.Listener.DeprecatedV1.bind_to_port', index=0,
...
_LISTENER_CONNECTIONBALANCECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='exact_balance', full_name='envoy.config.listener.v3.Listener.ConnectionBalanceConfig.exact_balance', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='balance_type', full_name='envoy.config.listener.v3.Listener.ConnectionBalanceConfig.balance_type',
...
_LISTENER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.config.listener.v3.Listener.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='address', full_name='envoy.config.listener.v3.Listener.address', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='filter_chains', full_name='envoy.config.listener.v3.Listener.filter_chains', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='per_connection_buffer_limit_bytes', full_name='envoy.config.listener.v3.Listener.per_connection_buffer_limit_bytes', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='metadata', full_name='envoy.config.listener.v3.Listener.metadata', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deprecated_v1', full_name='envoy.config.listener.v3.Listener.deprecated_v1', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='drain_type', full_name='envoy.config.listener.v3.Listener.drain_type', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='listener_filters', full_name='envoy.config.listener.v3.Listener.listener_filters', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='listener_filters_timeout', full_name='envoy.config.listener.v3.Listener.listener_filters_timeout', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='continue_on_listener_filters_timeout', full_name='envoy.config.listener.v3.Listener.continue_on_listener_filters_timeout', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='transparent', full_name='envoy.config.listener.v3.Listener.transparent', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='freebind', full_name='envoy.config.listener.v3.Listener.freebind', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='socket_options', full_name='envoy.config.listener.v3.Listener.socket_options', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tcp_fast_open_queue_length', full_name='envoy.config.listener.v3.Listener.tcp_fast_open_queue_length', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='traffic_direction', full_name='envoy.config.listener.v3.Listener.traffic_direction', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='udp_listener_config', full_name='envoy.config.listener.v3.Listener.udp_listener_config', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='api_listener', full_name='envoy.config.listener.v3.Listener.api_listener', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connection_balance_config', full_name='envoy.config.listener.v3.Listener.connection_balance_config', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reuse_port', full_name='envoy.config.listener.v3.Listener.reuse_port', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='access_log', full_name='envoy.config.listener.v3.Listener.access_log', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='udp_writer_config', full_name='envoy.config.listener.v3.Listener.udp_writer_config', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tcp_backlog_size', full_name='envoy.config.listener.v3.Listener.tcp_backlog_size', index=21,
...
_LISTENER.fields_by_name['address'].message_type = envoy_dot_config_dot_core_dot_v3_dot_address__pb2._ADDRESS
_LISTENER.fields_by_name['filter_chains'].message_type = envoy_dot_config_dot_listener_dot_v3_dot_listener__components__pb2._FILTERCHAIN
...
_LISTENER.fields_by_name['metadata'].message_type = envoy_dot_config_dot_core_dot_v3_dot_base__pb2._METADATA
...
_LISTENER.fields_by_name['listener_filters'].message_type = envoy_dot_config_dot_listener_dot_v3_dot_listener__components__pb2._LISTENERFILTER
...
_LISTENER.fields_by_name['socket_options'].message_type = envoy_dot_config_dot_core_dot_v3_dot_socket__option__pb2._SOCKETOPTION
_LISTENER.fields_by_name['tcp_fast_open_queue_length'].message_type = google_dot_protobuf_dot_wrappers__pb2._UINT32VALUE
_LISTENER.fields_by_name['traffic_direction'].enum_type = envoy_dot_config_dot_core_dot_v3_dot_base__pb2._TRAFFICDIRECTION
...
_LISTENER.fields_by_name['udp_writer_config'].message_type = envoy_dot_config_dot_core_dot_v3_dot_extension__pb2._TYPEDEXTENSIONCONFIG
