...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/config/cluster/aggregate/v2alpha/cluster.proto',
  package='envoy.config.cluster.aggregate.v2alpha',
  syntax='proto3',
  serialized_options=b'\n4io.envoyproxy.envoy.config.cluster.aggregate.v2alphaB\014ClusterProtoP\001\362\230\376\217\005(\022&envoy.extensions.clusters.aggregate.v3\272\200\310\321\006\002\020\001',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n4envoy/config/cluster/aggregate/v2alpha/cluster.proto\x12&envoy.config.cluster.aggregate.v2alpha\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"+\n\rClusterConfig\x12\x1a\n\x08\x63lusters\x18\x01 \x03(\tB\x08\xfa\x42\x05\x92\x01\x02\x08\x01\x42|\n4io.envoyproxy.envoy.config.cluster.aggregate.v2alphaB\x0c\x43lusterProtoP\x01\xf2\x98\xfe\x8f\x05(\x12&envoy.extensions.clusters.aggregate.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\x62\x06proto3'
  ,
...
_CLUSTERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='clusters', full_name='envoy.config.cluster.aggregate.v2alpha.ClusterConfig.clusters', index=0,
