...
_STREAMTAPSREQUEST_IDENTIFIER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='envoy.service.tap.v3.StreamTapsRequest.Identifier.node', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='tap_id', full_name='envoy.service.tap.v3.StreamTapsRequest.Identifier.tap_id', index=1,
...
_STREAMTAPSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='identifier', full_name='envoy.service.tap.v3.StreamTapsRequest.identifier', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='trace_id', full_name='envoy.service.tap.v3.StreamTapsRequest.trace_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='trace', full_name='envoy.service.tap.v3.StreamTapsRequest.trace', index=2,
...
_STREAMTAPSREQUEST_IDENTIFIER.fields_by_name['node'].message_type = envoy_dot_config_dot_core_dot_v3_dot_base__pb2._NODE
...
_TAPSINKSERVICE = _descriptor.ServiceDescriptor(
  name='TapSinkService',
  full_name='envoy.service.tap.v3.TapSinkService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='StreamTaps',
    full_name='envoy.service.tap.v3.TapSinkService.StreamTaps',
    index=0,
