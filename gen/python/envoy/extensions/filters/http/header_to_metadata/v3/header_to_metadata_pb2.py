...
_CONFIG_RULE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\372B\010r\006\300\001\001\310\001\000\362\230\376\217\005\031\022\027header_cookie_specifier', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cookie', full_name='envoy.extensions.filters.http.header_to_metadata.v3.Config.Rule.cookie', index=1,
      ...
      serialized_options=b'\372B\010r\006\300\001\001\310\001\000\362\230\376\217\005\031\022\027header_cookie_specifier', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_header_present', full_name='envoy.extensions.filters.http.header_to_metadata.v3.Config.Rule.on_header_present', index=2,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\362\230\376\217\005\014\n\non_present', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_header_missing', full_name='envoy.extensions.filters.http.header_to_metadata.v3.Config.Rule.on_header_missing', index=3,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\362\230\376\217\005\014\n\non_missing', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='envoy.extensions.filters.http.header_to_metadata.v3.Config.Rule.remove', index=4,
