...
_AUTHORIZATIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='allowed_client_headers_on_success', full_name='envoy.extensions.filters.http.ext_authz.v3.AuthorizationResponse.allowed_client_headers_on_success', index=3,
...
_AUTHORIZATIONRESPONSE.fields_by_name['allowed_client_headers_on_success'].message_type = envoy_dot_type_dot_matcher_dot_v3_dot_string__pb2._LISTSTRINGMATCHER
