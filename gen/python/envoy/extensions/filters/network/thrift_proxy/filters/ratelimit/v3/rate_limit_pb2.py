...
_RATELIMIT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='domain', full_name='envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit.domain', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='stage', full_name='envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit.stage', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='timeout', full_name='envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit.timeout', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='failure_mode_deny', full_name='envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit.failure_mode_deny', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rate_limit_service', full_name='envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit.rate_limit_service', index=4,
