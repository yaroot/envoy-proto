...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/extensions/tracers/zipkin/v4alpha/zipkin.proto',
...
_ZIPKINCONFIG_COLLECTORENDPOINTVERSION = _descriptor.EnumDescriptor(
  ...
  full_name='envoy.extensions.tracers.zipkin.v4alpha.ZipkinConfig.CollectorEndpointVersion',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ZIPKINCONFIG = _descriptor.Descriptor(
  name='ZipkinConfig',
  full_name='envoy.extensions.tracers.zipkin.v4alpha.ZipkinConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='collector_cluster', full_name='envoy.extensions.tracers.zipkin.v4alpha.ZipkinConfig.collector_cluster', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shared_span_context', full_name='envoy.extensions.tracers.zipkin.v4alpha.ZipkinConfig.shared_span_context', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='collector_endpoint_version', full_name='envoy.extensions.tracers.zipkin.v4alpha.ZipkinConfig.collector_endpoint_version', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='collector_hostname', full_name='envoy.extensions.tracers.zipkin.v4alpha.ZipkinConfig.collector_hostname', index=5,
...
ZipkinConfig = _reflection.GeneratedProtocolMessageType('ZipkinConfig', (_message.Message,), {
  ...
  '__module__' : 'envoy.extensions.tracers.zipkin.v4alpha.zipkin_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.tracers.zipkin.v4alpha.ZipkinConfig)
  })
