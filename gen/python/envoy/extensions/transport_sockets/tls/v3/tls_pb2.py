...
_COMMONTLSCONTEXT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='tls_certificate_provider_instance', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.tls_certificate_provider_instance', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tls_certificate_certificate_provider', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.tls_certificate_certificate_provider', index=4,
      ...
      serialized_options=b'\030\001\222\307\206\330\004\0033.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tls_certificate_certificate_provider_instance', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.tls_certificate_certificate_provider_instance', index=5,
      ...
      serialized_options=b'\030\001\222\307\206\330\004\0033.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='validation_context', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.validation_context', index=6,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='validation_context_sds_secret_config', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.validation_context_sds_secret_config', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='combined_validation_context', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.combined_validation_context', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='validation_context_certificate_provider', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.validation_context_certificate_provider', index=9,
      ...
      serialized_options=b'\030\001\222\307\206\330\004\0033.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='validation_context_certificate_provider_instance', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.validation_context_certificate_provider_instance', index=10,
      ...
      serialized_options=b'\030\001\222\307\206\330\004\0033.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='alpn_protocols', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.alpn_protocols', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='custom_handshaker', full_name='envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.custom_handshaker', index=12,
...
_COMMONTLSCONTEXT.fields_by_name['tls_certificate_provider_instance'].message_type = envoy_dot_extensions_dot_transport__sockets_dot_tls_dot_v3_dot_common__pb2._CERTIFICATEPROVIDERPLUGININSTANCE
