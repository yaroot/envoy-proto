...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/extensions/matching/common_inputs/environment_variable/v3/input.proto',
...
_CONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.extensions.matching.common_inputs.environment_variable.v3.Config.name', index=0,
