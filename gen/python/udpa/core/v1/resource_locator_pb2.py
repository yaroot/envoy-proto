...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='udpa/core/v1/resource_locator.proto',
...
_RESOURCELOCATOR_SCHEME = _descriptor.EnumDescriptor(
  name='Scheme',
  full_name='udpa.core.v1.ResourceLocator.Scheme',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='UDPA', index=0, number=0,
...
_RESOURCELOCATOR_DIRECTIVE = _descriptor.Descriptor(
  name='Directive',
  full_name='udpa.core.v1.ResourceLocator.Directive',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='alt', full_name='udpa.core.v1.ResourceLocator.Directive.alt', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='entry', full_name='udpa.core.v1.ResourceLocator.Directive.entry', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='directive', full_name='udpa.core.v1.ResourceLocator.Directive.directive',
...
_RESOURCELOCATOR = _descriptor.Descriptor(
  ...
  full_name='udpa.core.v1.ResourceLocator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='scheme', full_name='udpa.core.v1.ResourceLocator.scheme', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='udpa.core.v1.ResourceLocator.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='authority', full_name='udpa.core.v1.ResourceLocator.authority', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resource_type', full_name='udpa.core.v1.ResourceLocator.resource_type', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='exact_context', full_name='udpa.core.v1.ResourceLocator.exact_context', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='directives', full_name='udpa.core.v1.ResourceLocator.directives', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='context_param_specifier', full_name='udpa.core.v1.ResourceLocator.context_param_specifier',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_RESOURCELOCATOR.fields_by_name['exact_context'].message_type = udpa_dot_core_dot_v1_dot_context__params__pb2._CONTEXTPARAMS
...
ResourceLocator = _reflection.GeneratedProtocolMessageType('ResourceLocator', (_message.Message,), {
  ...
  'Directive' : _reflection.GeneratedProtocolMessageType('Directive', (_message.Message,), {
    ...
    '__module__' : 'udpa.core.v1.resource_locator_pb2'
    # @@protoc_insertion_point(class_scope:udpa.core.v1.ResourceLocator.Directive)
    })
  ,
  'DESCRIPTOR' : _RESOURCELOCATOR,
  '__module__' : 'udpa.core.v1.resource_locator_pb2'
  # @@protoc_insertion_point(class_scope:udpa.core.v1.ResourceLocator)
  })
...
_RESOURCELOCATOR.fields_by_name['id']._options = None
