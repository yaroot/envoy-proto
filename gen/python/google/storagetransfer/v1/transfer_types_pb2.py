...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.storagetransfer.v1.transfer_types_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _AWSACCESSKEY.fields_by_name['access_key_id']._serialized_options = b'\340A\002'
  _AWSACCESSKEY.fields_by_name['secret_access_key']._options = None
  _AWSACCESSKEY.fields_by_name['secret_access_key']._serialized_options = b'\340A\002'
  _AZURECREDENTIALS.fields_by_name['sas_token']._options = None
  _AZURECREDENTIALS.fields_by_name['sas_token']._serialized_options = b'\340A\002'
  _GCSDATA.fields_by_name['bucket_name']._options = None
  _GCSDATA.fields_by_name['bucket_name']._serialized_options = b'\340A\002'
  _AWSS3DATA.fields_by_name['bucket_name']._options = None
  _AWSS3DATA.fields_by_name['bucket_name']._serialized_options = b'\340A\002'
  _AWSS3DATA.fields_by_name['aws_access_key']._options = None
  _AWSS3DATA.fields_by_name['aws_access_key']._serialized_options = b'\340A\004'
  _AZUREBLOBSTORAGEDATA.fields_by_name['storage_account']._options = None
  _AZUREBLOBSTORAGEDATA.fields_by_name['storage_account']._serialized_options = b'\340A\002'
  _AZUREBLOBSTORAGEDATA.fields_by_name['azure_credentials']._options = None
  _AZUREBLOBSTORAGEDATA.fields_by_name['azure_credentials']._serialized_options = b'\340A\002\340A\004'
  _AZUREBLOBSTORAGEDATA.fields_by_name['container']._options = None
  _AZUREBLOBSTORAGEDATA.fields_by_name['container']._serialized_options = b'\340A\002'
  _HTTPDATA.fields_by_name['list_url']._options = None
  _HTTPDATA.fields_by_name['list_url']._serialized_options = b'\340A\002'
  _AWSS3COMPATIBLEDATA.fields_by_name['bucket_name']._options = None
  _AWSS3COMPATIBLEDATA.fields_by_name['bucket_name']._serialized_options = b'\340A\002'
  _AWSS3COMPATIBLEDATA.fields_by_name['endpoint']._options = None
  _AWSS3COMPATIBLEDATA.fields_by_name['endpoint']._serialized_options = b'\340A\002'
  _AGENTPOOL.fields_by_name['name']._options = None
  _AGENTPOOL.fields_by_name['name']._serialized_options = b'\340A\002'
  _AGENTPOOL.fields_by_name['state']._options = None
  _AGENTPOOL.fields_by_name['state']._serialized_options = b'\340A\003'
  _AGENTPOOL._options = None
  _AGENTPOOL._serialized_options = b'\352A]\n)storagetransfer.googleapis.com/agentPools\0220projects/{project_id}/agentPools/{agent_pool_id}'
  _SCHEDULE.fields_by_name['schedule_start_date']._options = None
  _SCHEDULE.fields_by_name['schedule_start_date']._serialized_options = b'\340A\002'
  _TRANSFERJOB.fields_by_name['creation_time']._options = None
  _TRANSFERJOB.fields_by_name['creation_time']._serialized_options = b'\340A\003'
  _TRANSFERJOB.fields_by_name['last_modification_time']._options = None
  _TRANSFERJOB.fields_by_name['last_modification_time']._serialized_options = b'\340A\003'
  _TRANSFERJOB.fields_by_name['deletion_time']._options = None
  _TRANSFERJOB.fields_by_name['deletion_time']._serialized_options = b'\340A\003'
  _ERRORLOGENTRY.fields_by_name['url']._options = None
  _ERRORLOGENTRY.fields_by_name['url']._serialized_options = b'\340A\002'
  _ERRORSUMMARY.fields_by_name['error_code']._options = None
  _ERRORSUMMARY.fields_by_name['error_code']._serialized_options = b'\340A\002'
  _ERRORSUMMARY.fields_by_name['error_count']._options = None
  _ERRORSUMMARY.fields_by_name['error_count']._serialized_options = b'\340A\002'
  _NOTIFICATIONCONFIG.fields_by_name['pubsub_topic']._options = None
  _NOTIFICATIONCONFIG.fields_by_name['pubsub_topic']._serialized_options = b'\340A\002'
  ...
  _GOOGLESERVICEACCOUNT._serialized_start=278
  _GOOGLESERVICEACCOUNT._serialized_end=343
  _AWSACCESSKEY._serialized_start=345
  _AWSACCESSKEY._serialized_end=419
  _AZURECREDENTIALS._serialized_start=421
  _AZURECREDENTIALS._serialized_end=463
  _OBJECTCONDITIONS._serialized_start=466
  _OBJECTCONDITIONS._serialized_end=805
  _GCSDATA._serialized_start=807
  _GCSDATA._serialized_end=856
  _AWSS3DATA._serialized_start=859
  _AWSS3DATA._serialized_end=998
  _AZUREBLOBSTORAGEDATA._serialized_start=1001
  _AZUREBLOBSTORAGEDATA._serialized_end=1171
  _HTTPDATA._serialized_start=1173
  _HTTPDATA._serialized_end=1206
  _POSIXFILESYSTEM._serialized_start=1208
  _POSIXFILESYSTEM._serialized_end=1249
  _AWSS3COMPATIBLEDATA._serialized_start=1252
  _AWSS3COMPATIBLEDATA._serialized_end=1441
  _S3COMPATIBLEMETADATA._serialized_start=1444
  _S3COMPATIBLEMETADATA._serialized_end=2202
  _S3COMPATIBLEMETADATA_AUTHMETHOD._serialized_start=1792
  _S3COMPATIBLEMETADATA_AUTHMETHOD._serialized_end=1901
  _S3COMPATIBLEMETADATA_REQUESTMODEL._serialized_start=1903
  _S3COMPATIBLEMETADATA_REQUESTMODEL._serialized_end=2018
  _S3COMPATIBLEMETADATA_NETWORKPROTOCOL._serialized_start=2020
  _S3COMPATIBLEMETADATA_NETWORKPROTOCOL._serialized_end=2126
  _S3COMPATIBLEMETADATA_LISTAPI._serialized_start=2128
  _S3COMPATIBLEMETADATA_LISTAPI._serialized_end=2202
  _AGENTPOOL._serialized_start=2205
  _AGENTPOOL._serialized_end=2608
  _AGENTPOOL_BANDWIDTHLIMIT._serialized_start=2401
  _AGENTPOOL_BANDWIDTHLIMIT._serialized_end=2437
  _AGENTPOOL_STATE._serialized_start=2439
  _AGENTPOOL_STATE._serialized_end=2510
  _TRANSFEROPTIONS._serialized_start=2611
  _TRANSFEROPTIONS._serialized_end=3009
  _TRANSFEROPTIONS_OVERWRITEWHEN._serialized_start=2924
  _TRANSFEROPTIONS_OVERWRITEWHEN._serialized_end=3009
  _TRANSFERSPEC._serialized_start=3012
  _TRANSFERSPEC._serialized_end=4019
  _METADATAOPTIONS._serialized_start=4022
  _METADATAOPTIONS._serialized_end=5543
  _METADATAOPTIONS_SYMLINK._serialized_start=4664
  _METADATAOPTIONS_SYMLINK._serialized_end=4738
  _METADATAOPTIONS_MODE._serialized_start=4740
  _METADATAOPTIONS_MODE._serialized_end=4802
  _METADATAOPTIONS_GID._serialized_start=4804
  _METADATAOPTIONS_GID._serialized_end=4860
  _METADATAOPTIONS_UID._serialized_start=4862
  _METADATAOPTIONS_UID._serialized_end=4918
  _METADATAOPTIONS_ACL._serialized_start=4920
  _METADATAOPTIONS_ACL._serialized_end=5000
  _METADATAOPTIONS_STORAGECLASS._serialized_start=5003
  _METADATAOPTIONS_STORAGECLASS._serialized_end=5233
  _METADATAOPTIONS_TEMPORARYHOLD._serialized_start=5235
  _METADATAOPTIONS_TEMPORARYHOLD._serialized_end=5336
  _METADATAOPTIONS_KMSKEY._serialized_start=5338
  _METADATAOPTIONS_KMSKEY._serialized_end=5433
  _METADATAOPTIONS_TIMECREATED._serialized_start=5435
  _METADATAOPTIONS_TIMECREATED._serialized_end=5543
  _TRANSFERMANIFEST._serialized_start=5545
  _TRANSFERMANIFEST._serialized_end=5581
  _SCHEDULE._serialized_start=5584
  _SCHEDULE._serialized_end=5845
  _TRANSFERJOB._serialized_start=5848
  _TRANSFERJOB._serialized_end=6522
  _TRANSFERJOB_STATUS._serialized_start=6450
  _TRANSFERJOB_STATUS._serialized_end=6522
  _ERRORLOGENTRY._serialized_start=6524
  _ERRORLOGENTRY._serialized_end=6580
  _ERRORSUMMARY._serialized_start=6583
  _ERRORSUMMARY._serialized_end=6735
  _TRANSFERCOUNTERS._serialized_start=6738
  _TRANSFERCOUNTERS._serialized_end=7573
  _NOTIFICATIONCONFIG._serialized_start=7576
  _NOTIFICATIONCONFIG._serialized_end=7997
  _NOTIFICATIONCONFIG_EVENTTYPE._serialized_start=7794
  _NOTIFICATIONCONFIG_EVENTTYPE._serialized_end=7928
  _NOTIFICATIONCONFIG_PAYLOADFORMAT._serialized_start=7930
  _NOTIFICATIONCONFIG_PAYLOADFORMAT._serialized_end=7997
  _LOGGINGCONFIG._serialized_start=8000
  _LOGGINGCONFIG._serialized_end=8395
  _LOGGINGCONFIG_LOGGABLEACTION._serialized_start=8225
  _LOGGINGCONFIG_LOGGABLEACTION._serialized_end=8306
  _LOGGINGCONFIG_LOGGABLEACTIONSTATE._serialized_start=8308
  _LOGGINGCONFIG_LOGGABLEACTIONSTATE._serialized_end=8395
  _TRANSFEROPERATION._serialized_start=8398
  _TRANSFEROPERATION._serialized_end=9024
  _TRANSFEROPERATION_STATUS._serialized_start=8913
  _TRANSFEROPERATION_STATUS._serialized_end=9024
