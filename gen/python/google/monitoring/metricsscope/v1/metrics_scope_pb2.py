...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.monitoring.metricsscope.v1.metrics_scope_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _METRICSSCOPE.fields_by_name['name']._serialized_options = b'\340A\005'
  _METRICSSCOPE.fields_by_name['create_time']._options = None
  _METRICSSCOPE.fields_by_name['create_time']._serialized_options = b'\340A\003'
  _METRICSSCOPE.fields_by_name['update_time']._options = None
  _METRICSSCOPE.fields_by_name['update_time']._serialized_options = b'\340A\003'
  _METRICSSCOPE.fields_by_name['monitored_projects']._options = None
  _METRICSSCOPE.fields_by_name['monitored_projects']._serialized_options = b'\340A\003'
  ...
  _MONITOREDPROJECT.fields_by_name['name']._serialized_options = b'\340A\005'
  _MONITOREDPROJECT.fields_by_name['create_time']._options = None
  _MONITOREDPROJECT.fields_by_name['create_time']._serialized_options = b'\340A\003'
  ...
  _METRICSSCOPE._serialized_end=505
  _MONITOREDPROJECT._serialized_start=508
  _MONITOREDPROJECT._serialized_end=715
