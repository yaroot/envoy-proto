...
_CALENDARPERIOD = _descriptor.EnumDescriptor(
  name='CalendarPeriod',
  full_name='google.cloud.billing.budgets.v1beta1.CalendarPeriod',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ALLUPDATESRULE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='monitoring_notification_channels', full_name='google.cloud.billing.budgets.v1beta1.AllUpdatesRule.monitoring_notification_channels', index=2,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='disable_default_iam_recipients', full_name='google.cloud.billing.budgets.v1beta1.AllUpdatesRule.disable_default_iam_recipients', index=3,
...
_FILTER_LABELSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.billing.budgets.v1beta1.Filter.LabelsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.billing.budgets.v1beta1.Filter.LabelsEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FILTER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='credit_types', full_name='google.cloud.billing.budgets.v1beta1.Filter.credit_types', index=1,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='credit_types_treatment', full_name='google.cloud.billing.budgets.v1beta1.Filter.credit_types_treatment', index=2,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='services', full_name='google.cloud.billing.budgets.v1beta1.Filter.services', index=3,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='subaccounts', full_name='google.cloud.billing.budgets.v1beta1.Filter.subaccounts', index=4,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='labels', full_name='google.cloud.billing.budgets.v1beta1.Filter.labels', index=5,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='calendar_period', full_name='google.cloud.billing.budgets.v1beta1.Filter.calendar_period', index=6,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='custom_period', full_name='google.cloud.billing.budgets.v1beta1.Filter.custom_period', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='usage_period', full_name='google.cloud.billing.budgets.v1beta1.Filter.usage_period',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_CUSTOMPERIOD = _descriptor.Descriptor(
  name='CustomPeriod',
  full_name='google.cloud.billing.budgets.v1beta1.CustomPeriod',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='start_date', full_name='google.cloud.billing.budgets.v1beta1.CustomPeriod.start_date', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date', full_name='google.cloud.billing.budgets.v1beta1.CustomPeriod.end_date', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
