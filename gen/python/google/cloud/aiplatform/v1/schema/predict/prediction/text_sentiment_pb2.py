...
_TEXTSENTIMENTPREDICTIONRESULT = _descriptor.Descriptor(
  ...
  full_name='google.cloud.aiplatform.v1.schema.predict.prediction.TextSentimentPredictionResult',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sentiment', full_name='google.cloud.aiplatform.v1.schema.predict.prediction.TextSentimentPredictionResult.sentiment', index=0,
