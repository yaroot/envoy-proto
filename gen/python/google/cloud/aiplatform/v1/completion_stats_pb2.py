...
_COMPLETIONSTATS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.aiplatform.v1.CompletionStats',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='successful_count', full_name='google.cloud.aiplatform.v1.CompletionStats.successful_count', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='failed_count', full_name='google.cloud.aiplatform.v1.CompletionStats.failed_count', index=1,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='incomplete_count', full_name='google.cloud.aiplatform.v1.CompletionStats.incomplete_count', index=2,
