...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/notebooks/v1/environment.proto',
...
_ENVIRONMENT = _descriptor.Descriptor(
  name='Environment',
  full_name='google.cloud.notebooks.v1.Environment',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.notebooks.v1.Environment.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.notebooks.v1.Environment.display_name', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.notebooks.v1.Environment.description', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='vm_image', full_name='google.cloud.notebooks.v1.Environment.vm_image', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='container_image', full_name='google.cloud.notebooks.v1.Environment.container_image', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='post_startup_script', full_name='google.cloud.notebooks.v1.Environment.post_startup_script', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.notebooks.v1.Environment.create_time', index=6,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='image_type', full_name='google.cloud.notebooks.v1.Environment.image_type',
...
_VMIMAGE = _descriptor.Descriptor(
  name='VmImage',
  full_name='google.cloud.notebooks.v1.VmImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='project', full_name='google.cloud.notebooks.v1.VmImage.project', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='image_name', full_name='google.cloud.notebooks.v1.VmImage.image_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='image_family', full_name='google.cloud.notebooks.v1.VmImage.image_family', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='image', full_name='google.cloud.notebooks.v1.VmImage.image',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_CONTAINERIMAGE = _descriptor.Descriptor(
  name='ContainerImage',
  full_name='google.cloud.notebooks.v1.ContainerImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='repository', full_name='google.cloud.notebooks.v1.ContainerImage.repository', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tag', full_name='google.cloud.notebooks.v1.ContainerImage.tag', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
