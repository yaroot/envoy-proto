...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/documentai/v1beta3/geometry.proto',
...
_VERTEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='google.cloud.documentai.v1beta3.Vertex.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='google.cloud.documentai.v1beta3.Vertex.y', index=1,
...
_NORMALIZEDVERTEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='google.cloud.documentai.v1beta3.NormalizedVertex.x', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='y', full_name='google.cloud.documentai.v1beta3.NormalizedVertex.y', index=1,
...
_BOUNDINGPOLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='vertices', full_name='google.cloud.documentai.v1beta3.BoundingPoly.vertices', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='normalized_vertices', full_name='google.cloud.documentai.v1beta3.BoundingPoly.normalized_vertices', index=1,
