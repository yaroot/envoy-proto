...
_SCANRUNWARNINGTRACE_CODE = _descriptor.EnumDescriptor(
  name='Code',
  full_name='google.cloud.websecurityscanner.v1.ScanRunWarningTrace.Code',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_SCANRUNWARNINGTRACE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.websecurityscanner.v1.ScanRunWarningTrace',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='google.cloud.websecurityscanner.v1.ScanRunWarningTrace.code', index=0,
