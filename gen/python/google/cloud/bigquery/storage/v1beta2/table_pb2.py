...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/bigquery/storage/v1beta2/table.proto',
...
_TABLEFIELDSCHEMA_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='BIGNUMERIC', index=13, number=13,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='INTERVAL', index=14, number=14,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='JSON', index=15, number=15,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_TABLESCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='fields', full_name='google.cloud.bigquery.storage.v1beta2.TableSchema.fields', index=0,
...
_TABLEFIELDSCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.bigquery.storage.v1beta2.TableFieldSchema.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.bigquery.storage.v1beta2.TableFieldSchema.type', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mode', full_name='google.cloud.bigquery.storage.v1beta2.TableFieldSchema.mode', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='fields', full_name='google.cloud.bigquery.storage.v1beta2.TableFieldSchema.fields', index=3,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.bigquery.storage.v1beta2.TableFieldSchema.description', index=4,
