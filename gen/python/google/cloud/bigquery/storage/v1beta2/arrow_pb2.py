...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/bigquery/storage/v1beta2/arrow.proto',
...
_ARROWSERIALIZATIONOPTIONS_FORMAT = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ARROW_0_14', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ARROW_0_15', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_ARROWSCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='serialized_schema', full_name='google.cloud.bigquery.storage.v1beta2.ArrowSchema.serialized_schema', index=0,
...
_ARROWRECORDBATCH = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='serialized_record_batch', full_name='google.cloud.bigquery.storage.v1beta2.ArrowRecordBatch.serialized_record_batch', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ARROWSERIALIZATIONOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='format', full_name='google.cloud.bigquery.storage.v1beta2.ArrowSerializationOptions.format', index=0,
...
_ARROWSERIALIZATIONOPTIONS.fields_by_name['format'].enum_type = _ARROWSERIALIZATIONOPTIONS_FORMAT
