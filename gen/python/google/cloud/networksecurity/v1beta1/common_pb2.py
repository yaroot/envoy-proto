...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/networksecurity/v1beta1/common.proto',
...
_OPERATIONMETADATA = _descriptor.Descriptor(
  ...
  full_name='google.cloud.networksecurity.v1beta1.OperationMetadata',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.networksecurity.v1beta1.OperationMetadata.create_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.cloud.networksecurity.v1beta1.OperationMetadata.end_time', index=1,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target', full_name='google.cloud.networksecurity.v1beta1.OperationMetadata.target', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='verb', full_name='google.cloud.networksecurity.v1beta1.OperationMetadata.verb', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status_message', full_name='google.cloud.networksecurity.v1beta1.OperationMetadata.status_message', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='requested_cancellation', full_name='google.cloud.networksecurity.v1beta1.OperationMetadata.requested_cancellation', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='api_version', full_name='google.cloud.networksecurity.v1beta1.OperationMetadata.api_version', index=6,
