...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/datacatalog/v1/timestamps.proto',
...
_SYSTEMTIMESTAMPS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.datacatalog.v1.SystemTimestamps',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.datacatalog.v1.SystemTimestamps.create_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='update_time', full_name='google.cloud.datacatalog.v1.SystemTimestamps.update_time', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='expire_time', full_name='google.cloud.datacatalog.v1.SystemTimestamps.expire_time', index=2,
