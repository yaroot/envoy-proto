...
_TRANSFERABLESKU = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='transfer_eligibility', full_name='google.cloud.channel.v1.TransferableSku.transfer_eligibility', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sku', full_name='google.cloud.channel.v1.TransferableSku.sku', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='legacy_sku', full_name='google.cloud.channel.v1.TransferableSku.legacy_sku', index=2,
      number=12, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRANSFERABLESKU.fields_by_name['legacy_sku'].message_type = google_dot_cloud_dot_channel_dot_v1_dot_products__pb2._SKU
