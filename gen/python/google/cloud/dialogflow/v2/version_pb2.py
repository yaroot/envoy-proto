...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/dialogflow/v2/version.proto',
...
_VERSION_VERSIONSTATUS = _descriptor.EnumDescriptor(
  name='VersionStatus',
  full_name='google.cloud.dialogflow.v2.Version.VersionStatus',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_VERSION = _descriptor.Descriptor(
  name='Version',
  full_name='google.cloud.dialogflow.v2.Version',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.dialogflow.v2.Version.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.dialogflow.v2.Version.description', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='version_number', full_name='google.cloud.dialogflow.v2.Version.version_number', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.dialogflow.v2.Version.create_time', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.cloud.dialogflow.v2.Version.status', index=4,
...
_LISTVERSIONSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.v2.ListVersionsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.dialogflow.v2.ListVersionsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.dialogflow.v2.ListVersionsRequest.page_size', index=1,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.cloud.dialogflow.v2.ListVersionsRequest.page_token', index=2,
...
_LISTVERSIONSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.v2.ListVersionsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='versions', full_name='google.cloud.dialogflow.v2.ListVersionsResponse.versions', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.cloud.dialogflow.v2.ListVersionsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETVERSIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.v2.GetVersionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.dialogflow.v2.GetVersionRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEVERSIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.v2.CreateVersionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.dialogflow.v2.CreateVersionRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A#\022!dialogflow.googleapis.com/Version', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version', full_name='google.cloud.dialogflow.v2.CreateVersionRequest.version', index=1,
...
_UPDATEVERSIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.v2.UpdateVersionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='google.cloud.dialogflow.v2.UpdateVersionRequest.version', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.cloud.dialogflow.v2.UpdateVersionRequest.update_mask', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETEVERSIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.v2.DeleteVersionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.dialogflow.v2.DeleteVersionRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VERSIONS = _descriptor.ServiceDescriptor(
  name='Versions',
  full_name='google.cloud.dialogflow.v2.Versions',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='ListVersions',
    full_name='google.cloud.dialogflow.v2.Versions.ListVersions',
    index=0,
    containing_service=None,
    input_type=_LISTVERSIONSREQUEST,
    output_type=_LISTVERSIONSRESPONSE,
    serialized_options=b'\202\323\344\223\002^\022&/v2/{parent=projects/*/agent}/versionsZ4\0222/v2/{parent=projects/*/locations/*/agent}/versions\332A\006parent',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetVersion',
    full_name='google.cloud.dialogflow.v2.Versions.GetVersion',
    index=1,
    containing_service=None,
    input_type=_GETVERSIONREQUEST,
    output_type=_VERSION,
    serialized_options=b'\202\323\344\223\002^\022&/v2/{name=projects/*/agent/versions/*}Z4\0222/v2/{name=projects/*/locations/*/agent/versions/*}\332A\004name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='CreateVersion',
    full_name='google.cloud.dialogflow.v2.Versions.CreateVersion',
    index=2,
    containing_service=None,
    input_type=_CREATEVERSIONREQUEST,
    output_type=_VERSION,
    serialized_options=b'\202\323\344\223\002p\"&/v2/{parent=projects/*/agent}/versions:\007versionZ=\"2/v2/{parent=projects/*/locations/*/agent}/versions:\007version\332A\016parent,version',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='UpdateVersion',
    full_name='google.cloud.dialogflow.v2.Versions.UpdateVersion',
    index=3,
    containing_service=None,
    input_type=_UPDATEVERSIONREQUEST,
    output_type=_VERSION,
    serialized_options=b'\202\323\344\223\002\200\0012./v2/{version.name=projects/*/agent/versions/*}:\007versionZE2:/v2/{version.name=projects/*/locations/*/agent/versions/*}:\007version\332A\023version,update_mask',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='DeleteVersion',
    full_name='google.cloud.dialogflow.v2.Versions.DeleteVersion',
    index=4,
    containing_service=None,
    input_type=_DELETEVERSIONREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\202\323\344\223\002^*&/v2/{name=projects/*/agent/versions/*}Z4*2/v2/{name=projects/*/locations/*/agent/versions/*}\332A\004name',
    create_key=_descriptor._internal_create_key,
  ),
])
