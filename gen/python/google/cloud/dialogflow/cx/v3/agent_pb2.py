...
_AGENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='enable_stackdriver_logging', full_name='google.cloud.dialogflow.cx.v3.Agent.enable_stackdriver_logging', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enable_spell_correction', full_name='google.cloud.dialogflow.cx.v3.Agent.enable_spell_correction', index=9,
