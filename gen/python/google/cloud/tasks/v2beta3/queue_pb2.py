...
_QUEUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='task_ttl', full_name='google.cloud.tasks.v2beta3.Queue.task_ttl', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tombstone_ttl', full_name='google.cloud.tasks.v2beta3.Queue.tombstone_ttl', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stackdriver_logging_config', full_name='google.cloud.tasks.v2beta3.Queue.stackdriver_logging_config', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.tasks.v2beta3.Queue.type', index=9,
    ...
    _descriptor.FieldDescriptor(
      name='stats', full_name='google.cloud.tasks.v2beta3.Queue.stats', index=10,
...
_QUEUESTATS = _descriptor.Descriptor(
  name='QueueStats',
  full_name='google.cloud.tasks.v2beta3.QueueStats',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='tasks_count', full_name='google.cloud.tasks.v2beta3.QueueStats.tasks_count', index=0,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='oldest_estimated_arrival_time', full_name='google.cloud.tasks.v2beta3.QueueStats.oldest_estimated_arrival_time', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='executed_last_minute_count', full_name='google.cloud.tasks.v2beta3.QueueStats.executed_last_minute_count', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='concurrent_dispatches_count', full_name='google.cloud.tasks.v2beta3.QueueStats.concurrent_dispatches_count', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='effective_execution_rate', full_name='google.cloud.tasks.v2beta3.QueueStats.effective_execution_rate', index=4,
...
_QUEUE.fields_by_name['task_ttl'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_QUEUE.fields_by_name['tombstone_ttl'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
...
_QUEUE.fields_by_name['stats'].message_type = _QUEUESTATS
...
_QUEUESTATS.fields_by_name['oldest_estimated_arrival_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
