...
_INSTANCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connect_mode', full_name='google.cloud.redis.v1.Instance.connect_mode', index=18,
...
_GETINSTANCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A\037\n\035redis.googleapis.com/Instance', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_UPGRADEINSTANCEREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.redis.v1.UpgradeInstanceRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.redis.v1.UpgradeInstanceRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A\037\n\035redis.googleapis.com/Instance', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='redis_version', full_name='google.cloud.redis.v1.UpgradeInstanceRequest.redis_version', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLOUDREDIS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.cloud.redis.v1.CloudRedis.UpgradeInstance',
    index=4,
    containing_service=None,
    input_type=_UPGRADEINSTANCEREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002:\"5/v1/{name=projects/*/locations/*/instances/*}:upgrade:\001*\332A\022name,redis_version\312AI\n\036google.cloud.redis.v1.Instance\022\'google.cloud.redis.v1.OperationMetadata',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='ImportInstance',
