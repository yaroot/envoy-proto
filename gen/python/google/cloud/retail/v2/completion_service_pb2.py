...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/retail/v2/completion_service.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_cloud_dot_retail_dot_v2_dot_common__pb2.DESCRIPTOR,google_dot_cloud_dot_retail_dot_v2_dot_import__config__pb2.DESCRIPTOR,google_dot_longrunning_dot_operations__pb2.DESCRIPTOR,])
...
_COMPLETEQUERYREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2.CompleteQueryRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='catalog', full_name='google.cloud.retail.v2.CompleteQueryRequest.catalog', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='query', full_name='google.cloud.retail.v2.CompleteQueryRequest.query', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='visitor_id', full_name='google.cloud.retail.v2.CompleteQueryRequest.visitor_id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='language_codes', full_name='google.cloud.retail.v2.CompleteQueryRequest.language_codes', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='device_type', full_name='google.cloud.retail.v2.CompleteQueryRequest.device_type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dataset', full_name='google.cloud.retail.v2.CompleteQueryRequest.dataset', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_suggestions', full_name='google.cloud.retail.v2.CompleteQueryRequest.max_suggestions', index=6,
...
_COMPLETEQUERYRESPONSE_COMPLETIONRESULT_ATTRIBUTESENTRY = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2.CompleteQueryResponse.CompletionResult.AttributesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.retail.v2.CompleteQueryResponse.CompletionResult.AttributesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.retail.v2.CompleteQueryResponse.CompletionResult.AttributesEntry.value', index=1,
...
_COMPLETEQUERYRESPONSE_COMPLETIONRESULT = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2.CompleteQueryResponse.CompletionResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='suggestion', full_name='google.cloud.retail.v2.CompleteQueryResponse.CompletionResult.suggestion', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='google.cloud.retail.v2.CompleteQueryResponse.CompletionResult.attributes', index=1,
...
_COMPLETEQUERYRESPONSE_RECENTSEARCHRESULT = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2.CompleteQueryResponse.RecentSearchResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='recent_search', full_name='google.cloud.retail.v2.CompleteQueryResponse.RecentSearchResult.recent_search', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMPLETEQUERYRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2.CompleteQueryResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='completion_results', full_name='google.cloud.retail.v2.CompleteQueryResponse.completion_results', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attribution_token', full_name='google.cloud.retail.v2.CompleteQueryResponse.attribution_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='recent_search_results', full_name='google.cloud.retail.v2.CompleteQueryResponse.recent_search_results', index=2,
...
_COMPLETEQUERYRESPONSE_COMPLETIONRESULT_ATTRIBUTESENTRY.fields_by_name['value'].message_type = google_dot_cloud_dot_retail_dot_v2_dot_common__pb2._CUSTOMATTRIBUTE
...
_COMPLETIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.cloud.retail.v2.CompletionService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='CompleteQuery',
    full_name='google.cloud.retail.v2.CompletionService.CompleteQuery',
    index=0,
    containing_service=None,
    input_type=_COMPLETEQUERYREQUEST,
    output_type=_COMPLETEQUERYRESPONSE,
    serialized_options=b'\202\323\344\223\002?\022=/v2/{catalog=projects/*/locations/*/catalogs/*}:completeQuery',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='ImportCompletionData',
    full_name='google.cloud.retail.v2.CompletionService.ImportCompletionData',
    index=1,
    containing_service=None,
    input_type=google_dot_cloud_dot_retail_dot_v2_dot_import__config__pb2._IMPORTCOMPLETIONDATAREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002I\"D/v2/{parent=projects/*/locations/*/catalogs/*}/completionData:import:\001*\312A\\\n3google.cloud.retail.v2.ImportCompletionDataResponse\022%google.cloud.retail.v2.ImportMetadata',
    create_key=_descriptor._internal_create_key,
  ),
])
