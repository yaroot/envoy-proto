...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CONTROL.fields_by_name['search_solution_use_case']._options = None
  _CONTROL.fields_by_name['search_solution_use_case']._serialized_options = b'\340A\002'
