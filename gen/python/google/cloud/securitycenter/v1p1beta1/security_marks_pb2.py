...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1p1beta1/security_marks.proto',
...
_SECURITYMARKS_MARKSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.securitycenter.v1p1beta1.SecurityMarks.MarksEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.securitycenter.v1p1beta1.SecurityMarks.MarksEntry.value', index=1,
...
_SECURITYMARKS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.securitycenter.v1p1beta1.SecurityMarks.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='marks', full_name='google.cloud.securitycenter.v1p1beta1.SecurityMarks.marks', index=1,
