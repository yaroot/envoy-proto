...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1p1beta1/finding.proto',
...
_FINDING_SEVERITY = _descriptor.EnumDescriptor(
  name='Severity',
  full_name='google.cloud.securitycenter.v1p1beta1.Finding.Severity',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_FINDING_SOURCEPROPERTIESENTRY = _descriptor.Descriptor(
  ...
  full_name='google.cloud.securitycenter.v1p1beta1.Finding.SourcePropertiesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.securitycenter.v1p1beta1.Finding.SourcePropertiesEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.securitycenter.v1p1beta1.Finding.SourcePropertiesEntry.value', index=1,
...
_FINDING = _descriptor.Descriptor(
  name='Finding',
  full_name='google.cloud.securitycenter.v1p1beta1.Finding',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.securitycenter.v1p1beta1.Finding.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.securitycenter.v1p1beta1.Finding.parent', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.cloud.securitycenter.v1p1beta1.Finding.resource_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.securitycenter.v1p1beta1.Finding.state', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='category', full_name='google.cloud.securitycenter.v1p1beta1.Finding.category', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='external_uri', full_name='google.cloud.securitycenter.v1p1beta1.Finding.external_uri', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='source_properties', full_name='google.cloud.securitycenter.v1p1beta1.Finding.source_properties', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='security_marks', full_name='google.cloud.securitycenter.v1p1beta1.Finding.security_marks', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='event_time', full_name='google.cloud.securitycenter.v1p1beta1.Finding.event_time', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.securitycenter.v1p1beta1.Finding.create_time', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='severity', full_name='google.cloud.securitycenter.v1p1beta1.Finding.severity', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='canonical_name', full_name='google.cloud.securitycenter.v1p1beta1.Finding.canonical_name', index=11,
...
_FINDING.fields_by_name['security_marks'].message_type = google_dot_cloud_dot_securitycenter_dot_v1p1beta1_dot_security__marks__pb2._SECURITYMARKS
