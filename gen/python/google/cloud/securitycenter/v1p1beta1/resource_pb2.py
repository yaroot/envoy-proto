...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1p1beta1/resource.proto',
...
_RESOURCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.securitycenter.v1p1beta1.Resource.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='project', full_name='google.cloud.securitycenter.v1p1beta1.Resource.project', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='project_display_name', full_name='google.cloud.securitycenter.v1p1beta1.Resource.project_display_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.securitycenter.v1p1beta1.Resource.parent', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parent_display_name', full_name='google.cloud.securitycenter.v1p1beta1.Resource.parent_display_name', index=4,
