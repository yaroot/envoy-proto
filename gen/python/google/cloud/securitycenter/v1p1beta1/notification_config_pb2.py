...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1p1beta1/notification_config.proto',
...
_NOTIFICATIONCONFIG_STREAMINGCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='filter', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.StreamingConfig.filter', index=0,
...
_NOTIFICATIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.description', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='event_type', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.event_type', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pubsub_topic', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.pubsub_topic', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='service_account', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.service_account', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='streaming_config', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.streaming_config', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='notify_config', full_name='google.cloud.securitycenter.v1p1beta1.NotificationConfig.notify_config',
...
_NOTIFICATIONCONFIG.fields_by_name['event_type'].enum_type = _NOTIFICATIONCONFIG_EVENTTYPE
_NOTIFICATIONCONFIG.fields_by_name['streaming_config'].message_type = _NOTIFICATIONCONFIG_STREAMINGCONFIG
...
_NOTIFICATIONCONFIG.fields_by_name['streaming_config'].containing_oneof = _NOTIFICATIONCONFIG.oneofs_by_name['notify_config']
