...
_INSIGHT = _descriptor.Descriptor(
  ...
  serialized_options=b'\352A\365\002\n\"recommender.googleapis.com/Insight\022Vprojects/{project}/locations/{location}/insightTypes/{insight_type}/insights/{insight}\022ebillingAccounts/{billing_account}/locations/{location}/insightTypes/{insight_type}/insights/{insight}\022Afolders/{folder}/locations/{location}/insightTypes/{insight_type}\022Morganizations/{organization}/locations/{location}/insightTypes/{insight_type}',
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
