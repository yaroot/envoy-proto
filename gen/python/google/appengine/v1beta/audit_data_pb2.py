...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/appengine/v1beta/audit_data.proto',
  ...
  ,
  dependencies=[google_dot_appengine_dot_v1beta_dot_appengine__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_UPDATESERVICEMETHOD.fields_by_name['request'].message_type = google_dot_appengine_dot_v1beta_dot_appengine__pb2._UPDATESERVICEREQUEST
_CREATEVERSIONMETHOD.fields_by_name['request'].message_type = google_dot_appengine_dot_v1beta_dot_appengine__pb2._CREATEVERSIONREQUEST
