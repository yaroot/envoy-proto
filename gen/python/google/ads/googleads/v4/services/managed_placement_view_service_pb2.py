...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/managed_placement_view_service.proto',
...
GetManagedPlacementViewRequest = _reflection.GeneratedProtocolMessageType('GetManagedPlacementViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.managed_placement_view_service_pb2'
...
_MANAGEDPLACEMENTVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_managed__placement__view__pb2._MANAGEDPLACEMENTVIEW,
    serialized_options=b'\202\323\344\223\0029\0227/v4/{resource_name=customers/*/managedPlacementViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
