...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/third_party_app_analytics_link_service.proto',
...
GetThirdPartyAppAnalyticsLinkRequest = _reflection.GeneratedProtocolMessageType('GetThirdPartyAppAnalyticsLinkRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.third_party_app_analytics_link_service_pb2'
...
_THIRDPARTYAPPANALYTICSLINKSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_third__party__app__analytics__link__pb2._THIRDPARTYAPPANALYTICSLINK,
    serialized_options=b'\202\323\344\223\002?\022=/v4/{resource_name=customers/*/thirdPartyAppAnalyticsLinks/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
