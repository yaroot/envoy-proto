...
_GETDYNAMICSEARCHADSSEARCHTERMVIEWREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest.resource_name', index=0,
...
GetDynamicSearchAdsSearchTermViewRequest = _reflection.GeneratedProtocolMessageType('GetDynamicSearchAdsSearchTermViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.dynamic_search_ads_search_term_view_service_pb2'
...
_DYNAMICSEARCHADSSEARCHTERMVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v4.services.DynamicSearchAdsSearchTermViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v4.services.DynamicSearchAdsSearchTermViewService.GetDynamicSearchAdsSearchTermView',
    index=0,
    containing_service=None,
    input_type=_GETDYNAMICSEARCHADSSEARCHTERMVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_dynamic__search__ads__search__term__view__pb2._DYNAMICSEARCHADSSEARCHTERMVIEW,
    serialized_options=b'\202\323\344\223\002C\022A/v4/{resource_name=customers/*/dynamicSearchAdsSearchTermViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
