...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/ad_parameter_service.proto',
...
_ADPARAMETEROPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__parameter__pb2._ADPARAMETER
_ADPARAMETEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__parameter__pb2._ADPARAMETER
...
GetAdParameterRequest = _reflection.GeneratedProtocolMessageType('GetAdParameterRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.ad_parameter_service_pb2'
...
_ADPARAMETERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__parameter__pb2._ADPARAMETER,
    serialized_options=b'\202\323\344\223\0020\022./v4/{resource_name=customers/*/adParameters/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0026\"1/v4/customers/{customer_id=*}/adParameters:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
