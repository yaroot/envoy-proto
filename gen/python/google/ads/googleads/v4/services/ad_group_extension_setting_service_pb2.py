...
_GETADGROUPEXTENSIONSETTINGREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.GetAdGroupExtensionSettingRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.services.GetAdGroupExtensionSettingRequest.resource_name', index=0,
...
_MUTATEADGROUPEXTENSIONSETTINGSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsRequest.validate_only', index=3,
...
_ADGROUPEXTENSIONSETTINGOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingOperation.operation',
...
_MUTATEADGROUPEXTENSIONSETTINGSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEADGROUPEXTENSIONSETTINGRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.services.MutateAdGroupExtensionSettingResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADGROUPEXTENSIONSETTINGOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__group__extension__setting__pb2._ADGROUPEXTENSIONSETTING
_ADGROUPEXTENSIONSETTINGOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__group__extension__setting__pb2._ADGROUPEXTENSIONSETTING
...
GetAdGroupExtensionSettingRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupExtensionSettingRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.ad_group_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.services.GetAdGroupExtensionSettingRequest)
  })
...
MutateAdGroupExtensionSettingsRequest = _reflection.GeneratedProtocolMessageType('MutateAdGroupExtensionSettingsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.ad_group_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsRequest)
  })
...
MutateAdGroupExtensionSettingsResponse = _reflection.GeneratedProtocolMessageType('MutateAdGroupExtensionSettingsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.ad_group_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsResponse)
  })
...
MutateAdGroupExtensionSettingResult = _reflection.GeneratedProtocolMessageType('MutateAdGroupExtensionSettingResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.ad_group_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.services.MutateAdGroupExtensionSettingResult)
  })
...
_ADGROUPEXTENSIONSETTINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingService.GetAdGroupExtensionSetting',
    index=0,
    containing_service=None,
    input_type=_GETADGROUPEXTENSIONSETTINGREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__group__extension__setting__pb2._ADGROUPEXTENSIONSETTING,
    serialized_options=b'\202\323\344\223\002<\022:/v4/{resource_name=customers/*/adGroupExtensionSettings/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateAdGroupExtensionSettings',
    full_name='google.ads.googleads.v4.services.AdGroupExtensionSettingService.MutateAdGroupExtensionSettings',
    index=1,
    containing_service=None,
    input_type=_MUTATEADGROUPEXTENSIONSETTINGSREQUEST,
    output_type=_MUTATEADGROUPEXTENSIONSETTINGSRESPONSE,
    serialized_options=b'\202\323\344\223\002B\"=/v4/customers/{customer_id=*}/adGroupExtensionSettings:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
