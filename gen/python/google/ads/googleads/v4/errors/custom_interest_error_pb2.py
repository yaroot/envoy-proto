...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/custom_interest_error.proto',
...
CustomInterestErrorEnum = _reflection.GeneratedProtocolMessageType('CustomInterestErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.custom_interest_error_pb2'
