...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/media_bundle_error.proto',
...
MediaBundleErrorEnum = _reflection.GeneratedProtocolMessageType('MediaBundleErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.media_bundle_error_pb2'
