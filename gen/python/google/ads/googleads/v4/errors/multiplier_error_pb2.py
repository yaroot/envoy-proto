...
_MULTIPLIERERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.errors.MultiplierErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
MultiplierErrorEnum = _reflection.GeneratedProtocolMessageType('MultiplierErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.multiplier_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.errors.MultiplierErrorEnum)
  })
