...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/change_status_error.proto',
...
ChangeStatusErrorEnum = _reflection.GeneratedProtocolMessageType('ChangeStatusErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.change_status_error_pb2'
