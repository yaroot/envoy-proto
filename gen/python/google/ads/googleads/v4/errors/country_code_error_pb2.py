...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/country_code_error.proto',
...
CountryCodeErrorEnum = _reflection.GeneratedProtocolMessageType('CountryCodeErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.country_code_error_pb2'
