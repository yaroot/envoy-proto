...
_AUTHENTICATIONERRORENUM_AUTHENTICATIONERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v4.errors.AuthenticationErrorEnum.AuthenticationError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_AUTHENTICATIONERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.errors.AuthenticationErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
AuthenticationErrorEnum = _reflection.GeneratedProtocolMessageType('AuthenticationErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.authentication_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.errors.AuthenticationErrorEnum)
  })
