...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/function_error.proto',
...
FunctionErrorEnum = _reflection.GeneratedProtocolMessageType('FunctionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.function_error_pb2'
