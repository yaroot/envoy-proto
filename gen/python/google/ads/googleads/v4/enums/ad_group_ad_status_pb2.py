...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/enums/ad_group_ad_status.proto',
...
AdGroupAdStatusEnum = _reflection.GeneratedProtocolMessageType('AdGroupAdStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.enums.ad_group_ad_status_pb2'
