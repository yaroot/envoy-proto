...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/enums/change_status_resource_type.proto',
...
ChangeStatusResourceTypeEnum = _reflection.GeneratedProtocolMessageType('ChangeStatusResourceTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.enums.change_status_resource_type_pb2'
