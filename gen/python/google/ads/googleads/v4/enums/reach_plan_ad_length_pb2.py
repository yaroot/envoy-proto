...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/enums/reach_plan_ad_length.proto',
...
ReachPlanAdLengthEnum = _reflection.GeneratedProtocolMessageType('ReachPlanAdLengthEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.enums.reach_plan_ad_length_pb2'
