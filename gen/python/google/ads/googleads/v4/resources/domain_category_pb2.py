...
_DOMAINCATEGORY = _descriptor.Descriptor(
  name='DomainCategory',
  full_name='google.ads.googleads.v4.resources.DomainCategory',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.DomainCategory.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='campaign', full_name='google.ads.googleads.v4.resources.DomainCategory.campaign', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='category', full_name='google.ads.googleads.v4.resources.DomainCategory.category', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='language_code', full_name='google.ads.googleads.v4.resources.DomainCategory.language_code', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='domain', full_name='google.ads.googleads.v4.resources.DomainCategory.domain', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='coverage_fraction', full_name='google.ads.googleads.v4.resources.DomainCategory.coverage_fraction', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='category_rank', full_name='google.ads.googleads.v4.resources.DomainCategory.category_rank', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='has_children', full_name='google.ads.googleads.v4.resources.DomainCategory.has_children', index=7,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='recommended_cpc_bid_micros', full_name='google.ads.googleads.v4.resources.DomainCategory.recommended_cpc_bid_micros', index=8,
...
DomainCategory = _reflection.GeneratedProtocolMessageType('DomainCategory', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.domain_category_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.resources.DomainCategory)
  })
