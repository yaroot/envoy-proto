...
_CARRIERCONSTANT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.CarrierConstant',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.CarrierConstant.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v4.resources.CarrierConstant.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v4.resources.CarrierConstant.name', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='country_code', full_name='google.ads.googleads.v4.resources.CarrierConstant.country_code', index=3,
...
CarrierConstant = _reflection.GeneratedProtocolMessageType('CarrierConstant', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.carrier_constant_pb2'
