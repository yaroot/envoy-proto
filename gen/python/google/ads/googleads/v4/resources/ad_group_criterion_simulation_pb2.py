...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/resources/ad_group_criterion_simulation.proto',
  package='google.ads.googleads.v4.resources',
  syntax='proto3',
  serialized_options=b'\n%com.google.ads.googleads.v4.resourcesB\037AdGroupCriterionSimulationProtoP\001ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v4/resources;resources\242\002\003GAA\252\002!Google.Ads.GoogleAds.V4.Resources\312\002!Google\\Ads\\GoogleAds\\V4\\Resources\352\002%Google::Ads::GoogleAds::V4::Resources',
...
_ADGROUPCRITERIONSIMULATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group_id', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.ad_group_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='criterion_id', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.criterion_id', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.type', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='modification_method', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.modification_method', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_date', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.start_date', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.end_date', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpc_bid_point_list', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.cpc_bid_point_list', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='point_list', full_name='google.ads.googleads.v4.resources.AdGroupCriterionSimulation.point_list',
...
_ADGROUPCRITERIONSIMULATION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_simulation__type__pb2._SIMULATIONTYPEENUM_SIMULATIONTYPE
_ADGROUPCRITERIONSIMULATION.fields_by_name['modification_method'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_simulation__modification__method__pb2._SIMULATIONMODIFICATIONMETHODENUM_SIMULATIONMODIFICATIONMETHOD
...
_ADGROUPCRITERIONSIMULATION.fields_by_name['cpc_bid_point_list'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_simulation__pb2._CPCBIDSIMULATIONPOINTLIST
...
AdGroupCriterionSimulation = _reflection.GeneratedProtocolMessageType('AdGroupCriterionSimulation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.ad_group_criterion_simulation_pb2'
