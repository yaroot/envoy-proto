...
_KEYWORDPLANCAMPAIGN = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.keyword_plan', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='language_constants', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.language_constants', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan_network', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.keyword_plan_network', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpc_bid_micros', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.cpc_bid_micros', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='geo_targets', full_name='google.ads.googleads.v4.resources.KeywordPlanCampaign.geo_targets', index=7,
...
_KEYWORDPLANGEOTARGET = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.KeywordPlanGeoTarget',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='geo_target_constant', full_name='google.ads.googleads.v4.resources.KeywordPlanGeoTarget.geo_target_constant', index=0,
...
_KEYWORDPLANCAMPAIGN.fields_by_name['keyword_plan_network'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_keyword__plan__network__pb2._KEYWORDPLANNETWORKENUM_KEYWORDPLANNETWORK
...
KeywordPlanCampaign = _reflection.GeneratedProtocolMessageType('KeywordPlanCampaign', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.keyword_plan_campaign_pb2'
