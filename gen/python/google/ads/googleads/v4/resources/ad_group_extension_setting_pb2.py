...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/resources/ad_group_extension_setting.proto',
  package='google.ads.googleads.v4.resources',
  syntax='proto3',
  serialized_options=b'\n%com.google.ads.googleads.v4.resourcesB\034AdGroupExtensionSettingProtoP\001ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v4/resources;resources\242\002\003GAA\252\002!Google.Ads.GoogleAds.V4.Resources\312\002!Google\\Ads\\GoogleAds\\V4\\Resources\352\002%Google::Ads::GoogleAds::V4::Resources',
...
_ADGROUPEXTENSIONSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.AdGroupExtensionSetting',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.AdGroupExtensionSetting.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='extension_type', full_name='google.ads.googleads.v4.resources.AdGroupExtensionSetting.extension_type', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group', full_name='google.ads.googleads.v4.resources.AdGroupExtensionSetting.ad_group', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='extension_feed_items', full_name='google.ads.googleads.v4.resources.AdGroupExtensionSetting.extension_feed_items', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='device', full_name='google.ads.googleads.v4.resources.AdGroupExtensionSetting.device', index=4,
...
_ADGROUPEXTENSIONSETTING.fields_by_name['extension_type'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_extension__type__pb2._EXTENSIONTYPEENUM_EXTENSIONTYPE
...
_ADGROUPEXTENSIONSETTING.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_extension__setting__device__pb2._EXTENSIONSETTINGDEVICEENUM_EXTENSIONSETTINGDEVICE
...
AdGroupExtensionSetting = _reflection.GeneratedProtocolMessageType('AdGroupExtensionSetting', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.ad_group_extension_setting_pb2'
