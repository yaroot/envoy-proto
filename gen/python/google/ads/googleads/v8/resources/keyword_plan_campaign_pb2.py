...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/keyword_plan_campaign.proto',
...
_KEYWORDPLANCAMPAIGN = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.keyword_plan', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='language_constants', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.language_constants', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan_network', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.keyword_plan_network', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpc_bid_micros', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.cpc_bid_micros', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='geo_targets', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign.geo_targets', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_keyword_plan', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign._keyword_plan',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign._id',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_name', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign._name',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_cpc_bid_micros', full_name='google.ads.googleads.v8.resources.KeywordPlanCampaign._cpc_bid_micros',
...
_KEYWORDPLANGEOTARGET = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.KeywordPlanGeoTarget',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='geo_target_constant', full_name='google.ads.googleads.v8.resources.KeywordPlanGeoTarget.geo_target_constant', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_geo_target_constant', full_name='google.ads.googleads.v8.resources.KeywordPlanGeoTarget._geo_target_constant',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_KEYWORDPLANCAMPAIGN.fields_by_name['keyword_plan_network'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_keyword__plan__network__pb2._KEYWORDPLANNETWORKENUM_KEYWORDPLANNETWORK
