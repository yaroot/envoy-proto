...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/keyword_plan_ad_group_keyword.proto',
...
_KEYWORDPLANADGROUPKEYWORD = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan_ad_group', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword.keyword_plan_ad_group', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword.id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='text', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword.text', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='match_type', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword.match_type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpc_bid_micros', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword.cpc_bid_micros', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='negative', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword.negative', index=6,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_keyword_plan_ad_group', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword._keyword_plan_ad_group',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword._id',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_text', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword._text',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_cpc_bid_micros', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword._cpc_bid_micros',
      index=3, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_negative', full_name='google.ads.googleads.v8.resources.KeywordPlanAdGroupKeyword._negative',
...
_KEYWORDPLANADGROUPKEYWORD.fields_by_name['match_type'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_keyword__match__type__pb2._KEYWORDMATCHTYPEENUM_KEYWORDMATCHTYPE
