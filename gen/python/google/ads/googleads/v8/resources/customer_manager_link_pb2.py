...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/customer_manager_link.proto',
...
_CUSTOMERMANAGERLINK = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.CustomerManagerLink',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.CustomerManagerLink.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='manager_customer', full_name='google.ads.googleads.v8.resources.CustomerManagerLink.manager_customer', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='manager_link_id', full_name='google.ads.googleads.v8.resources.CustomerManagerLink.manager_link_id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v8.resources.CustomerManagerLink.status', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_manager_customer', full_name='google.ads.googleads.v8.resources.CustomerManagerLink._manager_customer',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_manager_link_id', full_name='google.ads.googleads.v8.resources.CustomerManagerLink._manager_link_id',
...
_CUSTOMERMANAGERLINK.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_manager__link__status__pb2._MANAGERLINKSTATUSENUM_MANAGERLINKSTATUS
