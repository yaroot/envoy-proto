...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/ad_group_ad.proto',
...
_ADGROUPAD = _descriptor.Descriptor(
  name='AdGroupAd',
  full_name='google.ads.googleads.v8.resources.AdGroupAd',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.AdGroupAd.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v8.resources.AdGroupAd.status', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group', full_name='google.ads.googleads.v8.resources.AdGroupAd.ad_group', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='ad', full_name='google.ads.googleads.v8.resources.AdGroupAd.ad', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='policy_summary', full_name='google.ads.googleads.v8.resources.AdGroupAd.policy_summary', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='ad_strength', full_name='google.ads.googleads.v8.resources.AdGroupAd.ad_strength', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='action_items', full_name='google.ads.googleads.v8.resources.AdGroupAd.action_items', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='labels', full_name='google.ads.googleads.v8.resources.AdGroupAd.labels', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_ad_group', full_name='google.ads.googleads.v8.resources.AdGroupAd._ad_group',
...
_ADGROUPADPOLICYSUMMARY = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.AdGroupAdPolicySummary',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='policy_topic_entries', full_name='google.ads.googleads.v8.resources.AdGroupAdPolicySummary.policy_topic_entries', index=0,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='review_status', full_name='google.ads.googleads.v8.resources.AdGroupAdPolicySummary.review_status', index=1,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='approval_status', full_name='google.ads.googleads.v8.resources.AdGroupAdPolicySummary.approval_status', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADGROUPAD.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_ad__group__ad__status__pb2._ADGROUPADSTATUSENUM_ADGROUPADSTATUS
_ADGROUPAD.fields_by_name['ad'].message_type = google_dot_ads_dot_googleads_dot_v8_dot_resources_dot_ad__pb2._AD
_ADGROUPAD.fields_by_name['policy_summary'].message_type = _ADGROUPADPOLICYSUMMARY
_ADGROUPAD.fields_by_name['ad_strength'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_ad__strength__pb2._ADSTRENGTHENUM_ADSTRENGTH
...
_ADGROUPADPOLICYSUMMARY.fields_by_name['policy_topic_entries'].message_type = google_dot_ads_dot_googleads_dot_v8_dot_common_dot_policy__pb2._POLICYTOPICENTRY
_ADGROUPADPOLICYSUMMARY.fields_by_name['review_status'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_policy__review__status__pb2._POLICYREVIEWSTATUSENUM_POLICYREVIEWSTATUS
_ADGROUPADPOLICYSUMMARY.fields_by_name['approval_status'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_policy__approval__status__pb2._POLICYAPPROVALSTATUSENUM_POLICYAPPROVALSTATUS
