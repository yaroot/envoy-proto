...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/services/group_placement_view_service.proto',
...
_GETGROUPPLACEMENTVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.services.GetGroupPlacementViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.services.GetGroupPlacementViewRequest.resource_name', index=0,
...
_GROUPPLACEMENTVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v8.services.GroupPlacementViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v8.services.GroupPlacementViewService.GetGroupPlacementView',
    index=0,
    containing_service=None,
    input_type=_GETGROUPPLACEMENTVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v8_dot_resources_dot_group__placement__view__pb2._GROUPPLACEMENTVIEW,
    serialized_options=b'\202\323\344\223\0027\0225/v8/{resource_name=customers/*/groupPlacementViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
