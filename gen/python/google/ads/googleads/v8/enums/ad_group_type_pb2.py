...
_ADGROUPTYPEENUM_ADGROUPTYPE = _descriptor.EnumDescriptor(
  name='AdGroupType',
  full_name='google.ads.googleads.v8.enums.AdGroupTypeEnum.AdGroupType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ADGROUPTYPEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.enums.AdGroupTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
AdGroupTypeEnum = _reflection.GeneratedProtocolMessageType('AdGroupTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v8.enums.ad_group_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v8.enums.AdGroupTypeEnum)
  })
