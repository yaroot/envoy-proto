...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/common/asset_policy.proto',
...
_ADASSETPOLICYSUMMARY = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.common.AdAssetPolicySummary',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='policy_topic_entries', full_name='google.ads.googleads.v8.common.AdAssetPolicySummary.policy_topic_entries', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='review_status', full_name='google.ads.googleads.v8.common.AdAssetPolicySummary.review_status', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='approval_status', full_name='google.ads.googleads.v8.common.AdAssetPolicySummary.approval_status', index=2,
...
_ADASSETPOLICYSUMMARY.fields_by_name['policy_topic_entries'].message_type = google_dot_ads_dot_googleads_dot_v8_dot_common_dot_policy__pb2._POLICYTOPICENTRY
_ADASSETPOLICYSUMMARY.fields_by_name['review_status'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_policy__review__status__pb2._POLICYREVIEWSTATUSENUM_POLICYREVIEWSTATUS
_ADASSETPOLICYSUMMARY.fields_by_name['approval_status'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_policy__approval__status__pb2._POLICYAPPROVALSTATUSENUM_POLICYAPPROVALSTATUS
