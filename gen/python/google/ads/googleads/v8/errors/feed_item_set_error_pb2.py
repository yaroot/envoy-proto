...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/errors/feed_item_set_error.proto',
...
_FEEDITEMSETERRORENUM_FEEDITEMSETERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v8.errors.FeedItemSetErrorEnum.FeedItemSetError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DYNAMIC_FILTER_INVALID_CHAIN_IDS', index=8, number=8,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_FEEDITEMSETERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.errors.FeedItemSetErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
