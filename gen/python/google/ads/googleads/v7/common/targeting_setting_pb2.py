...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/common/targeting_setting.proto',
  ...
  serialized_pb=b'\n6google/ads/googleads/v7/common/targeting_setting.proto\x12\x1egoogle.ads.googleads.v7.common\x1a\x37google/ads/googleads/v7/enums/targeting_dimension.proto\x1a\x1cgoogle/api/annotations.proto\"\xc5\x01\n\x10TargetingSetting\x12N\n\x13target_restrictions\x18\x01 \x03(\x0b\x32\x31.google.ads.googleads.v7.common.TargetRestriction\x12\x61\n\x1dtarget_restriction_operations\x18\x02 \x03(\x0b\x32:.google.ads.googleads.v7.common.TargetRestrictionOperation\"\x9e\x01\n\x11TargetRestriction\x12\x65\n\x13targeting_dimension\x18\x01 \x01(\x0e\x32H.google.ads.googleads.v7.enums.TargetingDimensionEnum.TargetingDimension\x12\x15\n\x08\x62id_only\x18\x03 \x01(\x08H\x00\x88\x01\x01\x42\x0b\n\t_bid_only\"\xf4\x01\n\x1aTargetRestrictionOperation\x12U\n\x08operator\x18\x01 \x01(\x0e\x32\x43.google.ads.googleads.v7.common.TargetRestrictionOperation.Operator\x12@\n\x05value\x18\x02 \x01(\x0b\x32\x31.google.ads.googleads.v7.common.TargetRestriction\"=\n\x08Operator\x12\x0f\n\x0bUNSPECIFIED\x10\x00\x12\x0b\n\x07UNKNOWN\x10\x01\x12\x07\n\x03\x41\x44\x44\x10\x02\x12\n\n\x06REMOVE\x10\x03\x42\xf0\x01\n\"com.google.ads.googleads.v7.commonB\x15TargetingSettingProtoP\x01ZDgoogle.golang.org/genproto/googleapis/ads/googleads/v7/common;common\xa2\x02\x03GAA\xaa\x02\x1eGoogle.Ads.GoogleAds.V7.Common\xca\x02\x1eGoogle\\Ads\\GoogleAds\\V7\\Common\xea\x02\"Google::Ads::GoogleAds::V7::Commonb\x06proto3'
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_targeting__dimension__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])



_TARGETRESTRICTIONOPERATION_OPERATOR = _descriptor.EnumDescriptor(
  name='Operator',
  full_name='google.ads.googleads.v7.common.TargetRestrictionOperation.Operator',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_TARGETINGSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.common.TargetingSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='target_restrictions', full_name='google.ads.googleads.v7.common.TargetingSetting.target_restrictions', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='target_restriction_operations', full_name='google.ads.googleads.v7.common.TargetingSetting.target_restriction_operations', index=1,
...
_TARGETRESTRICTION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.common.TargetRestriction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='targeting_dimension', full_name='google.ads.googleads.v7.common.TargetRestriction.targeting_dimension', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bid_only', full_name='google.ads.googleads.v7.common.TargetRestriction.bid_only', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_bid_only', full_name='google.ads.googleads.v7.common.TargetRestriction._bid_only',
...
_TARGETRESTRICTIONOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.common.TargetRestrictionOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operator', full_name='google.ads.googleads.v7.common.TargetRestrictionOperation.operator', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='google.ads.googleads.v7.common.TargetRestrictionOperation.value', index=1,
...
_TARGETRESTRICTION.fields_by_name['targeting_dimension'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_targeting__dimension__pb2._TARGETINGDIMENSIONENUM_TARGETINGDIMENSION
