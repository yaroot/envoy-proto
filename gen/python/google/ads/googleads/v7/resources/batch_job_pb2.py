...
from google.ads.googleads.v7.enums import batch_job_status_pb2 as google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_batch__job__status__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/batch_job.proto',
  package='google.ads.googleads.v7.resources',
  syntax='proto3',
  serialized_options=b'\n%com.google.ads.googleads.v7.resourcesB\rBatchJobProtoP\001ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v7/resources;resources\242\002\003GAA\252\002!Google.Ads.GoogleAds.V7.Resources\312\002!Google\\Ads\\GoogleAds\\V7\\Resources\352\002%Google::Ads::GoogleAds::V7::Resources',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n1google/ads/googleads/v7/resources/batch_job.proto\x12!google.ads.googleads.v7.resources\x1a\x34google/ads/googleads/v7/enums/batch_job_status.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/api/annotations.proto\"\x92\x07\n\x08\x42\x61tchJob\x12@\n\rresource_name\x18\x01 \x01(\tB)\xe0\x41\x05\xfa\x41#\n!googleads.googleapis.com/BatchJob\x12\x14\n\x02id\x18\x07 \x01(\x03\x42\x03\xe0\x41\x03H\x00\x88\x01\x01\x12)\n\x17next_add_sequence_token\x18\x08 \x01(\tB\x03\xe0\x41\x03H\x01\x88\x01\x01\x12S\n\x08metadata\x18\x04 \x01(\x0b\x32<.google.ads.googleads.v7.resources.BatchJob.BatchJobMetadataB\x03\xe0\x41\x03\x12U\n\x06status\x18\x05 \x01(\x0e\x32@.google.ads.googleads.v7.enums.BatchJobStatusEnum.BatchJobStatusB\x03\xe0\x41\x03\x12(\n\x16long_running_operation\x18\t \x01(\tB\x03\xe0\x41\x03H\x02\x88\x01\x01\x1a\x94\x03\n\x10\x42\x61tchJobMetadata\x12$\n\x12\x63reation_date_time\x18\x08 \x01(\tB\x03\xe0\x41\x03H\x00\x88\x01\x01\x12!\n\x0fstart_date_time\x18\x07 \x01(\tB\x03\xe0\x41\x03H\x01\x88\x01\x01\x12&\n\x14\x63ompletion_date_time\x18\t \x01(\tB\x03\xe0\x41\x03H\x02\x88\x01\x01\x12,\n\x1a\x65stimated_completion_ratio\x18\n \x01(\x01\x42\x03\xe0\x41\x03H\x03\x88\x01\x01\x12!\n\x0foperation_count\x18\x0b \x01(\x03\x42\x03\xe0\x41\x03H\x04\x88\x01\x01\x12*\n\x18\x65xecuted_operation_count\x18\x0c \x01(\x03\x42\x03\xe0\x41\x03H\x05\x88\x01\x01\x42\x15\n\x13_creation_date_timeB\x12\n\x10_start_date_timeB\x17\n\x15_completion_date_timeB\x1d\n\x1b_estimated_completion_ratioB\x12\n\x10_operation_countB\x1b\n\x19_executed_operation_count:X\xea\x41U\n!googleads.googleapis.com/BatchJob\x12\x30\x63ustomers/{customer_id}/batchJobs/{batch_job_id}B\x05\n\x03_idB\x1a\n\x18_next_add_sequence_tokenB\x19\n\x17_long_running_operationB\xfa\x01\n%com.google.ads.googleads.v7.resourcesB\rBatchJobProtoP\x01ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v7/resources;resources\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V7.Resources\xca\x02!Google\\Ads\\GoogleAds\\V7\\Resources\xea\x02%Google::Ads::GoogleAds::V7::Resourcesb\x06proto3'
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_batch__job__status__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_BATCHJOB_BATCHJOBMETADATA = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='creation_date_time', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata.creation_date_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='start_date_time', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata.start_date_time', index=1,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='completion_date_time', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata.completion_date_time', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='estimated_completion_ratio', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata.estimated_completion_ratio', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='operation_count', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata.operation_count', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='executed_operation_count', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata.executed_operation_count', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_creation_date_time', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata._creation_date_time',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_start_date_time', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata._start_date_time',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_completion_date_time', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata._completion_date_time',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_estimated_completion_ratio', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata._estimated_completion_ratio',
      index=3, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_operation_count', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata._operation_count',
      index=4, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_executed_operation_count', full_name='google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata._executed_operation_count',
...
_BATCHJOB = _descriptor.Descriptor(
  name='BatchJob',
  full_name='google.ads.googleads.v7.resources.BatchJob',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.BatchJob.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v7.resources.BatchJob.id', index=1,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='next_add_sequence_token', full_name='google.ads.googleads.v7.resources.BatchJob.next_add_sequence_token', index=2,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='google.ads.googleads.v7.resources.BatchJob.metadata', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v7.resources.BatchJob.status', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='long_running_operation', full_name='google.ads.googleads.v7.resources.BatchJob.long_running_operation', index=5,
      number=9, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v7.resources.BatchJob._id',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_next_add_sequence_token', full_name='google.ads.googleads.v7.resources.BatchJob._next_add_sequence_token',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_long_running_operation', full_name='google.ads.googleads.v7.resources.BatchJob._long_running_operation',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_BATCHJOB.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_batch__job__status__pb2._BATCHJOBSTATUSENUM_BATCHJOBSTATUS
...
BatchJob = _reflection.GeneratedProtocolMessageType('BatchJob', (_message.Message,), {
  ...
  'BatchJobMetadata' : _reflection.GeneratedProtocolMessageType('BatchJobMetadata', (_message.Message,), {
    ...
    '__module__' : 'google.ads.googleads.v7.resources.batch_job_pb2'
    # @@protoc_insertion_point(class_scope:google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata)
    })
  ,
  'DESCRIPTOR' : _BATCHJOB,
  '__module__' : 'google.ads.googleads.v7.resources.batch_job_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v7.resources.BatchJob)
  })
