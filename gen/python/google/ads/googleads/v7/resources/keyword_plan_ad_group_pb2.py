...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/keyword_plan_ad_group.proto',
  package='google.ads.googleads.v7.resources',
  syntax='proto3',
  serialized_options=b'\n%com.google.ads.googleads.v7.resourcesB\027KeywordPlanAdGroupProtoP\001ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v7/resources;resources\242\002\003GAA\252\002!Google.Ads.GoogleAds.V7.Resources\312\002!Google\\Ads\\GoogleAds\\V7\\Resources\352\002%Google::Ads::GoogleAds::V7::Resources',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n=google/ads/googleads/v7/resources/keyword_plan_ad_group.proto\x12!google.ads.googleads.v7.resources\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/api/annotations.proto\"\xb4\x03\n\x12KeywordPlanAdGroup\x12J\n\rresource_name\x18\x01 \x01(\tB3\xe0\x41\x05\xfa\x41-\n+googleads.googleapis.com/KeywordPlanAdGroup\x12U\n\x15keyword_plan_campaign\x18\x06 \x01(\tB1\xfa\x41.\n,googleads.googleapis.com/KeywordPlanCampaignH\x00\x88\x01\x01\x12\x14\n\x02id\x18\x07 \x01(\x03\x42\x03\xe0\x41\x03H\x01\x88\x01\x01\x12\x11\n\x04name\x18\x08 \x01(\tH\x02\x88\x01\x01\x12\x1b\n\x0e\x63pc_bid_micros\x18\t \x01(\x03H\x03\x88\x01\x01:x\xea\x41u\n+googleads.googleapis.com/KeywordPlanAdGroup\x12\x46\x63ustomers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}B\x18\n\x16_keyword_plan_campaignB\x05\n\x03_idB\x07\n\x05_nameB\x11\n\x0f_cpc_bid_microsB\x84\x02\n%com.google.ads.googleads.v7.resourcesB\x17KeywordPlanAdGroupProtoP\x01ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v7/resources;resources\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V7.Resources\xca\x02!Google\\Ads\\GoogleAds\\V7\\Resources\xea\x02%Google::Ads::GoogleAds::V7::Resourcesb\x06proto3'
  ,
...
_KEYWORDPLANADGROUP = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan_campaign', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup.keyword_plan_campaign', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup.id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='cpc_bid_micros', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup.cpc_bid_micros', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_keyword_plan_campaign', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup._keyword_plan_campaign',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup._id',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_name', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup._name',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_cpc_bid_micros', full_name='google.ads.googleads.v7.resources.KeywordPlanAdGroup._cpc_bid_micros',
...
KeywordPlanAdGroup = _reflection.GeneratedProtocolMessageType('KeywordPlanAdGroup', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.resources.keyword_plan_ad_group_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v7.resources.KeywordPlanAdGroup)
  })
