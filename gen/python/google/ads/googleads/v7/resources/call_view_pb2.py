...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/call_view.proto',
...
_CALLVIEW = _descriptor.Descriptor(
  name='CallView',
  full_name='google.ads.googleads.v7.resources.CallView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.CallView.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='caller_region_code', full_name='google.ads.googleads.v7.resources.CallView.caller_region_code', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='caller_area_code', full_name='google.ads.googleads.v7.resources.CallView.caller_area_code', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='call_duration_seconds', full_name='google.ads.googleads.v7.resources.CallView.call_duration_seconds', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_call_date_time', full_name='google.ads.googleads.v7.resources.CallView.start_call_date_time', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_call_date_time', full_name='google.ads.googleads.v7.resources.CallView.end_call_date_time', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='call_tracking_display_location', full_name='google.ads.googleads.v7.resources.CallView.call_tracking_display_location', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v7.resources.CallView.type', index=7,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='call_status', full_name='google.ads.googleads.v7.resources.CallView.call_status', index=8,
...
_CALLVIEW.fields_by_name['call_tracking_display_location'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_call__tracking__display__location__pb2._CALLTRACKINGDISPLAYLOCATIONENUM_CALLTRACKINGDISPLAYLOCATION
_CALLVIEW.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_call__type__pb2._CALLTYPEENUM_CALLTYPE
_CALLVIEW.fields_by_name['call_status'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_google__voice__call__status__pb2._GOOGLEVOICECALLSTATUSENUM_GOOGLEVOICECALLSTATUS
