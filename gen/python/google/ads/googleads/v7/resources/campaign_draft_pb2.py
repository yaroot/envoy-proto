...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/campaign_draft.proto',
...
_CAMPAIGNDRAFT = _descriptor.Descriptor(
  name='CampaignDraft',
  full_name='google.ads.googleads.v7.resources.CampaignDraft',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.CampaignDraft.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='draft_id', full_name='google.ads.googleads.v7.resources.CampaignDraft.draft_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='base_campaign', full_name='google.ads.googleads.v7.resources.CampaignDraft.base_campaign', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v7.resources.CampaignDraft.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='draft_campaign', full_name='google.ads.googleads.v7.resources.CampaignDraft.draft_campaign', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v7.resources.CampaignDraft.status', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='has_experiment_running', full_name='google.ads.googleads.v7.resources.CampaignDraft.has_experiment_running', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='long_running_operation', full_name='google.ads.googleads.v7.resources.CampaignDraft.long_running_operation', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_draft_id', full_name='google.ads.googleads.v7.resources.CampaignDraft._draft_id',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_base_campaign', full_name='google.ads.googleads.v7.resources.CampaignDraft._base_campaign',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_name', full_name='google.ads.googleads.v7.resources.CampaignDraft._name',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_draft_campaign', full_name='google.ads.googleads.v7.resources.CampaignDraft._draft_campaign',
      index=3, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_has_experiment_running', full_name='google.ads.googleads.v7.resources.CampaignDraft._has_experiment_running',
      index=4, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_long_running_operation', full_name='google.ads.googleads.v7.resources.CampaignDraft._long_running_operation',
...
_CAMPAIGNDRAFT.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_campaign__draft__status__pb2._CAMPAIGNDRAFTSTATUSENUM_CAMPAIGNDRAFTSTATUS
