...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/keyword_plan_campaign.proto',
  package='google.ads.googleads.v7.resources',
  syntax='proto3',
  serialized_options=b'\n%com.google.ads.googleads.v7.resourcesB\030KeywordPlanCampaignProtoP\001ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v7/resources;resources\242\002\003GAA\252\002!Google.Ads.GoogleAds.V7.Resources\312\002!Google\\Ads\\GoogleAds\\V7\\Resources\352\002%Google::Ads::GoogleAds::V7::Resources',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n=google/ads/googleads/v7/resources/keyword_plan_campaign.proto\x12!google.ads.googleads.v7.resources\x1a\x38google/ads/googleads/v7/enums/keyword_plan_network.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/api/annotations.proto\"\xa0\x05\n\x13KeywordPlanCampaign\x12K\n\rresource_name\x18\x01 \x01(\tB4\xe0\x41\x05\xfa\x41.\n,googleads.googleapis.com/KeywordPlanCampaign\x12\x44\n\x0ckeyword_plan\x18\t \x01(\tB)\xfa\x41&\n$googleads.googleapis.com/KeywordPlanH\x00\x88\x01\x01\x12\x14\n\x02id\x18\n \x01(\x03\x42\x03\xe0\x41\x03H\x01\x88\x01\x01\x12\x11\n\x04name\x18\x0b \x01(\tH\x02\x88\x01\x01\x12J\n\x12language_constants\x18\x0c \x03(\tB.\xfa\x41+\n)googleads.googleapis.com/LanguageConstant\x12\x66\n\x14keyword_plan_network\x18\x06 \x01(\x0e\x32H.google.ads.googleads.v7.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork\x12\x1b\n\x0e\x63pc_bid_micros\x18\r \x01(\x03H\x03\x88\x01\x01\x12L\n\x0bgeo_targets\x18\x08 \x03(\x0b\x32\x37.google.ads.googleads.v7.resources.KeywordPlanGeoTarget:z\xea\x41w\n,googleads.googleapis.com/KeywordPlanCampaign\x12Gcustomers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}B\x0f\n\r_keyword_planB\x05\n\x03_idB\x07\n\x05_nameB\x11\n\x0f_cpc_bid_micros\"\x81\x01\n\x14KeywordPlanGeoTarget\x12Q\n\x13geo_target_constant\x18\x02 \x01(\tB/\xfa\x41,\n*googleads.googleapis.com/GeoTargetConstantH\x00\x88\x01\x01\x42\x16\n\x14_geo_target_constantB\x85\x02\n%com.google.ads.googleads.v7.resourcesB\x18KeywordPlanCampaignProtoP\x01ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v7/resources;resources\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V7.Resources\xca\x02!Google\\Ads\\GoogleAds\\V7\\Resources\xea\x02%Google::Ads::GoogleAds::V7::Resourcesb\x06proto3'
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_keyword__plan__network__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_KEYWORDPLANCAMPAIGN = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.keyword_plan', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='language_constants', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.language_constants', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='keyword_plan_network', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.keyword_plan_network', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpc_bid_micros', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.cpc_bid_micros', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='geo_targets', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign.geo_targets', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_keyword_plan', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign._keyword_plan',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign._id',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_name', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign._name',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_cpc_bid_micros', full_name='google.ads.googleads.v7.resources.KeywordPlanCampaign._cpc_bid_micros',
...
_KEYWORDPLANGEOTARGET = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.KeywordPlanGeoTarget',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='geo_target_constant', full_name='google.ads.googleads.v7.resources.KeywordPlanGeoTarget.geo_target_constant', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_geo_target_constant', full_name='google.ads.googleads.v7.resources.KeywordPlanGeoTarget._geo_target_constant',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_KEYWORDPLANCAMPAIGN.fields_by_name['keyword_plan_network'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_keyword__plan__network__pb2._KEYWORDPLANNETWORKENUM_KEYWORDPLANNETWORK
...
KeywordPlanCampaign = _reflection.GeneratedProtocolMessageType('KeywordPlanCampaign', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.resources.keyword_plan_campaign_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v7.resources.KeywordPlanCampaign)
  })
