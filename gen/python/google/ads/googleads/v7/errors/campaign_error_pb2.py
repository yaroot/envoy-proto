...
_CAMPAIGNERRORENUM_CAMPAIGNERROR = _descriptor.EnumDescriptor(
  name='CampaignError',
  full_name='google.ads.googleads.v7.errors.CampaignErrorEnum.CampaignError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PAYMENT_MODE_NOT_COMPATIBLE_WITH_VIEW_THROUGH_CONVERSION', index=43, number=47,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_CAMPAIGNERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.errors.CampaignErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
CampaignErrorEnum = _reflection.GeneratedProtocolMessageType('CampaignErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.errors.campaign_error_pb2'
