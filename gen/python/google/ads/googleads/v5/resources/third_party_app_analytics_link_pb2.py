...
_THIRDPARTYAPPANALYTICSLINK = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shareable_link_id', full_name='google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink.shareable_link_id', index=1,
...
_THIRDPARTYAPPANALYTICSLINK.fields_by_name['shareable_link_id'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
...
ThirdPartyAppAnalyticsLink = _reflection.GeneratedProtocolMessageType('ThirdPartyAppAnalyticsLink', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.resources.third_party_app_analytics_link_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink)
  })
