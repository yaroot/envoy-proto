...
from google.ads.googleads.v5.enums import billing_setup_status_pb2 as google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_billing__setup__status__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/resources/billing_setup.proto',
...
_BILLINGSETUP.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_billing__setup__status__pb2._BILLINGSETUPSTATUSENUM_BILLINGSETUPSTATUS
...
_BILLINGSETUP.fields_by_name['start_time_type'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_time__type__pb2._TIMETYPEENUM_TIMETYPE
_BILLINGSETUP.fields_by_name['end_date_time'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_BILLINGSETUP.fields_by_name['end_time_type'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_time__type__pb2._TIMETYPEENUM_TIMETYPE
...
BillingSetup = _reflection.GeneratedProtocolMessageType('BillingSetup', (_message.Message,), {
  ...
  'PaymentsAccountInfo' : _reflection.GeneratedProtocolMessageType('PaymentsAccountInfo', (_message.Message,), {
    ...
    '__module__' : 'google.ads.googleads.v5.resources.billing_setup_pb2'
