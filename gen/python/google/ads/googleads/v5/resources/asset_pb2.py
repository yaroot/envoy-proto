...
from google.ads.googleads.v5.common import asset_types_pb2 as google_dot_ads_dot_googleads_dot_v5_dot_common_dot_asset__types__pb2
from google.ads.googleads.v5.enums import asset_type_pb2 as google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_asset__type__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/resources/asset.proto',
...
_ASSET.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_asset__type__pb2._ASSETTYPEENUM_ASSETTYPE
_ASSET.fields_by_name['youtube_video_asset'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_common_dot_asset__types__pb2._YOUTUBEVIDEOASSET
_ASSET.fields_by_name['media_bundle_asset'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_common_dot_asset__types__pb2._MEDIABUNDLEASSET
_ASSET.fields_by_name['image_asset'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_common_dot_asset__types__pb2._IMAGEASSET
_ASSET.fields_by_name['text_asset'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_common_dot_asset__types__pb2._TEXTASSET
_ASSET.fields_by_name['book_on_google_asset'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_common_dot_asset__types__pb2._BOOKONGOOGLEASSET
...
Asset = _reflection.GeneratedProtocolMessageType('Asset', (_message.Message,), {
  'DESCRIPTOR' : _ASSET,
  '__module__' : 'google.ads.googleads.v5.resources.asset_pb2'
