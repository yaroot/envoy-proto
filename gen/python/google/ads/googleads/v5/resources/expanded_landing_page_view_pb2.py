...
_EXPANDEDLANDINGPAGEVIEW = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.resources.ExpandedLandingPageView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.resources.ExpandedLandingPageView.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='expanded_final_url', full_name='google.ads.googleads.v5.resources.ExpandedLandingPageView.expanded_final_url', index=1,
...
ExpandedLandingPageView = _reflection.GeneratedProtocolMessageType('ExpandedLandingPageView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.resources.expanded_landing_page_view_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.resources.ExpandedLandingPageView)
  })
