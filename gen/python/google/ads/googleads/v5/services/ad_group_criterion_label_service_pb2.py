...
_GETADGROUPCRITERIONLABELREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.GetAdGroupCriterionLabelRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.GetAdGroupCriterionLabelRequest.resource_name', index=0,
...
_MUTATEADGROUPCRITERIONLABELSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsRequest.validate_only', index=3,
...
_ADGROUPCRITERIONLABELOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.AdGroupCriterionLabelOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v5.services.AdGroupCriterionLabelOperation.create', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v5.services.AdGroupCriterionLabelOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v5.services.AdGroupCriterionLabelOperation.operation',
...
_MUTATEADGROUPCRITERIONLABELSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEADGROUPCRITERIONLABELRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.MutateAdGroupCriterionLabelResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADGROUPCRITERIONLABELOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_ad__group__criterion__label__pb2._ADGROUPCRITERIONLABEL
...
GetAdGroupCriterionLabelRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupCriterionLabelRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.ad_group_criterion_label_service_pb2'
...
MutateAdGroupCriterionLabelsRequest = _reflection.GeneratedProtocolMessageType('MutateAdGroupCriterionLabelsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.ad_group_criterion_label_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsRequest)
  })
...
MutateAdGroupCriterionLabelsResponse = _reflection.GeneratedProtocolMessageType('MutateAdGroupCriterionLabelsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.ad_group_criterion_label_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsResponse)
  })
...
_ADGROUPCRITERIONLABELSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v5.services.AdGroupCriterionLabelService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v5.services.AdGroupCriterionLabelService.GetAdGroupCriterionLabel',
    index=0,
    containing_service=None,
    input_type=_GETADGROUPCRITERIONLABELREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_ad__group__criterion__label__pb2._ADGROUPCRITERIONLABEL,
    serialized_options=b'\202\323\344\223\002:\0228/v5/{resource_name=customers/*/adGroupCriterionLabels/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateAdGroupCriterionLabels',
    full_name='google.ads.googleads.v5.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels',
    index=1,
    containing_service=None,
    input_type=_MUTATEADGROUPCRITERIONLABELSREQUEST,
    output_type=_MUTATEADGROUPCRITERIONLABELSRESPONSE,
    serialized_options=b'\202\323\344\223\002@\";/v5/customers/{customer_id=*}/adGroupCriterionLabels:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
