...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/services/display_keyword_view_service.proto',
...
_GETDISPLAYKEYWORDVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.GetDisplayKeywordViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.GetDisplayKeywordViewRequest.resource_name', index=0,
...
GetDisplayKeywordViewRequest = _reflection.GeneratedProtocolMessageType('GetDisplayKeywordViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.display_keyword_view_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.GetDisplayKeywordViewRequest)
  })
...
_DISPLAYKEYWORDVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v5.services.DisplayKeywordViewService.GetDisplayKeywordView',
    index=0,
    containing_service=None,
    input_type=_GETDISPLAYKEYWORDVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_display__keyword__view__pb2._DISPLAYKEYWORDVIEW,
    serialized_options=b'\202\323\344\223\0027\0225/v5/{resource_name=customers/*/displayKeywordViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
