...
_GETMEDIAFILEREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.GetMediaFileRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.GetMediaFileRequest.resource_name', index=0,
...
_MUTATEMEDIAFILESREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateMediaFilesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v5.services.MutateMediaFilesRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v5.services.MutateMediaFilesRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v5.services.MutateMediaFilesRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v5.services.MutateMediaFilesRequest.validate_only', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='response_content_type', full_name='google.ads.googleads.v5.services.MutateMediaFilesRequest.response_content_type', index=4,
...
_MEDIAFILEOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MediaFileOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v5.services.MediaFileOperation.create', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v5.services.MediaFileOperation.operation',
...
_MUTATEMEDIAFILESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateMediaFilesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v5.services.MutateMediaFilesResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v5.services.MutateMediaFilesResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEMEDIAFILERESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateMediaFileResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.MutateMediaFileResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='media_file', full_name='google.ads.googleads.v5.services.MutateMediaFileResult.media_file', index=1,
...
_MUTATEMEDIAFILESREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
_MEDIAFILEOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_media__file__pb2._MEDIAFILE
...
_MUTATEMEDIAFILERESULT.fields_by_name['media_file'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_media__file__pb2._MEDIAFILE
...
GetMediaFileRequest = _reflection.GeneratedProtocolMessageType('GetMediaFileRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.media_file_service_pb2'
...
MediaFileOperation = _reflection.GeneratedProtocolMessageType('MediaFileOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.media_file_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MediaFileOperation)
  })
...
_MEDIAFILESERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v5.services.MediaFileService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetMediaFile',
    full_name='google.ads.googleads.v5.services.MediaFileService.GetMediaFile',
    index=0,
    containing_service=None,
    input_type=_GETMEDIAFILEREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_media__file__pb2._MEDIAFILE,
    serialized_options=b'\202\323\344\223\002.\022,/v5/{resource_name=customers/*/mediaFiles/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateMediaFiles',
    full_name='google.ads.googleads.v5.services.MediaFileService.MutateMediaFiles',
    index=1,
    containing_service=None,
    input_type=_MUTATEMEDIAFILESREQUEST,
    output_type=_MUTATEMEDIAFILESRESPONSE,
    serialized_options=b'\202\323\344\223\0024\"//v5/customers/{customer_id=*}/mediaFiles:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
