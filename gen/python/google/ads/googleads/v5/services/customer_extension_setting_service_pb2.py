...
_GETCUSTOMEREXTENSIONSETTINGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.GetCustomerExtensionSettingRequest.resource_name', index=0,
...
_MUTATECUSTOMEREXTENSIONSETTINGSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsRequest.validate_only', index=3,
...
_CUSTOMEREXTENSIONSETTINGOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.CustomerExtensionSettingOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v5.services.CustomerExtensionSettingOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v5.services.CustomerExtensionSettingOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v5.services.CustomerExtensionSettingOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v5.services.CustomerExtensionSettingOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v5.services.CustomerExtensionSettingOperation.operation',
...
_MUTATECUSTOMEREXTENSIONSETTINGSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECUSTOMEREXTENSIONSETTINGRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.MutateCustomerExtensionSettingResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMEREXTENSIONSETTINGOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_customer__extension__setting__pb2._CUSTOMEREXTENSIONSETTING
_CUSTOMEREXTENSIONSETTINGOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_customer__extension__setting__pb2._CUSTOMEREXTENSIONSETTING
...
GetCustomerExtensionSettingRequest = _reflection.GeneratedProtocolMessageType('GetCustomerExtensionSettingRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_extension_setting_service_pb2'
...
MutateCustomerExtensionSettingsRequest = _reflection.GeneratedProtocolMessageType('MutateCustomerExtensionSettingsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateCustomerExtensionSettingsRequest)
  })
...
CustomerExtensionSettingOperation = _reflection.GeneratedProtocolMessageType('CustomerExtensionSettingOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.CustomerExtensionSettingOperation)
  })
...
MutateCustomerExtensionSettingsResponse = _reflection.GeneratedProtocolMessageType('MutateCustomerExtensionSettingsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateCustomerExtensionSettingsResponse)
  })
...
MutateCustomerExtensionSettingResult = _reflection.GeneratedProtocolMessageType('MutateCustomerExtensionSettingResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateCustomerExtensionSettingResult)
  })
...
_CUSTOMEREXTENSIONSETTINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v5.services.CustomerExtensionSettingService.GetCustomerExtensionSetting',
    index=0,
    containing_service=None,
    input_type=_GETCUSTOMEREXTENSIONSETTINGREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_customer__extension__setting__pb2._CUSTOMEREXTENSIONSETTING,
    serialized_options=b'\202\323\344\223\002=\022;/v5/{resource_name=customers/*/customerExtensionSettings/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomerExtensionSettings',
    full_name='google.ads.googleads.v5.services.CustomerExtensionSettingService.MutateCustomerExtensionSettings',
    index=1,
    containing_service=None,
    input_type=_MUTATECUSTOMEREXTENSIONSETTINGSREQUEST,
    output_type=_MUTATECUSTOMEREXTENSIONSETTINGSRESPONSE,
    serialized_options=b'\202\323\344\223\002C\">/v5/customers/{customer_id=*}/customerExtensionSettings:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
