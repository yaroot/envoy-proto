...
_CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASONENUM_CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASON = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v5.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASONENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.enums.CustomerPayPerConversionEligibilityFailureReasonEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
CustomerPayPerConversionEligibilityFailureReasonEnum = _reflection.GeneratedProtocolMessageType('CustomerPayPerConversionEligibilityFailureReasonEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.enums.customer_pay_per_conversion_eligibility_failure_reason_pb2'
