...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/common/real_time_bidding_setting.proto',
...
RealTimeBiddingSetting = _reflection.GeneratedProtocolMessageType('RealTimeBiddingSetting', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.common.real_time_bidding_setting_pb2'
