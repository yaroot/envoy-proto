...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/common/explorer_auto_optimizer_setting.proto',
...
ExplorerAutoOptimizerSetting = _reflection.GeneratedProtocolMessageType('ExplorerAutoOptimizerSetting', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.common.explorer_auto_optimizer_setting_pb2'
