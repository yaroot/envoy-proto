...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/errors/resource_access_denied_error.proto',
...
ResourceAccessDeniedErrorEnum = _reflection.GeneratedProtocolMessageType('ResourceAccessDeniedErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.errors.resource_access_denied_error_pb2'
