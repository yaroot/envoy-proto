...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/errors/media_upload_error.proto',
...
MediaUploadErrorEnum = _reflection.GeneratedProtocolMessageType('MediaUploadErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.errors.media_upload_error_pb2'
