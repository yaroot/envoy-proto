...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/errors/ad_group_bid_modifier_error.proto',
...
AdGroupBidModifierErrorEnum = _reflection.GeneratedProtocolMessageType('AdGroupBidModifierErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.errors.ad_group_bid_modifier_error_pb2'
