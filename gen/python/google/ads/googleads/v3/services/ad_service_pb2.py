...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/ad_service.proto',
...
_ADOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_ad__pb2._AD
...
GetAdRequest = _reflection.GeneratedProtocolMessageType('GetAdRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.ad_service_pb2'
...
_ADSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_ad__pb2._AD,
    serialized_options=b'\202\323\344\223\002\'\022%/v3/{resource_name=customers/*/ads/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateAds',
    ...
    serialized_options=b'\202\323\344\223\002-\"(/v3/customers/{customer_id=*}/ads:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
