...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/language_constant_service.proto',
  ...
  serialized_pb=b'\n@google/ads/googleads/v3/services/language_constant_service.proto\x12 google.ads.googleads.v3.services\x1a\x39google/ads/googleads/v3/resources/language_constant.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"f\n\x1aGetLanguageConstantRequest\x12H\n\rresource_name\x18\x01 \x01(\tB1\xe0\x41\x02\xfa\x41+\n)googleads.googleapis.com/LanguageConstant2\xac\x02\n\x17LanguageConstantService\x12\xc9\x01\n\x13GetLanguageConstant\x12<.google.ads.googleads.v3.services.GetLanguageConstantRequest\x1a\x33.google.ads.googleads.v3.resources.LanguageConstant\"?\x82\xd3\xe4\x93\x02)\x12\'/v3/{resource_name=languageConstants/*}\xda\x41\rresource_name\x1a\x45\xca\x41\x18googleads.googleapis.com\xd2\x41\'https://www.googleapis.com/auth/adwordsB\x83\x02\n$com.google.ads.googleads.v3.servicesB\x1cLanguageConstantServiceProtoP\x01ZHgoogle.golang.org/genproto/googleapis/ads/googleads/v3/services;services\xa2\x02\x03GAA\xaa\x02 Google.Ads.GoogleAds.V3.Services\xca\x02 Google\\Ads\\GoogleAds\\V3\\Services\xea\x02$Google::Ads::GoogleAds::V3::Servicesb\x06proto3'
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_language__constant__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,])
...
GetLanguageConstantRequest = _reflection.GeneratedProtocolMessageType('GetLanguageConstantRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.language_constant_service_pb2'
...
_LANGUAGECONSTANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_language__constant__pb2._LANGUAGECONSTANT,
    serialized_options=b'\202\323\344\223\002)\022\'/v3/{resource_name=languageConstants/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
