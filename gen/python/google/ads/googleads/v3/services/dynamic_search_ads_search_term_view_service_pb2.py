...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/dynamic_search_ads_search_term_view_service.proto',
...
GetDynamicSearchAdsSearchTermViewRequest = _reflection.GeneratedProtocolMessageType('GetDynamicSearchAdsSearchTermViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.dynamic_search_ads_search_term_view_service_pb2'
...
_DYNAMICSEARCHADSSEARCHTERMVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_dynamic__search__ads__search__term__view__pb2._DYNAMICSEARCHADSSEARCHTERMVIEW,
    serialized_options=b'\202\323\344\223\002C\022A/v3/{resource_name=customers/*/dynamicSearchAdsSearchTermViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
