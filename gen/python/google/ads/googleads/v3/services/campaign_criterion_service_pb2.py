...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/campaign_criterion_service.proto',
...
_CAMPAIGNCRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__criterion__pb2._CAMPAIGNCRITERION
_CAMPAIGNCRITERIONOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__criterion__pb2._CAMPAIGNCRITERION
...
GetCampaignCriterionRequest = _reflection.GeneratedProtocolMessageType('GetCampaignCriterionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.campaign_criterion_service_pb2'
...
_CAMPAIGNCRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__criterion__pb2._CAMPAIGNCRITERION,
    serialized_options=b'\202\323\344\223\0024\0222/v3/{resource_name=customers/*/campaignCriteria/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002:\"5/v3/customers/{customer_id=*}/campaignCriteria:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
