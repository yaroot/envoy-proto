...
_GETCAMPAIGNEXTENSIONSETTINGREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.GetCampaignExtensionSettingRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.GetCampaignExtensionSettingRequest.resource_name', index=0,
...
_MUTATECAMPAIGNEXTENSIONSETTINGSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsRequest.validate_only', index=3,
...
_CAMPAIGNEXTENSIONSETTINGOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.CampaignExtensionSettingOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v3.services.CampaignExtensionSettingOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v3.services.CampaignExtensionSettingOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v3.services.CampaignExtensionSettingOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v3.services.CampaignExtensionSettingOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v3.services.CampaignExtensionSettingOperation.operation',
...
_MUTATECAMPAIGNEXTENSIONSETTINGSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECAMPAIGNEXTENSIONSETTINGRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.MutateCampaignExtensionSettingResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CAMPAIGNEXTENSIONSETTINGOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__extension__setting__pb2._CAMPAIGNEXTENSIONSETTING
_CAMPAIGNEXTENSIONSETTINGOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__extension__setting__pb2._CAMPAIGNEXTENSIONSETTING
...
GetCampaignExtensionSettingRequest = _reflection.GeneratedProtocolMessageType('GetCampaignExtensionSettingRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.campaign_extension_setting_service_pb2'
...
CampaignExtensionSettingOperation = _reflection.GeneratedProtocolMessageType('CampaignExtensionSettingOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.campaign_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.CampaignExtensionSettingOperation)
  })
...
MutateCampaignExtensionSettingsResponse = _reflection.GeneratedProtocolMessageType('MutateCampaignExtensionSettingsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.campaign_extension_setting_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.MutateCampaignExtensionSettingsResponse)
  })
...
_CAMPAIGNEXTENSIONSETTINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v3.services.CampaignExtensionSettingService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v3.services.CampaignExtensionSettingService.GetCampaignExtensionSetting',
    index=0,
    containing_service=None,
    input_type=_GETCAMPAIGNEXTENSIONSETTINGREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__extension__setting__pb2._CAMPAIGNEXTENSIONSETTING,
    serialized_options=b'\202\323\344\223\002=\022;/v3/{resource_name=customers/*/campaignExtensionSettings/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCampaignExtensionSettings',
    full_name='google.ads.googleads.v3.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings',
    index=1,
    containing_service=None,
    input_type=_MUTATECAMPAIGNEXTENSIONSETTINGSREQUEST,
    output_type=_MUTATECAMPAIGNEXTENSIONSETTINGSRESPONSE,
    serialized_options=b'\202\323\344\223\002C\">/v3/customers/{customer_id=*}/campaignExtensionSettings:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
