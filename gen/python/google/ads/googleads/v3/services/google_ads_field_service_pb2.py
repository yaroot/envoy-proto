...
from google.ads.googleads.v3.resources import google_ads_field_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_google__ads__field__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/google_ads_field_service.proto',
...
_GETGOOGLEADSFIELDREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.GetGoogleAdsFieldRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.GetGoogleAdsFieldRequest.resource_name', index=0,
...
_SEARCHGOOGLEADSFIELDSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='query', full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsRequest.query', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsRequest.page_token', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsRequest.page_size', index=2,
...
_SEARCHGOOGLEADSFIELDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsResponse.results', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_results_count', full_name='google.ads.googleads.v3.services.SearchGoogleAdsFieldsResponse.total_results_count', index=2,
...
_SEARCHGOOGLEADSFIELDSRESPONSE.fields_by_name['results'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_google__ads__field__pb2._GOOGLEADSFIELD
...
GetGoogleAdsFieldRequest = _reflection.GeneratedProtocolMessageType('GetGoogleAdsFieldRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.google_ads_field_service_pb2'
...
SearchGoogleAdsFieldsResponse = _reflection.GeneratedProtocolMessageType('SearchGoogleAdsFieldsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.google_ads_field_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.SearchGoogleAdsFieldsResponse)
  })
...
_GOOGLEADSFIELDSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v3.services.GoogleAdsFieldService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v3.services.GoogleAdsFieldService.GetGoogleAdsField',
    index=0,
    containing_service=None,
    input_type=_GETGOOGLEADSFIELDREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_google__ads__field__pb2._GOOGLEADSFIELD,
    serialized_options=b'\202\323\344\223\002\'\022%/v3/{resource_name=googleAdsFields/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SearchGoogleAdsFields',
    full_name='google.ads.googleads.v3.services.GoogleAdsFieldService.SearchGoogleAdsFields',
    index=1,
    containing_service=None,
    input_type=_SEARCHGOOGLEADSFIELDSREQUEST,
    output_type=_SEARCHGOOGLEADSFIELDSRESPONSE,
    serialized_options=b'\202\323\344\223\002\037\"\032/v3/googleAdsFields:search:\001*\332A\005query',
    create_key=_descriptor._internal_create_key,
  ),
])
