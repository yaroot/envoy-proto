...
_GETCUSTOMERCLIENTLINKREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.GetCustomerClientLinkRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.GetCustomerClientLinkRequest.resource_name', index=0,
...
_MUTATECUSTOMERCLIENTLINKREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateCustomerClientLinkRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v3.services.MutateCustomerClientLinkRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operation', full_name='google.ads.googleads.v3.services.MutateCustomerClientLinkRequest.operation', index=1,
...
_CUSTOMERCLIENTLINKOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.CustomerClientLinkOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v3.services.CustomerClientLinkOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v3.services.CustomerClientLinkOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v3.services.CustomerClientLinkOperation.update', index=2,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v3.services.CustomerClientLinkOperation.operation',
...
_MUTATECUSTOMERCLIENTLINKRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateCustomerClientLinkResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='google.ads.googleads.v3.services.MutateCustomerClientLinkResponse.result', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECUSTOMERCLIENTLINKRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateCustomerClientLinkResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.MutateCustomerClientLinkResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMERCLIENTLINKOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_customer__client__link__pb2._CUSTOMERCLIENTLINK
_CUSTOMERCLIENTLINKOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_customer__client__link__pb2._CUSTOMERCLIENTLINK
...
GetCustomerClientLinkRequest = _reflection.GeneratedProtocolMessageType('GetCustomerClientLinkRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.customer_client_link_service_pb2'
...
CustomerClientLinkOperation = _reflection.GeneratedProtocolMessageType('CustomerClientLinkOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.customer_client_link_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.CustomerClientLinkOperation)
  })
...
MutateCustomerClientLinkResult = _reflection.GeneratedProtocolMessageType('MutateCustomerClientLinkResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.customer_client_link_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.MutateCustomerClientLinkResult)
  })
...
_CUSTOMERCLIENTLINKSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v3.services.CustomerClientLinkService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v3.services.CustomerClientLinkService.GetCustomerClientLink',
    index=0,
    containing_service=None,
    input_type=_GETCUSTOMERCLIENTLINKREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_customer__client__link__pb2._CUSTOMERCLIENTLINK,
    serialized_options=b'\202\323\344\223\0027\0225/v3/{resource_name=customers/*/customerClientLinks/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomerClientLink',
    full_name='google.ads.googleads.v3.services.CustomerClientLinkService.MutateCustomerClientLink',
    index=1,
    containing_service=None,
    input_type=_MUTATECUSTOMERCLIENTLINKREQUEST,
    output_type=_MUTATECUSTOMERCLIENTLINKRESPONSE,
    serialized_options=b'\202\323\344\223\002=\"8/v3/customers/{customer_id=*}/customerClientLinks:mutate:\001*\332A\025customer_id,operation',
    create_key=_descriptor._internal_create_key,
  ),
])
