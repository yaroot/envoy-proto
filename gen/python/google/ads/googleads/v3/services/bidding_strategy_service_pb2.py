...
_GETBIDDINGSTRATEGYREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.GetBiddingStrategyRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.GetBiddingStrategyRequest.resource_name', index=0,
...
_MUTATEBIDDINGSTRATEGIESREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesRequest.validate_only', index=3,
...
_BIDDINGSTRATEGYOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.BiddingStrategyOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v3.services.BiddingStrategyOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v3.services.BiddingStrategyOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v3.services.BiddingStrategyOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v3.services.BiddingStrategyOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v3.services.BiddingStrategyOperation.operation',
...
_MUTATEBIDDINGSTRATEGIESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v3.services.MutateBiddingStrategiesResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEBIDDINGSTRATEGYRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateBiddingStrategyResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.MutateBiddingStrategyResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BIDDINGSTRATEGYOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_bidding__strategy__pb2._BIDDINGSTRATEGY
_BIDDINGSTRATEGYOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_bidding__strategy__pb2._BIDDINGSTRATEGY
...
GetBiddingStrategyRequest = _reflection.GeneratedProtocolMessageType('GetBiddingStrategyRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.bidding_strategy_service_pb2'
...
_BIDDINGSTRATEGYSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v3.services.BiddingStrategyService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v3.services.BiddingStrategyService.GetBiddingStrategy',
    index=0,
    containing_service=None,
    input_type=_GETBIDDINGSTRATEGYREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_bidding__strategy__pb2._BIDDINGSTRATEGY,
    serialized_options=b'\202\323\344\223\0025\0223/v3/{resource_name=customers/*/biddingStrategies/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateBiddingStrategies',
    full_name='google.ads.googleads.v3.services.BiddingStrategyService.MutateBiddingStrategies',
    index=1,
    containing_service=None,
    input_type=_MUTATEBIDDINGSTRATEGIESREQUEST,
    output_type=_MUTATEBIDDINGSTRATEGIESRESPONSE,
    serialized_options=b'\202\323\344\223\002;\"6/v3/customers/{customer_id=*}/biddingStrategies:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
