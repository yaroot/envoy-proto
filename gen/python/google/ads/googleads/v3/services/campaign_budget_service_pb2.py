...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/campaign_budget_service.proto',
...
_CAMPAIGNBUDGETOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__budget__pb2._CAMPAIGNBUDGET
_CAMPAIGNBUDGETOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__budget__pb2._CAMPAIGNBUDGET
...
GetCampaignBudgetRequest = _reflection.GeneratedProtocolMessageType('GetCampaignBudgetRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.campaign_budget_service_pb2'
...
_CAMPAIGNBUDGETSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_campaign__budget__pb2._CAMPAIGNBUDGET,
    serialized_options=b'\202\323\344\223\0023\0221/v3/{resource_name=customers/*/campaignBudgets/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0029\"4/v3/customers/{customer_id=*}/campaignBudgets:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
