...
_GETSHAREDSETREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.GetSharedSetRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.GetSharedSetRequest.resource_name', index=0,
...
_MUTATESHAREDSETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateSharedSetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v3.services.MutateSharedSetsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v3.services.MutateSharedSetsRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v3.services.MutateSharedSetsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v3.services.MutateSharedSetsRequest.validate_only', index=3,
...
_SHAREDSETOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.SharedSetOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v3.services.SharedSetOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v3.services.SharedSetOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v3.services.SharedSetOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v3.services.SharedSetOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v3.services.SharedSetOperation.operation',
...
_MUTATESHAREDSETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateSharedSetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v3.services.MutateSharedSetsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v3.services.MutateSharedSetsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATESHAREDSETRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateSharedSetResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.MutateSharedSetResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SHAREDSETOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_shared__set__pb2._SHAREDSET
_SHAREDSETOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_shared__set__pb2._SHAREDSET
...
GetSharedSetRequest = _reflection.GeneratedProtocolMessageType('GetSharedSetRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.shared_set_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.GetSharedSetRequest)
  })
...
MutateSharedSetsResponse = _reflection.GeneratedProtocolMessageType('MutateSharedSetsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.shared_set_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.MutateSharedSetsResponse)
  })
...
_SHAREDSETSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v3.services.SharedSetService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetSharedSet',
    full_name='google.ads.googleads.v3.services.SharedSetService.GetSharedSet',
    index=0,
    containing_service=None,
    input_type=_GETSHAREDSETREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_shared__set__pb2._SHAREDSET,
    serialized_options=b'\202\323\344\223\002.\022,/v3/{resource_name=customers/*/sharedSets/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateSharedSets',
    full_name='google.ads.googleads.v3.services.SharedSetService.MutateSharedSets',
    index=1,
    containing_service=None,
    input_type=_MUTATESHAREDSETSREQUEST,
    output_type=_MUTATESHAREDSETSRESPONSE,
    serialized_options=b'\202\323\344\223\0024\"//v3/customers/{customer_id=*}/sharedSets:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
