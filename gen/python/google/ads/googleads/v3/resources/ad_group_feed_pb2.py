...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/ad_group_feed.proto',
...
_ADGROUPFEED.fields_by_name['placeholder_types'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_placeholder__type__pb2._PLACEHOLDERTYPEENUM_PLACEHOLDERTYPE
_ADGROUPFEED.fields_by_name['matching_function'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_matching__function__pb2._MATCHINGFUNCTION
_ADGROUPFEED.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_feed__link__status__pb2._FEEDLINKSTATUSENUM_FEEDLINKSTATUS
...
AdGroupFeed = _reflection.GeneratedProtocolMessageType('AdGroupFeed', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.ad_group_feed_pb2'
