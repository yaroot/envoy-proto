...
from google.ads.googleads.v3.common import ad_type_infos_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2
...
from google.ads.googleads.v3.common import final_app_url_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_common_dot_final__app__url__pb2
from google.ads.googleads.v3.common import url_collection_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_common_dot_url__collection__pb2
from google.ads.googleads.v3.enums import ad_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_ad__type__pb2
from google.ads.googleads.v3.enums import device_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_device__pb2
from google.ads.googleads.v3.enums import system_managed_entity_source_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_system__managed__entity__source__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/ad.proto',
...
_AD.fields_by_name['final_app_urls'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_final__app__url__pb2._FINALAPPURL
...
_AD.fields_by_name['url_custom_parameters'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_custom__parameter__pb2._CUSTOMPARAMETER
_AD.fields_by_name['display_url'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_AD.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_ad__type__pb2._ADTYPEENUM_ADTYPE
_AD.fields_by_name['added_by_google_ads'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_AD.fields_by_name['device_preference'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_device__pb2._DEVICEENUM_DEVICE
_AD.fields_by_name['url_collections'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_url__collection__pb2._URLCOLLECTION
_AD.fields_by_name['name'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_AD.fields_by_name['system_managed_resource_source'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_system__managed__entity__source__pb2._SYSTEMMANAGEDRESOURCESOURCEENUM_SYSTEMMANAGEDRESOURCESOURCE
_AD.fields_by_name['text_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._TEXTADINFO
_AD.fields_by_name['expanded_text_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._EXPANDEDTEXTADINFO
_AD.fields_by_name['call_only_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._CALLONLYADINFO
_AD.fields_by_name['expanded_dynamic_search_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._EXPANDEDDYNAMICSEARCHADINFO
_AD.fields_by_name['hotel_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._HOTELADINFO
_AD.fields_by_name['shopping_smart_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._SHOPPINGSMARTADINFO
_AD.fields_by_name['shopping_product_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._SHOPPINGPRODUCTADINFO
_AD.fields_by_name['gmail_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._GMAILADINFO
_AD.fields_by_name['image_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._IMAGEADINFO
_AD.fields_by_name['video_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._VIDEOADINFO
_AD.fields_by_name['responsive_search_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._RESPONSIVESEARCHADINFO
_AD.fields_by_name['legacy_responsive_display_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._LEGACYRESPONSIVEDISPLAYADINFO
_AD.fields_by_name['app_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._APPADINFO
_AD.fields_by_name['legacy_app_install_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._LEGACYAPPINSTALLADINFO
_AD.fields_by_name['responsive_display_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._RESPONSIVEDISPLAYADINFO
_AD.fields_by_name['display_upload_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._DISPLAYUPLOADADINFO
_AD.fields_by_name['app_engagement_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._APPENGAGEMENTADINFO
_AD.fields_by_name['shopping_comparison_listing_ad'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_ad__type__infos__pb2._SHOPPINGCOMPARISONLISTINGADINFO
...
Ad = _reflection.GeneratedProtocolMessageType('Ad', (_message.Message,), {
  'DESCRIPTOR' : _AD,
  '__module__' : 'google.ads.googleads.v3.resources.ad_pb2'
