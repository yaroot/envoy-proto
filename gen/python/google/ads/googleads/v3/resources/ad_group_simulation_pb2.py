...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/ad_group_simulation.proto',
...
_ADGROUPSIMULATION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_simulation__type__pb2._SIMULATIONTYPEENUM_SIMULATIONTYPE
_ADGROUPSIMULATION.fields_by_name['modification_method'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_simulation__modification__method__pb2._SIMULATIONMODIFICATIONMETHODENUM_SIMULATIONMODIFICATIONMETHOD
...
_ADGROUPSIMULATION.fields_by_name['cpc_bid_point_list'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_simulation__pb2._CPCBIDSIMULATIONPOINTLIST
_ADGROUPSIMULATION.fields_by_name['cpv_bid_point_list'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_simulation__pb2._CPVBIDSIMULATIONPOINTLIST
_ADGROUPSIMULATION.fields_by_name['target_cpa_point_list'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_simulation__pb2._TARGETCPASIMULATIONPOINTLIST
...
AdGroupSimulation = _reflection.GeneratedProtocolMessageType('AdGroupSimulation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.ad_group_simulation_pb2'
