...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/landing_page_view.proto',
...
_LANDINGPAGEVIEW = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.LandingPageView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.LandingPageView.resource_name', index=0,
...
LandingPageView = _reflection.GeneratedProtocolMessageType('LandingPageView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.landing_page_view_pb2'
