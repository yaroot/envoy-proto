...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/remarketing_action.proto',
...
_REMARKETINGACTION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.RemarketingAction',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.RemarketingAction.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='tag_snippets', full_name='google.ads.googleads.v3.resources.RemarketingAction.tag_snippets', index=3,
...
_REMARKETINGACTION.fields_by_name['tag_snippets'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_tag__snippet__pb2._TAGSNIPPET
...
RemarketingAction = _reflection.GeneratedProtocolMessageType('RemarketingAction', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.remarketing_action_pb2'
