...
_CUSTOMERNEGATIVECRITERION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.type', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='content_label', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.content_label', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='mobile_application', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.mobile_application', index=4,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mobile_app_category', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.mobile_app_category', index=5,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='placement', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.placement', index=6,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='youtube_video', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.youtube_video', index=7,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='youtube_channel', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.youtube_channel', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='criterion', full_name='google.ads.googleads.v3.resources.CustomerNegativeCriterion.criterion',
...
_CUSTOMERNEGATIVECRITERION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_criterion__type__pb2._CRITERIONTYPEENUM_CRITERIONTYPE
_CUSTOMERNEGATIVECRITERION.fields_by_name['content_label'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._CONTENTLABELINFO
_CUSTOMERNEGATIVECRITERION.fields_by_name['mobile_application'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._MOBILEAPPLICATIONINFO
_CUSTOMERNEGATIVECRITERION.fields_by_name['mobile_app_category'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._MOBILEAPPCATEGORYINFO
_CUSTOMERNEGATIVECRITERION.fields_by_name['placement'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._PLACEMENTINFO
_CUSTOMERNEGATIVECRITERION.fields_by_name['youtube_video'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._YOUTUBEVIDEOINFO
_CUSTOMERNEGATIVECRITERION.fields_by_name['youtube_channel'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._YOUTUBECHANNELINFO
...
CustomerNegativeCriterion = _reflection.GeneratedProtocolMessageType('CustomerNegativeCriterion', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.customer_negative_criterion_pb2'
