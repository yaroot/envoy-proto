...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/customer_client.proto',
...
CustomerClient = _reflection.GeneratedProtocolMessageType('CustomerClient', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.customer_client_pb2'
