...
from google.ads.googleads.v3.enums import geo_target_constant_status_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_geo__target__constant__status__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/geo_target_constant.proto',
...
_GEOTARGETCONSTANT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.GeoTargetConstant',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.GeoTargetConstant.resource_name', index=0,
...
_GEOTARGETCONSTANT.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_geo__target__constant__status__pb2._GEOTARGETCONSTANTSTATUSENUM_GEOTARGETCONSTANTSTATUS
...
GeoTargetConstant = _reflection.GeneratedProtocolMessageType('GeoTargetConstant', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.geo_target_constant_pb2'
