...
from google.ads.googleads.v3.enums import campaign_experiment_status_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_campaign__experiment__status__pb2
from google.ads.googleads.v3.enums import campaign_experiment_traffic_split_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_campaign__experiment__traffic__split__type__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/campaign_experiment.proto',
...
_CAMPAIGNEXPERIMENT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.CampaignExperiment',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.CampaignExperiment.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='google.ads.googleads.v3.resources.CampaignExperiment.description', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='traffic_split_percent', full_name='google.ads.googleads.v3.resources.CampaignExperiment.traffic_split_percent', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date', full_name='google.ads.googleads.v3.resources.CampaignExperiment.end_date', index=11,
...
_CAMPAIGNEXPERIMENT.fields_by_name['traffic_split_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_campaign__experiment__traffic__split__type__pb2._CAMPAIGNEXPERIMENTTRAFFICSPLITTYPEENUM_CAMPAIGNEXPERIMENTTRAFFICSPLITTYPE
_CAMPAIGNEXPERIMENT.fields_by_name['experiment_campaign'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_CAMPAIGNEXPERIMENT.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_campaign__experiment__status__pb2._CAMPAIGNEXPERIMENTSTATUSENUM_CAMPAIGNEXPERIMENTSTATUS
...
CampaignExperiment = _reflection.GeneratedProtocolMessageType('CampaignExperiment', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.campaign_experiment_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.resources.CampaignExperiment)
  })
