...
from google.ads.googleads.v3.enums import manager_link_status_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_manager__link__status__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/customer_client_link.proto',
...
_CUSTOMERCLIENTLINK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.CustomerClientLink.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='hidden', full_name='google.ads.googleads.v3.resources.CustomerClientLink.hidden', index=4,
...
_CUSTOMERCLIENTLINK.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_manager__link__status__pb2._MANAGERLINKSTATUSENUM_MANAGERLINKSTATUS
...
CustomerClientLink = _reflection.GeneratedProtocolMessageType('CustomerClientLink', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.customer_client_link_pb2'
