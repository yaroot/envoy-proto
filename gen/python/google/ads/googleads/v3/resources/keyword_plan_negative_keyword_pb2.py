...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/keyword_plan_negative_keyword.proto',
...
_KEYWORDPLANNEGATIVEKEYWORD.fields_by_name['match_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_keyword__match__type__pb2._KEYWORDMATCHTYPEENUM_KEYWORDMATCHTYPE
...
KeywordPlanNegativeKeyword = _reflection.GeneratedProtocolMessageType('KeywordPlanNegativeKeyword', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.keyword_plan_negative_keyword_pb2'
