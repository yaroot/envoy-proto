...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/customer_label.proto',
...
_CUSTOMERLABEL = _descriptor.Descriptor(
  name='CustomerLabel',
  full_name='google.ads.googleads.v3.resources.CustomerLabel',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.CustomerLabel.resource_name', index=0,
...
CustomerLabel = _reflection.GeneratedProtocolMessageType('CustomerLabel', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.customer_label_pb2'
