...
from google.ads.googleads.v3.enums import distance_bucket_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_distance__bucket__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/distance_view.proto',
...
_DISTANCEVIEW = _descriptor.Descriptor(
  name='DistanceView',
  full_name='google.ads.googleads.v3.resources.DistanceView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.DistanceView.resource_name', index=0,
...
_DISTANCEVIEW.fields_by_name['distance_bucket'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_distance__bucket__pb2._DISTANCEBUCKETENUM_DISTANCEBUCKET
...
DistanceView = _reflection.GeneratedProtocolMessageType('DistanceView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.distance_view_pb2'
