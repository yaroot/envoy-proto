...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/enum_error.proto',
...
EnumErrorEnum = _reflection.GeneratedProtocolMessageType('EnumErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.enum_error_pb2'
