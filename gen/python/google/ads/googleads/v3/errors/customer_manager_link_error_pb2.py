...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/customer_manager_link_error.proto',
...
CustomerManagerLinkErrorEnum = _reflection.GeneratedProtocolMessageType('CustomerManagerLinkErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.customer_manager_link_error_pb2'
