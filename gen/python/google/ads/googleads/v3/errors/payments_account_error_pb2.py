...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/payments_account_error.proto',
...
PaymentsAccountErrorEnum = _reflection.GeneratedProtocolMessageType('PaymentsAccountErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.payments_account_error_pb2'
