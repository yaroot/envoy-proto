...
_USERLISTSIZERANGEENUM_USERLISTSIZERANGE = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v3.enums.UserListSizeRangeEnum.UserListSizeRange',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_USERLISTSIZERANGEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.enums.UserListSizeRangeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
UserListSizeRangeEnum = _reflection.GeneratedProtocolMessageType('UserListSizeRangeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.user_list_size_range_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.enums.UserListSizeRangeEnum)
  })
