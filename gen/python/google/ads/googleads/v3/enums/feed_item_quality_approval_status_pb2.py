...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/feed_item_quality_approval_status.proto',
...
FeedItemQualityApprovalStatusEnum = _reflection.GeneratedProtocolMessageType('FeedItemQualityApprovalStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.feed_item_quality_approval_status_pb2'
