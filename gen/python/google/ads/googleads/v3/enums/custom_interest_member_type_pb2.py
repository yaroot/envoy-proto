...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/custom_interest_member_type.proto',
...
CustomInterestMemberTypeEnum = _reflection.GeneratedProtocolMessageType('CustomInterestMemberTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.custom_interest_member_type_pb2'
