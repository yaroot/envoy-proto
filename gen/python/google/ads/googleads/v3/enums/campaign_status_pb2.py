...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/campaign_status.proto',
...
CampaignStatusEnum = _reflection.GeneratedProtocolMessageType('CampaignStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.campaign_status_pb2'
