...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/search_term_targeting_status.proto',
...
SearchTermTargetingStatusEnum = _reflection.GeneratedProtocolMessageType('SearchTermTargetingStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.search_term_targeting_status_pb2'
