...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/frequency_cap_time_unit.proto',
...
FrequencyCapTimeUnitEnum = _reflection.GeneratedProtocolMessageType('FrequencyCapTimeUnitEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.frequency_cap_time_unit_pb2'
