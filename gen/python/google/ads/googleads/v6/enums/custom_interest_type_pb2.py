...
_CUSTOMINTERESTTYPEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.enums.CustomInterestTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
CustomInterestTypeEnum = _reflection.GeneratedProtocolMessageType('CustomInterestTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.enums.custom_interest_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.enums.CustomInterestTypeEnum)
  })
