...
_CLICKTYPEENUM_CLICKTYPE = _descriptor.EnumDescriptor(
  name='ClickType',
  full_name='google.ads.googleads.v6.enums.ClickTypeEnum.ClickType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CLICKTYPEENUM = _descriptor.Descriptor(
  name='ClickTypeEnum',
  full_name='google.ads.googleads.v6.enums.ClickTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
ClickTypeEnum = _reflection.GeneratedProtocolMessageType('ClickTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.enums.click_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.enums.ClickTypeEnum)
  })
