...
_EXTERNALCONVERSIONSOURCEENUM_EXTERNALCONVERSIONSOURCE = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v6.enums.ExternalConversionSourceEnum.ExternalConversionSource',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SEARCH_ADS_360', index=24, number=25,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='GOOGLE_HOSTED', index=25, number=27,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FLOODLIGHT', index=26, number=29,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ANALYTICS_SEARCH_ADS_360', index=27, number=31,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_EXTERNALCONVERSIONSOURCEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.enums.ExternalConversionSourceEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
ExternalConversionSourceEnum = _reflection.GeneratedProtocolMessageType('ExternalConversionSourceEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.enums.external_conversion_source_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.enums.ExternalConversionSourceEnum)
  })
