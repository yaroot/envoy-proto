...
_SEARCHTERMTARGETINGSTATUSENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.enums.SearchTermTargetingStatusEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
SearchTermTargetingStatusEnum = _reflection.GeneratedProtocolMessageType('SearchTermTargetingStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.enums.search_term_targeting_status_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.enums.SearchTermTargetingStatusEnum)
  })
