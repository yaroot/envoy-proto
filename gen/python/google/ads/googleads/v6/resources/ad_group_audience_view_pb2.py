...
_ADGROUPAUDIENCEVIEW = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.resources.AdGroupAudienceView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v6.resources.AdGroupAudienceView.resource_name', index=0,
...
AdGroupAudienceView = _reflection.GeneratedProtocolMessageType('AdGroupAudienceView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.resources.ad_group_audience_view_pb2'
