...
_CRITERIONERRORENUM_CRITERIONERROR = _descriptor.EnumDescriptor(
  name='CriterionError',
  full_name='google.ads.googleads.v6.errors.CriterionErrorEnum.CriterionError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CRITERIONERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.errors.CriterionErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
CriterionErrorEnum = _reflection.GeneratedProtocolMessageType('CriterionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.criterion_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.errors.CriterionErrorEnum)
  })
