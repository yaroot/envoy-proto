...
_MANAGERLINKERRORENUM_MANAGERLINKERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v6.errors.ManagerLinkErrorEnum.ManagerLinkError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_MANAGERLINKERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.errors.ManagerLinkErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
ManagerLinkErrorEnum = _reflection.GeneratedProtocolMessageType('ManagerLinkErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.manager_link_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.errors.ManagerLinkErrorEnum)
  })
