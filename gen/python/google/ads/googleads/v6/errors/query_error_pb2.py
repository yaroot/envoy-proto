...
_QUERYERRORENUM_QUERYERROR = _descriptor.EnumDescriptor(
  name='QueryError',
  full_name='google.ads.googleads.v6.errors.QueryErrorEnum.QueryError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_QUERYERRORENUM = _descriptor.Descriptor(
  name='QueryErrorEnum',
  full_name='google.ads.googleads.v6.errors.QueryErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
QueryErrorEnum = _reflection.GeneratedProtocolMessageType('QueryErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.query_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.errors.QueryErrorEnum)
  })
