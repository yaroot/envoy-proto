...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v6/errors/date_range_error.proto',
...
DateRangeErrorEnum = _reflection.GeneratedProtocolMessageType('DateRangeErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.date_range_error_pb2'
