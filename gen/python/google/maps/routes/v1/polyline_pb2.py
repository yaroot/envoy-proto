...
_POLYLINEENCODING = _descriptor.EnumDescriptor(
  name='PolylineEncoding',
  full_name='google.maps.routes.v1.PolylineEncoding',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='POLYLINE_ENCODING_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ENCODED_POLYLINE', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='GEO_JSON_LINESTRING', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_POLYLINEENCODING)
...
DESCRIPTOR.enum_types_by_name['PolylineEncoding'] = _POLYLINEENCODING
