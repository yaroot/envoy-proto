...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.envoyproxy.envoy.api.v2.endpoint.LoadReportProto.internal_static_envoy_api_v2_endpoint_UpstreamEndpointStats_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.envoyproxy.envoy.api.v2.endpoint.LoadReportProto.internal_static_envoy_api_v2_endpoint_UpstreamEndpointStats_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.class, io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats)) {
      return super.equals(obj);
    }
    io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats other = (io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats) obj;
  ...
  public static io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats parseFrom(
  ...
  public static io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats parseFrom(
  ...
  public static io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats getDefaultInstanceForType() {
      return io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.getDefaultInstance();
    }

    @java.lang.Override
    public io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats build() {
      io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats result = buildPartial();
    ...
    @java.lang.Override
    public io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats buildPartial() {
      io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats result = new io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats(this);
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats result) {
      if (loadMetricStatsBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats) {
        return mergeFrom((io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats)other);
      } else {
    ...
    public Builder mergeFrom(io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats other) {
      if (other == io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.getDefaultInstance()) return this;
      if (other.hasAddress()) {
  ...
  private static final io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats();
  }

  public static io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats getDefaultInstance() {
