...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(io.envoyproxy.envoy.api.v2.auth.Secret result) {
    ...
    private void buildPartialOneofs(io.envoyproxy.envoy.api.v2.auth.Secret result) {
      result.typeCase_ = typeCase_;
      result.type_ = this.type_;
      if (typeCase_ == 2 &&
          tlsCertificateBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  getTlsCertificateFieldBuilder().getBuilder(),
                  extensionRegistry);
              typeCase_ = 2;
              break;
            } // case 18
            ...
            case 42: {
              input.readMessage(
                  getGenericSecretFieldBuilder().getBuilder(),
                  extensionRegistry);
              typeCase_ = 5;
              break;
            } // case 42
