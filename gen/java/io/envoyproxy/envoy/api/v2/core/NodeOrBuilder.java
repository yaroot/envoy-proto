...
public interface NodeOrBuilder extends
   ...
   */
  @java.lang.Deprecated java.lang.String getBuildVersion();
  /**
   * <pre>
   * This is motivated by informing a management server during canary which
   * version of Envoy is being tested in a heterogeneous fleet. This will be set
   ...
   */
  io.envoyproxy.envoy.api.v2.core.BuildVersion getUserAgentBuildVersion();
  /**
   * <pre>
   * Structured version of the entity requesting config.
   * </pre>
   ...
   * <code>.envoy.api.v2.core.BuildVersion user_agent_build_version = 8;</code>
   */
  io.envoyproxy.envoy.api.v2.core.BuildVersionOrBuilder getUserAgentBuildVersionOrBuilder();
   ...
   */
  java.util.List<io.envoyproxy.envoy.api.v2.core.Extension> 
      getExtensionsList();
  /**
   * <pre>
   * List of extensions and their versions supported by the node.
   ...
   * <code>repeated .envoy.api.v2.core.Extension extensions = 9;</code>
   */
  io.envoyproxy.envoy.api.v2.core.Extension getExtensions(int index);
  /**
   * <pre>
   * List of extensions and their versions supported by the node.
   * </pre>
   ...
   * <code>repeated .envoy.api.v2.core.Extension extensions = 9;</code>
   */
  java.util.List<? extends io.envoyproxy.envoy.api.v2.core.ExtensionOrBuilder> 
   ...
   * <code>repeated .envoy.api.v2.core.Extension extensions = 9;</code>
   */
  io.envoyproxy.envoy.api.v2.core.ExtensionOrBuilder getExtensionsOrBuilder(
      int index);
   ...
   * <code>repeated .envoy.api.v2.core.Address listening_addresses = 11;</code>
   */
  io.envoyproxy.envoy.api.v2.core.Address getListeningAddresses(int index);
  /**
   * <pre>
   * Known listening ports on the node as a generic hint to the management server
   * for filtering :ref:`listeners &lt;config_listeners&gt;` to be returned. For example,
   ...
   * <code>repeated .envoy.api.v2.core.Address listening_addresses = 11;</code>
   */
  io.envoyproxy.envoy.api.v2.core.AddressOrBuilder getListeningAddressesOrBuilder(
      int index);

  public io.envoyproxy.envoy.api.v2.core.Node.UserAgentVersionTypeCase getUserAgentVersionTypeCase();
}
