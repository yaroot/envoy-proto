...
public interface FilterChainMatchOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.api.v2.listener.FilterChainMatch)
   ...
   * <code>repeated .envoy.api.v2.core.CidrRange prefix_ranges = 3;</code>
   */
  io.envoyproxy.envoy.api.v2.core.CidrRange getPrefixRanges(int index);
  /**
   * <pre>
   * If non-empty, an IP address and prefix length to match addresses when the
   * listener is bound to 0.0.0.0/:: or when use_original_dst is specified.
   ...
   * <code>repeated .envoy.api.v2.core.CidrRange prefix_ranges = 3;</code>
   */
  io.envoyproxy.envoy.api.v2.core.CidrRangeOrBuilder getPrefixRangesOrBuilder(
      int index);
   ...
   */
  io.envoyproxy.envoy.api.v2.listener.FilterChainMatch.ConnectionSourceType getSourceType();
   ...
   * <code>repeated .envoy.api.v2.core.CidrRange source_prefix_ranges = 6;</code>
   */
  io.envoyproxy.envoy.api.v2.core.CidrRange getSourcePrefixRanges(int index);
  /**
   * <pre>
   * The criteria is satisfied if the source IP address of the downstream
   * connection is contained in at least one of the specified subnets. If the
   ...
   * <code>repeated .envoy.api.v2.core.CidrRange source_prefix_ranges = 6;</code>
   */
  io.envoyproxy.envoy.api.v2.core.CidrRangeOrBuilder getSourcePrefixRangesOrBuilder(
      int index);
