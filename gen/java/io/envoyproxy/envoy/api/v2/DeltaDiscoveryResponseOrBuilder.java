...
public interface DeltaDiscoveryResponseOrBuilder extends
   ...
   */
  java.util.List<io.envoyproxy.envoy.api.v2.Resource> 
      getResourcesList();
  /**
   * <pre>
   * The response resources. These are typed resources, whose types must match
   ...
   * <code>repeated .envoy.api.v2.Resource resources = 2;</code>
   */
  io.envoyproxy.envoy.api.v2.Resource getResources(int index);
  /**
   * <pre>
   * The response resources. These are typed resources, whose types must match
   * the type_url field.
   ...
   * <code>repeated .envoy.api.v2.Resource resources = 2;</code>
   */
  java.util.List<? extends io.envoyproxy.envoy.api.v2.ResourceOrBuilder> 
   ...
   * <code>repeated .envoy.api.v2.Resource resources = 2;</code>
   */
  io.envoyproxy.envoy.api.v2.ResourceOrBuilder getResourcesOrBuilder(
      int index);
