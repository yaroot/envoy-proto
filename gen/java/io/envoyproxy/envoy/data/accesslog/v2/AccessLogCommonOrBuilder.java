...
public interface AccessLogCommonOrBuilder extends
   ...
   */
  io.envoyproxy.envoy.api.v2.core.Address getDownstreamDirectRemoteAddress();
  /**
   * <pre>
   * This field is the downstream direct remote address on which the request from the user was
   * received. Note: This is always the physical peer, even if the remote address is inferred from
   ...
   * <code>.envoy.api.v2.core.Address downstream_direct_remote_address = 20;</code>
   */
  io.envoyproxy.envoy.api.v2.core.AddressOrBuilder getDownstreamDirectRemoteAddressOrBuilder();
