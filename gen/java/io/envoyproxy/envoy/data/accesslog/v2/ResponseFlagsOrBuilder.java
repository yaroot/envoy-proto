...
public interface ResponseFlagsOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.data.accesslog.v2.ResponseFlags)
   ...
   */
  io.envoyproxy.envoy.data.accesslog.v2.ResponseFlags.Unauthorized getUnauthorizedDetails();
  /**
   * <pre>
   * Indicates if the request was deemed unauthorized and the reason for it.
   * </pre>
   ...
   * <code>.envoy.data.accesslog.v2.ResponseFlags.Unauthorized unauthorized_details = 13;</code>
   */
  io.envoyproxy.envoy.data.accesslog.v2.ResponseFlags.UnauthorizedOrBuilder getUnauthorizedDetailsOrBuilder();
