...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 74: {
            io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectSuccessRate.Builder subBuilder = null;
            if (eventCase_ == 9) {
              subBuilder = ((io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectSuccessRate) event_).toBuilder();
            }
            event_ =
                input.readMessage(io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectSuccessRate.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectSuccessRate) event_);
          ...
          case 82: {
            io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectConsecutive.Builder subBuilder = null;
            if (eventCase_ == 10) {
              subBuilder = ((io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectConsecutive) event_).toBuilder();
            }
            event_ =
                input.readMessage(io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectConsecutive.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectConsecutive) event_);
              event_ = subBuilder.buildPartial();
            }
            eventCase_ = 10;
            break;
          ...
          case 90: {
            io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage.Builder subBuilder = null;
            if (eventCase_ == 11) {
              subBuilder = ((io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage) event_).toBuilder();
            }
            event_ =
                input.readMessage(io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage) event_);
              event_ = subBuilder.buildPartial();
            }
            eventCase_ = 11;
            break;
  ...
  @java.lang.Override public io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectionType getType() {
    ...
    io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectionType result = io.envoyproxy.envoy.data.cluster.v2alpha.OutlierEjectionType.valueOf(type_);
