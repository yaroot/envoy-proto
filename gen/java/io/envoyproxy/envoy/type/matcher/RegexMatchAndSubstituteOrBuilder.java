...
public interface RegexMatchAndSubstituteOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.type.matcher.RegexMatchAndSubstitute)
   ...
   * @return The pattern.
   */
  io.envoyproxy.envoy.type.matcher.RegexMatcher getPattern();
  /**
   * <pre>
   * The regular expression used to find portions of a string (hereafter called
   * the "subject string") that should be replaced. When a new string is
   ...
   * <code>.envoy.type.matcher.RegexMatcher pattern = 1;</code>
   */
  io.envoyproxy.envoy.type.matcher.RegexMatcherOrBuilder getPatternOrBuilder();
