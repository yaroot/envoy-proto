...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            io.envoyproxy.envoy.type.DoubleRange.Builder subBuilder = null;
            if (matchPatternCase_ == 1) {
              subBuilder = ((io.envoyproxy.envoy.type.DoubleRange) matchPattern_).toBuilder();
            }
            matchPattern_ =
                input.readMessage(io.envoyproxy.envoy.type.DoubleRange.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((io.envoyproxy.envoy.type.DoubleRange) matchPattern_);
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.envoyproxy.envoy.type.matcher.DoubleMatcher parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.envoyproxy.envoy.type.matcher.DoubleMatcher) e.getUnfinishedMessage();
