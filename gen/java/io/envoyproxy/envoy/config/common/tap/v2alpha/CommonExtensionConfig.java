...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(io.envoyproxy.envoy.config.common.tap.v2alpha.CommonExtensionConfig result) {
      int from_bitField0_ = bitField0_;
    }

    private void buildPartialOneofs(io.envoyproxy.envoy.config.common.tap.v2alpha.CommonExtensionConfig result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getAdminConfigFieldBuilder().getBuilder(),
                  extensionRegistry);
              configTypeCase_ = 1;
              break;
            } // case 10
