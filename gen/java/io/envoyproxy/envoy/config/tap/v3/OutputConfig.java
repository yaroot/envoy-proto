...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.config.tap.v3.OutputConfig result) {
      if (sinksBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.config.tap.v3.OutputConfig result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              io.envoyproxy.envoy.config.tap.v3.OutputSink m =
                  input.readMessage(
                      io.envoyproxy.envoy.config.tap.v3.OutputSink.parser(),
                      extensionRegistry);
              if (sinksBuilder_ == null) {
                ensureSinksIsMutable();
                sinks_.add(m);
