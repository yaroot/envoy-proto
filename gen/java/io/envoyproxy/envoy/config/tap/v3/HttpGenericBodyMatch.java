...
private static final long serialVersionUID = 0L;
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch result) {
        int from_bitField0_ = bitField0_;
      }

      private void buildPartialOneofs(io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch result) {
  ...
  private java.util.List<io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch> patterns_;
  /**
   * <pre>
   * List of patterns to match.
   * </pre>
   *
   * <code>repeated .envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch patterns = 2 [(.validate.rules) = { ... }</code>
   */
  @java.lang.Override
  public java.util.List<io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch> getPatternsList() {
    return patterns_;
  }
  /**
   * <pre>
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch result) {
      if (patternsBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch result) {
      int from_bitField0_ = bitField0_;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch m =
                  input.readMessage(
                      io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch.parser(),
                      extensionRegistry);
              if (patternsBuilder_ == null) {
                ensurePatternsIsMutable();
                patterns_.add(m);
    ...
    private void ensurePatternsIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        patterns_ = new java.util.ArrayList<io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch>(patterns_);
     ...
     * <code>repeated .envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch patterns = 2 [(.validate.rules) = { ... }</code>
     */
    public java.util.List<io.envoyproxy.envoy.config.tap.v3.HttpGenericBodyMatch.GenericTextMatch.Builder> 
