...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              statsTags_ = new java.util.ArrayList<io.envoyproxy.envoy.config.metrics.v2.TagSpecifier>();
              mutable_bitField0_ |= 0x00000001;
            }
            statsTags_.add(
                input.readMessage(io.envoyproxy.envoy.config.metrics.v2.TagSpecifier.parser(), extensionRegistry));
            break;
          }
          case 18: {
          ...
          case 26: {
            io.envoyproxy.envoy.config.metrics.v2.StatsMatcher.Builder subBuilder = null;
            if (statsMatcher_ != null) {
              subBuilder = statsMatcher_.toBuilder();
            }
            statsMatcher_ = input.readMessage(io.envoyproxy.envoy.config.metrics.v2.StatsMatcher.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.envoyproxy.envoy.config.metrics.v2.StatsConfig parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.envoyproxy.envoy.config.metrics.v2.StatsConfig) e.getUnfinishedMessage();
    ...
    public Builder mergeStatsMatcher(io.envoyproxy.envoy.config.metrics.v2.StatsMatcher value) {
      if (statsMatcherBuilder_ == null) {
        if (statsMatcher_ != null) {
          statsMatcher_ =
            io.envoyproxy.envoy.config.metrics.v2.StatsMatcher.newBuilder(statsMatcher_).mergeFrom(value).buildPartial();
        } else {
          statsMatcher_ = value;
        }
        onChanged();
