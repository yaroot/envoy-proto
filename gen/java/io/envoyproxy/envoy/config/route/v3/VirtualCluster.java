...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.config.route.v3.VirtualCluster result) {
      if (headersBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.config.route.v3.VirtualCluster result) {
