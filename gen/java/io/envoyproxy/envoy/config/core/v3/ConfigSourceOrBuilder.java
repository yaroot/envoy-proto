...
public interface ConfigSourceOrBuilder extends
   ...
   */
  java.util.List<com.github.xds.core.v3.Authority> 
      getAuthoritiesList();
  /**
   * <pre>
   * Authorities that this config source may be used for. An authority specified in a xdstp:// URL
   ...
   * <code>repeated .xds.core.v3.Authority authorities = 7;</code>
   */
  com.github.xds.core.v3.Authority getAuthorities(int index);
  /**
   * <pre>
   * Authorities that this config source may be used for. An authority specified in a xdstp:// URL
   * is resolved to a ``ConfigSource`` prior to configuration fetch. This field provides the
   ...
   * <code>repeated .xds.core.v3.Authority authorities = 7;</code>
   */
  java.util.List<? extends com.github.xds.core.v3.AuthorityOrBuilder> 
   ...
   * <code>repeated .xds.core.v3.Authority authorities = 7;</code>
   */
  com.github.xds.core.v3.AuthorityOrBuilder getAuthoritiesOrBuilder(
      int index);
   ...
   */
  @java.lang.Deprecated boolean hasPath();
  /**
   * <pre>
   * Deprecated in favor of ``path_config_source``. Use that field instead.
   * </pre>
   ...
   */
  io.envoyproxy.envoy.config.core.v3.PathConfigSource getPathConfigSource();
  /**
   * <pre>
   * Local filesystem path configuration source.
   * </pre>
   ...
   * <code>.envoy.config.core.v3.PathConfigSource path_config_source = 8;</code>
   */
  io.envoyproxy.envoy.config.core.v3.PathConfigSourceOrBuilder getPathConfigSourceOrBuilder();
