...
private static final long serialVersionUID = 0L;
  ...
  public java.lang.String getOverrideAutoSniHeader() {
    java.lang.Object ref = overrideAutoSniHeader_;
  ...
  public static final class Builder extends
    ...
    private java.lang.Object overrideAutoSniHeader_ = "";
    /**
     * <pre>
     * An optional alternative to the host/authority header to be used for setting the SNI value.
     * It should be a valid downstream HTTP header, as seen by the
     ...
     *
     * <code>string override_auto_sni_header = 3 [(.validate.rules) = { ... }</code>
     * @param value The overrideAutoSniHeader to set.
     * @return This builder for chaining.
     */
     ...
     *
     * <code>string override_auto_sni_header = 3 [(.validate.rules) = { ... }</code>
     * @param value The bytes for overrideAutoSniHeader to set.
     * @return This builder for chaining.
     */
