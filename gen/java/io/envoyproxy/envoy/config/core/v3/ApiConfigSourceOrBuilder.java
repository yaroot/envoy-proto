...
public interface ApiConfigSourceOrBuilder extends
   ...
   * <code>repeated .envoy.config.core.v3.TypedExtensionConfig config_validators = 9;</code>
   */
  io.envoyproxy.envoy.config.core.v3.TypedExtensionConfig getConfigValidators(int index);
  /**
   * <pre>
   * A list of config validators that will be executed when a new update is
   * received from the ApiConfigSource. Note that each validator handles a
   ...
   * <code>repeated .envoy.config.core.v3.TypedExtensionConfig config_validators = 9;</code>
   */
  io.envoyproxy.envoy.config.core.v3.TypedExtensionConfigOrBuilder getConfigValidatorsOrBuilder(
      int index);
}
