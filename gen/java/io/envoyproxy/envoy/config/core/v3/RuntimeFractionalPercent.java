...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(io.envoyproxy.envoy.config.core.v3.RuntimeFractionalPercent result) {
    ...
    public Builder mergeDefaultValue(io.envoyproxy.envoy.type.v3.FractionalPercent value) {
      if (defaultValueBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          defaultValue_ != null &&
          defaultValue_ != io.envoyproxy.envoy.type.v3.FractionalPercent.getDefaultInstance()) {
