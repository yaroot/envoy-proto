...
public interface OpenCensusConfigOrBuilder extends
   ...
   */
  java.util.List<io.envoyproxy.envoy.config.trace.v2.OpenCensusConfig.TraceContext> getIncomingTraceContextList();
  /**
   * <pre>
   * List of incoming trace context headers we will accept. First one found
   * wins.
   ...
   */
  java.util.List<io.envoyproxy.envoy.config.trace.v2.OpenCensusConfig.TraceContext> getOutgoingTraceContextList();
  /**
   * <pre>
   * List of outgoing trace context headers we will produce.
   * </pre>
