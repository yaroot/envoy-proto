 ...
 * </pre>
 *
 * Protobuf enum {@code envoy.config.filter.network.dubbo_proxy.v2alpha1.SerializationType}
 */
public enum SerializationType
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return io.envoyproxy.envoy.config.filter.network.dubbo_proxy.v2alpha1.DubboProxyProto.getDescriptor().getEnumTypes().get(1);
  }
  ...
  // @@protoc_insertion_point(enum_scope:envoy.config.filter.network.dubbo_proxy.v2alpha1.SerializationType)
}
