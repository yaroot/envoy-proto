...
public interface RateLimitOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.network.rate_limit.v2.RateLimit)
   ...
   */
  java.util.List<io.envoyproxy.envoy.api.v2.ratelimit.RateLimitDescriptor> 
      getDescriptorsList();
  /**
   * <pre>
   * The rate limit descriptor list to use in the rate limit service request.
