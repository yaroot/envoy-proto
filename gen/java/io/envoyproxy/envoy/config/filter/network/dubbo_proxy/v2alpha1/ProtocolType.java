 ...
 * </pre>
 *
 * Protobuf enum {@code envoy.config.filter.network.dubbo_proxy.v2alpha1.ProtocolType}
 */
public enum ProtocolType
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return io.envoyproxy.envoy.config.filter.network.dubbo_proxy.v2alpha1.DubboProxyProto.getDescriptor().getEnumTypes().get(0);
  }
  ...
  // @@protoc_insertion_point(enum_scope:envoy.config.filter.network.dubbo_proxy.v2alpha1.ProtocolType)
}
