 ...
 * </pre>
 *
 * Protobuf type {@code envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions}
 */
public final class ThriftProtocolOptions extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions)
...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProxyProto.internal_static_envoy_config_filter_network_thrift_proxy_v2alpha1_ThriftProtocolOptions_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions.class, io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions)) {
      return super.equals(obj);
    }
    io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions other = (io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions) obj;
  ...
  public static io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions parseFrom(
  ...
  public static io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions parseFrom(
  ...
  public static io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions)
      io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptionsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProxyProto.internal_static_envoy_config_filter_network_thrift_proxy_v2alpha1_ThriftProtocolOptions_descriptor;
    }
    ...
    @java.lang.Override
    public io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions getDefaultInstanceForType() {
      return io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions.getDefaultInstance();
    }

    @java.lang.Override
    public io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions build() {
      io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions) {
        return mergeFrom((io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions)other);
      } else {
    ...
    public Builder mergeFrom(io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions other) {
      if (other == io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions)
  }

  // @@protoc_insertion_point(class_scope:envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions)
  private static final io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions();
  }

  public static io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions getDefaultInstance() {
