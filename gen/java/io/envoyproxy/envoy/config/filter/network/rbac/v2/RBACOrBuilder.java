...
public interface RBACOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.network.rbac.v2.RBAC)
   ...
   */
  io.envoyproxy.envoy.config.filter.network.rbac.v2.RBAC.EnforcementType getEnforcementType();
}
