...
public interface ClientSSLAuthOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth)
   ...
   * <code>repeated .envoy.api.v2.core.CidrRange ip_white_list = 4;</code>
   */
  io.envoyproxy.envoy.api.v2.core.CidrRange getIpWhiteList(int index);
  /**
   * <pre>
   * An optional list of IP address and subnet masks that should be white
   * listed for access by the filter. If no list is provided, there is no
   ...
   * <code>repeated .envoy.api.v2.core.CidrRange ip_white_list = 4;</code>
   */
  io.envoyproxy.envoy.api.v2.core.CidrRangeOrBuilder getIpWhiteListOrBuilder(
      int index);
}
