...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            io.envoyproxy.envoy.config.filter.fault.v2.FaultDelay.Builder subBuilder = null;
            if (delay_ != null) {
              subBuilder = delay_.toBuilder();
            }
            delay_ = input.readMessage(io.envoyproxy.envoy.config.filter.fault.v2.FaultDelay.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 18: {
            io.envoyproxy.envoy.config.filter.http.fault.v2.FaultAbort.Builder subBuilder = null;
            if (abort_ != null) {
              subBuilder = abort_.toBuilder();
            }
            abort_ = input.readMessage(io.envoyproxy.envoy.config.filter.http.fault.v2.FaultAbort.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 58: {
            io.envoyproxy.envoy.config.filter.fault.v2.FaultRateLimit.Builder subBuilder = null;
            if (responseRateLimit_ != null) {
              subBuilder = responseRateLimit_.toBuilder();
            }
            responseRateLimit_ = input.readMessage(io.envoyproxy.envoy.config.filter.fault.v2.FaultRateLimit.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.envoyproxy.envoy.config.filter.http.fault.v2.HTTPFault parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.envoyproxy.envoy.config.filter.http.fault.v2.HTTPFault) e.getUnfinishedMessage();
    ...
    public Builder mergeDelay(io.envoyproxy.envoy.config.filter.fault.v2.FaultDelay value) {
      if (delayBuilder_ == null) {
        if (delay_ != null) {
          delay_ =
            io.envoyproxy.envoy.config.filter.fault.v2.FaultDelay.newBuilder(delay_).mergeFrom(value).buildPartial();
        } else {
          delay_ = value;
        }
        onChanged();
    ...
    public Builder mergeAbort(io.envoyproxy.envoy.config.filter.http.fault.v2.FaultAbort value) {
      if (abortBuilder_ == null) {
        if (abort_ != null) {
          abort_ =
            io.envoyproxy.envoy.config.filter.http.fault.v2.FaultAbort.newBuilder(abort_).mergeFrom(value).buildPartial();
        } else {
          abort_ = value;
        }
        onChanged();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeResponseRateLimit(io.envoyproxy.envoy.config.filter.fault.v2.FaultRateLimit value) {
      if (responseRateLimitBuilder_ == null) {
        if (responseRateLimit_ != null) {
          responseRateLimit_ =
            io.envoyproxy.envoy.config.filter.fault.v2.FaultRateLimit.newBuilder(responseRateLimit_).mergeFrom(value).buildPartial();
        } else {
          responseRateLimit_ = value;
        }
        onChanged();
