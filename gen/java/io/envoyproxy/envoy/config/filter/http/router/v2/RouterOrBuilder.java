...
public interface RouterOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.http.router.v2.Router)
   ...
   * <code>repeated .envoy.config.filter.accesslog.v2.AccessLog upstream_log = 3;</code>
   */
  io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog getUpstreamLog(int index);
  /**
   * <pre>
   * Configuration for HTTP upstream logs emitted by the router. Upstream logs
   * are configured in the same way as access logs, but each log entry represents
   ...
   * <code>repeated .envoy.config.filter.accesslog.v2.AccessLog upstream_log = 3;</code>
   */
  io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLogOrBuilder getUpstreamLogOrBuilder(
      int index);
