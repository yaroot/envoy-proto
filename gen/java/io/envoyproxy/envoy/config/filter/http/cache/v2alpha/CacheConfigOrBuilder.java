...
public interface CacheConfigOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.http.cache.v2alpha.CacheConfig)
   ...
   * <code>repeated .envoy.type.matcher.StringMatcher allowed_vary_headers = 2;</code>
   */
  io.envoyproxy.envoy.type.matcher.StringMatcher getAllowedVaryHeaders(int index);
  /**
   * <pre>
   * List of matching rules that defines allowed *Vary* headers.
   * The *vary* response header holds a list of header names that affect the
   ...
   * <code>repeated .envoy.type.matcher.StringMatcher allowed_vary_headers = 2;</code>
   */
  io.envoyproxy.envoy.type.matcher.StringMatcherOrBuilder getAllowedVaryHeadersOrBuilder(
      int index);
   ...
   */
  io.envoyproxy.envoy.config.filter.http.cache.v2alpha.CacheConfig.KeyCreatorParams getKeyCreatorParams();
  /**
   * <pre>
   * [#not-implemented-hide:]
   * &lt;TODO(toddmgreer) implement key customization&gt;
   ...
   * <code>.envoy.config.filter.http.cache.v2alpha.CacheConfig.KeyCreatorParams key_creator_params = 3;</code>
   */
  io.envoyproxy.envoy.config.filter.http.cache.v2alpha.CacheConfig.KeyCreatorParamsOrBuilder getKeyCreatorParamsOrBuilder();
