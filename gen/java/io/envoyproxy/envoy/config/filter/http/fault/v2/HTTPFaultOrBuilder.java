...
public interface HTTPFaultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.http.fault.v2.HTTPFault)
   ...
   * @return The abort.
   */
  io.envoyproxy.envoy.config.filter.http.fault.v2.FaultAbort getAbort();
  /**
   * <pre>
   * If specified, the filter will abort requests based on the values in
   * the object. At least *abort* or *delay* must be specified.
   ...
   * <code>.envoy.config.filter.http.fault.v2.FaultAbort abort = 2;</code>
   */
  io.envoyproxy.envoy.config.filter.http.fault.v2.FaultAbortOrBuilder getAbortOrBuilder();
   ...
   */
  io.envoyproxy.envoy.config.filter.fault.v2.FaultRateLimit getResponseRateLimit();
  /**
   * <pre>
   * The response rate limit to be applied to the response body of the stream. When configured,
   * the percentage can be overridden by the :ref:`fault.http.rate_limit.response_percent
   ...
   * <code>.envoy.config.filter.fault.v2.FaultRateLimit response_rate_limit = 7;</code>
   */
  io.envoyproxy.envoy.config.filter.fault.v2.FaultRateLimitOrBuilder getResponseRateLimitOrBuilder();
