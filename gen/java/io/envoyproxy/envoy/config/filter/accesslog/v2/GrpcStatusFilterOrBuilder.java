...
public interface GrpcStatusFilterOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.accesslog.v2.GrpcStatusFilter)
   ...
   */
  java.util.List<io.envoyproxy.envoy.config.filter.accesslog.v2.GrpcStatusFilter.Status> getStatusesList();
  /**
   * <pre>
   * Logs only responses that have any one of the gRPC statuses in this field.
   * </pre>
   ...
   */
  io.envoyproxy.envoy.config.filter.accesslog.v2.GrpcStatusFilter.Status getStatuses(int index);
  /**
   * <pre>
   * Logs only responses that have any one of the gRPC statuses in this field.
   * </pre>
