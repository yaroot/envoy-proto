...
public interface RuntimeFilterOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.config.filter.accesslog.v2.RuntimeFilter)
   ...
   */
  io.envoyproxy.envoy.type.FractionalPercent getPercentSampled();
  /**
   * <pre>
   * The default sampling percentage. If not specified, defaults to 0% with denominator of 100.
   * </pre>
   ...
   * <code>.envoy.type.FractionalPercent percent_sampled = 2;</code>
   */
  io.envoyproxy.envoy.type.FractionalPercentOrBuilder getPercentSampledOrBuilder();
