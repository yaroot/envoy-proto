...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            percentSampled_ = input.readMessage(io.envoyproxy.envoy.type.FractionalPercent.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.envoyproxy.envoy.config.filter.accesslog.v2.RuntimeFilter parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.envoyproxy.envoy.config.filter.accesslog.v2.RuntimeFilter) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergePercentSampled(io.envoyproxy.envoy.type.FractionalPercent value) {
      if (percentSampledBuilder_ == null) {
        if (percentSampled_ != null) {
          percentSampled_ =
            io.envoyproxy.envoy.type.FractionalPercent.newBuilder(percentSampled_).mergeFrom(value).buildPartial();
        } else {
          percentSampled_ = value;
        }
        onChanged();
