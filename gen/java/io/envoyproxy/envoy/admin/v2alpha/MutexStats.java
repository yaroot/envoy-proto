 ...
 * </pre>
 *
 * Protobuf type {@code envoy.admin.v2alpha.MutexStats}
 */
public final class MutexStats extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:envoy.admin.v2alpha.MutexStats)
    MutexStatsOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.envoyproxy.envoy.admin.v2alpha.MutexStatsProto.internal_static_envoy_admin_v2alpha_MutexStats_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.envoyproxy.envoy.admin.v2alpha.MutexStatsProto.internal_static_envoy_admin_v2alpha_MutexStats_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.envoyproxy.envoy.admin.v2alpha.MutexStats.class, io.envoyproxy.envoy.admin.v2alpha.MutexStats.Builder.class);
  }

  public static final int NUM_CONTENTIONS_FIELD_NUMBER = 1;
  private long numContentions_ = 0L;
  /**
   * <pre>
  ...
  private long currentWaitCycles_ = 0L;
  /**
   * <pre>
  ...
  private long lifetimeWaitCycles_ = 0L;
  /**
   * <pre>
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.envoyproxy.envoy.admin.v2alpha.MutexStats)) {
      return super.equals(obj);
    }
    io.envoyproxy.envoy.admin.v2alpha.MutexStats other = (io.envoyproxy.envoy.admin.v2alpha.MutexStats) obj;
  ...
  public static io.envoyproxy.envoy.admin.v2alpha.MutexStats parseFrom(
  ...
  public static io.envoyproxy.envoy.admin.v2alpha.MutexStats parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.envoyproxy.envoy.admin.v2alpha.MutexStats parseFrom(
  ...
  public static io.envoyproxy.envoy.admin.v2alpha.MutexStats parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.envoyproxy.envoy.admin.v2alpha.MutexStats parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.envoyproxy.envoy.admin.v2alpha.MutexStats parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.envoyproxy.envoy.admin.v2alpha.MutexStats prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:envoy.admin.v2alpha.MutexStats)
      io.envoyproxy.envoy.admin.v2alpha.MutexStatsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.envoyproxy.envoy.admin.v2alpha.MutexStatsProto.internal_static_envoy_admin_v2alpha_MutexStats_descriptor;
    }
    ...
    // Construct using io.envoyproxy.envoy.admin.v2alpha.MutexStats.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.envoyproxy.envoy.admin.v2alpha.MutexStats getDefaultInstanceForType() {
      return io.envoyproxy.envoy.admin.v2alpha.MutexStats.getDefaultInstance();
    }

    @java.lang.Override
    public io.envoyproxy.envoy.admin.v2alpha.MutexStats build() {
      io.envoyproxy.envoy.admin.v2alpha.MutexStats result = buildPartial();
    ...
    @java.lang.Override
    public io.envoyproxy.envoy.admin.v2alpha.MutexStats buildPartial() {
      io.envoyproxy.envoy.admin.v2alpha.MutexStats result = new io.envoyproxy.envoy.admin.v2alpha.MutexStats(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(io.envoyproxy.envoy.admin.v2alpha.MutexStats result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.envoyproxy.envoy.admin.v2alpha.MutexStats) {
        return mergeFrom((io.envoyproxy.envoy.admin.v2alpha.MutexStats)other);
      } else {
    ...
    public Builder mergeFrom(io.envoyproxy.envoy.admin.v2alpha.MutexStats other) {
      if (other == io.envoyproxy.envoy.admin.v2alpha.MutexStats.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:envoy.admin.v2alpha.MutexStats)
  }

  // @@protoc_insertion_point(class_scope:envoy.admin.v2alpha.MutexStats)
  private static final io.envoyproxy.envoy.admin.v2alpha.MutexStats DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.envoyproxy.envoy.admin.v2alpha.MutexStats();
  }

  public static io.envoyproxy.envoy.admin.v2alpha.MutexStats getDefaultInstance() {
