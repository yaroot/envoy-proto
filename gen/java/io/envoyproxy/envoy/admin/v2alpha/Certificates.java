...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              certificates_ = new java.util.ArrayList<io.envoyproxy.envoy.admin.v2alpha.Certificate>();
              mutable_bitField0_ |= 0x00000001;
            }
            certificates_.add(
                input.readMessage(io.envoyproxy.envoy.admin.v2alpha.Certificate.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.envoyproxy.envoy.admin.v2alpha.Certificates parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.envoyproxy.envoy.admin.v2alpha.Certificates) e.getUnfinishedMessage();
