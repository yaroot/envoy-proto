...
private static final long serialVersionUID = 0L;
   ...
   * </pre>
   *
   * <code>bool excluded_via_immediate_hc_fail = 7;</code>
   * @return The excludedViaImmediateHcFail.
   */
  @java.lang.Override
  public boolean getExcludedViaImmediateHcFail() {
    return excludedViaImmediateHcFail_;
  }
   ...
   * </pre>
   *
   * <code>bool active_hc_timeout = 8;</code>
   * @return The activeHcTimeout.
   */
  @java.lang.Override
  public boolean getActiveHcTimeout() {
    return activeHcTimeout_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (excludedViaImmediateHcFail_ != false) {
      output.writeBool(7, excludedViaImmediateHcFail_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (excludedViaImmediateHcFail_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(7, excludedViaImmediateHcFail_);
    }
    if (activeHcTimeout_ != false) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getExcludedViaImmediateHcFail()
        != other.getExcludedViaImmediateHcFail()) return false;
  ...
  public int hashCode() {
    ...
    hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
        getPendingActiveHc());
    hash = (37 * hash) + EXCLUDED_VIA_IMMEDIATE_HC_FAIL_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
        getExcludedViaImmediateHcFail());
    hash = (37 * hash) + ACTIVE_HC_TIMEOUT_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
        getActiveHcTimeout());
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(io.envoyproxy.envoy.admin.v3.HostHealthStatus other) {
      ...
      if (other.getExcludedViaImmediateHcFail() != false) {
        setExcludedViaImmediateHcFail(other.getExcludedViaImmediateHcFail());
      }
      if (other.getActiveHcTimeout() != false) {
        setActiveHcTimeout(other.getActiveHcTimeout());
      }
     ...
     *
     * <code>bool excluded_via_immediate_hc_fail = 7;</code>
     * @param value The excludedViaImmediateHcFail to set.
     * @return This builder for chaining.
     */
     ...
     *
     * <code>bool active_hc_timeout = 8;</code>
     * @param value The activeHcTimeout to set.
     * @return This builder for chaining.
     */
