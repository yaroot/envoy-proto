...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.admin.v3.Certificates result) {
      if (certificatesBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.admin.v3.Certificates result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              io.envoyproxy.envoy.admin.v3.Certificate m =
                  input.readMessage(
                      io.envoyproxy.envoy.admin.v3.Certificate.parser(),
                      extensionRegistry);
              if (certificatesBuilder_ == null) {
                ensureCertificatesIsMutable();
                certificates_.add(m);
