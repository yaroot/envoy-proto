        ...
        switch (tag) {
          ...
          case 66: {
            if (!((mutable_bitField0_ & 0x00000004) != 0)) {
              removedResourceNames_ = new java.util.ArrayList<io.envoyproxy.envoy.service.discovery.v3.ResourceName>();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeControlPlane(io.envoyproxy.envoy.config.core.v3.ControlPlane value) {
      if (controlPlaneBuilder_ == null) {
        if (controlPlane_ != null) {
          controlPlane_ =
            io.envoyproxy.envoy.config.core.v3.ControlPlane.newBuilder(controlPlane_).mergeFrom(value).buildPartial();
        } else {
          controlPlane_ = value;
        }
        onChanged();
