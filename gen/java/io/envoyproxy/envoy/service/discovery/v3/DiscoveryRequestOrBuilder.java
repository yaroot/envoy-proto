...
public interface DiscoveryRequestOrBuilder extends
   ...
   */
  java.util.List<io.envoyproxy.envoy.service.discovery.v3.ResourceLocator> 
   ...
   * <code>repeated .envoy.service.discovery.v3.ResourceLocator resource_locators = 7;</code>
   */
  io.envoyproxy.envoy.service.discovery.v3.ResourceLocator getResourceLocators(int index);
  /**
   * <pre>
   * [#not-implemented-hide:]
   * Alternative to ``resource_names`` field that allows specifying dynamic
   ...
   * <code>repeated .envoy.service.discovery.v3.ResourceLocator resource_locators = 7;</code>
   */
  io.envoyproxy.envoy.service.discovery.v3.ResourceLocatorOrBuilder getResourceLocatorsOrBuilder(
      int index);
