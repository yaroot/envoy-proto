...
public interface ResourceOrBuilder extends
   ...
   */
  io.envoyproxy.envoy.service.discovery.v3.ResourceName getResourceName();
  /**
   * <pre>
   * Alternative to the ``name`` field, to be used when the server supports
   * multiple variants of the named resource that are differentiated by
   ...
   * <code>.envoy.service.discovery.v3.ResourceName resource_name = 8;</code>
   */
  io.envoyproxy.envoy.service.discovery.v3.ResourceNameOrBuilder getResourceNameOrBuilder();
