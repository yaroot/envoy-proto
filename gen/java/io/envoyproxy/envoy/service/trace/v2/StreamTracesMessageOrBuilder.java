...
public interface StreamTracesMessageOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.service.trace.v2.StreamTracesMessage)
   ...
   */
  io.envoyproxy.envoy.service.trace.v2.StreamTracesMessage.Identifier getIdentifier();
  /**
   * <pre>
   * Identifier data effectively is a structured metadata.
   * As a performance optimization this will only be sent in the first message
   ...
   * <code>.envoy.service.trace.v2.StreamTracesMessage.Identifier identifier = 1;</code>
   */
  io.envoyproxy.envoy.service.trace.v2.StreamTracesMessage.IdentifierOrBuilder getIdentifierOrBuilder();
