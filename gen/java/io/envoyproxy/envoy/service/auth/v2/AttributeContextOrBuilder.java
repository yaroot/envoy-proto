...
public interface AttributeContextOrBuilder extends
   ...
   * @return The source.
   */
  io.envoyproxy.envoy.service.auth.v2.AttributeContext.Peer getSource();
  /**
   * <pre>
   * The source of a network activity, such as starting a TCP connection.
   * In a multi hop network activity, the source represents the sender of the
   ...
   * <code>.envoy.service.auth.v2.AttributeContext.Peer source = 1;</code>
   */
  io.envoyproxy.envoy.service.auth.v2.AttributeContext.PeerOrBuilder getSourceOrBuilder();
   ...
   */
  io.envoyproxy.envoy.service.auth.v2.AttributeContext.Peer getDestination();
  /**
   * <pre>
   * The destination of a network activity, such as accepting a TCP connection.
   * In a multi hop network activity, the destination represents the receiver of
   ...
   * <code>.envoy.service.auth.v2.AttributeContext.Peer destination = 2;</code>
   */
  io.envoyproxy.envoy.service.auth.v2.AttributeContext.PeerOrBuilder getDestinationOrBuilder();
   ...
   * @return The request.
   */
  io.envoyproxy.envoy.service.auth.v2.AttributeContext.Request getRequest();
  /**
   * <pre>
   * Represents a network request, such as an HTTP request.
   * </pre>
   ...
   * <code>.envoy.service.auth.v2.AttributeContext.Request request = 4;</code>
   */
  io.envoyproxy.envoy.service.auth.v2.AttributeContext.RequestOrBuilder getRequestOrBuilder();
...
java.lang.String defaultValue);
   ...
   */
  io.envoyproxy.envoy.api.v2.core.Metadata getMetadataContext();
  /**
   * <pre>
   * Dynamic metadata associated with the request.
   * </pre>
   ...
   * <code>.envoy.api.v2.core.Metadata metadata_context = 11;</code>
   */
  io.envoyproxy.envoy.api.v2.core.MetadataOrBuilder getMetadataContextOrBuilder();
}
