...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.service.auth.v2.DeniedHttpResponse result) {
      if (headersBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.service.auth.v2.DeniedHttpResponse result) {
    ...
    public Builder mergeStatus(io.envoyproxy.envoy.type.HttpStatus value) {
      if (statusBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          status_ != null &&
          status_ != io.envoyproxy.envoy.type.HttpStatus.getDefaultInstance()) {
