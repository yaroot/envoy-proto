...
public interface OutputConfigOrBuilder extends
    // @@protoc_insertion_point(interface_extends:envoy.service.tap.v2alpha.OutputConfig)
   ...
   */
  java.util.List<io.envoyproxy.envoy.service.tap.v2alpha.OutputSink> 
      getSinksList();
  /**
   * <pre>
   * Output sinks for tap data. Currently a single sink is allowed in the list. Once multiple
   ...
   * <code>repeated .envoy.service.tap.v2alpha.OutputSink sinks = 1 [(.validate.rules) = { ... }</code>
   */
  io.envoyproxy.envoy.service.tap.v2alpha.OutputSink getSinks(int index);
  /**
   * <pre>
   * Output sinks for tap data. Currently a single sink is allowed in the list. Once multiple
   * sink types are supported this constraint will be relaxed.
   ...
   * <code>repeated .envoy.service.tap.v2alpha.OutputSink sinks = 1 [(.validate.rules) = { ... }</code>
   */
  java.util.List<? extends io.envoyproxy.envoy.service.tap.v2alpha.OutputSinkOrBuilder> 
   ...
   * <code>repeated .envoy.service.tap.v2alpha.OutputSink sinks = 1 [(.validate.rules) = { ... }</code>
   */
  io.envoyproxy.envoy.service.tap.v2alpha.OutputSinkOrBuilder getSinksOrBuilder(
      int index);
