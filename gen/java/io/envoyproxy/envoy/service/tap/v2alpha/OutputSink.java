...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.Builder subBuilder = null;
            if (outputSinkTypeCase_ == 4) {
              subBuilder = ((io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_).toBuilder();
            }
            outputSinkType_ =
                input.readMessage(io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_);
              outputSinkType_ = subBuilder.buildPartial();
            }
   ...
   * </pre>
   *
   * Protobuf enum {@code envoy.service.tap.v2alpha.OutputSink.Format}
   */
  public enum Format
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.getDescriptor().getEnumTypes().get(0);
    }
    ...
    // @@protoc_insertion_point(enum_scope:envoy.service.tap.v2alpha.OutputSink.Format)
  }
   ...
   * </pre>
   *
   * <code>.envoy.service.tap.v2alpha.OutputSink.Format format = 1 [(.validate.rules) = { ... }</code>
   ...
   * @return The format.
   */
  @java.lang.Override public io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format getFormat() {
    @SuppressWarnings("deprecation")
    io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format result = io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format.valueOf(format_);
    return result == null ? io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format.UNRECOGNIZED : result;
  }
   ...
   * </pre>
   *
   * <code>.envoy.service.tap.v2alpha.StreamingAdminSink streaming_admin = 2;</code>
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink getStreamingAdmin() {
    if (outputSinkTypeCase_ == 2) {
   ...
   * </pre>
   *
   * <code>.envoy.service.tap.v2alpha.FilePerTapSink file_per_tap = 3;</code>
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink getFilePerTap() {
    if (outputSinkTypeCase_ == 3) {
   ...
   * </pre>
   *
   * <code>.envoy.service.tap.v2alpha.StreamingGrpcSink streaming_grpc = 4;</code>
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink getStreamingGrpc() {
    if (outputSinkTypeCase_ == 4) {
       return (io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_;
    }
    return io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.getDefaultInstance();
  }
  /**
   * <pre>
   * [#not-implemented-hide:]
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSinkOrBuilder getStreamingGrpcOrBuilder() {
    if (outputSinkTypeCase_ == 4) {
       return (io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_;
    }
    return io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.getDefaultInstance();
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (format_ != io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format.JSON_BODY_AS_BYTES.getNumber()) {
      output.writeEnum(1, format_);
    }
    if (outputSinkTypeCase_ == 2) {
      output.writeMessage(2, (io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink) outputSinkType_);
    }
    if (outputSinkTypeCase_ == 3) {
      output.writeMessage(3, (io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink) outputSinkType_);
    }
    if (outputSinkTypeCase_ == 4) {
      output.writeMessage(4, (io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (outputSinkTypeCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, (io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink) outputSinkType_);
    }
    if (outputSinkTypeCase_ == 3) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, (io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink) outputSinkType_);
    }
    if (outputSinkTypeCase_ == 4) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(4, (io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_);
    }
  ...
  public static final class Builder extends
     ...
     */
    @java.lang.Override
    public io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format getFormat() {
      @SuppressWarnings("deprecation")
      io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format result = io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format.valueOf(format_);
      return result == null ? io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setFormat(io.envoyproxy.envoy.service.tap.v2alpha.OutputSink.Format value) {
      if (value == null) {
     ...
     * <code>.envoy.service.tap.v2alpha.StreamingAdminSink streaming_admin = 2;</code>
     */
    public Builder setStreamingAdmin(io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink value) {
      if (streamingAdminBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setStreamingAdmin(
        io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink.Builder builderForValue) {
      if (streamingAdminBuilder_ == null) {
     ...
     * <code>.envoy.service.tap.v2alpha.StreamingAdminSink streaming_admin = 2;</code>
     */
    public Builder mergeStreamingAdmin(io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink value) {
      if (streamingAdminBuilder_ == null) {
        if (outputSinkTypeCase_ == 2 &&
            outputSinkType_ != io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink.getDefaultInstance()) {
          outputSinkType_ = io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink.newBuilder((io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink) outputSinkType_)
     ...
     * <code>.envoy.service.tap.v2alpha.StreamingAdminSink streaming_admin = 2;</code>
     */
    public io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink.Builder getStreamingAdminBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink, io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSinkOrBuilder> 
      ...
      if (streamingAdminBuilder_ == null) {
        ...
        streamingAdminBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink, io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSinkOrBuilder>(
                (io.envoyproxy.envoy.service.tap.v2alpha.StreamingAdminSink) outputSinkType_,
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink, io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSinkOrBuilder> filePerTapBuilder_;
    /**
     * <pre>
     * Tap output will be written to a file per tap sink.
     * </pre>
     ...
     * <code>.envoy.service.tap.v2alpha.FilePerTapSink file_per_tap = 3;</code>
     */
    public Builder setFilePerTap(io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink value) {
      if (filePerTapBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setFilePerTap(
        io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink.Builder builderForValue) {
      if (filePerTapBuilder_ == null) {
        outputSinkType_ = builderForValue.build();
        onChanged();
      } else {
     ...
     * <code>.envoy.service.tap.v2alpha.FilePerTapSink file_per_tap = 3;</code>
     */
    public Builder mergeFilePerTap(io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink value) {
      if (filePerTapBuilder_ == null) {
        if (outputSinkTypeCase_ == 3 &&
            outputSinkType_ != io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink.getDefaultInstance()) {
          outputSinkType_ = io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink.newBuilder((io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink) outputSinkType_)
              .mergeFrom(value).buildPartial();
        } else {
          outputSinkType_ = value;
        }
     ...
     * <code>.envoy.service.tap.v2alpha.FilePerTapSink file_per_tap = 3;</code>
     */
    public io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink.Builder getFilePerTapBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink, io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSinkOrBuilder> 
      ...
      if (filePerTapBuilder_ == null) {
        ...
        filePerTapBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink, io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSinkOrBuilder>(
                (io.envoyproxy.envoy.service.tap.v2alpha.FilePerTapSink) outputSinkType_,
                getParentForChildren(),
                isClean());
        outputSinkType_ = null;
      }
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink, io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSinkOrBuilder> streamingGrpcBuilder_;
    /**
     * <pre>
     * [#not-implemented-hide:]
     * GrpcService to stream data to. The format argument must be PROTO_BINARY.
     ...
     * <code>.envoy.service.tap.v2alpha.StreamingGrpcSink streaming_grpc = 4;</code>
     */
    public Builder setStreamingGrpc(io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink value) {
      if (streamingGrpcBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setStreamingGrpc(
        io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.Builder builderForValue) {
      if (streamingGrpcBuilder_ == null) {
        outputSinkType_ = builderForValue.build();
        onChanged();
      } else {
     ...
     * <code>.envoy.service.tap.v2alpha.StreamingGrpcSink streaming_grpc = 4;</code>
     */
    public Builder mergeStreamingGrpc(io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink value) {
      if (streamingGrpcBuilder_ == null) {
        if (outputSinkTypeCase_ == 4 &&
            outputSinkType_ != io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.getDefaultInstance()) {
          outputSinkType_ = io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.newBuilder((io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_)
              .mergeFrom(value).buildPartial();
        } else {
          outputSinkType_ = value;
        }
     ...
     * <code>.envoy.service.tap.v2alpha.StreamingGrpcSink streaming_grpc = 4;</code>
     */
    public io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.Builder getStreamingGrpcBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink, io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSinkOrBuilder> 
      ...
      if (streamingGrpcBuilder_ == null) {
        ...
        streamingGrpcBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink, io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink.Builder, io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSinkOrBuilder>(
                (io.envoyproxy.envoy.service.tap.v2alpha.StreamingGrpcSink) outputSinkType_,
                getParentForChildren(),
                isClean());
        outputSinkType_ = null;
      }
    ...
    // @@protoc_insertion_point(builder_scope:envoy.service.tap.v2alpha.OutputSink)
  }

  // @@protoc_insertion_point(class_scope:envoy.service.tap.v2alpha.OutputSink)
  private static final io.envoyproxy.envoy.service.tap.v2alpha.OutputSink DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.envoyproxy.envoy.service.tap.v2alpha.OutputSink();
  }

  public static io.envoyproxy.envoy.service.tap.v2alpha.OutputSink getDefaultInstance() {
