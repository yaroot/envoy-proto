...
private static final long serialVersionUID = 0L;
  ...
  private io.envoyproxy.envoy.config.core.v3.DataSource pkcs12_;
  /**
   * <pre>
   ...
   * </pre>
   *
   * <code>.envoy.config.core.v3.DataSource pkcs12 = 8 [(.udpa.annotations.sensitive) = true];</code>
   * @return Whether the pkcs12 field is set.
   */
  @java.lang.Override
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.config.core.v3.DataSource getPkcs12() {
    return pkcs12_ == null ? io.envoyproxy.envoy.config.core.v3.DataSource.getDefaultInstance() : pkcs12_;
  }
  /**
   * <pre>
   * ``Pkcs12`` data containing TLS certificate, chain, and private key.
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.config.core.v3.DataSourceOrBuilder getPkcs12OrBuilder() {
    return pkcs12_ == null ? io.envoyproxy.envoy.config.core.v3.DataSource.getDefaultInstance() : pkcs12_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (pkcs12_ != null) {
      output.writeMessage(8, getPkcs12());
    }
  ...
  public int getSerializedSize() {
    ...
    if (pkcs12_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(8, getPkcs12());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasPkcs12() != other.hasPkcs12()) return false;
    if (hasPkcs12()) {
      if (!getPkcs12()
          .equals(other.getPkcs12())) return false;
    }
  ...
  public int hashCode() {
    ...
    if (hasPkcs12()) {
      hash = (37 * hash) + PKCS12_FIELD_NUMBER;
      hash = (53 * hash) + getPkcs12().hashCode();
    }
    if (hasWatchedDirectory()) {
  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      pkcs12_ = null;
      if (pkcs12Builder_ != null) {
        pkcs12Builder_.dispose();
        pkcs12Builder_ = null;
      }
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.TlsCertificate result) {
      if (signedCertificateTimestampBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.TlsCertificate result) {
      ...
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.pkcs12_ = pkcs12Builder_ == null
            ? pkcs12_
            : pkcs12Builder_.build();
      }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66: {
              input.readMessage(
                  getPkcs12FieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public Builder mergeCertificateChain(io.envoyproxy.envoy.config.core.v3.DataSource value) {
      if (certificateChainBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          certificateChain_ != null &&
          certificateChain_ != io.envoyproxy.envoy.config.core.v3.DataSource.getDefaultInstance()) {
    ...
    private io.envoyproxy.envoy.config.core.v3.DataSource pkcs12_;
    private com.google.protobuf.SingleFieldBuilderV3<
        io.envoyproxy.envoy.config.core.v3.DataSource, io.envoyproxy.envoy.config.core.v3.DataSource.Builder, io.envoyproxy.envoy.config.core.v3.DataSourceOrBuilder> pkcs12Builder_;
    /**
     * <pre>
     * ``Pkcs12`` data containing TLS certificate, chain, and private key.
     * If ``pkcs12`` is a filesystem path, the file will be read, but no watch will
    ...
    public io.envoyproxy.envoy.config.core.v3.DataSource getPkcs12() {
      if (pkcs12Builder_ == null) {
        ...
        return pkcs12Builder_.getMessage();
      }
    }
    /**
     * <pre>
     ...
     * <code>.envoy.config.core.v3.DataSource pkcs12 = 8 [(.udpa.annotations.sensitive) = true];</code>
     */
    public Builder setPkcs12(io.envoyproxy.envoy.config.core.v3.DataSource value) {
      if (pkcs12Builder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ...
        pkcs12Builder_.setMessage(value);
      }
      bitField0_ |= 0x00000004;
      onChanged();
      return this;
     ...
     * <code>.envoy.config.core.v3.DataSource pkcs12 = 8 [(.udpa.annotations.sensitive) = true];</code>
     */
    public Builder setPkcs12(
        io.envoyproxy.envoy.config.core.v3.DataSource.Builder builderForValue) {
      if (pkcs12Builder_ == null) {
        pkcs12_ = builderForValue.build();
      } else {
        pkcs12Builder_.setMessage(builderForValue.build());
      }
      bitField0_ |= 0x00000004;
      onChanged();
      return this;
     ...
     * <code>.envoy.config.core.v3.DataSource pkcs12 = 8 [(.udpa.annotations.sensitive) = true];</code>
     */
    public Builder mergePkcs12(io.envoyproxy.envoy.config.core.v3.DataSource value) {
      if (pkcs12Builder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          pkcs12_ != null &&
          pkcs12_ != io.envoyproxy.envoy.config.core.v3.DataSource.getDefaultInstance()) {
          getPkcs12Builder().mergeFrom(value);
        } else {
          pkcs12_ = value;
        }
      } else {
        pkcs12Builder_.mergeFrom(value);
      }
      bitField0_ |= 0x00000004;
      onChanged();
      return this;
     ...
     * <code>.envoy.config.core.v3.DataSource pkcs12 = 8 [(.udpa.annotations.sensitive) = true];</code>
     */
    public io.envoyproxy.envoy.config.core.v3.DataSource.Builder getPkcs12Builder() {
      bitField0_ |= 0x00000004;
      onChanged();
    ...
    public io.envoyproxy.envoy.config.core.v3.DataSourceOrBuilder getPkcs12OrBuilder() {
      if (pkcs12Builder_ != null) {
        return pkcs12Builder_.getMessageOrBuilder();
      } else {
        return pkcs12_ == null ?
            io.envoyproxy.envoy.config.core.v3.DataSource.getDefaultInstance() : pkcs12_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (pkcs12Builder_ == null) {
        pkcs12Builder_ = new com.google.protobuf.SingleFieldBuilderV3<
            io.envoyproxy.envoy.config.core.v3.DataSource, io.envoyproxy.envoy.config.core.v3.DataSource.Builder, io.envoyproxy.envoy.config.core.v3.DataSourceOrBuilder>(
                getPkcs12(),
                getParentForChildren(),
                isClean());
    ...
    public Builder mergePrivateKeyProvider(io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.PrivateKeyProvider value) {
      if (privateKeyProviderBuilder_ == null) {
        if (((bitField0_ & 0x00000010) != 0) &&
          privateKeyProvider_ != null &&
          privateKeyProvider_ != io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.PrivateKeyProvider.getDefaultInstance()) {
    ...
    public Builder mergePassword(io.envoyproxy.envoy.config.core.v3.DataSource value) {
      if (passwordBuilder_ == null) {
        if (((bitField0_ & 0x00000020) != 0) &&
          password_ != null &&
          password_ != io.envoyproxy.envoy.config.core.v3.DataSource.getDefaultInstance()) {
    ...
    public Builder mergeOcspStaple(io.envoyproxy.envoy.config.core.v3.DataSource value) {
      if (ocspStapleBuilder_ == null) {
        if (((bitField0_ & 0x00000040) != 0) &&
          ocspStaple_ != null &&
          ocspStaple_ != io.envoyproxy.envoy.config.core.v3.DataSource.getDefaultInstance()) {
