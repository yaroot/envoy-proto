...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 66: {
            io.envoyproxy.envoy.config.core.v3.DataSource.Builder subBuilder = null;
            if (pkcs12_ != null) {
              subBuilder = pkcs12_.toBuilder();
            }
            pkcs12_ = input.readMessage(io.envoyproxy.envoy.config.core.v3.DataSource.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom(pkcs12_);
              pkcs12_ = subBuilder.buildPartial();
            }
  ...
  public static final class Builder extends
    ...
    public io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.TlsCertificate buildPartial() {
      ...
      if (pkcs12Builder_ == null) {
        result.pkcs12_ = pkcs12_;
      } else {
        result.pkcs12_ = pkcs12Builder_.build();
      }
      if (watchedDirectoryBuilder_ == null) {
     ...
     */
    public boolean hasPkcs12() {
      return pkcs12Builder_ != null || pkcs12_ != null;
    }
    /**
     * <pre>
     * ``Pkcs12`` data containing TLS certificate, chain, and private key.
    ...
    public Builder mergePkcs12(io.envoyproxy.envoy.config.core.v3.DataSource value) {
      if (pkcs12Builder_ == null) {
        if (pkcs12_ != null) {
          pkcs12_ =
            io.envoyproxy.envoy.config.core.v3.DataSource.newBuilder(pkcs12_).mergeFrom(value).buildPartial();
        } else {
          pkcs12_ = value;
        }
        onChanged();
