...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.SdsSecretConfig result) {
    ...
    public Builder mergeSdsConfig(io.envoyproxy.envoy.config.core.v3.ConfigSource value) {
      if (sdsConfigBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          sdsConfig_ != null &&
          sdsConfig_ != io.envoyproxy.envoy.config.core.v3.ConfigSource.getDefaultInstance()) {
