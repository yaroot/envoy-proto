...
private static final long serialVersionUID = 0L;
   ...
   */
  @java.lang.Override
  public java.util.List<io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor> getDescriptorsList() {
    return descriptors_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptorOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor getDescriptors(int index) {
   ...
   */
  @java.lang.Override
  public io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptorOrBuilder getDescriptorsOrBuilder(
      int index) {
    return descriptors_.get(index);
  }
  ...
  public boolean getLocalRateLimitPerDownstreamConnection() {
    return localRateLimitPerDownstreamConnection_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < descriptors_.size(); i++) {
      output.writeMessage(8, descriptors_.get(i));
    }
    if (stage_ != 0) {
      output.writeUInt32(9, stage_);
    }
    for (int i = 0; i < requestHeadersToAddWhenNotEnforced_.size(); i++) {
      output.writeMessage(10, requestHeadersToAddWhenNotEnforced_.get(i));
    }
    if (localRateLimitPerDownstreamConnection_ != false) {
      output.writeBool(11, localRateLimitPerDownstreamConnection_);
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < descriptors_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(8, descriptors_.get(i));
    }
    if (stage_ != 0) {
      size += com.google.protobuf.CodedOutputStream
    ...
    for (int i = 0; i < requestHeadersToAddWhenNotEnforced_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(10, requestHeadersToAddWhenNotEnforced_.get(i));
    }
    if (localRateLimitPerDownstreamConnection_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(11, localRateLimitPerDownstreamConnection_);
    }
    if (enableXRatelimitHeaders_ != io.envoyproxy.envoy.extensions.common.ratelimit.v3.XRateLimitHeadersRFCVersion.OFF.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + LOCAL_RATE_LIMIT_PER_DOWNSTREAM_CONNECTION_FIELD_NUMBER;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(io.envoyproxy.envoy.extensions.filters.http.local_ratelimit.v3.LocalRateLimit other) {
      ...
      if (other.getLocalRateLimitPerDownstreamConnection() != false) {
        setLocalRateLimitPerDownstreamConnection(other.getLocalRateLimitPerDownstreamConnection());
      }
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor, io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.Builder, io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptorOrBuilder> descriptorsBuilder_;
    ...
    public Builder setDescriptors(
        int index, io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor value) {
      if (descriptorsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setDescriptors(
        int index, io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.Builder builderForValue) {
      if (descriptorsBuilder_ == null) {
        ensureDescriptorsIsMutable();
     ...
     * <code>repeated .envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor descriptors = 8;</code>
     */
    public Builder addDescriptors(io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor value) {
      if (descriptorsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addDescriptors(
        io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.Builder builderForValue) {
      if (descriptorsBuilder_ == null) {
        ensureDescriptorsIsMutable();
    ...
    public Builder addAllDescriptors(
        java.lang.Iterable<? extends io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor> values) {
      if (descriptorsBuilder_ == null) {
        ensureDescriptorsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, descriptors_);
     ...
     * <code>repeated .envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor descriptors = 8;</code>
     */
    public io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.Builder getDescriptorsBuilder(
        int index) {
     ...
     * <code>repeated .envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor descriptors = 8;</code>
     */
    public io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.Builder addDescriptorsBuilder() {
      return getDescriptorsFieldBuilder().addBuilder(
          io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.getDefaultInstance());
    }
    /**
     * <pre>
     * The rate limit descriptor list to use in the local rate limit to override
    ...
    public io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.Builder addDescriptorsBuilder(
        int index) {
      return getDescriptorsFieldBuilder().addBuilder(
          index, io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.getDefaultInstance());
    }
    /**
     * <pre>
     * The rate limit descriptor list to use in the local rate limit to override
     ...
     * <code>repeated .envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor descriptors = 8;</code>
     */
    public java.util.List<io.envoyproxy.envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor.Builder> 
     ...
     *
     * <code>bool local_rate_limit_per_downstream_connection = 11;</code>
     * @param value The localRateLimitPerDownstreamConnection to set.
     * @return This builder for chaining.
     */
     ...
     * @return This builder for chaining.
     */
    public Builder setEnableXRatelimitHeaders(io.envoyproxy.envoy.extensions.common.ratelimit.v3.XRateLimitHeadersRFCVersion value) {
      if (value == null) {
        throw new NullPointerException();
      }
