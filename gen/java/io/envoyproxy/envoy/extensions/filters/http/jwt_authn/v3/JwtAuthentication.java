...
io.envoyproxy.envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement defaultValue) {
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication result) {
      if (rulesBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              io.envoyproxy.envoy.extensions.filters.http.jwt_authn.v3.RequirementRule m =
                  input.readMessage(
                      io.envoyproxy.envoy.extensions.filters.http.jwt_authn.v3.RequirementRule.parser(),
                      extensionRegistry);
              if (rulesBuilder_ == null) {
                ensureRulesIsMutable();
                rules_.add(m);
            ...
            case 42: {
              ...
              internalGetMutableRequirementMap().getMutableMap().put(
    ...
    public Builder mergeFilterStateRules(io.envoyproxy.envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule value) {
      if (filterStateRulesBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          filterStateRules_ != null &&
          filterStateRules_ != io.envoyproxy.envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule.getDefaultInstance()) {
