...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.extensions.filters.network.ratelimit.v3.RateLimit result) {
      if (descriptorsBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.extensions.filters.network.ratelimit.v3.RateLimit result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              io.envoyproxy.envoy.extensions.common.ratelimit.v3.RateLimitDescriptor m =
                  input.readMessage(
                      io.envoyproxy.envoy.extensions.common.ratelimit.v3.RateLimitDescriptor.parser(),
                      extensionRegistry);
              if (descriptorsBuilder_ == null) {
                ensureDescriptorsIsMutable();
                descriptors_.add(m);
