...
public interface RedisProxyOrBuilder extends
   ...
   * <code>.envoy.config.core.v3.DataSource downstream_auth_password = 6 [deprecated = true, (.udpa.annotations.sensitive) = true, (.envoy.annotations.deprecated_at_minor_version) = "3.0"];</code>
   */
  @java.lang.Deprecated io.envoyproxy.envoy.config.core.v3.DataSourceOrBuilder getDownstreamAuthPasswordOrBuilder();
   ...
   * <code>repeated .envoy.config.core.v3.DataSource downstream_auth_passwords = 9 [(.udpa.annotations.sensitive) = true];</code>
   */
  io.envoyproxy.envoy.config.core.v3.DataSource getDownstreamAuthPasswords(int index);
  /**
   * <pre>
   * Authenticate Redis client connections locally by forcing downstream clients to issue a `Redis
   * AUTH command &lt;https://redis.io/commands/auth&gt;`_ with one of these passwords before enabling any other
   ...
   * <code>repeated .envoy.config.core.v3.DataSource downstream_auth_passwords = 9 [(.udpa.annotations.sensitive) = true];</code>
   */
  io.envoyproxy.envoy.config.core.v3.DataSourceOrBuilder getDownstreamAuthPasswordsOrBuilder(
      int index);
