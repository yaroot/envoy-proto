...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRouteConfigurationsList result) {
      if (scopedRouteConfigurationsBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRouteConfigurationsList result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              io.envoyproxy.envoy.config.route.v3.ScopedRouteConfiguration m =
                  input.readMessage(
                      io.envoyproxy.envoy.config.route.v3.ScopedRouteConfiguration.parser(),
                      extensionRegistry);
              if (scopedRouteConfigurationsBuilder_ == null) {
                ensureScopedRouteConfigurationsIsMutable();
