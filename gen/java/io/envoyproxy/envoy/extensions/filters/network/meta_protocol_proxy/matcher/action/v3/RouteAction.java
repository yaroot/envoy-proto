 ...
 * </pre>
 *
 * Protobuf type {@code envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction}
 */
public final class RouteAction extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.ActionProto.internal_static_envoy_extensions_filters_network_meta_protocol_proxy_matcher_action_v3_RouteAction_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.ActionProto.internal_static_envoy_extensions_filters_network_meta_protocol_proxy_matcher_action_v3_RouteAction_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction.class, io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction)) {
      return super.equals(obj);
    }
    io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction other = (io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction) obj;
  ...
  public static io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction parseFrom(
  ...
  public static io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction parseFrom(
  ...
  public static io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction)
      io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteActionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.ActionProto.internal_static_envoy_extensions_filters_network_meta_protocol_proxy_matcher_action_v3_RouteAction_descriptor;
    }
    ...
    // Construct using io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction getDefaultInstanceForType() {
      return io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction.getDefaultInstance();
    }

    @java.lang.Override
    public io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction build() {
      io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction result = buildPartial();
    ...
    @java.lang.Override
    public io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction buildPartial() {
      io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction result = new io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction(this);
      if (clusterSpecifierCase_ == 1) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction) {
        return mergeFrom((io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction)other);
      } else {
    ...
    public Builder mergeFrom(io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction other) {
      if (other == io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction)
  }

  // @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction)
  private static final io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction();
  }

  public static io.envoyproxy.envoy.extensions.filters.network.meta_protocol_proxy.matcher.action.v3.RouteAction getDefaultInstance() {
