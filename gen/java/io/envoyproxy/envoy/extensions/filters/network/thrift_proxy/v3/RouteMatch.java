...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.envoyproxy.envoy.extensions.filters.network.thrift_proxy.v3.RouteMatch result) {
      if (headersBuilder_ == null) {
    ...
    private void buildPartial0(io.envoyproxy.envoy.extensions.filters.network.thrift_proxy.v3.RouteMatch result) {
    ...
    private void buildPartialOneofs(io.envoyproxy.envoy.extensions.filters.network.thrift_proxy.v3.RouteMatch result) {
