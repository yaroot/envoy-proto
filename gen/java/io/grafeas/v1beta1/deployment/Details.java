...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            io.grafeas.v1beta1.deployment.Deployment.Builder subBuilder = null;
            if (deployment_ != null) {
              subBuilder = deployment_.toBuilder();
            }
            deployment_ = input.readMessage(io.grafeas.v1beta1.deployment.Deployment.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grafeas.v1beta1.deployment.Details parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grafeas.v1beta1.deployment.Details) e.getUnfinishedMessage();
    ...
    public Builder mergeDeployment(io.grafeas.v1beta1.deployment.Deployment value) {
      if (deploymentBuilder_ == null) {
        if (deployment_ != null) {
          deployment_ =
            io.grafeas.v1beta1.deployment.Deployment.newBuilder(deployment_).mergeFrom(value).buildPartial();
        } else {
          deployment_ = value;
        }
        onChanged();
