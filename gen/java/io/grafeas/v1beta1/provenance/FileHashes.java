...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.grafeas.v1beta1.provenance.FileHashes result) {
      if (fileHashBuilder_ == null) {
    ...
    private void buildPartial0(io.grafeas.v1beta1.provenance.FileHashes result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              io.grafeas.v1beta1.provenance.Hash m =
                  input.readMessage(
                      io.grafeas.v1beta1.provenance.Hash.parser(),
                      extensionRegistry);
              if (fileHashBuilder_ == null) {
                ensureFileHashIsMutable();
                fileHash_.add(m);
