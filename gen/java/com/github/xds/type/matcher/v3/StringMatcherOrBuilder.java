...
public interface StringMatcherOrBuilder extends
    // @@protoc_insertion_point(interface_extends:xds.type.matcher.v3.StringMatcher)
   ...
   */
  com.github.xds.type.matcher.v3.RegexMatcher getSafeRegex();
  /**
   * <pre>
   * The input string must match the regular expression specified here.
   * </pre>
   ...
   * <code>.xds.type.matcher.v3.RegexMatcher safe_regex = 5 [(.validate.rules) = { ... }</code>
   */
  com.github.xds.type.matcher.v3.RegexMatcherOrBuilder getSafeRegexOrBuilder();
  ...
  public com.github.xds.type.matcher.v3.StringMatcher.MatchPatternCase getMatchPatternCase();
}
