...
public interface ResourceLocatorOrBuilder extends
   ...
   * @return The scheme.
   */
  com.github.xds.core.v3.ResourceLocator.Scheme getScheme();
   ...
   */
  com.github.xds.core.v3.ContextParams getExactContext();
  /**
   * <pre>
   * Additional parameters that can be used to select resource variants.
   * Matches must be exact, i.e. all context parameters must match exactly and
   ...
   * <code>.xds.core.v3.ContextParams exact_context = 5;</code>
   */
  com.github.xds.core.v3.ContextParamsOrBuilder getExactContextOrBuilder();
   ...
   */
  java.util.List<com.github.xds.core.v3.ResourceLocator.Directive> 
      getDirectivesList();
  /**
   * <pre>
   * A list of directives that appear in the xDS resource locator #fragment.
   ...
   * <code>repeated .xds.core.v3.ResourceLocator.Directive directives = 6;</code>
   */
  com.github.xds.core.v3.ResourceLocator.Directive getDirectives(int index);
  /**
   * <pre>
   * A list of directives that appear in the xDS resource locator #fragment.
   * When encoding to URI form, directives are percent encoded with comma
   ...
   * <code>repeated .xds.core.v3.ResourceLocator.Directive directives = 6;</code>
   */
  java.util.List<? extends com.github.xds.core.v3.ResourceLocator.DirectiveOrBuilder> 
   ...
   * <code>repeated .xds.core.v3.ResourceLocator.Directive directives = 6;</code>
   */
  com.github.xds.core.v3.ResourceLocator.DirectiveOrBuilder getDirectivesOrBuilder(
      int index);

  public com.github.xds.core.v3.ResourceLocator.ContextParamSpecifierCase getContextParamSpecifierCase();
}
