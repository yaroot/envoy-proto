...
public interface CreateIngressRuleRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.appengine.v1beta.CreateIngressRuleRequest)
   ...
   * @return The rule.
   */
  com.google.appengine.v1beta.firewall.FirewallRule getRule();
  /**
   * <pre>
   * A FirewallRule containing the new resource.
   * The user may optionally provide a position at which the new rule will be
   ...
   * <code>.google.appengine.v1beta.FirewallRule rule = 2;</code>
   */
  com.google.appengine.v1beta.firewall.FirewallRuleOrBuilder getRuleOrBuilder();
}
