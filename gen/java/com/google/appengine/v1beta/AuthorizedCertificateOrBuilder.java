...
public interface AuthorizedCertificateOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.appengine.v1beta.AuthorizedCertificate)
   ...
   */
  com.google.appengine.v1beta.CertificateRawData getCertificateRawData();
  /**
   * <pre>
   * The SSL certificate serving the `AuthorizedCertificate` resource. This
   * must be obtained independently from a certificate authority.
   ...
   * <code>.google.appengine.v1beta.CertificateRawData certificate_raw_data = 6;</code>
   */
  com.google.appengine.v1beta.CertificateRawDataOrBuilder getCertificateRawDataOrBuilder();
   ...
   */
  com.google.appengine.v1beta.ManagedCertificate getManagedCertificate();
  /**
   * <pre>
   * Only applicable if this certificate is managed by App Engine. Managed
   * certificates are tied to the lifecycle of a `DomainMapping` and cannot be
   ...
   * <code>.google.appengine.v1beta.ManagedCertificate managed_certificate = 7;</code>
   */
  com.google.appengine.v1beta.ManagedCertificateOrBuilder getManagedCertificateOrBuilder();
