...
public interface UpdateEventRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.UpdateEventRequest)
   ...
   * @return The event.
   */
  com.google.cloud.visionai.v1alpha1.Event getEvent();
  /**
   * <pre>
   * Required. The resource being updated.
   * </pre>
   ...
   * <code>.google.cloud.visionai.v1alpha1.Event event = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.visionai.v1alpha1.EventOrBuilder getEventOrBuilder();
