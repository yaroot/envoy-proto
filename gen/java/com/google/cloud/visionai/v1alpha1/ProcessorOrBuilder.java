...
public interface ProcessorOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.Processor)
...
java.lang.String defaultValue);
   ...
   */
  com.google.cloud.visionai.v1alpha1.Processor.ProcessorType getProcessorType();
   ...
   */
  com.google.cloud.visionai.v1alpha1.ModelType getModelType();
   ...
   */
  com.google.cloud.visionai.v1alpha1.CustomProcessorSourceInfo getCustomProcessorSourceInfo();
  /**
   * <pre>
   * Source info for customer created processor.
   * </pre>
   ...
   * <code>.google.cloud.visionai.v1alpha1.CustomProcessorSourceInfo custom_processor_source_info = 7;</code>
   */
  com.google.cloud.visionai.v1alpha1.CustomProcessorSourceInfoOrBuilder getCustomProcessorSourceInfoOrBuilder();
   ...
   * @return The state.
   */
  com.google.cloud.visionai.v1alpha1.Processor.ProcessorState getState();
   ...
   */
  com.google.cloud.visionai.v1alpha1.ProcessorIOSpec getProcessorIoSpec();
  /**
   * <pre>
   * Output only. [Output only] The input / output specifications of a processor, each type
   * of processor has fixed input / output specs which cannot be altered by
   ...
   * <code>.google.cloud.visionai.v1alpha1.ProcessorIOSpec processor_io_spec = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.visionai.v1alpha1.ProcessorIOSpecOrBuilder getProcessorIoSpecOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.visionai.v1alpha1.StreamAnnotationType> getSupportedAnnotationTypesList();
  /**
   * <code>repeated .google.cloud.visionai.v1alpha1.StreamAnnotationType supported_annotation_types = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.visionai.v1alpha1.StreamAnnotationType getSupportedAnnotationTypes(int index);
  /**
   * <code>repeated .google.cloud.visionai.v1alpha1.StreamAnnotationType supported_annotation_types = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
