...
public interface CreateAnnotationRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.CreateAnnotationRequest)
   ...
   */
  com.google.cloud.visionai.v1alpha1.Annotation getAnnotation();
  /**
   * <pre>
   * Required. The annotation to create.
   * </pre>
   ...
   * <code>.google.cloud.visionai.v1alpha1.Annotation annotation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.visionai.v1alpha1.AnnotationOrBuilder getAnnotationOrBuilder();
