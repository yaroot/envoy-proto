...
public interface NodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.Node)
   ...
   */
  com.google.cloud.visionai.v1alpha1.ProcessorConfig getNodeConfig();
  /**
   * <pre>
   * Node config.
   * </pre>
   ...
   * <code>.google.cloud.visionai.v1alpha1.ProcessorConfig node_config = 3;</code>
   */
  com.google.cloud.visionai.v1alpha1.ProcessorConfigOrBuilder getNodeConfigOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.visionai.v1alpha1.Node.InputEdge> 
      getParentsList();
  /**
   * <pre>
   * Parent node. Input node should not have parent node. For V1 Alpha1/Beta
   ...
   * <code>repeated .google.cloud.visionai.v1alpha1.Node.InputEdge parents = 5;</code>
   */
  com.google.cloud.visionai.v1alpha1.Node.InputEdge getParents(int index);
  /**
   * <pre>
   * Parent node. Input node should not have parent node. For V1 Alpha1/Beta
   * only media warehouse node can have multiple parents, other types of nodes
   ...
   * <code>repeated .google.cloud.visionai.v1alpha1.Node.InputEdge parents = 5;</code>
   */
  java.util.List<? extends com.google.cloud.visionai.v1alpha1.Node.InputEdgeOrBuilder> 
   ...
   * <code>repeated .google.cloud.visionai.v1alpha1.Node.InputEdge parents = 5;</code>
   */
  com.google.cloud.visionai.v1alpha1.Node.InputEdgeOrBuilder getParentsOrBuilder(
      int index);

  public com.google.cloud.visionai.v1alpha1.Node.StreamOutputConfigCase getStreamOutputConfigCase();
}
