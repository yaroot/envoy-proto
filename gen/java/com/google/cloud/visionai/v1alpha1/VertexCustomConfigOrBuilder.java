...
public interface VertexCustomConfigOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.VertexCustomConfig)
   ...
   */
  com.google.cloud.visionai.v1alpha1.DedicatedResources getDedicatedResources();
  /**
   * <pre>
   * A description of resources that are dedicated to the DeployedModel, and
   * that need a higher degree of manual configuration.
   ...
   * <code>.google.cloud.visionai.v1alpha1.DedicatedResources dedicated_resources = 2;</code>
   */
  com.google.cloud.visionai.v1alpha1.DedicatedResourcesOrBuilder getDedicatedResourcesOrBuilder();
