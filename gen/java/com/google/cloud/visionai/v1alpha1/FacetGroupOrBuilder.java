...
public interface FacetGroupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.FacetGroup)
   ...
   */
  java.util.List<com.google.cloud.visionai.v1alpha1.FacetBucket> 
      getBucketsList();
  /**
   * <pre>
   * Buckets associated with the facet. E.g. for "Team" facet, the bucket
   ...
   * <code>repeated .google.cloud.visionai.v1alpha1.FacetBucket buckets = 3;</code>
   */
  com.google.cloud.visionai.v1alpha1.FacetBucket getBuckets(int index);
  /**
   * <pre>
   * Buckets associated with the facet. E.g. for "Team" facet, the bucket
   * can be 49ers, patriots, etc.
   ...
   * <code>repeated .google.cloud.visionai.v1alpha1.FacetBucket buckets = 3;</code>
   */
  java.util.List<? extends com.google.cloud.visionai.v1alpha1.FacetBucketOrBuilder> 
   ...
   * <code>repeated .google.cloud.visionai.v1alpha1.FacetBucket buckets = 3;</code>
   */
  com.google.cloud.visionai.v1alpha1.FacetBucketOrBuilder getBucketsOrBuilder(
      int index);
