...
public interface PacketHeaderOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.PacketHeader)
   ...
   * @return The type.
   */
  com.google.cloud.visionai.v1alpha1.PacketType getType();
  /**
   * <pre>
   * Input only. Immutable. The type of the payload.
   * </pre>
   ...
   * <code>.google.cloud.visionai.v1alpha1.PacketType type = 2 [(.google.api.field_behavior) = INPUT_ONLY, (.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.cloud.visionai.v1alpha1.PacketTypeOrBuilder getTypeOrBuilder();
   ...
   */
  com.google.cloud.visionai.v1alpha1.ServerMetadata getServerMetadata();
  /**
   * <pre>
   * Output only. Metadata that the server appends to each packet before sending
   * it to receivers. You don't need to set a value for this field when sending
   ...
   * <code>.google.cloud.visionai.v1alpha1.ServerMetadata server_metadata = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.visionai.v1alpha1.ServerMetadataOrBuilder getServerMetadataOrBuilder();
   ...
   */
  com.google.cloud.visionai.v1alpha1.SeriesMetadata getSeriesMetadata();
  /**
   * <pre>
   * Input only. Immutable. Metadata that the server needs to know where to
   * write the packets to. It's only required for the first packet.
   ...
   * <code>.google.cloud.visionai.v1alpha1.SeriesMetadata series_metadata = 5 [(.google.api.field_behavior) = INPUT_ONLY, (.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.cloud.visionai.v1alpha1.SeriesMetadataOrBuilder getSeriesMetadataOrBuilder();
