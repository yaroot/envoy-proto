...
public interface CreateAssetRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.visionai.v1alpha1.CreateAssetRequest)
   ...
   * @return The asset.
   */
  com.google.cloud.visionai.v1alpha1.Asset getAsset();
  /**
   * <pre>
   * Required. The asset to create.
   * </pre>
   ...
   * <code>.google.cloud.visionai.v1alpha1.Asset asset = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.visionai.v1alpha1.AssetOrBuilder getAssetOrBuilder();
