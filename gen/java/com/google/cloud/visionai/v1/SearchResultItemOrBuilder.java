...
public interface SearchResultItemOrBuilder extends
   ...
   */
  @java.lang.Deprecated java.util.List<com.google.cloud.visionai.v1.Partition.TemporalPartition> 
      getSegmentsList();
  /**
   * <pre>
   * The matched asset segments.
   ...
   * <code>repeated .google.cloud.visionai.v1.Partition.TemporalPartition segments = 2 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.visionai.v1.Partition.TemporalPartition getSegments(int index);
  /**
   * <pre>
   * The matched asset segments.
   * Deprecated: please use singular `segment` field.
   ...
   * <code>repeated .google.cloud.visionai.v1.Partition.TemporalPartition segments = 2 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<? extends com.google.cloud.visionai.v1.Partition.TemporalPartitionOrBuilder> 
   ...
   * <code>repeated .google.cloud.visionai.v1.Partition.TemporalPartition segments = 2 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.visionai.v1.Partition.TemporalPartitionOrBuilder getSegmentsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.visionai.v1.Annotation> 
   ...
   * <code>repeated .google.cloud.visionai.v1.Annotation requested_annotations = 3;</code>
   */
  com.google.cloud.visionai.v1.AnnotationOrBuilder getRequestedAnnotationsOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.visionai.v1.AnnotationMatchingResult annotation_matching_results = 4;</code>
   */
  com.google.cloud.visionai.v1.AnnotationMatchingResultOrBuilder getAnnotationMatchingResultsOrBuilder(
      int index);
}
