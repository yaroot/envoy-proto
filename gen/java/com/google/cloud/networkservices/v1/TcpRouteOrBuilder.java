...
public interface TcpRouteOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.networkservices.v1.TcpRoute.RouteRule> 
      getRulesList();
  /**
   * <pre>
   * Required. Rules that define how traffic is routed and handled. At least one RouteRule
   ...
   * <code>repeated .google.cloud.networkservices.v1.TcpRoute.RouteRule rules = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.networkservices.v1.TcpRoute.RouteRuleOrBuilder getRulesOrBuilder(
      int index);
