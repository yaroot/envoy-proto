...
public interface TlsRouteOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.networkservices.v1.TlsRoute.RouteRule> 
      getRulesList();
  /**
   * <pre>
   * Required. Rules that define how traffic is routed and handled. At least one RouteRule
   ...
   * <code>repeated .google.cloud.networkservices.v1.TlsRoute.RouteRule rules = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.networkservices.v1.TlsRoute.RouteRuleOrBuilder getRulesOrBuilder(
      int index);
