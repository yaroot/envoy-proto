...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.google.cloud.sql.v1.DemoteMasterMySqlReplicaConfiguration.Builder subBuilder = null;
            if (mysqlReplicaConfiguration_ != null) {
              subBuilder = mysqlReplicaConfiguration_.toBuilder();
            }
            mysqlReplicaConfiguration_ = input.readMessage(com.google.cloud.sql.v1.DemoteMasterMySqlReplicaConfiguration.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.sql.v1.DemoteMasterConfiguration parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.sql.v1.DemoteMasterConfiguration) e.getUnfinishedMessage();
      ...
      if (mysqlReplicaConfigurationBuilder_ == null) {
        if (mysqlReplicaConfiguration_ != null) {
          mysqlReplicaConfiguration_ =
            com.google.cloud.sql.v1.DemoteMasterMySqlReplicaConfiguration.newBuilder(mysqlReplicaConfiguration_).mergeFrom(value).buildPartial();
        } else {
          mysqlReplicaConfiguration_ = value;
        }
        onChanged();
