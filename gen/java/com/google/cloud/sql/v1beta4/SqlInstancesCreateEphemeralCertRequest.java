...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 802: {
            com.google.cloud.sql.v1beta4.SslCertsCreateEphemeralRequest.Builder subBuilder = null;
            if (body_ != null) {
              subBuilder = body_.toBuilder();
            }
            body_ = input.readMessage(com.google.cloud.sql.v1beta4.SslCertsCreateEphemeralRequest.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.sql.v1beta4.SqlInstancesCreateEphemeralCertRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.sql.v1beta4.SqlInstancesCreateEphemeralCertRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeBody(com.google.cloud.sql.v1beta4.SslCertsCreateEphemeralRequest value) {
      if (bodyBuilder_ == null) {
        if (body_ != null) {
          body_ =
            com.google.cloud.sql.v1beta4.SslCertsCreateEphemeralRequest.newBuilder(body_).mergeFrom(value).buildPartial();
        } else {
          body_ = value;
        }
        onChanged();
