...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.google.cloud.sql.v1beta4.CloneContext.Builder subBuilder = null;
            if (cloneContext_ != null) {
              subBuilder = cloneContext_.toBuilder();
            }
            cloneContext_ = input.readMessage(com.google.cloud.sql.v1beta4.CloneContext.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.sql.v1beta4.InstancesCloneRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.sql.v1beta4.InstancesCloneRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeCloneContext(com.google.cloud.sql.v1beta4.CloneContext value) {
      if (cloneContextBuilder_ == null) {
        if (cloneContext_ != null) {
          cloneContext_ =
            com.google.cloud.sql.v1beta4.CloneContext.newBuilder(cloneContext_).mergeFrom(value).buildPartial();
        } else {
          cloneContext_ = value;
        }
        onChanged();
