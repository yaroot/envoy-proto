...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.google.cloud.bigquery.migration.v2alpha.SqlTranslationErrorDetail.Builder subBuilder = null;
            if (warningDetail_ != null) {
              subBuilder = warningDetail_.toBuilder();
            }
            warningDetail_ = input.readMessage(com.google.cloud.bigquery.migration.v2alpha.SqlTranslationErrorDetail.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom(warningDetail_);
              warningDetail_ = subBuilder.buildPartial();
            }
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.bigquery.migration.v2alpha.SqlTranslationWarning buildPartial() {
      ...
      if (warningDetailBuilder_ == null) {
        result.warningDetail_ = warningDetail_;
      } else {
        result.warningDetail_ = warningDetailBuilder_.build();
      }
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.bigquery.migration.v2alpha.SqlTranslationWarning parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.bigquery.migration.v2alpha.SqlTranslationWarning) e.getUnfinishedMessage();
     ...
     */
    public boolean hasWarningDetail() {
      return warningDetailBuilder_ != null || warningDetail_ != null;
    }
    /**
     * <pre>
     * Specifies the details of the warning, including the warning message and
    ...
    public Builder mergeWarningDetail(com.google.cloud.bigquery.migration.v2alpha.SqlTranslationErrorDetail value) {
      if (warningDetailBuilder_ == null) {
        if (warningDetail_ != null) {
          warningDetail_ =
            com.google.cloud.bigquery.migration.v2alpha.SqlTranslationErrorDetail.newBuilder(warningDetail_).mergeFrom(value).buildPartial();
        } else {
          warningDetail_ = value;
        }
        onChanged();
  ...
  private static final com.google.protobuf.Parser<SqlTranslationWarning>
    ...
    public SqlTranslationWarning parsePartialFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new SqlTranslationWarning(input, extensionRegistry);
    }
  };
