...
private static final long serialVersionUID = 0L;
  ...
  @java.lang.Override public com.google.ads.googleads.v10.enums.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator getRuleOperator() {
    com.google.ads.googleads.v10.enums.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator result = com.google.ads.googleads.v10.enums.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator.forNumber(ruleOperator_);
  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      if (leftOperandBuilder_ != null) {
        leftOperandBuilder_.dispose();
        leftOperandBuilder_ = null;
      }
      rightOperand_ = null;
      if (rightOperandBuilder_ != null) {
        rightOperandBuilder_.dispose();
    ...
    private void buildPartial0(com.google.ads.googleads.v10.common.CombinedRuleUserListInfo result) {
      int from_bitField0_ = bitField0_;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.leftOperand_ = leftOperandBuilder_ == null
            ? leftOperand_
            : leftOperandBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.rightOperand_ = rightOperandBuilder_ == null
            ? rightOperand_
            : rightOperandBuilder_.build();
      }
    ...
    public Builder mergeLeftOperand(com.google.ads.googleads.v10.common.UserListRuleInfo value) {
      if (leftOperandBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          leftOperand_ != null &&
          leftOperand_ != com.google.ads.googleads.v10.common.UserListRuleInfo.getDefaultInstance()) {
          getLeftOperandBuilder().mergeFrom(value);
        } else {
          leftOperand_ = value;
        }
      } else {
    ...
    public Builder mergeRightOperand(com.google.ads.googleads.v10.common.UserListRuleInfo value) {
      if (rightOperandBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          rightOperand_ != null &&
          rightOperand_ != com.google.ads.googleads.v10.common.UserListRuleInfo.getDefaultInstance()) {
          getRightOperandBuilder().mergeFrom(value);
        } else {
          rightOperand_ = value;
        }
      } else {
