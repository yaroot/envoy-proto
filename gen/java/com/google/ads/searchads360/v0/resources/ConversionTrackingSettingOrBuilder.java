...
public interface ConversionTrackingSettingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.searchads360.v0.resources.ConversionTrackingSetting)
   ...
   */
  boolean hasGoogleAdsCrossAccountConversionTrackingId();
  /**
   * <pre>
   * Output only. The conversion tracking id of the customer's manager. This is set when the
   * customer is opted into  conversion tracking, and it overrides
   ...
   */
  long getGoogleAdsCrossAccountConversionTrackingId();
   ...
   */
  com.google.ads.searchads360.v0.enums.ConversionTrackingStatusEnum.ConversionTrackingStatus getConversionTrackingStatus();
