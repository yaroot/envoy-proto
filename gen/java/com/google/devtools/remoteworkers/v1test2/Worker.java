...
private static final long serialVersionUID = 0L;
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.google.devtools.remoteworkers.v1test2.Worker.Property result) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.google.devtools.remoteworkers.v1test2.Worker.Config result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.key_ = key_;
        }
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.devtools.remoteworkers.v1test2.Worker result) {
      if (devicesBuilder_ == null) {
    ...
    private void buildPartial0(com.google.devtools.remoteworkers.v1test2.Worker result) {
      int from_bitField0_ = bitField0_;
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.devtools.remoteworkers.v1test2.Device m =
                  input.readMessage(
                      com.google.devtools.remoteworkers.v1test2.Device.parser(),
                      extensionRegistry);
              if (devicesBuilder_ == null) {
                ensureDevicesIsMutable();
                devices_.add(m);
            ...
            case 18: {
              com.google.devtools.remoteworkers.v1test2.Worker.Property m =
                  input.readMessage(
                      com.google.devtools.remoteworkers.v1test2.Worker.Property.parser(),
                      extensionRegistry);
              if (propertiesBuilder_ == null) {
                ensurePropertiesIsMutable();
                properties_.add(m);
            ...
            case 26: {
              com.google.devtools.remoteworkers.v1test2.Worker.Config m =
                  input.readMessage(
                      com.google.devtools.remoteworkers.v1test2.Worker.Config.parser(),
                      extensionRegistry);
              if (configsBuilder_ == null) {
                ensureConfigsIsMutable();
                configs_.add(m);
