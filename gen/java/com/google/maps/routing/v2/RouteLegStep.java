...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 50: {
            com.google.maps.routing.v2.NavigationInstruction.Builder subBuilder = null;
            if (navigationInstruction_ != null) {
              subBuilder = navigationInstruction_.toBuilder();
            }
            navigationInstruction_ = input.readMessage(com.google.maps.routing.v2.NavigationInstruction.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 58: {
            com.google.maps.routing.v2.RouteLegStepTravelAdvisory.Builder subBuilder = null;
            if (travelAdvisory_ != null) {
              subBuilder = travelAdvisory_.toBuilder();
            }
            travelAdvisory_ = input.readMessage(com.google.maps.routing.v2.RouteLegStepTravelAdvisory.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.maps.routing.v2.RouteLegStep parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.maps.routing.v2.RouteLegStep) e.getUnfinishedMessage();
