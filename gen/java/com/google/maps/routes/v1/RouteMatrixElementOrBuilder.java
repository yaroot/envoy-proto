...
public interface RouteMatrixElementOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.maps.routes.v1.RouteMatrixElement)
   ...
   */
  com.google.maps.routes.v1.RouteMatrixElementCondition getCondition();
   ...
   */
  com.google.maps.routes.v1.FallbackInfo getFallbackInfo();
  /**
   * <pre>
   * In some cases when the server is not able to compute the route with the
   * given preferences for this particular origin/destination pair, it may
   ...
   * <code>.google.maps.routes.v1.FallbackInfo fallback_info = 8;</code>
   */
  com.google.maps.routes.v1.FallbackInfoOrBuilder getFallbackInfoOrBuilder();
}
