...
private static final long serialVersionUID = 0L;
  ...
  @java.lang.Override public com.google.firestore.admin.v1beta1.Index.State getState() {
    com.google.firestore.admin.v1beta1.Index.State result = com.google.firestore.admin.v1beta1.Index.State.forNumber(state_);
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.firestore.admin.v1beta1.Index result) {
      if (fieldsBuilder_ == null) {
    ...
    private void buildPartial0(com.google.firestore.admin.v1beta1.Index result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              com.google.firestore.admin.v1beta1.IndexField m =
                  input.readMessage(
                      com.google.firestore.admin.v1beta1.IndexField.parser(),
                      extensionRegistry);
              if (fieldsBuilder_ == null) {
                ensureFieldsIsMutable();
                fields_.add(m);
