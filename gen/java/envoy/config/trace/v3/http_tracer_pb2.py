...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/config/trace/v3/http_tracer.proto',
  package='envoy.config.trace.v3',
  syntax='proto3',
  serialized_options=b'\n#io.envoyproxy.envoy.config.trace.v3B\017HttpTracerProtoP\001\272\200\310\321\006\002\020\002',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\'envoy/config/trace/v3/http_tracer.proto\x12\x15\x65nvoy.config.trace.v3\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xf8\x01\n\x07Tracing\x12\x31\n\x04http\x18\x01 \x01(\x0b\x32#.envoy.config.trace.v3.Tracing.Http\x1a\x93\x01\n\x04Http\x12\x15\n\x04name\x18\x01 \x01(\tB\x07\xfa\x42\x04r\x02 \x01\x12,\n\x0ctyped_config\x18\x03 \x01(\x0b\x32\x14.google.protobuf.AnyH\x00:)\x9a\xc5\x88\x1e$\n\"envoy.config.trace.v2.Tracing.HttpB\r\n\x0b\x63onfig_typeJ\x04\x08\x02\x10\x03R\x06\x63onfig:$\x9a\xc5\x88\x1e\x1f\n\x1d\x65nvoy.config.trace.v2.TracingB@\n#io.envoyproxy.envoy.config.trace.v3B\x0fHttpTracerProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\x62\x06proto3'
  ,
...
_TRACING_HTTP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.config.trace.v3.Tracing.Http.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='typed_config', full_name='envoy.config.trace.v3.Tracing.Http.typed_config', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='config_type', full_name='envoy.config.trace.v3.Tracing.Http.config_type',
...
_TRACING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='http', full_name='envoy.config.trace.v3.Tracing.http', index=0,
