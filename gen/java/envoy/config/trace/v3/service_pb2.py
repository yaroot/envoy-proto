...
_TRACESERVICECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='grpc_service', full_name='envoy.config.trace.v3.TraceServiceConfig.grpc_service', index=0,
...
_TRACESERVICECONFIG.fields_by_name['grpc_service'].message_type = envoy_dot_config_dot_core_dot_v3_dot_grpc__service__pb2._GRPCSERVICE
