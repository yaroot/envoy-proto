...
_CLUSTER_EDSCLUSTERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='eds_resource_locator', full_name='envoy.config.cluster.v3.Cluster.EdsClusterConfig.eds_resource_locator', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLUSTER_EDSCLUSTERCONFIG.fields_by_name['service_name']._options = None
_CLUSTER_EDSCLUSTERCONFIG.fields_by_name['eds_resource_locator']._options = None
