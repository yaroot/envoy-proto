...
_SCOPEDROUTECONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.config.route.v4alpha.ScopedRouteConfiguration.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='route_configuration_name', full_name='envoy.config.route.v4alpha.ScopedRouteConfiguration.route_configuration_name', index=1,
      ...
      serialized_options=b'\372B\004r\002 \001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='key', full_name='envoy.config.route.v4alpha.ScopedRouteConfiguration.key', index=2,
