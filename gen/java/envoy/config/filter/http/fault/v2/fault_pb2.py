...
_FAULTABORT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='header_abort', full_name='envoy.config.filter.http.fault.v2.FaultAbort.header_abort', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='percentage', full_name='envoy.config.filter.http.fault.v2.FaultAbort.percentage', index=2,
...
_HTTPFAULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='response_rate_limit', full_name='envoy.config.filter.http.fault.v2.HTTPFault.response_rate_limit', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='delay_percent_runtime', full_name='envoy.config.filter.http.fault.v2.HTTPFault.delay_percent_runtime', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='abort_percent_runtime', full_name='envoy.config.filter.http.fault.v2.HTTPFault.abort_percent_runtime', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='delay_duration_runtime', full_name='envoy.config.filter.http.fault.v2.HTTPFault.delay_duration_runtime', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='abort_http_status_runtime', full_name='envoy.config.filter.http.fault.v2.HTTPFault.abort_http_status_runtime', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_active_faults_runtime', full_name='envoy.config.filter.http.fault.v2.HTTPFault.max_active_faults_runtime', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='response_rate_limit_percent_runtime', full_name='envoy.config.filter.http.fault.v2.HTTPFault.response_rate_limit_percent_runtime', index=12,
...
_HTTPFAULT.fields_by_name['headers'].message_type = envoy_dot_api_dot_v2_dot_route_dot_route__components__pb2._HEADERMATCHER
_HTTPFAULT.fields_by_name['max_active_faults'].message_type = google_dot_protobuf_dot_wrappers__pb2._UINT32VALUE
_HTTPFAULT.fields_by_name['response_rate_limit'].message_type = envoy_dot_config_dot_filter_dot_fault_dot_v2_dot_fault__pb2._FAULTRATELIMIT
