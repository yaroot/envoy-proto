...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/config/core/v4alpha/backoff.proto',
  package='envoy.config.core.v4alpha',
  syntax='proto3',
  serialized_options=b'\n\'io.envoyproxy.envoy.config.core.v4alphaB\014BackoffProtoP\001\272\200\310\321\006\002\020\003',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\'envoy/config/core/v4alpha/backoff.proto\x12\x19\x65nvoy.config.core.v4alpha\x1a\x1egoogle/protobuf/duration.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xbb\x01\n\x0f\x42\x61\x63koffStrategy\x12@\n\rbase_interval\x18\x01 \x01(\x0b\x32\x19.google.protobuf.DurationB\x0e\xfa\x42\x0b\xaa\x01\x08\x08\x01\x32\x04\x10\xc0\x84=\x12\x39\n\x0cmax_interval\x18\x02 \x01(\x0b\x32\x19.google.protobuf.DurationB\x08\xfa\x42\x05\xaa\x01\x02*\x00:+\x9a\xc5\x88\x1e&\n$envoy.config.core.v3.BackoffStrategyBA\n\'io.envoyproxy.envoy.config.core.v4alphaB\x0c\x42\x61\x63koffProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03\x62\x06proto3'
  ,
...
_BACKOFFSTRATEGY = _descriptor.Descriptor(
  ...
  full_name='envoy.config.core.v4alpha.BackoffStrategy',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='base_interval', full_name='envoy.config.core.v4alpha.BackoffStrategy.base_interval', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max_interval', full_name='envoy.config.core.v4alpha.BackoffStrategy.max_interval', index=1,
...
BackoffStrategy = _reflection.GeneratedProtocolMessageType('BackoffStrategy', (_message.Message,), {
  ...
  '__module__' : 'envoy.config.core.v4alpha.backoff_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.core.v4alpha.BackoffStrategy)
  })
