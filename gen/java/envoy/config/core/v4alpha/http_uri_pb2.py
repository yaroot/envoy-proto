...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/config/core/v4alpha/http_uri.proto',
  package='envoy.config.core.v4alpha',
  syntax='proto3',
  serialized_options=b'\n\'io.envoyproxy.envoy.config.core.v4alphaB\014HttpUriProtoP\001\272\200\310\321\006\002\020\003',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n(envoy/config/core/v4alpha/http_uri.proto\x12\x19\x65nvoy.config.core.v4alpha\x1a\x1egoogle/protobuf/duration.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xb3\x01\n\x07HttpUri\x12\x14\n\x03uri\x18\x01 \x01(\tB\x07\xfa\x42\x04r\x02\x10\x01\x12\x1a\n\x07\x63luster\x18\x02 \x01(\tB\x07\xfa\x42\x04r\x02\x10\x01H\x00\x12\x36\n\x07timeout\x18\x03 \x01(\x0b\x32\x19.google.protobuf.DurationB\n\xfa\x42\x07\xaa\x01\x04\x08\x01\x32\x00:#\x9a\xc5\x88\x1e\x1e\n\x1c\x65nvoy.config.core.v3.HttpUriB\x19\n\x12http_upstream_type\x12\x03\xf8\x42\x01\x42\x41\n\'io.envoyproxy.envoy.config.core.v4alphaB\x0cHttpUriProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03\x62\x06proto3'
  ,
...
_HTTPURI = _descriptor.Descriptor(
  name='HttpUri',
  full_name='envoy.config.core.v4alpha.HttpUri',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='envoy.config.core.v4alpha.HttpUri.uri', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='cluster', full_name='envoy.config.core.v4alpha.HttpUri.cluster', index=1,
      ...
      serialized_options=b'\372B\004r\002\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='envoy.config.core.v4alpha.HttpUri.timeout', index=2,
  ...
  serialized_options=b'\232\305\210\036\036\n\034envoy.config.core.v3.HttpUri',
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
    _descriptor.OneofDescriptor(
      name='http_upstream_type', full_name='envoy.config.core.v4alpha.HttpUri.http_upstream_type',
...
HttpUri = _reflection.GeneratedProtocolMessageType('HttpUri', (_message.Message,), {
  'DESCRIPTOR' : _HTTPURI,
  '__module__' : 'envoy.config.core.v4alpha.http_uri_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.core.v4alpha.HttpUri)
  })
