...
_CLUSTERLOADASSIGNMENT_POLICY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='endpoint_stale_after', full_name='envoy.api.v2.ClusterLoadAssignment.Policy.endpoint_stale_after', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='disable_overprovisioning', full_name='envoy.api.v2.ClusterLoadAssignment.Policy.disable_overprovisioning', index=3,
...
_CLUSTERLOADASSIGNMENT_NAMEDENDPOINTSENTRY.fields_by_name['value'].message_type = envoy_dot_api_dot_v2_dot_endpoint_dot_endpoint__components__pb2._ENDPOINT
_CLUSTERLOADASSIGNMENT_NAMEDENDPOINTSENTRY.containing_type = _CLUSTERLOADASSIGNMENT
_CLUSTERLOADASSIGNMENT.fields_by_name['endpoints'].message_type = envoy_dot_api_dot_v2_dot_endpoint_dot_endpoint__components__pb2._LOCALITYLBENDPOINTS
