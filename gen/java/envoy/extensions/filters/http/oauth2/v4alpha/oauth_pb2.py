...
_OAUTH2CONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='auth_scopes', full_name='envoy.extensions.filters.http.oauth2.v4alpha.OAuth2Config.auth_scopes', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resources', full_name='envoy.extensions.filters.http.oauth2.v4alpha.OAuth2Config.resources', index=9,
