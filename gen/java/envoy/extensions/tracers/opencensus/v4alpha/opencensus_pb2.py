...
_OPENCENSUSCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='zipkin_exporter_enabled', full_name='envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.zipkin_exporter_enabled', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='zipkin_url', full_name='envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.zipkin_url', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ocagent_exporter_enabled', full_name='envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.ocagent_exporter_enabled', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ocagent_address', full_name='envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.ocagent_address', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ocagent_grpc_service', full_name='envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.ocagent_grpc_service', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='incoming_trace_context', full_name='envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.incoming_trace_context', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='outgoing_trace_context', full_name='envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.outgoing_trace_context', index=12,
