...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/service/trace/v3/trace_service.proto',
  package='envoy.service.trace.v3',
  syntax='proto3',
  serialized_options=b'\n$io.envoyproxy.envoy.service.trace.v3B\021TraceServiceProtoP\001\210\001\001\272\200\310\321\006\002\020\002',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n*envoy/service/trace/v3/trace_service.proto\x12\x16\x65nvoy.service.trace.v3\x1a\x1f\x65nvoy/config/core/v3/base.proto\x1a\x1cgoogle/api/annotations.proto\x1a%opencensus/proto/trace/v1/trace.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"J\n\x14StreamTracesResponse:2\x9a\xc5\x88\x1e-\n+envoy.service.trace.v2.StreamTracesResponse\"\xc4\x02\n\x13StreamTracesMessage\x12J\n\nidentifier\x18\x01 \x01(\x0b\x32\x36.envoy.service.trace.v3.StreamTracesMessage.Identifier\x12.\n\x05spans\x18\x02 \x03(\x0b\x32\x1f.opencensus.proto.trace.v1.Span\x1a~\n\nIdentifier\x12\x32\n\x04node\x18\x01 \x01(\x0b\x32\x1a.envoy.config.core.v3.NodeB\x08\xfa\x42\x05\x8a\x01\x02\x10\x01:<\x9a\xc5\x88\x1e\x37\n5envoy.service.trace.v2.StreamTracesMessage.Identifier:1\x9a\xc5\x88\x1e,\n*envoy.service.trace.v2.StreamTracesMessage2}\n\x0cTraceService\x12m\n\x0cStreamTraces\x12+.envoy.service.trace.v3.StreamTracesMessage\x1a,.envoy.service.trace.v3.StreamTracesResponse\"\x00(\x01\x42\x46\n$io.envoyproxy.envoy.service.trace.v3B\x11TraceServiceProtoP\x01\x88\x01\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\x62\x06proto3'
  ,
  dependencies=[envoy_dot_config_dot_core_dot_v3_dot_base__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,opencensus_dot_proto_dot_trace_dot_v1_dot_trace__pb2.DESCRIPTOR,udpa_dot_annotations_dot_status__pb2.DESCRIPTOR,udpa_dot_annotations_dot_versioning__pb2.DESCRIPTOR,validate_dot_validate__pb2.DESCRIPTOR,])
...
_STREAMTRACESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='envoy.service.trace.v3.StreamTracesResponse',
  filename=None,
  file=DESCRIPTOR,
...
_STREAMTRACESMESSAGE_IDENTIFIER = _descriptor.Descriptor(
  name='Identifier',
  full_name='envoy.service.trace.v3.StreamTracesMessage.Identifier',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='envoy.service.trace.v3.StreamTracesMessage.Identifier.node', index=0,
...
_STREAMTRACESMESSAGE = _descriptor.Descriptor(
  ...
  full_name='envoy.service.trace.v3.StreamTracesMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='identifier', full_name='envoy.service.trace.v3.StreamTracesMessage.identifier', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='spans', full_name='envoy.service.trace.v3.StreamTracesMessage.spans', index=1,
...
_STREAMTRACESMESSAGE_IDENTIFIER.fields_by_name['node'].message_type = envoy_dot_config_dot_core_dot_v3_dot_base__pb2._NODE
...
_TRACESERVICE = _descriptor.ServiceDescriptor(
  name='TraceService',
  full_name='envoy.service.trace.v3.TraceService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='StreamTraces',
    full_name='envoy.service.trace.v3.TraceService.StreamTraces',
    index=0,
