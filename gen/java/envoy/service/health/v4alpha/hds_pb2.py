...
_ENDPOINTHEALTHRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='endpoints_health', full_name='envoy.service.health.v4alpha.EndpointHealthResponse.endpoints_health', index=0,
