...
_STREAMEVENTSREQUEST_IDENTIFIER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='envoy.service.event_reporting.v3.StreamEventsRequest.Identifier.node', index=0,
...
_STREAMEVENTSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='identifier', full_name='envoy.service.event_reporting.v3.StreamEventsRequest.identifier', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='events', full_name='envoy.service.event_reporting.v3.StreamEventsRequest.events', index=1,
...
_STREAMEVENTSREQUEST_IDENTIFIER.fields_by_name['node'].message_type = envoy_dot_config_dot_core_dot_v3_dot_base__pb2._NODE
...
_EVENTREPORTINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='envoy.service.event_reporting.v3.EventReportingService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='StreamEvents',
    full_name='envoy.service.event_reporting.v3.EventReportingService.StreamEvents',
    index=0,
