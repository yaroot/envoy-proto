...
_CLIENTCONFIG_GENERICXDSCONFIG = _descriptor.Descriptor(
  ...
  full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='type_url', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.type_url', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version_info', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.version_info', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='xds_config', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.xds_config', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_updated', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.last_updated', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='config_status', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.config_status', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='client_status', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.client_status', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error_state', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.error_state', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='is_static_resource', full_name='envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig.is_static_resource', index=8,
  ...
  serialized_options=b'\232\305\210\0367\n5envoy.service.status.v3.ClientConfig.GenericXdsConfig',
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_CLIENTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='generic_xds_configs', full_name='envoy.service.status.v4alpha.ClientConfig.generic_xds_configs', index=1,
...
_CLIENTCONFIG_GENERICXDSCONFIG.fields_by_name['client_status'].enum_type = envoy_dot_admin_dot_v4alpha_dot_config__dump__pb2._CLIENTRESOURCESTATUS
_CLIENTCONFIG_GENERICXDSCONFIG.fields_by_name['error_state'].message_type = envoy_dot_admin_dot_v4alpha_dot_config__dump__pb2._UPDATEFAILURESTATE
...
ClientConfig = _reflection.GeneratedProtocolMessageType('ClientConfig', (_message.Message,), {
  ...
  'GenericXdsConfig' : _reflection.GeneratedProtocolMessageType('GenericXdsConfig', (_message.Message,), {
    ...
    '__module__' : 'envoy.service.status.v4alpha.csds_pb2'
    # @@protoc_insertion_point(class_scope:envoy.service.status.v4alpha.ClientConfig.GenericXdsConfig)
    })
  ,
...
_CLIENTCONFIG_GENERICXDSCONFIG._options = None
