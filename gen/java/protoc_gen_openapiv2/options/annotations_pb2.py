...
openapiv2_swagger = _descriptor.FieldDescriptor(
  name='openapiv2_swagger', full_name='grpc.gateway.protoc_gen_openapiv2.options.openapiv2_swagger', index=0,
...
openapiv2_operation = _descriptor.FieldDescriptor(
  name='openapiv2_operation', full_name='grpc.gateway.protoc_gen_openapiv2.options.openapiv2_operation', index=1,
  number=1042, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
openapiv2_schema = _descriptor.FieldDescriptor(
  name='openapiv2_schema', full_name='grpc.gateway.protoc_gen_openapiv2.options.openapiv2_schema', index=2,
  number=1042, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
openapiv2_tag = _descriptor.FieldDescriptor(
  name='openapiv2_tag', full_name='grpc.gateway.protoc_gen_openapiv2.options.openapiv2_tag', index=3,
  number=1042, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
openapiv2_field = _descriptor.FieldDescriptor(
  name='openapiv2_field', full_name='grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field', index=4,
  number=1042, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
