...
_ACCESSPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.identity.accesscontextmanager.v1.AccessPolicy.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.identity.accesscontextmanager.v1.AccessPolicy.parent', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='title', full_name='google.identity.accesscontextmanager.v1.AccessPolicy.title', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.identity.accesscontextmanager.v1.AccessPolicy.create_time', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update_time', full_name='google.identity.accesscontextmanager.v1.AccessPolicy.update_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='etag', full_name='google.identity.accesscontextmanager.v1.AccessPolicy.etag', index=5,
...
_ACCESSPOLICY.fields_by_name['update_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
