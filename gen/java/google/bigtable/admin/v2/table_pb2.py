...
_TABLE_VIEW = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ENCRYPTION_VIEW', index=4, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FULL', index=5, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_ENCRYPTIONINFO_ENCRYPTIONTYPE = _descriptor.EnumDescriptor(
  name='EncryptionType',
...
_sym_db.RegisterEnumDescriptor(_ENCRYPTIONINFO_ENCRYPTIONTYPE)
...
_TABLE_CLUSTERSTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encryption_info', full_name='google.bigtable.admin.v2.Table.ClusterState.encryption_info', index=1,
...
_ENCRYPTIONINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='encryption_type', full_name='google.bigtable.admin.v2.EncryptionInfo.encryption_type', index=0,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encryption_status', full_name='google.bigtable.admin.v2.EncryptionInfo.encryption_status', index=1,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='kms_key_version', full_name='google.bigtable.admin.v2.EncryptionInfo.kms_key_version', index=2,
  ...
  nested_types=[],
  enum_types=[
    _ENCRYPTIONINFO_ENCRYPTIONTYPE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_BACKUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encryption_info', full_name='google.bigtable.admin.v2.Backup.encryption_info', index=7,
...
_TABLE_CLUSTERSTATE.fields_by_name['encryption_info'].message_type = _ENCRYPTIONINFO
...
_ENCRYPTIONINFO.fields_by_name['encryption_type'].enum_type = _ENCRYPTIONINFO_ENCRYPTIONTYPE
_ENCRYPTIONINFO.fields_by_name['encryption_status'].message_type = google_dot_rpc_dot_status__pb2._STATUS
_ENCRYPTIONINFO_ENCRYPTIONTYPE.containing_type = _ENCRYPTIONINFO
...
_BACKUP.fields_by_name['encryption_info'].message_type = _ENCRYPTIONINFO
