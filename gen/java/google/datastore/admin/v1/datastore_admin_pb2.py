...
_CREATEINDEXREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='project_id', full_name='google.datastore.admin.v1.CreateIndexRequest.project_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='index', full_name='google.datastore.admin.v1.CreateIndexRequest.index', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETEINDEXREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='project_id', full_name='google.datastore.admin.v1.DeleteIndexRequest.project_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='index_id', full_name='google.datastore.admin.v1.DeleteIndexRequest.index_id', index=1,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEINDEXREQUEST.fields_by_name['index'].message_type = google_dot_datastore_dot_admin_dot_v1_dot_index__pb2._INDEX
...
_DATASTOREADMIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CreateIndex',
    full_name='google.datastore.admin.v1.DatastoreAdmin.CreateIndex',
    index=2,
    containing_service=None,
    input_type=_CREATEINDEXREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002*\"!/v1/projects/{project_id}/indexes:\005index\312A\037\n\005Index\022\026IndexOperationMetadata',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='DeleteIndex',
    full_name='google.datastore.admin.v1.DatastoreAdmin.DeleteIndex',
    index=3,
    containing_service=None,
    input_type=_DELETEINDEXREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002.*,/v1/projects/{project_id}/indexes/{index_id}\312A\037\n\005Index\022\026IndexOperationMetadata',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetIndex',
