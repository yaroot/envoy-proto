...
_RESTOREDATABASEENCRYPTIONCONFIG_ENCRYPTIONTYPE = _descriptor.EnumDescriptor(
  name='EncryptionType',
  full_name='google.spanner.admin.database.v1.RestoreDatabaseEncryptionConfig.EncryptionType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='USE_CONFIG_DEFAULT_OR_BACKUP_ENCRYPTION', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_DATABASE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encryption_config', full_name='google.spanner.admin.database.v1.Database.encryption_config', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encryption_info', full_name='google.spanner.admin.database.v1.Database.encryption_info', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version_retention_period', full_name='google.spanner.admin.database.v1.Database.version_retention_period', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='earliest_version_time', full_name='google.spanner.admin.database.v1.Database.earliest_version_time', index=7,
...
_CREATEDATABASEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='encryption_config', full_name='google.spanner.admin.database.v1.CreateDatabaseRequest.encryption_config', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEDATABASEDDLMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='throttled', full_name='google.spanner.admin.database.v1.UpdateDatabaseDdlMetadata.throttled', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='progress', full_name='google.spanner.admin.database.v1.UpdateDatabaseDdlMetadata.progress', index=4,
...
_RESTOREDATABASEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='encryption_config', full_name='google.spanner.admin.database.v1.RestoreDatabaseRequest.encryption_config', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESTOREDATABASEENCRYPTIONCONFIG = _descriptor.Descriptor(
  name='RestoreDatabaseEncryptionConfig',
  full_name='google.spanner.admin.database.v1.RestoreDatabaseEncryptionConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='encryption_type', full_name='google.spanner.admin.database.v1.RestoreDatabaseEncryptionConfig.encryption_type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='kms_key_name', full_name='google.spanner.admin.database.v1.RestoreDatabaseEncryptionConfig.kms_key_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATABASE.fields_by_name['encryption_config'].message_type = google_dot_spanner_dot_admin_dot_database_dot_v1_dot_common__pb2._ENCRYPTIONCONFIG
_DATABASE.fields_by_name['encryption_info'].message_type = google_dot_spanner_dot_admin_dot_database_dot_v1_dot_common__pb2._ENCRYPTIONINFO
_DATABASE.fields_by_name['earliest_version_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_DATABASE_STATE.containing_type = _DATABASE
_LISTDATABASESRESPONSE.fields_by_name['databases'].message_type = _DATABASE
_CREATEDATABASEREQUEST.fields_by_name['encryption_config'].message_type = google_dot_spanner_dot_admin_dot_database_dot_v1_dot_common__pb2._ENCRYPTIONCONFIG
...
_UPDATEDATABASEDDLMETADATA.fields_by_name['progress'].message_type = google_dot_spanner_dot_admin_dot_database_dot_v1_dot_common__pb2._OPERATIONPROGRESS
...
_RESTOREDATABASEREQUEST.fields_by_name['encryption_config'].message_type = _RESTOREDATABASEENCRYPTIONCONFIG
...
_RESTOREDATABASEENCRYPTIONCONFIG.fields_by_name['encryption_type'].enum_type = _RESTOREDATABASEENCRYPTIONCONFIG_ENCRYPTIONTYPE
_RESTOREDATABASEENCRYPTIONCONFIG_ENCRYPTIONTYPE.containing_type = _RESTOREDATABASEENCRYPTIONCONFIG
...
DESCRIPTOR.message_types_by_name['RestoreDatabaseEncryptionConfig'] = _RESTOREDATABASEENCRYPTIONCONFIG
