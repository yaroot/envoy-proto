...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/common/feed_common.proto',
...
Money = _reflection.GeneratedProtocolMessageType('Money', (_message.Message,), {
  'DESCRIPTOR' : _MONEY,
  '__module__' : 'google.ads.googleads.v3.common.feed_common_pb2'
