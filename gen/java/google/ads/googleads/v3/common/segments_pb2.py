...
from google.ads.googleads.v3.enums import ad_network_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_ad__network__type__pb2
from google.ads.googleads.v3.enums import click_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_click__type__pb2
from google.ads.googleads.v3.enums import conversion_action_category_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__action__category__pb2
from google.ads.googleads.v3.enums import conversion_attribution_event_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__attribution__event__type__pb2
from google.ads.googleads.v3.enums import conversion_lag_bucket_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__lag__bucket__pb2
from google.ads.googleads.v3.enums import conversion_or_adjustment_lag_bucket_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__or__adjustment__lag__bucket__pb2
...
from google.ads.googleads.v3.enums import external_conversion_source_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_external__conversion__source__pb2
...
from google.ads.googleads.v3.enums import hotel_price_bucket_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_hotel__price__bucket__pb2
from google.ads.googleads.v3.enums import hotel_rate_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_hotel__rate__type__pb2
from google.ads.googleads.v3.enums import month_of_year_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_month__of__year__pb2
...
from google.ads.googleads.v3.enums import search_engine_results_page_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_search__engine__results__page__type__pb2
from google.ads.googleads.v3.enums import search_term_match_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_search__term__match__type__pb2
from google.ads.googleads.v3.enums import slot_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_slot__pb2
from google.protobuf import wrappers_pb2 as google_dot_protobuf_dot_wrappers__pb2
from google.api import annotations_pb2 as google_dot_api_dot_annotations__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/common/segments.proto',
...
_SEGMENTS.fields_by_name['ad_network_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_ad__network__type__pb2._ADNETWORKTYPEENUM_ADNETWORKTYPE
_SEGMENTS.fields_by_name['click_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_click__type__pb2._CLICKTYPEENUM_CLICKTYPE
_SEGMENTS.fields_by_name['conversion_action'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_SEGMENTS.fields_by_name['conversion_action_category'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__action__category__pb2._CONVERSIONACTIONCATEGORYENUM_CONVERSIONACTIONCATEGORY
...
_SEGMENTS.fields_by_name['conversion_attribution_event_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__attribution__event__type__pb2._CONVERSIONATTRIBUTIONEVENTTYPEENUM_CONVERSIONATTRIBUTIONEVENTTYPE
_SEGMENTS.fields_by_name['conversion_lag_bucket'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__lag__bucket__pb2._CONVERSIONLAGBUCKETENUM_CONVERSIONLAGBUCKET
_SEGMENTS.fields_by_name['conversion_or_adjustment_lag_bucket'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_conversion__or__adjustment__lag__bucket__pb2._CONVERSIONORADJUSTMENTLAGBUCKETENUM_CONVERSIONORADJUSTMENTLAGBUCKET
_SEGMENTS.fields_by_name['date'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_SEGMENTS.fields_by_name['day_of_week'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_day__of__week__pb2._DAYOFWEEKENUM_DAYOFWEEK
_SEGMENTS.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_device__pb2._DEVICEENUM_DEVICE
_SEGMENTS.fields_by_name['external_conversion_source'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_external__conversion__source__pb2._EXTERNALCONVERSIONSOURCEENUM_EXTERNALCONVERSIONSOURCE
...
_SEGMENTS.fields_by_name['hotel_check_in_day_of_week'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_day__of__week__pb2._DAYOFWEEKENUM_DAYOFWEEK
...
_SEGMENTS.fields_by_name['hotel_date_selection_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_hotel__date__selection__type__pb2._HOTELDATESELECTIONTYPEENUM_HOTELDATESELECTIONTYPE
...
_SEGMENTS.fields_by_name['hotel_rate_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_hotel__rate__type__pb2._HOTELRATETYPEENUM_HOTELRATETYPE
_SEGMENTS.fields_by_name['hotel_price_bucket'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_hotel__price__bucket__pb2._HOTELPRICEBUCKETENUM_HOTELPRICEBUCKET
...
_SEGMENTS.fields_by_name['month_of_year'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_month__of__year__pb2._MONTHOFYEARENUM_MONTHOFYEAR
_SEGMENTS.fields_by_name['partner_hotel_id'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_SEGMENTS.fields_by_name['placeholder_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_placeholder__type__pb2._PLACEHOLDERTYPEENUM_PLACEHOLDERTYPE
...
_SEGMENTS.fields_by_name['product_channel'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_product__channel__pb2._PRODUCTCHANNELENUM_PRODUCTCHANNEL
_SEGMENTS.fields_by_name['product_channel_exclusivity'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_product__channel__exclusivity__pb2._PRODUCTCHANNELEXCLUSIVITYENUM_PRODUCTCHANNELEXCLUSIVITY
_SEGMENTS.fields_by_name['product_condition'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_product__condition__pb2._PRODUCTCONDITIONENUM_PRODUCTCONDITION
...
_SEGMENTS.fields_by_name['search_engine_results_page_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_search__engine__results__page__type__pb2._SEARCHENGINERESULTSPAGETYPEENUM_SEARCHENGINERESULTSPAGETYPE
_SEGMENTS.fields_by_name['search_term_match_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_search__term__match__type__pb2._SEARCHTERMMATCHTYPEENUM_SEARCHTERMMATCHTYPE
_SEGMENTS.fields_by_name['slot'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_slot__pb2._SLOTENUM_SLOT
...
_KEYWORD.fields_by_name['info'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._KEYWORDINFO
...
Segments = _reflection.GeneratedProtocolMessageType('Segments', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.common.segments_pb2'
