...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/paid_organic_search_term_view.proto',
...
PaidOrganicSearchTermView = _reflection.GeneratedProtocolMessageType('PaidOrganicSearchTermView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.paid_organic_search_term_view_pb2'
