...
_MOBILEAPPCATEGORYCONSTANT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.MobileAppCategoryConstant',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.MobileAppCategoryConstant.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v3.resources.MobileAppCategoryConstant.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v3.resources.MobileAppCategoryConstant.name', index=2,
...
MobileAppCategoryConstant = _reflection.GeneratedProtocolMessageType('MobileAppCategoryConstant', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.mobile_app_category_constant_pb2'
