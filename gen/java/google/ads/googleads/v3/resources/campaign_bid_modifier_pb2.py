...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/campaign_bid_modifier.proto',
...
_CAMPAIGNBIDMODIFIER = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.CampaignBidModifier',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.CampaignBidModifier.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='interaction_type', full_name='google.ads.googleads.v3.resources.CampaignBidModifier.interaction_type', index=4,
...
_CAMPAIGNBIDMODIFIER.fields_by_name['interaction_type'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._INTERACTIONTYPEINFO
...
CampaignBidModifier = _reflection.GeneratedProtocolMessageType('CampaignBidModifier', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.campaign_bid_modifier_pb2'
