...
from google.ads.googleads.v3.enums import feed_item_target_status_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_feed__item__target__status__pb2
from google.ads.googleads.v3.enums import feed_item_target_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_feed__item__target__type__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/feed_item_target.proto',
...
_FEEDITEMTARGET.fields_by_name['feed_item_target_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_feed__item__target__type__pb2._FEEDITEMTARGETTYPEENUM_FEEDITEMTARGETTYPE
_FEEDITEMTARGET.fields_by_name['feed_item_target_id'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_FEEDITEMTARGET.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_feed__item__target__status__pb2._FEEDITEMTARGETSTATUSENUM_FEEDITEMTARGETSTATUS
...
_FEEDITEMTARGET.fields_by_name['keyword'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._KEYWORDINFO
_FEEDITEMTARGET.fields_by_name['geo_target_constant'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_FEEDITEMTARGET.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_feed__item__target__device__pb2._FEEDITEMTARGETDEVICEENUM_FEEDITEMTARGETDEVICE
_FEEDITEMTARGET.fields_by_name['ad_schedule'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._ADSCHEDULEINFO
...
FeedItemTarget = _reflection.GeneratedProtocolMessageType('FeedItemTarget', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.feed_item_target_pb2'
