...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/domain_category.proto',
...
DomainCategory = _reflection.GeneratedProtocolMessageType('DomainCategory', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.domain_category_pb2'
