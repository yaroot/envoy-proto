...
_SHAREDCRITERION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.SharedCriterion',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.SharedCriterion.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shared_set', full_name='google.ads.googleads.v3.resources.SharedCriterion.shared_set', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='criterion_id', full_name='google.ads.googleads.v3.resources.SharedCriterion.criterion_id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v3.resources.SharedCriterion.type', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='keyword', full_name='google.ads.googleads.v3.resources.SharedCriterion.keyword', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='youtube_video', full_name='google.ads.googleads.v3.resources.SharedCriterion.youtube_video', index=5,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='youtube_channel', full_name='google.ads.googleads.v3.resources.SharedCriterion.youtube_channel', index=6,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='placement', full_name='google.ads.googleads.v3.resources.SharedCriterion.placement', index=7,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mobile_app_category', full_name='google.ads.googleads.v3.resources.SharedCriterion.mobile_app_category', index=8,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mobile_application', full_name='google.ads.googleads.v3.resources.SharedCriterion.mobile_application', index=9,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='criterion', full_name='google.ads.googleads.v3.resources.SharedCriterion.criterion',
...
_SHAREDCRITERION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_criterion__type__pb2._CRITERIONTYPEENUM_CRITERIONTYPE
_SHAREDCRITERION.fields_by_name['keyword'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._KEYWORDINFO
_SHAREDCRITERION.fields_by_name['youtube_video'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._YOUTUBEVIDEOINFO
_SHAREDCRITERION.fields_by_name['youtube_channel'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._YOUTUBECHANNELINFO
_SHAREDCRITERION.fields_by_name['placement'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._PLACEMENTINFO
_SHAREDCRITERION.fields_by_name['mobile_app_category'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._MOBILEAPPCATEGORYINFO
_SHAREDCRITERION.fields_by_name['mobile_application'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_criteria__pb2._MOBILEAPPLICATIONINFO
...
SharedCriterion = _reflection.GeneratedProtocolMessageType('SharedCriterion', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.shared_criterion_pb2'
