...
from google.ads.googleads.v3.enums import budget_delivery_method_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__delivery__method__pb2
from google.ads.googleads.v3.enums import budget_period_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__period__pb2
from google.ads.googleads.v3.enums import budget_status_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__status__pb2
from google.ads.googleads.v3.enums import budget_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__type__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/campaign_budget.proto',
...
_CAMPAIGNBUDGET = _descriptor.Descriptor(
  name='CampaignBudget',
  full_name='google.ads.googleads.v3.resources.CampaignBudget',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.CampaignBudget.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='amount_micros', full_name='google.ads.googleads.v3.resources.CampaignBudget.amount_micros', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_amount_micros', full_name='google.ads.googleads.v3.resources.CampaignBudget.total_amount_micros', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v3.resources.CampaignBudget.status', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='explicitly_shared', full_name='google.ads.googleads.v3.resources.CampaignBudget.explicitly_shared', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reference_count', full_name='google.ads.googleads.v3.resources.CampaignBudget.reference_count', index=8,
...
_CAMPAIGNBUDGET.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__status__pb2._BUDGETSTATUSENUM_BUDGETSTATUS
_CAMPAIGNBUDGET.fields_by_name['delivery_method'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__delivery__method__pb2._BUDGETDELIVERYMETHODENUM_BUDGETDELIVERYMETHOD
...
_CAMPAIGNBUDGET.fields_by_name['period'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__period__pb2._BUDGETPERIODENUM_BUDGETPERIOD
...
_CAMPAIGNBUDGET.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_budget__type__pb2._BUDGETTYPEENUM_BUDGETTYPE
...
CampaignBudget = _reflection.GeneratedProtocolMessageType('CampaignBudget', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.campaign_budget_pb2'
