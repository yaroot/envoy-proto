...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/parental_status_view.proto',
...
ParentalStatusView = _reflection.GeneratedProtocolMessageType('ParentalStatusView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.parental_status_view_pb2'
