...
from google.ads.googleads.v3.enums import billing_setup_status_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_billing__setup__status__pb2
...
_BILLINGSETUP_PAYMENTSACCOUNTINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='payments_account_id', full_name='google.ads.googleads.v3.resources.BillingSetup.PaymentsAccountInfo.payments_account_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='payments_account_name', full_name='google.ads.googleads.v3.resources.BillingSetup.PaymentsAccountInfo.payments_account_name', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='payments_profile_id', full_name='google.ads.googleads.v3.resources.BillingSetup.PaymentsAccountInfo.payments_profile_id', index=2,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='payments_profile_name', full_name='google.ads.googleads.v3.resources.BillingSetup.PaymentsAccountInfo.payments_profile_name', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='secondary_payments_profile_id', full_name='google.ads.googleads.v3.resources.BillingSetup.PaymentsAccountInfo.secondary_payments_profile_id', index=4,
...
_BILLINGSETUP = _descriptor.Descriptor(
  name='BillingSetup',
  full_name='google.ads.googleads.v3.resources.BillingSetup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.BillingSetup.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v3.resources.BillingSetup.id', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v3.resources.BillingSetup.status', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='payments_account', full_name='google.ads.googleads.v3.resources.BillingSetup.payments_account', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='payments_account_info', full_name='google.ads.googleads.v3.resources.BillingSetup.payments_account_info', index=4,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_date_time', full_name='google.ads.googleads.v3.resources.BillingSetup.start_date_time', index=5,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_time_type', full_name='google.ads.googleads.v3.resources.BillingSetup.start_time_type', index=6,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date_time', full_name='google.ads.googleads.v3.resources.BillingSetup.end_date_time', index=7,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_time_type', full_name='google.ads.googleads.v3.resources.BillingSetup.end_time_type', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='start_time', full_name='google.ads.googleads.v3.resources.BillingSetup.start_time',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='end_time', full_name='google.ads.googleads.v3.resources.BillingSetup.end_time',
...
_BILLINGSETUP.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_billing__setup__status__pb2._BILLINGSETUPSTATUSENUM_BILLINGSETUPSTATUS
...
_BILLINGSETUP.fields_by_name['start_time_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_time__type__pb2._TIMETYPEENUM_TIMETYPE
_BILLINGSETUP.fields_by_name['end_date_time'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_BILLINGSETUP.fields_by_name['end_time_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_time__type__pb2._TIMETYPEENUM_TIMETYPE
...
BillingSetup = _reflection.GeneratedProtocolMessageType('BillingSetup', (_message.Message,), {
  ...
  'PaymentsAccountInfo' : _reflection.GeneratedProtocolMessageType('PaymentsAccountInfo', (_message.Message,), {
    ...
    '__module__' : 'google.ads.googleads.v3.resources.billing_setup_pb2'
