...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/campaign_audience_view.proto',
...
CampaignAudienceView = _reflection.GeneratedProtocolMessageType('CampaignAudienceView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.campaign_audience_view_pb2'
