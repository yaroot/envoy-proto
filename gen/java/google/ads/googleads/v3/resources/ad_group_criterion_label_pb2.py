...
_ADGROUPCRITERIONLABEL = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.AdGroupCriterionLabel',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.AdGroupCriterionLabel.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group_criterion', full_name='google.ads.googleads.v3.resources.AdGroupCriterionLabel.ad_group_criterion', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='label', full_name='google.ads.googleads.v3.resources.AdGroupCriterionLabel.label', index=2,
...
AdGroupCriterionLabel = _reflection.GeneratedProtocolMessageType('AdGroupCriterionLabel', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.ad_group_criterion_label_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.resources.AdGroupCriterionLabel)
  })
