...
from google.ads.googleads.v3.enums import custom_interest_member_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_custom__interest__member__type__pb2
from google.ads.googleads.v3.enums import custom_interest_status_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_custom__interest__status__pb2
from google.ads.googleads.v3.enums import custom_interest_type_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_custom__interest__type__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/custom_interest.proto',
...
_CUSTOMINTEREST = _descriptor.Descriptor(
  name='CustomInterest',
  full_name='google.ads.googleads.v3.resources.CustomInterest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.CustomInterest.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v3.resources.CustomInterest.name', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v3.resources.CustomInterest.type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.ads.googleads.v3.resources.CustomInterest.description', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='members', full_name='google.ads.googleads.v3.resources.CustomInterest.members', index=6,
...
_CUSTOMINTERESTMEMBER = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.CustomInterestMember',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='member_type', full_name='google.ads.googleads.v3.resources.CustomInterestMember.member_type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parameter', full_name='google.ads.googleads.v3.resources.CustomInterestMember.parameter', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMINTEREST.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_custom__interest__status__pb2._CUSTOMINTERESTSTATUSENUM_CUSTOMINTERESTSTATUS
_CUSTOMINTEREST.fields_by_name['name'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_CUSTOMINTEREST.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_custom__interest__type__pb2._CUSTOMINTERESTTYPEENUM_CUSTOMINTERESTTYPE
...
_CUSTOMINTERESTMEMBER.fields_by_name['member_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_custom__interest__member__type__pb2._CUSTOMINTERESTMEMBERTYPEENUM_CUSTOMINTERESTMEMBERTYPE
...
CustomInterest = _reflection.GeneratedProtocolMessageType('CustomInterest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.custom_interest_pb2'
