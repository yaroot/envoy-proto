...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/keyword_plan_campaign.proto',
...
_KEYWORDPLANCAMPAIGN.fields_by_name['keyword_plan_network'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_keyword__plan__network__pb2._KEYWORDPLANNETWORKENUM_KEYWORDPLANNETWORK
...
KeywordPlanCampaign = _reflection.GeneratedProtocolMessageType('KeywordPlanCampaign', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.keyword_plan_campaign_pb2'
