...
from google.ads.googleads.v3.common import dates_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_common_dot_dates__pb2
from google.ads.googleads.v3.enums import keyword_plan_forecast_interval_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_keyword__plan__forecast__interval__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/keyword_plan.proto',
...
_KEYWORDPLAN = _descriptor.Descriptor(
  name='KeywordPlan',
  full_name='google.ads.googleads.v3.resources.KeywordPlan',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.KeywordPlan.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='forecast_period', full_name='google.ads.googleads.v3.resources.KeywordPlan.forecast_period', index=3,
...
_KEYWORDPLANFORECASTPERIOD = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.KeywordPlanForecastPeriod',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='date_interval', full_name='google.ads.googleads.v3.resources.KeywordPlanForecastPeriod.date_interval', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='date_range', full_name='google.ads.googleads.v3.resources.KeywordPlanForecastPeriod.date_range', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYWORDPLANFORECASTPERIOD.fields_by_name['date_interval'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_keyword__plan__forecast__interval__pb2._KEYWORDPLANFORECASTINTERVALENUM_KEYWORDPLANFORECASTINTERVAL
_KEYWORDPLANFORECASTPERIOD.fields_by_name['date_range'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_common_dot_dates__pb2._DATERANGE
...
KeywordPlan = _reflection.GeneratedProtocolMessageType('KeywordPlan', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.keyword_plan_pb2'
...
KeywordPlanForecastPeriod = _reflection.GeneratedProtocolMessageType('KeywordPlanForecastPeriod', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.keyword_plan_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.resources.KeywordPlanForecastPeriod)
  })
