...
_DISPLAYKEYWORDVIEW = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.DisplayKeywordView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.DisplayKeywordView.resource_name', index=0,
...
DisplayKeywordView = _reflection.GeneratedProtocolMessageType('DisplayKeywordView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.display_keyword_view_pb2'
