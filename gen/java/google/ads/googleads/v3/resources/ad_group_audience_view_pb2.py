...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/ad_group_audience_view.proto',
...
AdGroupAudienceView = _reflection.GeneratedProtocolMessageType('AdGroupAudienceView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.ad_group_audience_view_pb2'
