...
from google.ads.googleads.v3.enums import customer_pay_per_conversion_eligibility_failure_reason_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_customer__pay__per__conversion__eligibility__failure__reason__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/customer.proto',
...
_CUSTOMER = _descriptor.Descriptor(
  name='Customer',
  full_name='google.ads.googleads.v3.resources.Customer',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.Customer.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='currency_code', full_name='google.ads.googleads.v3.resources.Customer.currency_code', index=3,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='final_url_suffix', full_name='google.ads.googleads.v3.resources.Customer.final_url_suffix', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='auto_tagging_enabled', full_name='google.ads.googleads.v3.resources.Customer.auto_tagging_enabled', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='has_partners_badge', full_name='google.ads.googleads.v3.resources.Customer.has_partners_badge', index=8,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='conversion_tracking_setting', full_name='google.ads.googleads.v3.resources.Customer.conversion_tracking_setting', index=12,
...
_CALLREPORTINGSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.CallReportingSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='call_reporting_enabled', full_name='google.ads.googleads.v3.resources.CallReportingSetting.call_reporting_enabled', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='call_conversion_reporting_enabled', full_name='google.ads.googleads.v3.resources.CallReportingSetting.call_conversion_reporting_enabled', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='call_conversion_action', full_name='google.ads.googleads.v3.resources.CallReportingSetting.call_conversion_action', index=2,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONVERSIONTRACKINGSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.ConversionTrackingSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='conversion_tracking_id', full_name='google.ads.googleads.v3.resources.ConversionTrackingSetting.conversion_tracking_id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REMARKETINGSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.RemarketingSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='google_global_site_tag', full_name='google.ads.googleads.v3.resources.RemarketingSetting.google_global_site_tag', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMER.fields_by_name['pay_per_conversion_eligibility_failure_reasons'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_customer__pay__per__conversion__eligibility__failure__reason__pb2._CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASONENUM_CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASON
...
Customer = _reflection.GeneratedProtocolMessageType('Customer', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.customer_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.resources.Customer)
  })
