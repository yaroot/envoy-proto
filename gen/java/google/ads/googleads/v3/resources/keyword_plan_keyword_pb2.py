...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/resources/keyword_plan_keyword.proto',
...
_KEYWORDPLANKEYWORD = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.resources.KeywordPlanKeyword',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.resources.KeywordPlanKeyword.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='match_type', full_name='google.ads.googleads.v3.resources.KeywordPlanKeyword.match_type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpc_bid_micros', full_name='google.ads.googleads.v3.resources.KeywordPlanKeyword.cpc_bid_micros', index=5,
  ...
  serialized_options=b'\352An\n+googleads.googleapis.com/KeywordPlanKeyword\022?customers/{customer}/keywordPlanKeywords/{keyword_plan_keyword}',
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_KEYWORDPLANKEYWORD.fields_by_name['match_type'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_keyword__match__type__pb2._KEYWORDMATCHTYPEENUM_KEYWORDMATCHTYPE
...
KeywordPlanKeyword = _reflection.GeneratedProtocolMessageType('KeywordPlanKeyword', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.resources.keyword_plan_keyword_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.resources.KeywordPlanKeyword)
  })
