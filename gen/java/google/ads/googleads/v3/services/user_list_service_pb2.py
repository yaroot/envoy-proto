...
_GETUSERLISTREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.GetUserListRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.GetUserListRequest.resource_name', index=0,
...
_MUTATEUSERLISTSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateUserListsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v3.services.MutateUserListsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v3.services.MutateUserListsRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v3.services.MutateUserListsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v3.services.MutateUserListsRequest.validate_only', index=3,
...
_USERLISTOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.UserListOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v3.services.UserListOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v3.services.UserListOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v3.services.UserListOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v3.services.UserListOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v3.services.UserListOperation.operation',
...
_MUTATEUSERLISTSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateUserListsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v3.services.MutateUserListsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v3.services.MutateUserListsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEUSERLISTRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.services.MutateUserListResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v3.services.MutateUserListResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USERLISTOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_user__list__pb2._USERLIST
_USERLISTOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_user__list__pb2._USERLIST
...
GetUserListRequest = _reflection.GeneratedProtocolMessageType('GetUserListRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.user_list_service_pb2'
...
MutateUserListsResponse = _reflection.GeneratedProtocolMessageType('MutateUserListsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.user_list_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.services.MutateUserListsResponse)
  })
...
_USERLISTSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v3.services.UserListService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetUserList',
    full_name='google.ads.googleads.v3.services.UserListService.GetUserList',
    index=0,
    containing_service=None,
    input_type=_GETUSERLISTREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_user__list__pb2._USERLIST,
    serialized_options=b'\202\323\344\223\002-\022+/v3/{resource_name=customers/*/userLists/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateUserLists',
    full_name='google.ads.googleads.v3.services.UserListService.MutateUserLists',
    index=1,
    containing_service=None,
    input_type=_MUTATEUSERLISTSREQUEST,
    output_type=_MUTATEUSERLISTSRESPONSE,
    serialized_options=b'\202\323\344\223\0023\"./v3/customers/{customer_id=*}/userLists:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
