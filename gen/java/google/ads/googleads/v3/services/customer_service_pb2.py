...
from google.ads.googleads.v3.enums import access_role_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_access__role__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/customer_service.proto',
...
_CREATECUSTOMERCLIENTREQUEST.fields_by_name['customer_client'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_customer__pb2._CUSTOMER
...
_CREATECUSTOMERCLIENTREQUEST.fields_by_name['access_role'].enum_type = google_dot_ads_dot_googleads_dot_v3_dot_enums_dot_access__role__pb2._ACCESSROLEENUM_ACCESSROLE
_CUSTOMEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_customer__pb2._CUSTOMER
...
GetCustomerRequest = _reflection.GeneratedProtocolMessageType('GetCustomerRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.customer_service_pb2'
...
_CUSTOMERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_customer__pb2._CUSTOMER,
    serialized_options=b'\202\323\344\223\002!\022\037/v3/{resource_name=customers/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomer',
    ...
    serialized_options=b'\202\323\344\223\002)\"$/v3/customers/{customer_id=*}:mutate:\001*\332A\025customer_id,operation',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\'\022%/v3/customers:listAccessibleCustomers',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0027\"2/v3/customers/{customer_id=*}:createCustomerClient:\001*\332A\033customer_id,customer_client',
    create_key=_descriptor._internal_create_key,
  ),
])
