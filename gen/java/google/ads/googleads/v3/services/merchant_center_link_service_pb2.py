...
from google.ads.googleads.v3.resources import merchant_center_link_pb2 as google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_merchant__center__link__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/services/merchant_center_link_service.proto',
...
_LISTMERCHANTCENTERLINKSRESPONSE.fields_by_name['merchant_center_links'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_merchant__center__link__pb2._MERCHANTCENTERLINK
...
_MERCHANTCENTERLINKOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_merchant__center__link__pb2._MERCHANTCENTERLINK
...
ListMerchantCenterLinksRequest = _reflection.GeneratedProtocolMessageType('ListMerchantCenterLinksRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.services.merchant_center_link_service_pb2'
...
_MERCHANTCENTERLINKSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0023\0221/v3/customers/{customer_id=*}/merchantCenterLinks\332A\013customer_id',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v3_dot_resources_dot_merchant__center__link__pb2._MERCHANTCENTERLINK,
    serialized_options=b'\202\323\344\223\0027\0225/v3/{resource_name=customers/*/merchantCenterLinks/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002=\"8/v3/customers/{customer_id=*}/merchantCenterLinks:mutate:\001*\332A\025customer_id,operation',
    create_key=_descriptor._internal_create_key,
  ),
])
