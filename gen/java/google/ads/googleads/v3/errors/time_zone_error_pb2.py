...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/time_zone_error.proto',
...
TimeZoneErrorEnum = _reflection.GeneratedProtocolMessageType('TimeZoneErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.time_zone_error_pb2'
