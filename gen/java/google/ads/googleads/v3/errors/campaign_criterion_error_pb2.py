...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/campaign_criterion_error.proto',
...
CampaignCriterionErrorEnum = _reflection.GeneratedProtocolMessageType('CampaignCriterionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.campaign_criterion_error_pb2'
