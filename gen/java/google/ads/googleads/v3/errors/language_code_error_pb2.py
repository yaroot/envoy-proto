...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/language_code_error.proto',
...
LanguageCodeErrorEnum = _reflection.GeneratedProtocolMessageType('LanguageCodeErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.language_code_error_pb2'
