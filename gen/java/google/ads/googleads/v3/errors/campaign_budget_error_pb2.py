...
_CAMPAIGNBUDGETERRORENUM_CAMPAIGNBUDGETERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v3.errors.CampaignBudgetErrorEnum.CampaignBudgetError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CAMPAIGNBUDGETERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.errors.CampaignBudgetErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
CampaignBudgetErrorEnum = _reflection.GeneratedProtocolMessageType('CampaignBudgetErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.campaign_budget_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.errors.CampaignBudgetErrorEnum)
  })
