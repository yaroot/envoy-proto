...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/shared_criterion_error.proto',
...
SharedCriterionErrorEnum = _reflection.GeneratedProtocolMessageType('SharedCriterionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.shared_criterion_error_pb2'
