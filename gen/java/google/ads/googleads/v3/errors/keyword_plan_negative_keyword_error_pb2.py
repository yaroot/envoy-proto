...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/keyword_plan_negative_keyword_error.proto',
...
KeywordPlanNegativeKeywordErrorEnum = _reflection.GeneratedProtocolMessageType('KeywordPlanNegativeKeywordErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.keyword_plan_negative_keyword_error_pb2'
