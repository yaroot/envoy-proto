...
_CRITERIONERRORENUM_CRITERIONERROR = _descriptor.EnumDescriptor(
  name='CriterionError',
  full_name='google.ads.googleads.v3.errors.CriterionErrorEnum.CriterionError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_TARGET_USER_LIST_FOR_SMART_DISPLAY_CAMPAIGNS', index=99, number=99,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LISTING_SCOPE_TOO_MANY_DIMENSION_TYPES', index=100, number=100,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LISTING_SCOPE_TOO_MANY_IN_OPERATORS', index=101, number=101,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LISTING_SCOPE_IN_OPERATOR_NOT_SUPPORTED', index=102, number=102,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DUPLICATE_LISTING_DIMENSION_TYPE', index=103, number=103,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DUPLICATE_LISTING_DIMENSION_VALUE', index=104, number=104,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_SET_BIDS_ON_LISTING_GROUP_SUBDIVISION', index=105, number=105,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_CRITERIONERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.errors.CriterionErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
CriterionErrorEnum = _reflection.GeneratedProtocolMessageType('CriterionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.criterion_error_pb2'
