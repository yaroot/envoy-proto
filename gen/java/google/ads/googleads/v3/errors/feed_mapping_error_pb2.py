...
_FEEDMAPPINGERRORENUM_FEEDMAPPINGERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v3.errors.FeedMappingErrorEnum.FeedMappingError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_FEEDMAPPINGERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v3.errors.FeedMappingErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
FeedMappingErrorEnum = _reflection.GeneratedProtocolMessageType('FeedMappingErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.feed_mapping_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.errors.FeedMappingErrorEnum)
  })
