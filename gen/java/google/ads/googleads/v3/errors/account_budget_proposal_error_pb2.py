...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/errors/account_budget_proposal_error.proto',
...
AccountBudgetProposalErrorEnum = _reflection.GeneratedProtocolMessageType('AccountBudgetProposalErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.account_budget_proposal_error_pb2'
