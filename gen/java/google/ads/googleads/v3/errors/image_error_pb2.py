...
_IMAGEERRORENUM_IMAGEERROR = _descriptor.EnumDescriptor(
  name='ImageError',
  full_name='google.ads.googleads.v3.errors.ImageErrorEnum.ImageError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_IMAGEERRORENUM = _descriptor.Descriptor(
  name='ImageErrorEnum',
  full_name='google.ads.googleads.v3.errors.ImageErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
ImageErrorEnum = _reflection.GeneratedProtocolMessageType('ImageErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.errors.image_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v3.errors.ImageErrorEnum)
  })
