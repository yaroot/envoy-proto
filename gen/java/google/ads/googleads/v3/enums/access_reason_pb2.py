...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/access_reason.proto',
...
AccessReasonEnum = _reflection.GeneratedProtocolMessageType('AccessReasonEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.access_reason_pb2'
