...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/shared_set_status.proto',
...
SharedSetStatusEnum = _reflection.GeneratedProtocolMessageType('SharedSetStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.shared_set_status_pb2'
