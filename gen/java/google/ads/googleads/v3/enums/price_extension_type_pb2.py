...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/price_extension_type.proto',
...
PriceExtensionTypeEnum = _reflection.GeneratedProtocolMessageType('PriceExtensionTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.price_extension_type_pb2'
