...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/search_term_match_type.proto',
...
SearchTermMatchTypeEnum = _reflection.GeneratedProtocolMessageType('SearchTermMatchTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.search_term_match_type_pb2'
