...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v3/enums/spending_limit_type.proto',
...
SpendingLimitTypeEnum = _reflection.GeneratedProtocolMessageType('SpendingLimitTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v3.enums.spending_limit_type_pb2'
