...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/enums/linked_account_type.proto',
...
LinkedAccountTypeEnum = _reflection.GeneratedProtocolMessageType('LinkedAccountTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.enums.linked_account_type_pb2'
