...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/enums/account_budget_status.proto',
...
AccountBudgetStatusEnum = _reflection.GeneratedProtocolMessageType('AccountBudgetStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.enums.account_budget_status_pb2'
