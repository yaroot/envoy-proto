...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/enums/batch_job_status.proto',
...
BatchJobStatusEnum = _reflection.GeneratedProtocolMessageType('BatchJobStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.enums.batch_job_status_pb2'
