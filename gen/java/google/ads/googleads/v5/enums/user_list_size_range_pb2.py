...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/enums/user_list_size_range.proto',
...
UserListSizeRangeEnum = _reflection.GeneratedProtocolMessageType('UserListSizeRangeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.enums.user_list_size_range_pb2'
