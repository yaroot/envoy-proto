...
_ADTYPEENUM_ADTYPE = _descriptor.EnumDescriptor(
  name='AdType',
  full_name='google.ads.googleads.v5.enums.AdTypeEnum.AdType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_AD', index=17, number=20,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='HTML5_UPLOAD_AD', index=18, number=21,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DYNAMIC_HTML5_AD', index=19, number=22,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='APP_ENGAGEMENT_AD', index=20, number=23,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SHOPPING_COMPARISON_LISTING_AD', index=21, number=24,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='VIDEO_BUMPER_AD', index=22, number=25,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='VIDEO_NON_SKIPPABLE_IN_STREAM_AD', index=23, number=26,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='VIDEO_OUTSTREAM_AD', index=24, number=27,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='VIDEO_TRUEVIEW_DISCOVERY_AD', index=25, number=28,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='VIDEO_TRUEVIEW_IN_STREAM_AD', index=26, number=29,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='VIDEO_RESPONSIVE_AD', index=27, number=30,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_ADTYPEENUM = _descriptor.Descriptor(
  name='AdTypeEnum',
  full_name='google.ads.googleads.v5.enums.AdTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
AdTypeEnum = _reflection.GeneratedProtocolMessageType('AdTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.enums.ad_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.enums.AdTypeEnum)
  })
