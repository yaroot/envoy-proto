...
_URLFIELDERRORENUM_URLFIELDERROR = _descriptor.EnumDescriptor(
  name='UrlFieldError',
  full_name='google.ads.googleads.v5.errors.UrlFieldErrorEnum.UrlFieldError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_URLFIELDERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.errors.UrlFieldErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
UrlFieldErrorEnum = _reflection.GeneratedProtocolMessageType('UrlFieldErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.errors.url_field_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.errors.UrlFieldErrorEnum)
  })
