...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/errors/feed_mapping_error.proto',
...
FeedMappingErrorEnum = _reflection.GeneratedProtocolMessageType('FeedMappingErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.errors.feed_mapping_error_pb2'
