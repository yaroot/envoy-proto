...
_ADGROUPERRORENUM_ADGROUPERROR = _descriptor.EnumDescriptor(
  name='AdGroupError',
  full_name='google.ads.googleads.v5.errors.AdGroupErrorEnum.AdGroupError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ADGROUPERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.errors.AdGroupErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
AdGroupErrorEnum = _reflection.GeneratedProtocolMessageType('AdGroupErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.errors.ad_group_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.errors.AdGroupErrorEnum)
  })
