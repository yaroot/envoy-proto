...
_GETCAMPAIGNBIDMODIFIERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.GetCampaignBidModifierRequest.resource_name', index=0,
...
_MUTATECAMPAIGNBIDMODIFIERSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCampaignBidModifiersRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v5.services.MutateCampaignBidModifiersRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v5.services.MutateCampaignBidModifiersRequest.operations', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v5.services.MutateCampaignBidModifiersRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v5.services.MutateCampaignBidModifiersRequest.validate_only', index=3,
...
_CAMPAIGNBIDMODIFIEROPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.CampaignBidModifierOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v5.services.CampaignBidModifierOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v5.services.CampaignBidModifierOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v5.services.CampaignBidModifierOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v5.services.CampaignBidModifierOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v5.services.CampaignBidModifierOperation.operation',
...
_MUTATECAMPAIGNBIDMODIFIERSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v5.services.MutateCampaignBidModifiersResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v5.services.MutateCampaignBidModifiersResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECAMPAIGNBIDMODIFIERRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCampaignBidModifierResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.MutateCampaignBidModifierResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CAMPAIGNBIDMODIFIEROPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER
_CAMPAIGNBIDMODIFIEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER
...
GetCampaignBidModifierRequest = _reflection.GeneratedProtocolMessageType('GetCampaignBidModifierRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.campaign_bid_modifier_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.GetCampaignBidModifierRequest)
  })
...
MutateCampaignBidModifiersRequest = _reflection.GeneratedProtocolMessageType('MutateCampaignBidModifiersRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.campaign_bid_modifier_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateCampaignBidModifiersRequest)
  })
...
MutateCampaignBidModifierResult = _reflection.GeneratedProtocolMessageType('MutateCampaignBidModifierResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.campaign_bid_modifier_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateCampaignBidModifierResult)
  })
...
_CAMPAIGNBIDMODIFIERSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v5.services.CampaignBidModifierService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v5.services.CampaignBidModifierService.GetCampaignBidModifier',
    index=0,
    containing_service=None,
    input_type=_GETCAMPAIGNBIDMODIFIERREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER,
    serialized_options=b'\202\323\344\223\0028\0226/v5/{resource_name=customers/*/campaignBidModifiers/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCampaignBidModifiers',
    full_name='google.ads.googleads.v5.services.CampaignBidModifierService.MutateCampaignBidModifiers',
    index=1,
    containing_service=None,
    input_type=_MUTATECAMPAIGNBIDMODIFIERSREQUEST,
    output_type=_MUTATECAMPAIGNBIDMODIFIERSRESPONSE,
    serialized_options=b'\202\323\344\223\002>\"9/v5/customers/{customer_id=*}/campaignBidModifiers:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
