...
_GETCUSTOMERMANAGERLINKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.GetCustomerManagerLinkRequest.resource_name', index=0,
...
_MUTATECUSTOMERMANAGERLINKREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCustomerManagerLinkRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v5.services.MutateCustomerManagerLinkRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v5.services.MutateCustomerManagerLinkRequest.operations', index=1,
...
_MOVEMANAGERLINKREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MoveManagerLinkRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v5.services.MoveManagerLinkRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='previous_customer_manager_link', full_name='google.ads.googleads.v5.services.MoveManagerLinkRequest.previous_customer_manager_link', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='new_manager', full_name='google.ads.googleads.v5.services.MoveManagerLinkRequest.new_manager', index=2,
...
_CUSTOMERMANAGERLINKOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.CustomerManagerLinkOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v5.services.CustomerManagerLinkOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v5.services.CustomerManagerLinkOperation.update', index=1,
...
_MUTATECUSTOMERMANAGERLINKRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCustomerManagerLinkResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v5.services.MutateCustomerManagerLinkResponse.results', index=0,
...
_MOVEMANAGERLINKRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MoveManagerLinkResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.MoveManagerLinkResponse.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECUSTOMERMANAGERLINKRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.services.MutateCustomerManagerLinkResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.services.MutateCustomerManagerLinkResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMERMANAGERLINKOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_customer__manager__link__pb2._CUSTOMERMANAGERLINK
...
GetCustomerManagerLinkRequest = _reflection.GeneratedProtocolMessageType('GetCustomerManagerLinkRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_manager_link_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.GetCustomerManagerLinkRequest)
  })
...
MoveManagerLinkRequest = _reflection.GeneratedProtocolMessageType('MoveManagerLinkRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_manager_link_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MoveManagerLinkRequest)
  })
...
MutateCustomerManagerLinkResponse = _reflection.GeneratedProtocolMessageType('MutateCustomerManagerLinkResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.services.customer_manager_link_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v5.services.MutateCustomerManagerLinkResponse)
  })
...
_CUSTOMERMANAGERLINKSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v5.services.CustomerManagerLinkService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v5.services.CustomerManagerLinkService.GetCustomerManagerLink',
    index=0,
    containing_service=None,
    input_type=_GETCUSTOMERMANAGERLINKREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v5_dot_resources_dot_customer__manager__link__pb2._CUSTOMERMANAGERLINK,
    serialized_options=b'\202\323\344\223\0028\0226/v5/{resource_name=customers/*/customerManagerLinks/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomerManagerLink',
    full_name='google.ads.googleads.v5.services.CustomerManagerLinkService.MutateCustomerManagerLink',
    index=1,
    containing_service=None,
    input_type=_MUTATECUSTOMERMANAGERLINKREQUEST,
    output_type=_MUTATECUSTOMERMANAGERLINKRESPONSE,
    serialized_options=b'\202\323\344\223\002>\"9/v5/customers/{customer_id=*}/customerManagerLinks:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MoveManagerLink',
    full_name='google.ads.googleads.v5.services.CustomerManagerLinkService.MoveManagerLink',
    index=2,
    containing_service=None,
    input_type=_MOVEMANAGERLINKREQUEST,
    output_type=_MOVEMANAGERLINKRESPONSE,
    serialized_options=b'\202\323\344\223\002G\"B/v5/customers/{customer_id=*}/customerManagerLinks:moveManagerLink:\001*\332A6customer_id,previous_customer_manager_link,new_manager',
    create_key=_descriptor._internal_create_key,
  ),
])
