...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v5/resources/customer_extension_setting.proto',
...
_CUSTOMEREXTENSIONSETTING.fields_by_name['extension_type'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_extension__type__pb2._EXTENSIONTYPEENUM_EXTENSIONTYPE
...
_CUSTOMEREXTENSIONSETTING.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_extension__setting__device__pb2._EXTENSIONSETTINGDEVICEENUM_EXTENSIONSETTINGDEVICE
...
CustomerExtensionSetting = _reflection.GeneratedProtocolMessageType('CustomerExtensionSetting', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.resources.customer_extension_setting_pb2'
