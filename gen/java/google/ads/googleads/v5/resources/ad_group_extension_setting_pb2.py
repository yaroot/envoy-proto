...
from google.ads.googleads.v5.enums import extension_setting_device_pb2 as google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_extension__setting__device__pb2
...
_ADGROUPEXTENSIONSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v5.resources.AdGroupExtensionSetting',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.resources.AdGroupExtensionSetting.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='extension_type', full_name='google.ads.googleads.v5.resources.AdGroupExtensionSetting.extension_type', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group', full_name='google.ads.googleads.v5.resources.AdGroupExtensionSetting.ad_group', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='extension_feed_items', full_name='google.ads.googleads.v5.resources.AdGroupExtensionSetting.extension_feed_items', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='device', full_name='google.ads.googleads.v5.resources.AdGroupExtensionSetting.device', index=4,
...
_ADGROUPEXTENSIONSETTING.fields_by_name['extension_type'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_extension__type__pb2._EXTENSIONTYPEENUM_EXTENSIONTYPE
...
_ADGROUPEXTENSIONSETTING.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_extension__setting__device__pb2._EXTENSIONSETTINGDEVICEENUM_EXTENSIONSETTINGDEVICE
...
AdGroupExtensionSetting = _reflection.GeneratedProtocolMessageType('AdGroupExtensionSetting', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.resources.ad_group_extension_setting_pb2'
