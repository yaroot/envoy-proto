...
_CAMPAIGNEXTENSIONSETTING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v5.resources.CampaignExtensionSetting.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='extension_type', full_name='google.ads.googleads.v5.resources.CampaignExtensionSetting.extension_type', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='campaign', full_name='google.ads.googleads.v5.resources.CampaignExtensionSetting.campaign', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='extension_feed_items', full_name='google.ads.googleads.v5.resources.CampaignExtensionSetting.extension_feed_items', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='device', full_name='google.ads.googleads.v5.resources.CampaignExtensionSetting.device', index=4,
...
_CAMPAIGNEXTENSIONSETTING.fields_by_name['extension_type'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_extension__type__pb2._EXTENSIONTYPEENUM_EXTENSIONTYPE
...
_CAMPAIGNEXTENSIONSETTING.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v5_dot_enums_dot_extension__setting__device__pb2._EXTENSIONSETTINGDEVICEENUM_EXTENSIONSETTINGDEVICE
...
CampaignExtensionSetting = _reflection.GeneratedProtocolMessageType('CampaignExtensionSetting', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v5.resources.campaign_extension_setting_pb2'
