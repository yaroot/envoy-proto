...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/user_location_view.proto',
...
_USERLOCATIONVIEW = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.UserLocationView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.UserLocationView.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='country_criterion_id', full_name='google.ads.googleads.v7.resources.UserLocationView.country_criterion_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='targeting_location', full_name='google.ads.googleads.v7.resources.UserLocationView.targeting_location', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_country_criterion_id', full_name='google.ads.googleads.v7.resources.UserLocationView._country_criterion_id',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_targeting_location', full_name='google.ads.googleads.v7.resources.UserLocationView._targeting_location',
