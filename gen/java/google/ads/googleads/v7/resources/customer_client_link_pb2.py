...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/customer_client_link.proto',
...
_CUSTOMERCLIENTLINK = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.CustomerClientLink',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.CustomerClientLink.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='client_customer', full_name='google.ads.googleads.v7.resources.CustomerClientLink.client_customer', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='manager_link_id', full_name='google.ads.googleads.v7.resources.CustomerClientLink.manager_link_id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v7.resources.CustomerClientLink.status', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='hidden', full_name='google.ads.googleads.v7.resources.CustomerClientLink.hidden', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_client_customer', full_name='google.ads.googleads.v7.resources.CustomerClientLink._client_customer',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_manager_link_id', full_name='google.ads.googleads.v7.resources.CustomerClientLink._manager_link_id',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_hidden', full_name='google.ads.googleads.v7.resources.CustomerClientLink._hidden',
...
_CUSTOMERCLIENTLINK.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_manager__link__status__pb2._MANAGERLINKSTATUSENUM_MANAGERLINKSTATUS
