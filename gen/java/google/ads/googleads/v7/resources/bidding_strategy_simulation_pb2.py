...
_BIDDINGSTRATEGYSIMULATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='bidding_strategy_id', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.bidding_strategy_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.type', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='modification_method', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.modification_method', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_date', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.start_date', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.end_date', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_cpa_point_list', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.target_cpa_point_list', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_roas_point_list', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.target_roas_point_list', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='point_list', full_name='google.ads.googleads.v7.resources.BiddingStrategySimulation.point_list',
...
_BIDDINGSTRATEGYSIMULATION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_simulation__type__pb2._SIMULATIONTYPEENUM_SIMULATIONTYPE
_BIDDINGSTRATEGYSIMULATION.fields_by_name['modification_method'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_simulation__modification__method__pb2._SIMULATIONMODIFICATIONMETHODENUM_SIMULATIONMODIFICATIONMETHOD
_BIDDINGSTRATEGYSIMULATION.fields_by_name['target_cpa_point_list'].message_type = google_dot_ads_dot_googleads_dot_v7_dot_common_dot_simulation__pb2._TARGETCPASIMULATIONPOINTLIST
_BIDDINGSTRATEGYSIMULATION.fields_by_name['target_roas_point_list'].message_type = google_dot_ads_dot_googleads_dot_v7_dot_common_dot_simulation__pb2._TARGETROASSIMULATIONPOINTLIST
...
BiddingStrategySimulation = _reflection.GeneratedProtocolMessageType('BiddingStrategySimulation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.resources.bidding_strategy_simulation_pb2'
