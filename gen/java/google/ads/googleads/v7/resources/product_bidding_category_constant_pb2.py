...
from google.ads.googleads.v7.enums import product_bidding_category_status_pb2 as google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_product__bidding__category__status__pb2
...
_PRODUCTBIDDINGCATEGORYCONSTANT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='country_code', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.country_code', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='product_bidding_category_constant_parent', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.product_bidding_category_constant_parent', index=3,
      ...
      serialized_options=b'\340A\003\372A9\n7googleads.googleapis.com/ProductBiddingCategoryConstant', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='level', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.level', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.status', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='language_code', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.language_code', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='localized_name', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant.localized_name', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant._id',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_country_code', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant._country_code',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_product_bidding_category_constant_parent', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant._product_bidding_category_constant_parent',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_language_code', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant._language_code',
      index=3, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_localized_name', full_name='google.ads.googleads.v7.resources.ProductBiddingCategoryConstant._localized_name',
...
_PRODUCTBIDDINGCATEGORYCONSTANT.fields_by_name['level'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_product__bidding__category__level__pb2._PRODUCTBIDDINGCATEGORYLEVELENUM_PRODUCTBIDDINGCATEGORYLEVEL
_PRODUCTBIDDINGCATEGORYCONSTANT.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v7_dot_enums_dot_product__bidding__category__status__pb2._PRODUCTBIDDINGCATEGORYSTATUSENUM_PRODUCTBIDDINGCATEGORYSTATUS
...
ProductBiddingCategoryConstant = _reflection.GeneratedProtocolMessageType('ProductBiddingCategoryConstant', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.resources.product_bidding_category_constant_pb2'
