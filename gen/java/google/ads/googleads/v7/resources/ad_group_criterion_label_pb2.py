...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/resources/ad_group_criterion_label.proto',
...
_ADGROUPCRITERIONLABEL = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.resources.AdGroupCriterionLabel',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.resources.AdGroupCriterionLabel.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group_criterion', full_name='google.ads.googleads.v7.resources.AdGroupCriterionLabel.ad_group_criterion', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='label', full_name='google.ads.googleads.v7.resources.AdGroupCriterionLabel.label', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_ad_group_criterion', full_name='google.ads.googleads.v7.resources.AdGroupCriterionLabel._ad_group_criterion',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_label', full_name='google.ads.googleads.v7.resources.AdGroupCriterionLabel._label',
