...
_MEDIAUPLOADERRORENUM_MEDIAUPLOADERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v7.errors.MediaUploadErrorEnum.MediaUploadError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_UPLOAD_MEDIA_TYPE_THROUGH_API', index=34, number=34,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DIMENSIONS_NOT_ALLOWED', index=35, number=35,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_MEDIAUPLOADERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.errors.MediaUploadErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
MediaUploadErrorEnum = _reflection.GeneratedProtocolMessageType('MediaUploadErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.errors.media_upload_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v7.errors.MediaUploadErrorEnum)
  })
