...
_EXTENSIONFEEDITEMERRORENUM_EXTENSIONFEEDITEMERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v7.errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CUSTOMER_NOT_ON_ALLOWLIST_FOR_CALLTRACKING', index=15, number=47,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CONCRETE_EXTENSION_TYPE_REQUIRED', index=45, number=45,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SCHEDULE_END_NOT_AFTER_START', index=46, number=46,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_EXTENSIONFEEDITEMERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.errors.ExtensionFeedItemErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
ExtensionFeedItemErrorEnum = _reflection.GeneratedProtocolMessageType('ExtensionFeedItemErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.errors.extension_feed_item_error_pb2'
