...
_USERLISTERRORENUM_USERLISTERROR = _descriptor.EnumDescriptor(
  name='UserListError',
  full_name='google.ads.googleads.v7.errors.UserListErrorEnum.UserListError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ADVERTISER_NOT_ON_ALLOWLIST_FOR_USING_UPLOADED_DATA', index=24, number=37,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_USERLISTERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.errors.UserListErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
UserListErrorEnum = _reflection.GeneratedProtocolMessageType('UserListErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v7.errors.user_list_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v7.errors.UserListErrorEnum)
  })
