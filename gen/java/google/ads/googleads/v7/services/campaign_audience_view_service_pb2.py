...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/services/campaign_audience_view_service.proto',
...
_GETCAMPAIGNAUDIENCEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.services.GetCampaignAudienceViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.services.GetCampaignAudienceViewRequest.resource_name', index=0,
...
_CAMPAIGNAUDIENCEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v7.services.CampaignAudienceViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v7.services.CampaignAudienceViewService.GetCampaignAudienceView',
    index=0,
    containing_service=None,
    input_type=_GETCAMPAIGNAUDIENCEVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v7_dot_resources_dot_campaign__audience__view__pb2._CAMPAIGNAUDIENCEVIEW,
    serialized_options=b'\202\323\344\223\0029\0227/v7/{resource_name=customers/*/campaignAudienceViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
