...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/services/shopping_performance_view_service.proto',
...
_GETSHOPPINGPERFORMANCEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.services.GetShoppingPerformanceViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.services.GetShoppingPerformanceViewRequest.resource_name', index=0,
...
_SHOPPINGPERFORMANCEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v7.services.ShoppingPerformanceViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v7.services.ShoppingPerformanceViewService.GetShoppingPerformanceView',
    index=0,
    containing_service=None,
    input_type=_GETSHOPPINGPERFORMANCEVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v7_dot_resources_dot_shopping__performance__view__pb2._SHOPPINGPERFORMANCEVIEW,
    serialized_options=b'\202\323\344\223\0029\0227/v7/{resource_name=customers/*/shoppingPerformanceView}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
