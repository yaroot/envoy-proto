...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v7/services/third_party_app_analytics_link_service.proto',
...
_GETTHIRDPARTYAPPANALYTICSLINKREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.services.GetThirdPartyAppAnalyticsLinkRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.services.GetThirdPartyAppAnalyticsLinkRequest.resource_name', index=0,
...
_REGENERATESHAREABLELINKIDREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.services.RegenerateShareableLinkIdRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v7.services.RegenerateShareableLinkIdRequest.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REGENERATESHAREABLELINKIDRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v7.services.RegenerateShareableLinkIdResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_THIRDPARTYAPPANALYTICSLINKSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v7.services.ThirdPartyAppAnalyticsLinkService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v7.services.ThirdPartyAppAnalyticsLinkService.GetThirdPartyAppAnalyticsLink',
    index=0,
    containing_service=None,
    input_type=_GETTHIRDPARTYAPPANALYTICSLINKREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v7_dot_resources_dot_third__party__app__analytics__link__pb2._THIRDPARTYAPPANALYTICSLINK,
    serialized_options=b'\202\323\344\223\002?\022=/v7/{resource_name=customers/*/thirdPartyAppAnalyticsLinks/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='RegenerateShareableLinkId',
    full_name='google.ads.googleads.v7.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId',
    index=1,
    containing_service=None,
    input_type=_REGENERATESHAREABLELINKIDREQUEST,
    output_type=_REGENERATESHAREABLELINKIDRESPONSE,
    serialized_options=b'\202\323\344\223\002\\\"W/v7/{resource_name=customers/*/thirdPartyAppAnalyticsLinks/*}:regenerateShareableLinkId:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
