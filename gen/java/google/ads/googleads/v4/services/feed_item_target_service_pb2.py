...
_GETFEEDITEMTARGETREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.GetFeedItemTargetRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.services.GetFeedItemTargetRequest.resource_name', index=0,
...
_MUTATEFEEDITEMTARGETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.MutateFeedItemTargetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v4.services.MutateFeedItemTargetsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v4.services.MutateFeedItemTargetsRequest.operations', index=1,
...
_FEEDITEMTARGETOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.FeedItemTargetOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v4.services.FeedItemTargetOperation.create', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v4.services.FeedItemTargetOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v4.services.FeedItemTargetOperation.operation',
...
_MUTATEFEEDITEMTARGETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.MutateFeedItemTargetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v4.services.MutateFeedItemTargetsResponse.results', index=0,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEFEEDITEMTARGETRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.MutateFeedItemTargetResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.services.MutateFeedItemTargetResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEEDITEMTARGETOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_feed__item__target__pb2._FEEDITEMTARGET
...
GetFeedItemTargetRequest = _reflection.GeneratedProtocolMessageType('GetFeedItemTargetRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.feed_item_target_service_pb2'
...
MutateFeedItemTargetResult = _reflection.GeneratedProtocolMessageType('MutateFeedItemTargetResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.feed_item_target_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.services.MutateFeedItemTargetResult)
  })
...
_FEEDITEMTARGETSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v4.services.FeedItemTargetService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v4.services.FeedItemTargetService.GetFeedItemTarget',
    index=0,
    containing_service=None,
    input_type=_GETFEEDITEMTARGETREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_feed__item__target__pb2._FEEDITEMTARGET,
    serialized_options=b'\202\323\344\223\0023\0221/v4/{resource_name=customers/*/feedItemTargets/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateFeedItemTargets',
    full_name='google.ads.googleads.v4.services.FeedItemTargetService.MutateFeedItemTargets',
    index=1,
    containing_service=None,
    input_type=_MUTATEFEEDITEMTARGETSREQUEST,
    output_type=_MUTATEFEEDITEMTARGETSRESPONSE,
    serialized_options=b'\202\323\344\223\0029\"4/v4/customers/{customer_id=*}/feedItemTargets:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
