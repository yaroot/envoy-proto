...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/expanded_landing_page_view_service.proto',
...
GetExpandedLandingPageViewRequest = _reflection.GeneratedProtocolMessageType('GetExpandedLandingPageViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.expanded_landing_page_view_service_pb2'
...
_EXPANDEDLANDINGPAGEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_expanded__landing__page__view__pb2._EXPANDEDLANDINGPAGEVIEW,
    serialized_options=b'\202\323\344\223\002<\022:/v4/{resource_name=customers/*/expandedLandingPageViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
