...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/campaign_service.proto',
...
_CAMPAIGNOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_campaign__pb2._CAMPAIGN
_CAMPAIGNOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_campaign__pb2._CAMPAIGN
...
GetCampaignRequest = _reflection.GeneratedProtocolMessageType('GetCampaignRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.campaign_service_pb2'
...
_CAMPAIGNSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_campaign__pb2._CAMPAIGN,
    serialized_options=b'\202\323\344\223\002-\022+/v4/{resource_name=customers/*/campaigns/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0023\"./v4/customers/{customer_id=*}/campaigns:mutate:\001*\332A\026customer_id,operations',
    create_key=_descriptor._internal_create_key,
  ),
])
