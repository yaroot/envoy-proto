...
from google.ads.googleads.v4.resources import invoice_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_invoice__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/invoice_service.proto',
...
_LISTINVOICESREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.ListInvoicesRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v4.services.ListInvoicesRequest.customer_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='billing_setup', full_name='google.ads.googleads.v4.services.ListInvoicesRequest.billing_setup', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='issue_year', full_name='google.ads.googleads.v4.services.ListInvoicesRequest.issue_year', index=2,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='issue_month', full_name='google.ads.googleads.v4.services.ListInvoicesRequest.issue_month', index=3,
...
_LISTINVOICESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.ListInvoicesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='invoices', full_name='google.ads.googleads.v4.services.ListInvoicesResponse.invoices', index=0,
...
_LISTINVOICESREQUEST.fields_by_name['issue_month'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_month__of__year__pb2._MONTHOFYEARENUM_MONTHOFYEAR
_LISTINVOICESRESPONSE.fields_by_name['invoices'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_invoice__pb2._INVOICE
...
ListInvoicesRequest = _reflection.GeneratedProtocolMessageType('ListInvoicesRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.invoice_service_pb2'
...
ListInvoicesResponse = _reflection.GeneratedProtocolMessageType('ListInvoicesResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.invoice_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.services.ListInvoicesResponse)
  })
...
_INVOICESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListInvoices',
    full_name='google.ads.googleads.v4.services.InvoiceService.ListInvoices',
    index=0,
    containing_service=None,
    input_type=_LISTINVOICESREQUEST,
    output_type=_LISTINVOICESRESPONSE,
    serialized_options=b'\202\323\344\223\002(\022&/v4/customers/{customer_id=*}/invoices\332A0customer_id,billing_setup,issue_year,issue_month',
    create_key=_descriptor._internal_create_key,
  ),
])
