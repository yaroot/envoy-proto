...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/ad_group_audience_view_service.proto',
...
_GETADGROUPAUDIENCEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.services.GetAdGroupAudienceViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.services.GetAdGroupAudienceViewRequest.resource_name', index=0,
...
GetAdGroupAudienceViewRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupAudienceViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.ad_group_audience_view_service_pb2'
...
_ADGROUPAUDIENCEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v4.services.AdGroupAudienceViewService.GetAdGroupAudienceView',
    index=0,
    containing_service=None,
    input_type=_GETADGROUPAUDIENCEVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__group__audience__view__pb2._ADGROUPAUDIENCEVIEW,
    serialized_options=b'\202\323\344\223\0028\0226/v4/{resource_name=customers/*/adGroupAudienceViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
