...
from google.ads.googleads.v4.resources import google_ads_field_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_google__ads__field__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/google_ads_field_service.proto',
...
_SEARCHGOOGLEADSFIELDSRESPONSE.fields_by_name['results'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_google__ads__field__pb2._GOOGLEADSFIELD
...
GetGoogleAdsFieldRequest = _reflection.GeneratedProtocolMessageType('GetGoogleAdsFieldRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.google_ads_field_service_pb2'
...
_GOOGLEADSFIELDSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_google__ads__field__pb2._GOOGLEADSFIELD,
    serialized_options=b'\202\323\344\223\002\'\022%/v4/{resource_name=googleAdsFields/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\037\"\032/v4/googleAdsFields:search:\001*\332A\005query',
    create_key=_descriptor._internal_create_key,
  ),
])
