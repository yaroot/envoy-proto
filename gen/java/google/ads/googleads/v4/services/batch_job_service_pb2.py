...
from google.ads.googleads.v4.services import google_ads_service_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_services_dot_google__ads__service__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/services/batch_job_service.proto',
...
_BATCHJOBOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_batch__job__pb2._BATCHJOB
...
_ADDBATCHJOBOPERATIONSREQUEST.fields_by_name['mutate_operations'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_services_dot_google__ads__service__pb2._MUTATEOPERATION
_LISTBATCHJOBRESULTSRESPONSE.fields_by_name['results'].message_type = _BATCHJOBRESULT
_BATCHJOBRESULT.fields_by_name['mutate_operation_response'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_services_dot_google__ads__service__pb2._MUTATEOPERATIONRESPONSE
...
MutateBatchJobRequest = _reflection.GeneratedProtocolMessageType('MutateBatchJobRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.services.batch_job_service_pb2'
...
_BATCHJOBSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0023\"./v4/customers/{customer_id=*}/batchJobs:mutate:\001*\332A\025customer_id,operation',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetBatchJob',
    ...
    output_type=google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_batch__job__pb2._BATCHJOB,
    serialized_options=b'\202\323\344\223\002-\022+/v4/{resource_name=customers/*/batchJobs/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0029\0227/v4/{resource_name=customers/*/batchJobs/*}:listResults\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='RunBatchJob',
    ...
    serialized_options=b'\202\323\344\223\0024\"//v4/{resource_name=customers/*/batchJobs/*}:run:\001*\332A\rresource_name\312AT\n\025google.protobuf.Empty\022;google.ads.googleads.v4.resources.BatchJob.BatchJobMetadata',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002>\"9/v4/{resource_name=customers/*/batchJobs/*}:addOperations:\001*\332A.resource_name,sequence_token,mutate_operations\332A\037resource_name,mutate_operations',
    create_key=_descriptor._internal_create_key,
  ),
])
