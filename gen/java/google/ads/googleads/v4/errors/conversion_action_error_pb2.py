...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/conversion_action_error.proto',
...
ConversionActionErrorEnum = _reflection.GeneratedProtocolMessageType('ConversionActionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.conversion_action_error_pb2'
