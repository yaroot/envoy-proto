...
_ACCOUNTBUDGETPROPOSALERRORENUM_ACCOUNTBUDGETPROPOSALERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v4.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ACCOUNTBUDGETPROPOSALERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.errors.AccountBudgetProposalErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
AccountBudgetProposalErrorEnum = _reflection.GeneratedProtocolMessageType('AccountBudgetProposalErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.account_budget_proposal_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.errors.AccountBudgetProposalErrorEnum)
  })
