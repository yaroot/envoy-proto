...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/feed_item_error.proto',
...
FeedItemErrorEnum = _reflection.GeneratedProtocolMessageType('FeedItemErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.feed_item_error_pb2'
