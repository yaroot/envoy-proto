...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/errors/batch_job_error.proto',
...
BatchJobErrorEnum = _reflection.GeneratedProtocolMessageType('BatchJobErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.batch_job_error_pb2'
