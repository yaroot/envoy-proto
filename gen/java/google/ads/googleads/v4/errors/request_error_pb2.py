...
_REQUESTERRORENUM_REQUESTERROR = _descriptor.EnumDescriptor(
  name='RequestError',
  full_name='google.ads.googleads.v4.errors.RequestErrorEnum.RequestError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TOTAL_RESULTS_COUNT_NOT_ORIGINALLY_REQUESTED', index=23, number=32,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_REQUESTERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.errors.RequestErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
RequestErrorEnum = _reflection.GeneratedProtocolMessageType('RequestErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.request_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.errors.RequestErrorEnum)
  })
