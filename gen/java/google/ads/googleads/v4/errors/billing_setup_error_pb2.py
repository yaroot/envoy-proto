...
_BILLINGSETUPERRORENUM_BILLINGSETUPERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v4.errors.BillingSetupErrorEnum.BillingSetupError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_BILLINGSETUPERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.errors.BillingSetupErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
BillingSetupErrorEnum = _reflection.GeneratedProtocolMessageType('BillingSetupErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.billing_setup_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.errors.BillingSetupErrorEnum)
  })
