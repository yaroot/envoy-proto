...
_SETTINGERRORENUM_SETTINGERROR = _descriptor.EnumDescriptor(
  name='SettingError',
  full_name='google.ads.googleads.v4.errors.SettingErrorEnum.SettingError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_SETTINGERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.errors.SettingErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
SettingErrorEnum = _reflection.GeneratedProtocolMessageType('SettingErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.setting_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.errors.SettingErrorEnum)
  })
