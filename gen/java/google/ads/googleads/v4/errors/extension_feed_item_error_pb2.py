...
_EXTENSIONFEEDITEMERRORENUM_EXTENSIONFEEDITEMERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v4.errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
ExtensionFeedItemErrorEnum = _reflection.GeneratedProtocolMessageType('ExtensionFeedItemErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.errors.extension_feed_item_error_pb2'
