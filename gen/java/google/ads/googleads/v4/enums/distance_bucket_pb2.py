...
_DISTANCEBUCKETENUM_DISTANCEBUCKET = _descriptor.EnumDescriptor(
  name='DistanceBucket',
  full_name='google.ads.googleads.v4.enums.DistanceBucketEnum.DistanceBucket',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_DISTANCEBUCKETENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.enums.DistanceBucketEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
DistanceBucketEnum = _reflection.GeneratedProtocolMessageType('DistanceBucketEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.enums.distance_bucket_pb2'
