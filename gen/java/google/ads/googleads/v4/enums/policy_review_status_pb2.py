...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/enums/policy_review_status.proto',
...
PolicyReviewStatusEnum = _reflection.GeneratedProtocolMessageType('PolicyReviewStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.enums.policy_review_status_pb2'
