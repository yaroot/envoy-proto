...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/enums/change_status_operation.proto',
...
ChangeStatusOperationEnum = _reflection.GeneratedProtocolMessageType('ChangeStatusOperationEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.enums.change_status_operation_pb2'
