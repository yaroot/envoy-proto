...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/resources/expanded_landing_page_view.proto',
...
ExpandedLandingPageView = _reflection.GeneratedProtocolMessageType('ExpandedLandingPageView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.expanded_landing_page_view_pb2'
