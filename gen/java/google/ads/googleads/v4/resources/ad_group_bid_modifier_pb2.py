...
from google.ads.googleads.v4.enums import bid_modifier_source_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_bid__modifier__source__pb2
...
_ADGROUPBIDMODIFIER = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.AdGroupBidModifier',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.ad_group', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='criterion_id', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.criterion_id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='bid_modifier', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.bid_modifier', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='base_ad_group', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.base_ad_group', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='bid_modifier_source', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.bid_modifier_source', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hotel_date_selection_type', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_date_selection_type', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='hotel_advance_booking_window', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_advance_booking_window', index=7,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hotel_length_of_stay', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_length_of_stay', index=8,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hotel_check_in_day', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_check_in_day', index=9,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='device', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.device', index=10,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='preferred_content', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.preferred_content', index=11,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='criterion', full_name='google.ads.googleads.v4.resources.AdGroupBidModifier.criterion',
...
_ADGROUPBIDMODIFIER.fields_by_name['bid_modifier_source'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_bid__modifier__source__pb2._BIDMODIFIERSOURCEENUM_BIDMODIFIERSOURCE
_ADGROUPBIDMODIFIER.fields_by_name['hotel_date_selection_type'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._HOTELDATESELECTIONTYPEINFO
_ADGROUPBIDMODIFIER.fields_by_name['hotel_advance_booking_window'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._HOTELADVANCEBOOKINGWINDOWINFO
_ADGROUPBIDMODIFIER.fields_by_name['hotel_length_of_stay'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._HOTELLENGTHOFSTAYINFO
_ADGROUPBIDMODIFIER.fields_by_name['hotel_check_in_day'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._HOTELCHECKINDAYINFO
_ADGROUPBIDMODIFIER.fields_by_name['device'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._DEVICEINFO
_ADGROUPBIDMODIFIER.fields_by_name['preferred_content'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._PREFERREDCONTENTINFO
...
AdGroupBidModifier = _reflection.GeneratedProtocolMessageType('AdGroupBidModifier', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.ad_group_bid_modifier_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.resources.AdGroupBidModifier)
  })
