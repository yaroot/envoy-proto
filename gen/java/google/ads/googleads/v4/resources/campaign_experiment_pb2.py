...
from google.ads.googleads.v4.enums import campaign_experiment_status_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_campaign__experiment__status__pb2
from google.ads.googleads.v4.enums import campaign_experiment_traffic_split_type_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_campaign__experiment__traffic__split__type__pb2
...
_CAMPAIGNEXPERIMENT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.CampaignExperiment',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.CampaignExperiment.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v4.resources.CampaignExperiment.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='campaign_draft', full_name='google.ads.googleads.v4.resources.CampaignExperiment.campaign_draft', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v4.resources.CampaignExperiment.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='google.ads.googleads.v4.resources.CampaignExperiment.description', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='traffic_split_percent', full_name='google.ads.googleads.v4.resources.CampaignExperiment.traffic_split_percent', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='traffic_split_type', full_name='google.ads.googleads.v4.resources.CampaignExperiment.traffic_split_type', index=6,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='experiment_campaign', full_name='google.ads.googleads.v4.resources.CampaignExperiment.experiment_campaign', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v4.resources.CampaignExperiment.status', index=8,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='long_running_operation', full_name='google.ads.googleads.v4.resources.CampaignExperiment.long_running_operation', index=9,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_date', full_name='google.ads.googleads.v4.resources.CampaignExperiment.start_date', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date', full_name='google.ads.googleads.v4.resources.CampaignExperiment.end_date', index=11,
...
_CAMPAIGNEXPERIMENT.fields_by_name['traffic_split_type'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_campaign__experiment__traffic__split__type__pb2._CAMPAIGNEXPERIMENTTRAFFICSPLITTYPEENUM_CAMPAIGNEXPERIMENTTRAFFICSPLITTYPE
_CAMPAIGNEXPERIMENT.fields_by_name['experiment_campaign'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_CAMPAIGNEXPERIMENT.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_campaign__experiment__status__pb2._CAMPAIGNEXPERIMENTSTATUSENUM_CAMPAIGNEXPERIMENTSTATUS
...
CampaignExperiment = _reflection.GeneratedProtocolMessageType('CampaignExperiment', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.campaign_experiment_pb2'
