...
from google.ads.googleads.v4.enums import extension_setting_device_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_extension__setting__device__pb2
...
_CUSTOMEREXTENSIONSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.CustomerExtensionSetting',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.CustomerExtensionSetting.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='extension_type', full_name='google.ads.googleads.v4.resources.CustomerExtensionSetting.extension_type', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='extension_feed_items', full_name='google.ads.googleads.v4.resources.CustomerExtensionSetting.extension_feed_items', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='device', full_name='google.ads.googleads.v4.resources.CustomerExtensionSetting.device', index=3,
...
_CUSTOMEREXTENSIONSETTING.fields_by_name['extension_type'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_extension__type__pb2._EXTENSIONTYPEENUM_EXTENSIONTYPE
...
_CUSTOMEREXTENSIONSETTING.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_extension__setting__device__pb2._EXTENSIONSETTINGDEVICEENUM_EXTENSIONSETTINGDEVICE
...
CustomerExtensionSetting = _reflection.GeneratedProtocolMessageType('CustomerExtensionSetting', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.customer_extension_setting_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v4.resources.CustomerExtensionSetting)
  })
