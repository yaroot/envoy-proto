...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/resources/shared_criterion.proto',
...
_SHAREDCRITERION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_criterion__type__pb2._CRITERIONTYPEENUM_CRITERIONTYPE
_SHAREDCRITERION.fields_by_name['keyword'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._KEYWORDINFO
_SHAREDCRITERION.fields_by_name['youtube_video'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._YOUTUBEVIDEOINFO
_SHAREDCRITERION.fields_by_name['youtube_channel'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._YOUTUBECHANNELINFO
_SHAREDCRITERION.fields_by_name['placement'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._PLACEMENTINFO
_SHAREDCRITERION.fields_by_name['mobile_app_category'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._MOBILEAPPCATEGORYINFO
_SHAREDCRITERION.fields_by_name['mobile_application'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._MOBILEAPPLICATIONINFO
...
SharedCriterion = _reflection.GeneratedProtocolMessageType('SharedCriterion', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.shared_criterion_pb2'
