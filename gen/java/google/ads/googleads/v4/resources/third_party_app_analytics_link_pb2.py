...
_THIRDPARTYAPPANALYTICSLINK = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v4.resources.ThirdPartyAppAnalyticsLink',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.ThirdPartyAppAnalyticsLink.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shareable_link_id', full_name='google.ads.googleads.v4.resources.ThirdPartyAppAnalyticsLink.shareable_link_id', index=1,
...
ThirdPartyAppAnalyticsLink = _reflection.GeneratedProtocolMessageType('ThirdPartyAppAnalyticsLink', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.third_party_app_analytics_link_pb2'
