...
from google.ads.googleads.v4.enums import ad_group_ad_status_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_ad__group__ad__status__pb2
from google.ads.googleads.v4.enums import ad_strength_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_ad__strength__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/resources/ad_group_ad.proto',
...
_ADGROUPAD.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_ad__group__ad__status__pb2._ADGROUPADSTATUSENUM_ADGROUPADSTATUS
_ADGROUPAD.fields_by_name['ad_group'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_ADGROUPAD.fields_by_name['ad'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_resources_dot_ad__pb2._AD
_ADGROUPAD.fields_by_name['policy_summary'].message_type = _ADGROUPADPOLICYSUMMARY
_ADGROUPAD.fields_by_name['ad_strength'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_ad__strength__pb2._ADSTRENGTHENUM_ADSTRENGTH
_ADGROUPADPOLICYSUMMARY.fields_by_name['policy_topic_entries'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_policy__pb2._POLICYTOPICENTRY
_ADGROUPADPOLICYSUMMARY.fields_by_name['review_status'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_policy__review__status__pb2._POLICYREVIEWSTATUSENUM_POLICYREVIEWSTATUS
_ADGROUPADPOLICYSUMMARY.fields_by_name['approval_status'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_policy__approval__status__pb2._POLICYAPPROVALSTATUSENUM_POLICYAPPROVALSTATUS
...
AdGroupAd = _reflection.GeneratedProtocolMessageType('AdGroupAd', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.ad_group_ad_pb2'
