...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v4/resources/keyword_plan_ad_group_keyword.proto',
...
_KEYWORDPLANADGROUPKEYWORD.fields_by_name['match_type'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_keyword__match__type__pb2._KEYWORDMATCHTYPEENUM_KEYWORDMATCHTYPE
...
KeywordPlanAdGroupKeyword = _reflection.GeneratedProtocolMessageType('KeywordPlanAdGroupKeyword', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.keyword_plan_ad_group_keyword_pb2'
