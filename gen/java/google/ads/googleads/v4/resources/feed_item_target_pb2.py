...
from google.ads.googleads.v4.enums import feed_item_target_status_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_feed__item__target__status__pb2
from google.ads.googleads.v4.enums import feed_item_target_type_pb2 as google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_feed__item__target__type__pb2
...
_FEEDITEMTARGET = _descriptor.Descriptor(
  name='FeedItemTarget',
  full_name='google.ads.googleads.v4.resources.FeedItemTarget',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v4.resources.FeedItemTarget.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='feed_item', full_name='google.ads.googleads.v4.resources.FeedItemTarget.feed_item', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='feed_item_target_type', full_name='google.ads.googleads.v4.resources.FeedItemTarget.feed_item_target_type', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='feed_item_target_id', full_name='google.ads.googleads.v4.resources.FeedItemTarget.feed_item_target_id', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v4.resources.FeedItemTarget.status', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='campaign', full_name='google.ads.googleads.v4.resources.FeedItemTarget.campaign', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group', full_name='google.ads.googleads.v4.resources.FeedItemTarget.ad_group', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='keyword', full_name='google.ads.googleads.v4.resources.FeedItemTarget.keyword', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='geo_target_constant', full_name='google.ads.googleads.v4.resources.FeedItemTarget.geo_target_constant', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='device', full_name='google.ads.googleads.v4.resources.FeedItemTarget.device', index=9,
      ...
      serialized_options=b'\340A\005', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ad_schedule', full_name='google.ads.googleads.v4.resources.FeedItemTarget.ad_schedule', index=10,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='target', full_name='google.ads.googleads.v4.resources.FeedItemTarget.target',
...
_FEEDITEMTARGET.fields_by_name['feed_item_target_type'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_feed__item__target__type__pb2._FEEDITEMTARGETTYPEENUM_FEEDITEMTARGETTYPE
_FEEDITEMTARGET.fields_by_name['feed_item_target_id'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_FEEDITEMTARGET.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_feed__item__target__status__pb2._FEEDITEMTARGETSTATUSENUM_FEEDITEMTARGETSTATUS
...
_FEEDITEMTARGET.fields_by_name['keyword'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._KEYWORDINFO
_FEEDITEMTARGET.fields_by_name['geo_target_constant'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_FEEDITEMTARGET.fields_by_name['device'].enum_type = google_dot_ads_dot_googleads_dot_v4_dot_enums_dot_feed__item__target__device__pb2._FEEDITEMTARGETDEVICEENUM_FEEDITEMTARGETDEVICE
_FEEDITEMTARGET.fields_by_name['ad_schedule'].message_type = google_dot_ads_dot_googleads_dot_v4_dot_common_dot_criteria__pb2._ADSCHEDULEINFO
...
FeedItemTarget = _reflection.GeneratedProtocolMessageType('FeedItemTarget', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v4.resources.feed_item_target_pb2'
