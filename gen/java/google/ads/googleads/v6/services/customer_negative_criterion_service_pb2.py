...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v6/services/customer_negative_criterion_service.proto',
...
_MUTATECUSTOMERNEGATIVECRITERIAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='response_content_type', full_name='google.ads.googleads.v6.services.MutateCustomerNegativeCriteriaRequest.response_content_type', index=4,
...
_MUTATECUSTOMERNEGATIVECRITERIARESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='customer_negative_criterion', full_name='google.ads.googleads.v6.services.MutateCustomerNegativeCriteriaResult.customer_negative_criterion', index=1,
...
_MUTATECUSTOMERNEGATIVECRITERIAREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads_dot_v6_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
_CUSTOMERNEGATIVECRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v6_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION
...
_MUTATECUSTOMERNEGATIVECRITERIARESULT.fields_by_name['customer_negative_criterion'].message_type = google_dot_ads_dot_googleads_dot_v6_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION
...
GetCustomerNegativeCriterionRequest = _reflection.GeneratedProtocolMessageType('GetCustomerNegativeCriterionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.services.customer_negative_criterion_service_pb2'
...
_CUSTOMERNEGATIVECRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v6_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION,
