...
from google.ads.googleads.v6.enums import campaign_shared_set_status_pb2 as google_dot_ads_dot_googleads_dot_v6_dot_enums_dot_campaign__shared__set__status__pb2
...
_CAMPAIGNSHAREDSET = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.resources.CampaignSharedSet',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v6.resources.CampaignSharedSet.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='campaign', full_name='google.ads.googleads.v6.resources.CampaignSharedSet.campaign', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='shared_set', full_name='google.ads.googleads.v6.resources.CampaignSharedSet.shared_set', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v6.resources.CampaignSharedSet.status', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_campaign', full_name='google.ads.googleads.v6.resources.CampaignSharedSet._campaign',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_shared_set', full_name='google.ads.googleads.v6.resources.CampaignSharedSet._shared_set',
...
_CAMPAIGNSHAREDSET.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v6_dot_enums_dot_campaign__shared__set__status__pb2._CAMPAIGNSHAREDSETSTATUSENUM_CAMPAIGNSHAREDSETSTATUS
...
CampaignSharedSet = _reflection.GeneratedProtocolMessageType('CampaignSharedSet', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.resources.campaign_shared_set_pb2'
