...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v6/enums/keyword_plan_competition_level.proto',
...
KeywordPlanCompetitionLevelEnum = _reflection.GeneratedProtocolMessageType('KeywordPlanCompetitionLevelEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.enums.keyword_plan_competition_level_pb2'
