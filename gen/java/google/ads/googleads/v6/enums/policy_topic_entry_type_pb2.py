...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v6/enums/policy_topic_entry_type.proto',
...
PolicyTopicEntryTypeEnum = _reflection.GeneratedProtocolMessageType('PolicyTopicEntryTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.enums.policy_topic_entry_type_pb2'
