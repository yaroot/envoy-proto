...
_ACCOUNTBUDGETPROPOSALERRORENUM_ACCOUNTBUDGETPROPOSALERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v6.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_CREATE_BUDGET_THROUGH_API', index=25, number=25,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_ACCOUNTBUDGETPROPOSALERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.errors.AccountBudgetProposalErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
AccountBudgetProposalErrorEnum = _reflection.GeneratedProtocolMessageType('AccountBudgetProposalErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.account_budget_proposal_error_pb2'
