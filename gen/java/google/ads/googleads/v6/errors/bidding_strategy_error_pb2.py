...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v6/errors/bidding_strategy_error.proto',
...
BiddingStrategyErrorEnum = _reflection.GeneratedProtocolMessageType('BiddingStrategyErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.bidding_strategy_error_pb2'
