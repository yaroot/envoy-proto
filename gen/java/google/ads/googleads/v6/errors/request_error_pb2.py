...
_REQUESTERRORENUM_REQUESTERROR = _descriptor.EnumDescriptor(
  name='RequestError',
  full_name='google.ads.googleads.v6.errors.RequestErrorEnum.RequestError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_REQUESTERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.errors.RequestErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
RequestErrorEnum = _reflection.GeneratedProtocolMessageType('RequestErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.request_error_pb2'
