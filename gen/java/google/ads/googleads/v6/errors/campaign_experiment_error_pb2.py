...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v6/errors/campaign_experiment_error.proto',
...
CampaignExperimentErrorEnum = _reflection.GeneratedProtocolMessageType('CampaignExperimentErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.campaign_experiment_error_pb2'
