...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v6/errors/mutate_error.proto',
...
MutateErrorEnum = _reflection.GeneratedProtocolMessageType('MutateErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.mutate_error_pb2'
