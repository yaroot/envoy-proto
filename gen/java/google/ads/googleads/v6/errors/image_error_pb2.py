...
_IMAGEERRORENUM_IMAGEERROR = _descriptor.EnumDescriptor(
  name='ImageError',
  full_name='google.ads.googleads.v6.errors.ImageErrorEnum.ImageError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='IMAGE_CONSTRAINTS_VIOLATED', index=39, number=39,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FORMAT_NOT_ALLOWED', index=40, number=40,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_IMAGEERRORENUM = _descriptor.Descriptor(
  name='ImageErrorEnum',
  full_name='google.ads.googleads.v6.errors.ImageErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
ImageErrorEnum = _reflection.GeneratedProtocolMessageType('ImageErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.image_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v6.errors.ImageErrorEnum)
  })
