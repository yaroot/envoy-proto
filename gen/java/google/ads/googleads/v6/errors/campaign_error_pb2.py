...
_CAMPAIGNERRORENUM_CAMPAIGNERROR = _descriptor.EnumDescriptor(
  name='CampaignError',
  full_name='google.ads.googleads.v6.errors.CampaignErrorEnum.CampaignError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CAMPAIGNERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v6.errors.CampaignErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
CampaignErrorEnum = _reflection.GeneratedProtocolMessageType('CampaignErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v6.errors.campaign_error_pb2'
