...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/income_range_view.proto',
...
_INCOMERANGEVIEW = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.IncomeRangeView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.IncomeRangeView.resource_name', index=0,
