...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/ad_schedule_view.proto',
...
_ADSCHEDULEVIEW = _descriptor.Descriptor(
  name='AdScheduleView',
  full_name='google.ads.googleads.v8.resources.AdScheduleView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.AdScheduleView.resource_name', index=0,
