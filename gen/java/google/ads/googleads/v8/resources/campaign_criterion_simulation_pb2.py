...
_CAMPAIGNCRITERIONSIMULATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='campaign_id', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.campaign_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='criterion_id', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.criterion_id', index=2,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.type', index=3,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='modification_method', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.modification_method', index=4,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_date', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.start_date', index=5,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.end_date', index=6,
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bid_modifier_point_list', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.bid_modifier_point_list', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='point_list', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation.point_list',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_campaign_id', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation._campaign_id',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_criterion_id', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation._criterion_id',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_start_date', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation._start_date',
      index=3, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_end_date', full_name='google.ads.googleads.v8.resources.CampaignCriterionSimulation._end_date',
...
_CAMPAIGNCRITERIONSIMULATION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_simulation__type__pb2._SIMULATIONTYPEENUM_SIMULATIONTYPE
_CAMPAIGNCRITERIONSIMULATION.fields_by_name['modification_method'].enum_type = google_dot_ads_dot_googleads_dot_v8_dot_enums_dot_simulation__modification__method__pb2._SIMULATIONMODIFICATIONMETHODENUM_SIMULATIONMODIFICATIONMETHOD
_CAMPAIGNCRITERIONSIMULATION.fields_by_name['bid_modifier_point_list'].message_type = google_dot_ads_dot_googleads_dot_v8_dot_common_dot_simulation__pb2._BIDMODIFIERSIMULATIONPOINTLIST
...
CampaignCriterionSimulation = _reflection.GeneratedProtocolMessageType('CampaignCriterionSimulation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v8.resources.campaign_criterion_simulation_pb2'
