...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/ad_parameter.proto',
...
_ADPARAMETER = _descriptor.Descriptor(
  name='AdParameter',
  full_name='google.ads.googleads.v8.resources.AdParameter',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.AdParameter.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group_criterion', full_name='google.ads.googleads.v8.resources.AdParameter.ad_group_criterion', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='parameter_index', full_name='google.ads.googleads.v8.resources.AdParameter.parameter_index', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='insertion_text', full_name='google.ads.googleads.v8.resources.AdParameter.insertion_text', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_ad_group_criterion', full_name='google.ads.googleads.v8.resources.AdParameter._ad_group_criterion',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_parameter_index', full_name='google.ads.googleads.v8.resources.AdParameter._parameter_index',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_insertion_text', full_name='google.ads.googleads.v8.resources.AdParameter._insertion_text',
