...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/resources/campaign_bid_modifier.proto',
...
_CAMPAIGNBIDMODIFIER = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.resources.CampaignBidModifier',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.resources.CampaignBidModifier.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='campaign', full_name='google.ads.googleads.v8.resources.CampaignBidModifier.campaign', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='criterion_id', full_name='google.ads.googleads.v8.resources.CampaignBidModifier.criterion_id', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='bid_modifier', full_name='google.ads.googleads.v8.resources.CampaignBidModifier.bid_modifier', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='interaction_type', full_name='google.ads.googleads.v8.resources.CampaignBidModifier.interaction_type', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='criterion', full_name='google.ads.googleads.v8.resources.CampaignBidModifier.criterion',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_campaign', full_name='google.ads.googleads.v8.resources.CampaignBidModifier._campaign',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_criterion_id', full_name='google.ads.googleads.v8.resources.CampaignBidModifier._criterion_id',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_bid_modifier', full_name='google.ads.googleads.v8.resources.CampaignBidModifier._bid_modifier',
...
_CAMPAIGNBIDMODIFIER.fields_by_name['interaction_type'].message_type = google_dot_ads_dot_googleads_dot_v8_dot_common_dot_criteria__pb2._INTERACTIONTYPEINFO
