...
_RECOMMENDATIONTYPEENUM_RECOMMENDATIONTYPE = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v8.enums.RecommendationTypeEnum.RecommendationType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FORECASTING_CAMPAIGN_BUDGET', index=16, number=16,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TARGET_ROAS_OPT_IN', index=17, number=17,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='RESPONSIVE_SEARCH_AD', index=18, number=18,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MARGINAL_ROI_CAMPAIGN_BUDGET', index=19, number=19,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_RECOMMENDATIONTYPEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.enums.RecommendationTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
RecommendationTypeEnum = _reflection.GeneratedProtocolMessageType('RecommendationTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v8.enums.recommendation_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v8.enums.RecommendationTypeEnum)
  })
