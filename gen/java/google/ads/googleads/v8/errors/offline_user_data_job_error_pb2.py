...
_OFFLINEUSERDATAJOBERRORENUM_OFFLINEUSERDATAJOBERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v8.errors.OfflineUserDataJobErrorEnum.OfflineUserDataJobError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FUTURE_TIME_NOT_ALLOWED', index=32, number=37,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LAST_PURCHASE_TIME_LESS_THAN_ACQUISITION_TIME', index=33, number=38,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_OFFLINEUSERDATAJOBERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.errors.OfflineUserDataJobErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
OfflineUserDataJobErrorEnum = _reflection.GeneratedProtocolMessageType('OfflineUserDataJobErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v8.errors.offline_user_data_job_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v8.errors.OfflineUserDataJobErrorEnum)
  })
