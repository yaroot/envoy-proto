...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/services/landing_page_view_service.proto',
...
_GETLANDINGPAGEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.services.GetLandingPageViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.services.GetLandingPageViewRequest.resource_name', index=0,
...
_LANDINGPAGEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v8.services.LandingPageViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v8.services.LandingPageViewService.GetLandingPageView',
    index=0,
    containing_service=None,
    input_type=_GETLANDINGPAGEVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v8_dot_resources_dot_landing__page__view__pb2._LANDINGPAGEVIEW,
    serialized_options=b'\202\323\344\223\0024\0222/v8/{resource_name=customers/*/landingPageViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
