...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v8/services/ad_schedule_view_service.proto',
...
_GETADSCHEDULEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v8.services.GetAdScheduleViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v8.services.GetAdScheduleViewRequest.resource_name', index=0,
...
_ADSCHEDULEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v8.services.AdScheduleViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v8.services.AdScheduleViewService.GetAdScheduleView',
    index=0,
    containing_service=None,
    input_type=_GETADSCHEDULEVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v8_dot_resources_dot_ad__schedule__view__pb2._ADSCHEDULEVIEW,
    serialized_options=b'\202\323\344\223\0023\0221/v8/{resource_name=customers/*/adScheduleViews/*}\332A\rresource_name',
    create_key=_descriptor._internal_create_key,
  ),
])
