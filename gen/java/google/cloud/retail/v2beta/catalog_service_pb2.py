...
_SETDEFAULTBRANCHREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2beta.SetDefaultBranchRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='catalog', full_name='google.cloud.retail.v2beta.SetDefaultBranchRequest.catalog', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='branch_id', full_name='google.cloud.retail.v2beta.SetDefaultBranchRequest.branch_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='note', full_name='google.cloud.retail.v2beta.SetDefaultBranchRequest.note', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETDEFAULTBRANCHREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2beta.GetDefaultBranchRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='catalog', full_name='google.cloud.retail.v2beta.GetDefaultBranchRequest.catalog', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETDEFAULTBRANCHRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.retail.v2beta.GetDefaultBranchResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='branch', full_name='google.cloud.retail.v2beta.GetDefaultBranchResponse.branch', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\372A\036\n\034retail.googleapis.com/Branch', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='set_time', full_name='google.cloud.retail.v2beta.GetDefaultBranchResponse.set_time', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='note', full_name='google.cloud.retail.v2beta.GetDefaultBranchResponse.note', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CATALOGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.cloud.retail.v2beta.CatalogService.SetDefaultBranch',
    index=2,
    containing_service=None,
    input_type=_SETDEFAULTBRANCHREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\202\323\344\223\002I\"D/v2beta/{catalog=projects/*/locations/*/catalogs/*}:setDefaultBranch:\001*\332A\007catalog',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetDefaultBranch',
    full_name='google.cloud.retail.v2beta.CatalogService.GetDefaultBranch',
    index=3,
    containing_service=None,
    input_type=_GETDEFAULTBRANCHREQUEST,
    output_type=_GETDEFAULTBRANCHRESPONSE,
    serialized_options=b'\202\323\344\223\002F\022D/v2beta/{catalog=projects/*/locations/*/catalogs/*}:getDefaultBranch\332A\007catalog',
    create_key=_descriptor._internal_create_key,
  ),
])
