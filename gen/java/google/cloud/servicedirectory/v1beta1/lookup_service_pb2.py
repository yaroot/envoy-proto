...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/servicedirectory/v1beta1/lookup_service.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_cloud_dot_servicedirectory_dot_v1beta1_dot_service__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,])
...
_RESOLVESERVICEREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.servicedirectory.v1beta1.ResolveServiceRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.servicedirectory.v1beta1.ResolveServiceRequest.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max_endpoints', full_name='google.cloud.servicedirectory.v1beta1.ResolveServiceRequest.max_endpoints', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='endpoint_filter', full_name='google.cloud.servicedirectory.v1beta1.ResolveServiceRequest.endpoint_filter', index=2,
...
_RESOLVESERVICERESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.servicedirectory.v1beta1.ResolveServiceResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='google.cloud.servicedirectory.v1beta1.ResolveServiceResponse.service', index=0,
...
_RESOLVESERVICERESPONSE.fields_by_name['service'].message_type = google_dot_cloud_dot_servicedirectory_dot_v1beta1_dot_service__pb2._SERVICE
...
_LOOKUPSERVICE = _descriptor.ServiceDescriptor(
  name='LookupService',
  full_name='google.cloud.servicedirectory.v1beta1.LookupService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='ResolveService',
    full_name='google.cloud.servicedirectory.v1beta1.LookupService.ResolveService',
    index=0,
    containing_service=None,
    input_type=_RESOLVESERVICEREQUEST,
    output_type=_RESOLVESERVICERESPONSE,
    serialized_options=b'\202\323\344\223\002K\"F/v1beta1/{name=projects/*/locations/*/namespaces/*/services/*}:resolve:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
