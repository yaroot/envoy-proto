...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/bigquery/storage/v1/avro.proto',
...
_AVROSCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='schema', full_name='google.cloud.bigquery.storage.v1.AvroSchema.schema', index=0,
...
_AVROROWS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='serialized_binary_rows', full_name='google.cloud.bigquery.storage.v1.AvroRows.serialized_binary_rows', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='row_count', full_name='google.cloud.bigquery.storage.v1.AvroRows.row_count', index=1,
