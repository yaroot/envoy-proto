...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/bigquery/storage/v1beta2/avro.proto',
...
_AVROSCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='schema', full_name='google.cloud.bigquery.storage.v1beta2.AvroSchema.schema', index=0,
...
_AVROROWS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='serialized_binary_rows', full_name='google.cloud.bigquery.storage.v1beta2.AvroRows.serialized_binary_rows', index=0,
