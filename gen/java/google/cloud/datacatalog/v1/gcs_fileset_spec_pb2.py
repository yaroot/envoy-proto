...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/datacatalog/v1/gcs_fileset_spec.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_cloud_dot_datacatalog_dot_v1_dot_timestamps__pb2.DESCRIPTOR,])
...
_GCSFILESPEC.fields_by_name['gcs_timestamps'].message_type = google_dot_cloud_dot_datacatalog_dot_v1_dot_timestamps__pb2._SYSTEMTIMESTAMPS
