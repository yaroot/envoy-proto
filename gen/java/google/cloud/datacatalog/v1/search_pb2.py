...
_SEARCHCATALOGRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='integrated_system', full_name='google.cloud.datacatalog.v1.SearchCatalogResult.integrated_system', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='user_specified_system', full_name='google.cloud.datacatalog.v1.SearchCatalogResult.user_specified_system', index=5,
