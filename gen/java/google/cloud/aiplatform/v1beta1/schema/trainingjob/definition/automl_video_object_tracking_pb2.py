...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/aiplatform/v1beta1/schema/trainingjob/definition/automl_video_object_tracking.proto',
  package='google.cloud.aiplatform.v1beta1.schema.trainingjob.definition',
  syntax='proto3',
  serialized_options=b'\nAcom.google.cloud.aiplatform.v1beta1.schema.trainingjob.definitionB\036AutoMLVideoObjectTrackingProtoP\001Zggoogle.golang.org/genproto/googleapis/cloud/aiplatform/v1beta1/schema/trainingjob/definition;definition',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n`google/cloud/aiplatform/v1beta1/schema/trainingjob/definition/automl_video_object_tracking.proto\x12=google.cloud.aiplatform.v1beta1.schema.trainingjob.definition\x1a\x1cgoogle/api/annotations.proto\"\x8b\x01\n\x19\x41utoMlVideoObjectTracking\x12n\n\x06inputs\x18\x01 \x01(\x0b\x32^.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoObjectTrackingInputs\"\xea\x02\n\x1f\x41utoMlVideoObjectTrackingInputs\x12|\n\nmodel_type\x18\x01 \x01(\x0e\x32h.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoObjectTrackingInputs.ModelType\"\xc8\x01\n\tModelType\x12\x1a\n\x16MODEL_TYPE_UNSPECIFIED\x10\x00\x12\t\n\x05\x43LOUD\x10\x01\x12\x16\n\x12MOBILE_VERSATILE_1\x10\x02\x12\x1c\n\x18MOBILE_CORAL_VERSATILE_1\x10\x03\x12\x1e\n\x1aMOBILE_CORAL_LOW_LATENCY_1\x10\x04\x12\x1d\n\x19MOBILE_JETSON_VERSATILE_1\x10\x05\x12\x1f\n\x1bMOBILE_JETSON_LOW_LATENCY_1\x10\x06\x42\xce\x01\nAcom.google.cloud.aiplatform.v1beta1.schema.trainingjob.definitionB\x1e\x41utoMLVideoObjectTrackingProtoP\x01Zggoogle.golang.org/genproto/googleapis/cloud/aiplatform/v1beta1/schema/trainingjob/definition;definitionb\x06proto3'
  ,
...
_AUTOMLVIDEOOBJECTTRACKINGINPUTS_MODELTYPE = _descriptor.EnumDescriptor(
  name='ModelType',
  full_name='google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoObjectTrackingInputs.ModelType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_AUTOMLVIDEOOBJECTTRACKING = _descriptor.Descriptor(
  ...
  full_name='google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoObjectTracking',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='inputs', full_name='google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoObjectTracking.inputs', index=0,
...
_AUTOMLVIDEOOBJECTTRACKINGINPUTS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoObjectTrackingInputs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='model_type', full_name='google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoObjectTrackingInputs.model_type', index=0,
...
AutoMlVideoObjectTracking = _reflection.GeneratedProtocolMessageType('AutoMlVideoObjectTracking', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.automl_video_object_tracking_pb2'
