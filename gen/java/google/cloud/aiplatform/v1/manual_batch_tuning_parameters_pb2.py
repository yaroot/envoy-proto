...
_MANUALBATCHTUNINGPARAMETERS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.aiplatform.v1.ManualBatchTuningParameters',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='google.cloud.aiplatform.v1.ManualBatchTuningParameters.batch_size', index=0,
