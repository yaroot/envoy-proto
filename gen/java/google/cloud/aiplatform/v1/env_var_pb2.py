...
_ENVVAR = _descriptor.Descriptor(
  name='EnvVar',
  full_name='google.cloud.aiplatform.v1.EnvVar',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.aiplatform.v1.EnvVar.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.aiplatform.v1.EnvVar.value', index=1,
