...
_QUEUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stackdriver_logging_config', full_name='google.cloud.tasks.v2.Queue.stackdriver_logging_config', index=6,
...
_STACKDRIVERLOGGINGCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sampling_ratio', full_name='google.cloud.tasks.v2.StackdriverLoggingConfig.sampling_ratio', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
