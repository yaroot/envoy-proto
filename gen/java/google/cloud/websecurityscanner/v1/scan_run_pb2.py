...
_SCANRUN_RESULTSTATE = _descriptor.EnumDescriptor(
  name='ResultState',
  full_name='google.cloud.websecurityscanner.v1.ScanRun.ResultState',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_SCANRUN = _descriptor.Descriptor(
  name='ScanRun',
  full_name='google.cloud.websecurityscanner.v1.ScanRun',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.websecurityscanner.v1.ScanRun.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='execution_state', full_name='google.cloud.websecurityscanner.v1.ScanRun.execution_state', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='result_state', full_name='google.cloud.websecurityscanner.v1.ScanRun.result_state', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='google.cloud.websecurityscanner.v1.ScanRun.start_time', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.cloud.websecurityscanner.v1.ScanRun.end_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='urls_crawled_count', full_name='google.cloud.websecurityscanner.v1.ScanRun.urls_crawled_count', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='urls_tested_count', full_name='google.cloud.websecurityscanner.v1.ScanRun.urls_tested_count', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='has_vulnerabilities', full_name='google.cloud.websecurityscanner.v1.ScanRun.has_vulnerabilities', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='progress_percent', full_name='google.cloud.websecurityscanner.v1.ScanRun.progress_percent', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error_trace', full_name='google.cloud.websecurityscanner.v1.ScanRun.error_trace', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='warning_traces', full_name='google.cloud.websecurityscanner.v1.ScanRun.warning_traces', index=10,
...
_SCANRUN.fields_by_name['error_trace'].message_type = google_dot_cloud_dot_websecurityscanner_dot_v1_dot_scan__run__error__trace__pb2._SCANRUNERRORTRACE
_SCANRUN.fields_by_name['warning_traces'].message_type = google_dot_cloud_dot_websecurityscanner_dot_v1_dot_scan__run__warning__trace__pb2._SCANRUNWARNINGTRACE
