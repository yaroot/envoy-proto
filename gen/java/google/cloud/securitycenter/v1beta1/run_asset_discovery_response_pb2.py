...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1beta1/run_asset_discovery_response.proto',
...
_RUNASSETDISCOVERYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.state', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='duration', full_name='google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.duration', index=1,
