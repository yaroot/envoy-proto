...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1/notification_message.proto',
...
_NOTIFICATIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='notification_config_name', full_name='google.cloud.securitycenter.v1.NotificationMessage.notification_config_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='finding', full_name='google.cloud.securitycenter.v1.NotificationMessage.finding', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resource', full_name='google.cloud.securitycenter.v1.NotificationMessage.resource', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='event', full_name='google.cloud.securitycenter.v1.NotificationMessage.event',
...
_NOTIFICATIONMESSAGE.fields_by_name['finding'].message_type = google_dot_cloud_dot_securitycenter_dot_v1_dot_finding__pb2._FINDING
_NOTIFICATIONMESSAGE.fields_by_name['resource'].message_type = google_dot_cloud_dot_securitycenter_dot_v1_dot_resource__pb2._RESOURCE
