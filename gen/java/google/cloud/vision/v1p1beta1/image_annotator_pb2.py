...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_cloud_dot_vision_dot_v1p1beta1_dot_geometry__pb2.DESCRIPTOR,google_dot_cloud_dot_vision_dot_v1p1beta1_dot_text__annotation__pb2.DESCRIPTOR,google_dot_cloud_dot_vision_dot_v1p1beta1_dot_web__detection__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,google_dot_type_dot_color__pb2.DESCRIPTOR,google_dot_type_dot_latlng__pb2.DESCRIPTOR,])
...
_TEXTDETECTIONPARAMS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p1beta1.TextDetectionParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='enable_text_detection_confidence_score', full_name='google.cloud.vision.v1p1beta1.TextDetectionParams.enable_text_detection_confidence_score', index=0,
...
_IMAGECONTEXT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='text_detection_params', full_name='google.cloud.vision.v1p1beta1.ImageContext.text_detection_params', index=4,
...
TextDetectionParams = _reflection.GeneratedProtocolMessageType('TextDetectionParams', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.vision.v1p1beta1.image_annotator_pb2'
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p1beta1.TextDetectionParams)
  })
