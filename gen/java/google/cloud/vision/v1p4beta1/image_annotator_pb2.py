...
_TEXTDETECTIONPARAMS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p4beta1.TextDetectionParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='enable_text_detection_confidence_score', full_name='google.cloud.vision.v1p4beta1.TextDetectionParams.enable_text_detection_confidence_score', index=0,
...
_IMAGECONTEXT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='text_detection_params', full_name='google.cloud.vision.v1p4beta1.ImageContext.text_detection_params', index=6,
