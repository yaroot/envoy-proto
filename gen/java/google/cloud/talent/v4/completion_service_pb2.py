...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/talent/v4/completion_service.proto',
...
_COMPLETEQUERYREQUEST_COMPLETIONTYPE = _descriptor.EnumDescriptor(
  name='CompletionType',
  full_name='google.cloud.talent.v4.CompleteQueryRequest.CompletionType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_COMPLETEQUERYREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.talent.v4.CompleteQueryRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='tenant', full_name='google.cloud.talent.v4.CompleteQueryRequest.tenant', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='query', full_name='google.cloud.talent.v4.CompleteQueryRequest.query', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='language_codes', full_name='google.cloud.talent.v4.CompleteQueryRequest.language_codes', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.talent.v4.CompleteQueryRequest.page_size', index=3,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='company', full_name='google.cloud.talent.v4.CompleteQueryRequest.company', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='scope', full_name='google.cloud.talent.v4.CompleteQueryRequest.scope', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.talent.v4.CompleteQueryRequest.type', index=6,
...
_COMPLETEQUERYRESPONSE_COMPLETIONRESULT = _descriptor.Descriptor(
  ...
  full_name='google.cloud.talent.v4.CompleteQueryResponse.CompletionResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='suggestion', full_name='google.cloud.talent.v4.CompleteQueryResponse.CompletionResult.suggestion', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.talent.v4.CompleteQueryResponse.CompletionResult.type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='image_uri', full_name='google.cloud.talent.v4.CompleteQueryResponse.CompletionResult.image_uri', index=2,
...
_COMPLETEQUERYRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.talent.v4.CompleteQueryResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='completion_results', full_name='google.cloud.talent.v4.CompleteQueryResponse.completion_results', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='google.cloud.talent.v4.CompleteQueryResponse.metadata', index=1,
...
_COMPLETEQUERYRESPONSE.fields_by_name['metadata'].message_type = google_dot_cloud_dot_talent_dot_v4_dot_common__pb2._RESPONSEMETADATA
...
_COMPLETION = _descriptor.ServiceDescriptor(
  name='Completion',
  full_name='google.cloud.talent.v4.Completion',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='CompleteQuery',
    full_name='google.cloud.talent.v4.Completion.CompleteQuery',
    index=0,
    containing_service=None,
    input_type=_COMPLETEQUERYREQUEST,
    output_type=_COMPLETEQUERYRESPONSE,
    serialized_options=b'\202\323\344\223\0021\022//v4/{tenant=projects/*/tenants/*}:completeQuery',
    create_key=_descriptor._internal_create_key,
  ),
])
