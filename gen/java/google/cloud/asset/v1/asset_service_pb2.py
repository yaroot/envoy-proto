...
_CONTENTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='OS_INVENTORY', index=5, number=6,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='RELATIONSHIP', index=6, number=7,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_PARTITIONSPEC_PARTITIONKEY = _descriptor.EnumDescriptor(
  name='PartitionKey',
  full_name='google.cloud.asset.v1.PartitionSpec.PartitionKey',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ANALYZEMOVEREQUEST_ANALYSISVIEW = _descriptor.EnumDescriptor(
  name='AnalysisView',
  full_name='google.cloud.asset.v1.AnalyzeMoveRequest.AnalysisView',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='ANALYSIS_VIEW_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_ANALYZEMOVEREQUEST_ANALYSISVIEW)


_ANALYZEIAMPOLICYLONGRUNNINGMETADATA = _descriptor.Descriptor(
  name='AnalyzeIamPolicyLongrunningMetadata',
  full_name='google.cloud.asset.v1.AnalyzeIamPolicyLongrunningMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.asset.v1.AnalyzeIamPolicyLongrunningMetadata.create_time', index=0,
...
_EXPORTASSETSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='relationship_types', full_name='google.cloud.asset.v1.ExportAssetsRequest.relationship_types', index=5,
...
_LISTASSETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.asset.v1.ListAssetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.asset.v1.ListAssetsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A!\022\037cloudasset.googleapis.com/Asset', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_time', full_name='google.cloud.asset.v1.ListAssetsRequest.read_time', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='asset_types', full_name='google.cloud.asset.v1.ListAssetsRequest.asset_types', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='content_type', full_name='google.cloud.asset.v1.ListAssetsRequest.content_type', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.asset.v1.ListAssetsRequest.page_size', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.cloud.asset.v1.ListAssetsRequest.page_token', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='relationship_types', full_name='google.cloud.asset.v1.ListAssetsRequest.relationship_types', index=6,
...
_LISTASSETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.asset.v1.ListAssetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='read_time', full_name='google.cloud.asset.v1.ListAssetsResponse.read_time', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='assets', full_name='google.cloud.asset.v1.ListAssetsResponse.assets', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.cloud.asset.v1.ListAssetsResponse.next_page_token', index=2,
...
_BATCHGETASSETSHISTORYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='relationship_types', full_name='google.cloud.asset.v1.BatchGetAssetsHistoryRequest.relationship_types', index=4,
...
_BIGQUERYDESTINATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partition_spec', full_name='google.cloud.asset.v1.BigQueryDestination.partition_spec', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='separate_tables_per_asset_type', full_name='google.cloud.asset.v1.BigQueryDestination.separate_tables_per_asset_type', index=4,
...
_PARTITIONSPEC = _descriptor.Descriptor(
  name='PartitionSpec',
  full_name='google.cloud.asset.v1.PartitionSpec',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partition_key', full_name='google.cloud.asset.v1.PartitionSpec.partition_key', index=0,
...
_FEED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='relationship_types', full_name='google.cloud.asset.v1.Feed.relationship_types', index=6,
      number=7, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHALLRESOURCESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_mask', full_name='google.cloud.asset.v1.SearchAllResourcesRequest.read_mask', index=6,
...
_SEARCHALLIAMPOLICIESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='asset_types', full_name='google.cloud.asset.v1.SearchAllIamPoliciesRequest.asset_types', index=4,
      number=5, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='order_by', full_name='google.cloud.asset.v1.SearchAllIamPoliciesRequest.order_by', index=5,
...
_IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT = _descriptor.Descriptor(
  name='ConditionContext',
  full_name='google.cloud.asset.v1.IamPolicyAnalysisQuery.ConditionContext',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='access_time', full_name='google.cloud.asset.v1.IamPolicyAnalysisQuery.ConditionContext.access_time', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='TimeContext', full_name='google.cloud.asset.v1.IamPolicyAnalysisQuery.ConditionContext.TimeContext',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_IAMPOLICYANALYSISQUERY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='condition_context', full_name='google.cloud.asset.v1.IamPolicyAnalysisQuery.condition_context', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_IAMPOLICYANALYSISQUERY_RESOURCESELECTOR, _IAMPOLICYANALYSISQUERY_IDENTITYSELECTOR, _IAMPOLICYANALYSISQUERY_ACCESSSELECTOR, _IAMPOLICYANALYSISQUERY_OPTIONS, _IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_ANALYZEIAMPOLICYRESPONSE_IAMPOLICYANALYSIS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='non_critical_errors', full_name='google.cloud.asset.v1.AnalyzeIamPolicyResponse.IamPolicyAnalysis.non_critical_errors', index=3,
...
_IAMPOLICYANALYSISOUTPUTCONFIG_BIGQUERYDESTINATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='write_disposition', full_name='google.cloud.asset.v1.IamPolicyAnalysisOutputConfig.BigQueryDestination.write_disposition', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ANALYZEIAMPOLICYLONGRUNNINGREQUEST = _descriptor.Descriptor(
  name='AnalyzeIamPolicyLongrunningRequest',
  full_name='google.cloud.asset.v1.AnalyzeIamPolicyLongrunningRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='analysis_query', full_name='google.cloud.asset.v1.AnalyzeIamPolicyLongrunningRequest.analysis_query', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='output_config', full_name='google.cloud.asset.v1.AnalyzeIamPolicyLongrunningRequest.output_config', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ANALYZEIAMPOLICYLONGRUNNINGRESPONSE = _descriptor.Descriptor(
  name='AnalyzeIamPolicyLongrunningResponse',
  full_name='google.cloud.asset.v1.AnalyzeIamPolicyLongrunningResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_ANALYZEMOVEREQUEST = _descriptor.Descriptor(
  name='AnalyzeMoveRequest',
  full_name='google.cloud.asset.v1.AnalyzeMoveRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource', full_name='google.cloud.asset.v1.AnalyzeMoveRequest.resource', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='destination_parent', full_name='google.cloud.asset.v1.AnalyzeMoveRequest.destination_parent', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='view', full_name='google.cloud.asset.v1.AnalyzeMoveRequest.view', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _ANALYZEMOVEREQUEST_ANALYSISVIEW,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_ANALYZEMOVERESPONSE = _descriptor.Descriptor(
  name='AnalyzeMoveResponse',
  full_name='google.cloud.asset.v1.AnalyzeMoveResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='move_analysis', full_name='google.cloud.asset.v1.AnalyzeMoveResponse.move_analysis', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MOVEANALYSIS = _descriptor.Descriptor(
  name='MoveAnalysis',
  full_name='google.cloud.asset.v1.MoveAnalysis',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.asset.v1.MoveAnalysis.display_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='analysis', full_name='google.cloud.asset.v1.MoveAnalysis.analysis', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error', full_name='google.cloud.asset.v1.MoveAnalysis.error', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='result', full_name='google.cloud.asset.v1.MoveAnalysis.result',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_MOVEANALYSISRESULT = _descriptor.Descriptor(
  name='MoveAnalysisResult',
  full_name='google.cloud.asset.v1.MoveAnalysisResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='blockers', full_name='google.cloud.asset.v1.MoveAnalysisResult.blockers', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='warnings', full_name='google.cloud.asset.v1.MoveAnalysisResult.warnings', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MOVEIMPACT = _descriptor.Descriptor(
  name='MoveImpact',
  full_name='google.cloud.asset.v1.MoveImpact',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='detail', full_name='google.cloud.asset.v1.MoveImpact.detail', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ANALYZEIAMPOLICYLONGRUNNINGMETADATA.fields_by_name['create_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
_LISTASSETSRESPONSE.fields_by_name['assets'].message_type = google_dot_cloud_dot_asset_dot_v1_dot_assets__pb2._ASSET
...
_SEARCHALLRESOURCESREQUEST.fields_by_name['read_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
...
_IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT.fields_by_name['access_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT.containing_type = _IAMPOLICYANALYSISQUERY
_IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT.oneofs_by_name['TimeContext'].fields.append(
  _IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT.fields_by_name['access_time'])
_IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT.fields_by_name['access_time'].containing_oneof = _IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT.oneofs_by_name['TimeContext']
...
_IAMPOLICYANALYSISQUERY.fields_by_name['condition_context'].message_type = _IAMPOLICYANALYSISQUERY_CONDITIONCONTEXT
...
_ANALYZEIAMPOLICYLONGRUNNINGREQUEST.fields_by_name['analysis_query'].message_type = _IAMPOLICYANALYSISQUERY
_ANALYZEIAMPOLICYLONGRUNNINGREQUEST.fields_by_name['output_config'].message_type = _IAMPOLICYANALYSISOUTPUTCONFIG
_ANALYZEMOVEREQUEST.fields_by_name['view'].enum_type = _ANALYZEMOVEREQUEST_ANALYSISVIEW
_ANALYZEMOVEREQUEST_ANALYSISVIEW.containing_type = _ANALYZEMOVEREQUEST
_ANALYZEMOVERESPONSE.fields_by_name['move_analysis'].message_type = _MOVEANALYSIS
_MOVEANALYSIS.fields_by_name['analysis'].message_type = _MOVEANALYSISRESULT
_MOVEANALYSIS.fields_by_name['error'].message_type = google_dot_rpc_dot_status__pb2._STATUS
_MOVEANALYSIS.oneofs_by_name['result'].fields.append(
  _MOVEANALYSIS.fields_by_name['analysis'])
_MOVEANALYSIS.fields_by_name['analysis'].containing_oneof = _MOVEANALYSIS.oneofs_by_name['result']
_MOVEANALYSIS.oneofs_by_name['result'].fields.append(
  _MOVEANALYSIS.fields_by_name['error'])
_MOVEANALYSIS.fields_by_name['error'].containing_oneof = _MOVEANALYSIS.oneofs_by_name['result']
_MOVEANALYSISRESULT.fields_by_name['blockers'].message_type = _MOVEIMPACT
_MOVEANALYSISRESULT.fields_by_name['warnings'].message_type = _MOVEIMPACT
DESCRIPTOR.message_types_by_name['AnalyzeIamPolicyLongrunningMetadata'] = _ANALYZEIAMPOLICYLONGRUNNINGMETADATA
...
DESCRIPTOR.message_types_by_name['AnalyzeIamPolicyLongrunningRequest'] = _ANALYZEIAMPOLICYLONGRUNNINGREQUEST
DESCRIPTOR.message_types_by_name['AnalyzeIamPolicyLongrunningResponse'] = _ANALYZEIAMPOLICYLONGRUNNINGRESPONSE
DESCRIPTOR.message_types_by_name['AnalyzeMoveRequest'] = _ANALYZEMOVEREQUEST
DESCRIPTOR.message_types_by_name['AnalyzeMoveResponse'] = _ANALYZEMOVERESPONSE
DESCRIPTOR.message_types_by_name['MoveAnalysis'] = _MOVEANALYSIS
DESCRIPTOR.message_types_by_name['MoveAnalysisResult'] = _MOVEANALYSISRESULT
DESCRIPTOR.message_types_by_name['MoveImpact'] = _MOVEIMPACT
...
_ASSETSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListAssets',
    full_name='google.cloud.asset.v1.AssetService.ListAssets',
    index=1,
    containing_service=None,
    input_type=_LISTASSETSREQUEST,
    output_type=_LISTASSETSRESPONSE,
    serialized_options=b'\202\323\344\223\002\031\022\027/v1/{parent=*/*}/assets\332A\006parent',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.cloud.asset.v1.AssetService.AnalyzeIamPolicyLongrunning',
    index=11,
    containing_service=None,
    input_type=_ANALYZEIAMPOLICYLONGRUNNINGREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002?\":/v1/{analysis_query.scope=*/*}:analyzeIamPolicyLongrunning:\001*\312Av\n9google.cloud.asset.v1.AnalyzeIamPolicyLongrunningResponse\0229google.cloud.asset.v1.AnalyzeIamPolicyLongrunningMetadata',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='AnalyzeMove',
    full_name='google.cloud.asset.v1.AssetService.AnalyzeMove',
    index=12,
    containing_service=None,
    input_type=_ANALYZEMOVEREQUEST,
    output_type=_ANALYZEMOVERESPONSE,
    serialized_options=b'\202\323\344\223\002 \022\036/v1/{resource=*/*}:analyzeMove',
    create_key=_descriptor._internal_create_key,
  ),
])
