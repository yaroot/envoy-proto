...
_ENVIRONMENTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002W\"R/v3/{environment=projects/*/locations/*/agents/*/environments/*}:runContinuousTest:\001*\312A6\n\031RunContinuousTestResponse\022\031RunContinuousTestMetadata',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002S\022Q/v3/{parent=projects/*/locations/*/agents/*/environments/*}/continuousTestResults\332A\006parent',
    create_key=_descriptor._internal_create_key,
  ),
])
