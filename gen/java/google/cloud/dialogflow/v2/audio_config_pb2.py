...
_INPUTAUDIOCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='disable_no_speech_recognized_event', full_name='google.cloud.dialogflow.v2.InputAudioConfig.disable_no_speech_recognized_event', index=9,
...
_SPEECHTOTEXTCONFIG = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.v2.SpeechToTextConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='speech_model_variant', full_name='google.cloud.dialogflow.v2.SpeechToTextConfig.speech_model_variant', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
