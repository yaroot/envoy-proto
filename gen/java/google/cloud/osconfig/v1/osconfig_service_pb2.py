...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/osconfig/v1/osconfig_service.proto',
...
_OSCONFIGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._EXECUTEPATCHJOBREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._PATCHJOB,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._GETPATCHJOBREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._PATCHJOB,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=2,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._CANCELPATCHJOBREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._PATCHJOB,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=3,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._LISTPATCHJOBSREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._LISTPATCHJOBSRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=4,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._LISTPATCHJOBINSTANCEDETAILSREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__jobs__pb2._LISTPATCHJOBINSTANCEDETAILSRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=5,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__deployments__pb2._CREATEPATCHDEPLOYMENTREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__deployments__pb2._PATCHDEPLOYMENT,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=6,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__deployments__pb2._GETPATCHDEPLOYMENTREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__deployments__pb2._PATCHDEPLOYMENT,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=7,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__deployments__pb2._LISTPATCHDEPLOYMENTSREQUEST,
    output_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__deployments__pb2._LISTPATCHDEPLOYMENTSRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=8,
    containing_service=None,
    input_type=google_dot_cloud_dot_osconfig_dot_v1_dot_patch__deployments__pb2._DELETEPATCHDEPLOYMENTREQUEST,
