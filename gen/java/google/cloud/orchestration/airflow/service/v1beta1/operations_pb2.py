...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/orchestration/airflow/service/v1beta1/operations.proto',
...
_OPERATIONMETADATA_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.State',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_OPERATIONMETADATA_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.Type',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_OPERATIONMETADATA = _descriptor.Descriptor(
  ...
  full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.state', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='operation_type', full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.operation_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resource', full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.resource', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resource_uuid', full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.resource_uuid', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.create_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.end_time', index=5,
