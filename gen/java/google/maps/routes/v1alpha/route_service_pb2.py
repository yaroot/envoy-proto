...
_ROUTESALPHA = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.maps.routes.v1alpha.RoutesAlpha.ComputeCustomRoutes',
    index=2,
    containing_service=None,
    input_type=google_dot_maps_dot_routes_dot_v1_dot_compute__custom__routes__request__pb2._COMPUTECUSTOMROUTESREQUEST,
    output_type=google_dot_maps_dot_routes_dot_v1_dot_compute__custom__routes__response__pb2._COMPUTECUSTOMROUTESRESPONSE,
    serialized_options=b'\202\323\344\223\002!\"\034/v1alpha:computeCustomRoutes:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
