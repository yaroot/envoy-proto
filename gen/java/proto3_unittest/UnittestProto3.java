...
public final class UnittestProto3 {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 226: {
              ...
              optionalUnverifiedLazyMessage_ = input.readMessage(proto3_unittest.UnittestProto3.TestAllTypes.NestedMessage.parser(), extensionRegistry);
              if (subBuilder != null) {
        ...
        if (optionalUnverifiedLazyMessageBuilder_ == null) {
          if (optionalUnverifiedLazyMessage_ != null) {
            optionalUnverifiedLazyMessage_ =
              proto3_unittest.UnittestProto3.TestAllTypes.NestedMessage.newBuilder(optionalUnverifiedLazyMessage_).mergeFrom(value).buildPartial();
          } else {
            optionalUnverifiedLazyMessage_ = value;
          }
          onChanged();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        proto3_unittest.UnittestProto3.TestMessageWithDummy parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (proto3_unittest.UnittestProto3.TestMessageWithDummy) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    private static final com.google.protobuf.Parser<TestMessageWithDummy>
      ...
      public TestMessageWithDummy parsePartialFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new TestMessageWithDummy(input, extensionRegistry);
      }
    };
  ...
  private static final long serialVersionUID = 0L;
    ...
    public proto3_unittest.UnittestProto3.TestOneof2.NestedEnum getFooEnum() {
      if (fooCase_ == 6) {
        @SuppressWarnings("deprecation")
        proto3_unittest.UnittestProto3.TestOneof2.NestedEnum result = proto3_unittest.UnittestProto3.TestOneof2.NestedEnum.valueOf(
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        proto3_unittest.UnittestProto3.TestOneof2 parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (proto3_unittest.UnittestProto3.TestOneof2) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
