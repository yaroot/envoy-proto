...
func (x *Polyline) GetGeoJsonLinestring() *_struct.Struct {
...
type Polyline_GeoJsonLinestring struct {
	...
	GeoJsonLinestring *_struct.Struct `protobuf:"bytes,2,opt,name=geo_json_linestring,json=geoJsonLinestring,proto3,oneof"`
}
...
var file_google_maps_routes_v1_polyline_proto_rawDesc = []byte{
	...
	0x56, 0x49, 0x45, 0x57, 0x10, 0x02, 0x42, 0xa3, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
...
var file_google_maps_routes_v1_polyline_proto_depIdxs = []int32{
	2, // 0: google.maps.routes.v1.Polyline.geo_json_linestring:type_name -> google.protobuf.Struct
