...
func (x *ExecutionEvent) GetEventTime() *timestamp.Timestamp {
	if x != nil {
		return x.EventTime
	}
	return nil
...
type ExecutionState struct {
	...
	SessionStorage *_struct.Struct `protobuf:"bytes,2,opt,name=session_storage,json=sessionStorage,proto3" json:"session_storage,omitempty"`
	...
	UserStorage *_struct.Struct `protobuf:"bytes,6,opt,name=user_storage,json=userStorage,proto3" json:"user_storage,omitempty"`
	// State of the home storage:
	// https://developers.google.com/assistant/conversational/storage-home
	HouseholdStorage *_struct.Struct `protobuf:"bytes,8,opt,name=household_storage,json=householdStorage,proto3" json:"household_storage,omitempty"`
}
...
func (x *ExecutionState) GetSessionStorage() *_struct.Struct {
	if x != nil {
...
func (x *ExecutionState) GetUserStorage() *_struct.Struct {
	if x != nil {
...
func (x *ExecutionState) GetHouseholdStorage() *_struct.Struct {
	if x != nil {
