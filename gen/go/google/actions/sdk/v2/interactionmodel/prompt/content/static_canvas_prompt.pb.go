...
type StaticCanvasPrompt struct {
	...
	Data []*_struct.Value `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`
...
func (x *StaticCanvasPrompt) GetData() []*_struct.Value {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_google_actions_sdk_v2_interactionmodel_prompt_content_static_canvas_prompt_proto_rawDesc = []byte{
	...
	0x22, 0xca, 0x01, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x43, 0x61, 0x6e, 0x76, 0x61,
	...
	0x74, 0x61, 0x54, 0x6f, 0x43, 0x61, 0x6e, 0x76, 0x61, 0x73, 0x41, 0x70, 0x70, 0x42, 0xa3, 0x01,
	...
	0x6d, 0x70, 0x74, 0x42, 0x17, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x43, 0x61, 0x6e, 0x76, 0x61,
	0x73, 0x50, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x53,
