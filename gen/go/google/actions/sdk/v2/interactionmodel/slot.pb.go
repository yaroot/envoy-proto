...
type Slot struct {
	...
	//      }
	//    }
	Config *_struct.Value `protobuf:"bytes,6,opt,name=config,proto3" json:"config,omitempty"`
...
func (x *Slot) GetConfig() *_struct.Value {
	if x != nil {
		return x.Config
	}
	return nil
...
type Slot_DefaultValue struct {
	...
	Constant *_struct.Value `protobuf:"bytes,2,opt,name=constant,proto3" json:"constant,omitempty"`
}
...
func (x *Slot_DefaultValue) GetConstant() *_struct.Value {
	if x != nil {
		return x.Constant
	}
	return nil
