...
type AutoscalerRecommendation_Outputs struct {
	...
	GracefulDecommissionTimeout *duration.Duration `protobuf:"bytes,3,opt,name=graceful_decommission_timeout,json=gracefulDecommissionTimeout,proto3" json:"graceful_decommission_timeout,omitempty"`
...
func (x *AutoscalerRecommendation_Outputs) GetGracefulDecommissionTimeout() *duration.Duration {
	if x != nil {
