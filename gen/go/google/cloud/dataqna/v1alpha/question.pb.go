...
type Question struct {
	...
	DebugInfo *any.Any `protobuf:"bytes,10,opt,name=debug_info,json=debugInfo,proto3" json:"debug_info,omitempty"`
}
...
func (x *Question) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Question) GetDebugInfo() *any.Any {
	if x != nil {
		return x.DebugInfo
	}
	return nil
...
func (x *ExecutionInfo) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
