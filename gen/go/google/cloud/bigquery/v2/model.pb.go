...
type Model_RankingMetrics struct {
	...
	MeanAveragePrecision *wrappers.DoubleValue `protobuf:"bytes,1,opt,name=mean_average_precision,json=meanAveragePrecision,proto3" json:"mean_average_precision,omitempty"`
	...
	// original ratings.
	NormalizedDiscountedCumulativeGain *wrappers.DoubleValue `protobuf:"bytes,3,opt,name=normalized_discounted_cumulative_gain,json=normalizedDiscountedCumulativeGain,proto3" json:"normalized_discounted_cumulative_gain,omitempty"`
	// Determines the goodness of a ranking by computing the percentile rank
	// from the predicted confidence and dividing it by the original rank.
	AverageRank *wrappers.DoubleValue `protobuf:"bytes,4,opt,name=average_rank,json=averageRank,proto3" json:"average_rank,omitempty"`
}
...
func (x *Model_RankingMetrics) GetMeanAveragePrecision() *wrappers.DoubleValue {
	if x != nil {
...
func (x *Model_RankingMetrics) GetMeanSquaredError() *wrappers.DoubleValue {
	if x != nil {
		return x.MeanSquaredError
	}
	return nil
...
func (x *Model_RankingMetrics) GetNormalizedDiscountedCumulativeGain() *wrappers.DoubleValue {
	if x != nil {
...
func (x *Model_RankingMetrics) GetAverageRank() *wrappers.DoubleValue {
	if x != nil {
...
type Model_GlobalExplanation_Explanation struct {
	...
	Attribution *wrappers.DoubleValue `protobuf:"bytes,2,opt,name=attribution,proto3" json:"attribution,omitempty"`
}
...
func (x *Model_GlobalExplanation_Explanation) GetAttribution() *wrappers.DoubleValue {
	if x != nil {
...
type Model_TrainingRun_TrainingOptions struct {
	...
	Dropout *wrappers.DoubleValue `protobuf:"bytes,26,opt,name=dropout,proto3" json:"dropout,omitempty"`
	...
	MinSplitLoss *wrappers.DoubleValue `protobuf:"bytes,29,opt,name=min_split_loss,json=minSplitLoss,proto3" json:"min_split_loss,omitempty"`
	...
	// specified.
	WalsAlpha *wrappers.DoubleValue `protobuf:"bytes,32,opt,name=wals_alpha,json=walsAlpha,proto3" json:"wals_alpha,omitempty"`
...
func (x *Model_TrainingRun_TrainingOptions) GetDropout() *wrappers.DoubleValue {
	if x != nil {
		return x.Dropout
	}
	return nil
...
func (x *Model_TrainingRun_TrainingOptions) GetMinSplitLoss() *wrappers.DoubleValue {
	if x != nil {
...
func (x *Model_TrainingRun_TrainingOptions) GetWalsAlpha() *wrappers.DoubleValue {
	if x != nil {
		return x.WalsAlpha
	}
	return nil
...
var file_google_cloud_bigquery_v2_model_proto_goTypes = []interface{}{
	...
	(*wrappers.Int64Value)(nil),     // 57: google.protobuf.Int64Value
