...
func (x *SystemTimestamps) Reset() {
	*x = SystemTimestamps{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_datacatalog_v1_timestamps_proto_msgTypes[0]
...
var file_google_cloud_datacatalog_v1_timestamps_proto_rawDesc = []byte{
	0x0a, 0x2c, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x64,
	0x61, 0x74, 0x61, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1b,
	...
	0x0a, 0x10, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	...
	0x41, 0x03, 0x52, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0xcb,
...
var (
	file_google_cloud_datacatalog_v1_timestamps_proto_rawDescOnce sync.Once
	file_google_cloud_datacatalog_v1_timestamps_proto_rawDescData = file_google_cloud_datacatalog_v1_timestamps_proto_rawDesc
)

func file_google_cloud_datacatalog_v1_timestamps_proto_rawDescGZIP() []byte {
	file_google_cloud_datacatalog_v1_timestamps_proto_rawDescOnce.Do(func() {
		file_google_cloud_datacatalog_v1_timestamps_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_datacatalog_v1_timestamps_proto_rawDescData)
	})
	return file_google_cloud_datacatalog_v1_timestamps_proto_rawDescData
}
...
var file_google_cloud_datacatalog_v1_timestamps_proto_depIdxs = []int32{
	...
	1, // 1: google.cloud.datacatalog.v1.SystemTimestamps.update_time:type_name -> google.protobuf.Timestamp
	1, // 2: google.cloud.datacatalog.v1.SystemTimestamps.expire_time:type_name -> google.protobuf.Timestamp
...
func init() { file_google_cloud_datacatalog_v1_timestamps_proto_init() }
func file_google_cloud_datacatalog_v1_timestamps_proto_init() {
	if File_google_cloud_datacatalog_v1_timestamps_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_datacatalog_v1_timestamps_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_datacatalog_v1_timestamps_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_datacatalog_v1_timestamps_proto_goTypes,
		DependencyIndexes: file_google_cloud_datacatalog_v1_timestamps_proto_depIdxs,
		MessageInfos:      file_google_cloud_datacatalog_v1_timestamps_proto_msgTypes,
	}.Build()
	File_google_cloud_datacatalog_v1_timestamps_proto = out.File
	file_google_cloud_datacatalog_v1_timestamps_proto_rawDesc = nil
	file_google_cloud_datacatalog_v1_timestamps_proto_goTypes = nil
	file_google_cloud_datacatalog_v1_timestamps_proto_depIdxs = nil
}
