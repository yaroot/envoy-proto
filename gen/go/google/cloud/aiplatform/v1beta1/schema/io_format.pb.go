...
type PredictionResult struct {
	...
	Prediction *_struct.Value `protobuf:"bytes,3,opt,name=prediction,proto3" json:"prediction,omitempty"`
}
...
func (x *PredictionResult) GetInstance() *_struct.Struct {
...
func (x *PredictionResult) GetPrediction() *_struct.Value {
	if x != nil {
		return x.Prediction
	}
	return nil
...
type PredictionResult_Instance struct {
	...
	Instance *_struct.Struct `protobuf:"bytes,1,opt,name=instance,proto3,oneof"`
}
...
type ImageObjectDetectionPredictionResult struct {
	...
	// of the image.
	Bboxes []*_struct.ListValue `protobuf:"bytes,4,rep,name=bboxes,proto3" json:"bboxes,omitempty"`
}
...
func (x *ImageObjectDetectionPredictionResult) GetBboxes() []*_struct.ListValue {
	if x != nil {
		return x.Bboxes
	}
	return nil
...
type VideoClassificationPredictionResult struct {
	...
	TimeSegmentStart *duration.Duration `protobuf:"bytes,4,opt,name=time_segment_start,json=timeSegmentStart,proto3" json:"time_segment_start,omitempty"`
	...
	TimeSegmentEnd *duration.Duration `protobuf:"bytes,5,opt,name=time_segment_end,json=timeSegmentEnd,proto3" json:"time_segment_end,omitempty"`
	// The Model's confidence in correction of this prediction, higher
	// value means higher confidence.
	Confidence *wrappers.FloatValue `protobuf:"bytes,6,opt,name=confidence,proto3" json:"confidence,omitempty"`
}
...
func (x *VideoClassificationPredictionResult) GetTimeSegmentStart() *duration.Duration {
	if x != nil {
		return x.TimeSegmentStart
	}
	return nil
...
func (x *VideoClassificationPredictionResult) GetTimeSegmentEnd() *duration.Duration {
	if x != nil {
		return x.TimeSegmentEnd
	}
	return nil
...
func (x *VideoClassificationPredictionResult) GetConfidence() *wrappers.FloatValue {
	if x != nil {
		return x.Confidence
	}
	return nil
