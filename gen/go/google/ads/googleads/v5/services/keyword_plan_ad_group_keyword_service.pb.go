...
func (x *GetKeywordPlanAdGroupKeywordRequest) Reset() {
	*x = GetKeywordPlanAdGroupKeywordRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[0]
...
func (*GetKeywordPlanAdGroupKeywordRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateKeywordPlanAdGroupKeywordsRequest) Reset() {
	*x = MutateKeywordPlanAdGroupKeywordsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanAdGroupKeywordsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *KeywordPlanAdGroupKeywordOperation) Reset() {
	*x = KeywordPlanAdGroupKeywordOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordPlanAdGroupKeywordOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanAdGroupKeywordsResponse) Reset() {
	*x = MutateKeywordPlanAdGroupKeywordsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanAdGroupKeywordsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateKeywordPlanAdGroupKeywordResult) Reset() {
	*x = MutateKeywordPlanAdGroupKeywordResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanAdGroupKeywordResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDesc = []byte{
	...
	0x3f, 0x2f, 0x76, 0x35, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x7b,
...
var (
	file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescData = file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDesc
)

func file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDescData
}

var file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_goTypes = []interface{}{
	(*GetKeywordPlanAdGroupKeywordRequest)(nil),      // 0: google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest
	(*MutateKeywordPlanAdGroupKeywordsRequest)(nil),  // 1: google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest
	(*KeywordPlanAdGroupKeywordOperation)(nil),       // 2: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordOperation
	(*MutateKeywordPlanAdGroupKeywordsResponse)(nil), // 3: google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse
	(*MutateKeywordPlanAdGroupKeywordResult)(nil),    // 4: google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordResult
	(*fieldmaskpb.FieldMask)(nil),                    // 5: google.protobuf.FieldMask
	(*resources.KeywordPlanAdGroupKeyword)(nil),      // 6: google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword
	(*status.Status)(nil),                            // 7: google.rpc.Status
}
var file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest.operations:type_name -> google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordOperation
	5, // 1: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordOperation.create:type_name -> google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword
	6, // 3: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordOperation.update:type_name -> google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword
	7, // 4: google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse.results:type_name -> google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordResult
	0, // 6: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService.GetKeywordPlanAdGroupKeyword:input_type -> google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest
	1, // 7: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService.MutateKeywordPlanAdGroupKeywords:input_type -> google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest
	6, // 8: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService.GetKeywordPlanAdGroupKeyword:output_type -> google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword
	3, // 9: google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService.MutateKeywordPlanAdGroupKeywords:output_type -> google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse
...
func init() { file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_init() }
func file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_init() {
	if File_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto = out.File
	file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_rawDesc = nil
	file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_goTypes = nil
	file_google_ads_googleads_v5_services_keyword_plan_ad_group_keyword_service_proto_depIdxs = nil
}
