...
func (x *GetCampaignExtensionSettingRequest) Reset() {
	*x = GetCampaignExtensionSettingRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[0]
...
func (*GetCampaignExtensionSettingRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignExtensionSettingsRequest) Reset() {
	*x = MutateCampaignExtensionSettingsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignExtensionSettingsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignExtensionSettingOperation) Reset() {
	*x = CampaignExtensionSettingOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignExtensionSettingOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignExtensionSettingsResponse) Reset() {
	*x = MutateCampaignExtensionSettingsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignExtensionSettingsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignExtensionSettingResult) Reset() {
	*x = MutateCampaignExtensionSettingResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignExtensionSettingResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescData = file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDesc
)

func file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDescData
}

var file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_goTypes = []interface{}{
	(*GetCampaignExtensionSettingRequest)(nil),      // 0: google.ads.googleads.v5.services.GetCampaignExtensionSettingRequest
	(*MutateCampaignExtensionSettingsRequest)(nil),  // 1: google.ads.googleads.v5.services.MutateCampaignExtensionSettingsRequest
	(*CampaignExtensionSettingOperation)(nil),       // 2: google.ads.googleads.v5.services.CampaignExtensionSettingOperation
	(*MutateCampaignExtensionSettingsResponse)(nil), // 3: google.ads.googleads.v5.services.MutateCampaignExtensionSettingsResponse
	(*MutateCampaignExtensionSettingResult)(nil),    // 4: google.ads.googleads.v5.services.MutateCampaignExtensionSettingResult
	(*field_mask.FieldMask)(nil),                    // 5: google.protobuf.FieldMask
	(*resources.CampaignExtensionSetting)(nil),      // 6: google.ads.googleads.v5.resources.CampaignExtensionSetting
	(*status.Status)(nil),                           // 7: google.rpc.Status
}
var file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v5.services.MutateCampaignExtensionSettingsRequest.operations:type_name -> google.ads.googleads.v5.services.CampaignExtensionSettingOperation
	5, // 1: google.ads.googleads.v5.services.CampaignExtensionSettingOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v5.services.CampaignExtensionSettingOperation.create:type_name -> google.ads.googleads.v5.resources.CampaignExtensionSetting
	6, // 3: google.ads.googleads.v5.services.CampaignExtensionSettingOperation.update:type_name -> google.ads.googleads.v5.resources.CampaignExtensionSetting
	7, // 4: google.ads.googleads.v5.services.MutateCampaignExtensionSettingsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v5.services.MutateCampaignExtensionSettingsResponse.results:type_name -> google.ads.googleads.v5.services.MutateCampaignExtensionSettingResult
	0, // 6: google.ads.googleads.v5.services.CampaignExtensionSettingService.GetCampaignExtensionSetting:input_type -> google.ads.googleads.v5.services.GetCampaignExtensionSettingRequest
	1, // 7: google.ads.googleads.v5.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings:input_type -> google.ads.googleads.v5.services.MutateCampaignExtensionSettingsRequest
	6, // 8: google.ads.googleads.v5.services.CampaignExtensionSettingService.GetCampaignExtensionSetting:output_type -> google.ads.googleads.v5.resources.CampaignExtensionSetting
	3, // 9: google.ads.googleads.v5.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings:output_type -> google.ads.googleads.v5.services.MutateCampaignExtensionSettingsResponse
...
func init() { file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_init() }
func file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_init() {
	if File_google_ads_googleads_v5_services_campaign_extension_setting_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v5_services_campaign_extension_setting_service_proto = out.File
	file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_rawDesc = nil
	file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_goTypes = nil
	file_google_ads_googleads_v5_services_campaign_extension_setting_service_proto_depIdxs = nil
}
