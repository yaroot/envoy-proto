...
func (x *FrequencyCapEntry) Reset() {
	*x = FrequencyCapEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes[0]
...
func (*FrequencyCapEntry) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescGZIP(), []int{0}
}
...
type FrequencyCapKey struct {
	...
	Level enums.FrequencyCapLevelEnum_FrequencyCapLevel `protobuf:"varint,1,opt,name=level,proto3,enum=google.ads.googleads.v5.enums.FrequencyCapLevelEnum_FrequencyCapLevel" json:"level,omitempty"`
	// The type of event that the cap applies to (e.g. impression).
	EventType enums.FrequencyCapEventTypeEnum_FrequencyCapEventType `protobuf:"varint,3,opt,name=event_type,json=eventType,proto3,enum=google.ads.googleads.v5.enums.FrequencyCapEventTypeEnum_FrequencyCapEventType" json:"event_type,omitempty"`
...
func (x *FrequencyCapKey) Reset() {
	*x = FrequencyCapKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FrequencyCapKey) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v5_common_frequency_cap_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v5_common_frequency_cap_proto_rawDesc = []byte{
	...
	0x73, 0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x72, 0x65, 0x71, 0x75,
	...
	0x76, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65,
...
var (
	file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescData = file_google_ads_googleads_v5_common_frequency_cap_proto_rawDesc
)

func file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescData)
	})
	return file_google_ads_googleads_v5_common_frequency_cap_proto_rawDescData
}

var file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v5_common_frequency_cap_proto_goTypes = []interface{}{
	(*FrequencyCapEntry)(nil),                                  // 0: google.ads.googleads.v5.common.FrequencyCapEntry
	(*FrequencyCapKey)(nil),                                    // 1: google.ads.googleads.v5.common.FrequencyCapKey
	(enums.FrequencyCapLevelEnum_FrequencyCapLevel)(0),         // 2: google.ads.googleads.v5.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	(enums.FrequencyCapEventTypeEnum_FrequencyCapEventType)(0), // 3: google.ads.googleads.v5.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	(enums.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit)(0),   // 4: google.ads.googleads.v5.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
}
var file_google_ads_googleads_v5_common_frequency_cap_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v5.common.FrequencyCapEntry.key:type_name -> google.ads.googleads.v5.common.FrequencyCapKey
	2, // 1: google.ads.googleads.v5.common.FrequencyCapKey.level:type_name -> google.ads.googleads.v5.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	3, // 2: google.ads.googleads.v5.common.FrequencyCapKey.event_type:type_name -> google.ads.googleads.v5.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	4, // 3: google.ads.googleads.v5.common.FrequencyCapKey.time_unit:type_name -> google.ads.googleads.v5.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
...
func init() { file_google_ads_googleads_v5_common_frequency_cap_proto_init() }
func file_google_ads_googleads_v5_common_frequency_cap_proto_init() {
	if File_google_ads_googleads_v5_common_frequency_cap_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v5_common_frequency_cap_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v5_common_frequency_cap_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v5_common_frequency_cap_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v5_common_frequency_cap_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v5_common_frequency_cap_proto = out.File
	file_google_ads_googleads_v5_common_frequency_cap_proto_rawDesc = nil
	file_google_ads_googleads_v5_common_frequency_cap_proto_goTypes = nil
	file_google_ads_googleads_v5_common_frequency_cap_proto_depIdxs = nil
}
