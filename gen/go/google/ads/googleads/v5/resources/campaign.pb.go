...
type Campaign struct {
	...
	Status enums.CampaignStatusEnum_CampaignStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v5.enums.CampaignStatusEnum_CampaignStatus" json:"status,omitempty"`
	// Output only. The ad serving status of the campaign.
	ServingStatus enums.CampaignServingStatusEnum_CampaignServingStatus `protobuf:"varint,21,opt,name=serving_status,json=servingStatus,proto3,enum=google.ads.googleads.v5.enums.CampaignServingStatusEnum_CampaignServingStatus" json:"serving_status,omitempty"`
	// The ad serving optimization status of the campaign.
	AdServingOptimizationStatus enums.AdServingOptimizationStatusEnum_AdServingOptimizationStatus `protobuf:"varint,8,opt,name=ad_serving_optimization_status,json=adServingOptimizationStatus,proto3,enum=google.ads.googleads.v5.enums.AdServingOptimizationStatusEnum_AdServingOptimizationStatus" json:"ad_serving_optimization_status,omitempty"`
	...
	AdvertisingChannelType enums.AdvertisingChannelTypeEnum_AdvertisingChannelType `protobuf:"varint,9,opt,name=advertising_channel_type,json=advertisingChannelType,proto3,enum=google.ads.googleads.v5.enums.AdvertisingChannelTypeEnum_AdvertisingChannelType" json:"advertising_channel_type,omitempty"`
	...
	ExperimentType enums.CampaignExperimentTypeEnum_CampaignExperimentType `protobuf:"varint,17,opt,name=experiment_type,json=experimentType,proto3,enum=google.ads.googleads.v5.enums.CampaignExperimentTypeEnum_CampaignExperimentType" json:"experiment_type,omitempty"`
	...
	//
	// This field is read-only.
	BiddingStrategyType enums.BiddingStrategyTypeEnum_BiddingStrategyType `protobuf:"varint,22,opt,name=bidding_strategy_type,json=biddingStrategyType,proto3,enum=google.ads.googleads.v5.enums.BiddingStrategyTypeEnum_BiddingStrategyType" json:"bidding_strategy_type,omitempty"`
	...
	VideoBrandSafetySuitability enums.BrandSafetySuitabilityEnum_BrandSafetySuitability `protobuf:"varint,42,opt,name=video_brand_safety_suitability,json=videoBrandSafetySuitability,proto3,enum=google.ads.googleads.v5.enums.BrandSafetySuitabilityEnum_BrandSafetySuitability" json:"video_brand_safety_suitability,omitempty"`
	...
	PaymentMode enums.PaymentModeEnum_PaymentMode `protobuf:"varint,52,opt,name=payment_mode,json=paymentMode,proto3,enum=google.ads.googleads.v5.enums.PaymentModeEnum_PaymentMode" json:"payment_mode,omitempty"`
...
func (x *Campaign) Reset() {
	*x = Campaign{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[0]
...
func (*Campaign) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0}
}
...
func (x *Campaign_NetworkSettings) Reset() {
	*x = Campaign_NetworkSettings{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_NetworkSettings) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Campaign_HotelSettingInfo) Reset() {
	*x = Campaign_HotelSettingInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_HotelSettingInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 1}
}
...
type Campaign_DynamicSearchAdsSetting struct {
	...
	// or "www.google.com".
	DomainName *string `protobuf:"bytes,6,opt,name=domain_name,json=domainName,proto3,oneof" json:"domain_name,omitempty"`
	// The language code specifying the language of the domain, e.g., "en".
	LanguageCode *string `protobuf:"bytes,7,opt,name=language_code,json=languageCode,proto3,oneof" json:"language_code,omitempty"`
...
func (x *Campaign_DynamicSearchAdsSetting) Reset() {
	*x = Campaign_DynamicSearchAdsSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_DynamicSearchAdsSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 2}
}
...
type Campaign_GeoTargetTypeSetting struct {
	...
	PositiveGeoTargetType enums.PositiveGeoTargetTypeEnum_PositiveGeoTargetType `protobuf:"varint,1,opt,name=positive_geo_target_type,json=positiveGeoTargetType,proto3,enum=google.ads.googleads.v5.enums.PositiveGeoTargetTypeEnum_PositiveGeoTargetType" json:"positive_geo_target_type,omitempty"`
	// The setting used for negative geotargeting in this particular campaign.
	NegativeGeoTargetType enums.NegativeGeoTargetTypeEnum_NegativeGeoTargetType `protobuf:"varint,2,opt,name=negative_geo_target_type,json=negativeGeoTargetType,proto3,enum=google.ads.googleads.v5.enums.NegativeGeoTargetTypeEnum_NegativeGeoTargetType" json:"negative_geo_target_type,omitempty"`
}

func (x *Campaign_GeoTargetTypeSetting) Reset() {
	*x = Campaign_GeoTargetTypeSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_GeoTargetTypeSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 3}
}
...
type Campaign_AppCampaignSetting struct {
	...
	AppStore enums.AppCampaignAppStoreEnum_AppCampaignAppStore `protobuf:"varint,3,opt,name=app_store,json=appStore,proto3,enum=google.ads.googleads.v5.enums.AppCampaignAppStoreEnum_AppCampaignAppStore" json:"app_store,omitempty"`
}

func (x *Campaign_AppCampaignSetting) Reset() {
	*x = Campaign_AppCampaignSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_AppCampaignSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 4}
}
...
func (x *Campaign_ShoppingSetting) Reset() {
	*x = Campaign_ShoppingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_ShoppingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 5}
}
...
func (x *Campaign_TrackingSetting) Reset() {
	*x = Campaign_TrackingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_TrackingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 6}
}
...
type Campaign_OptimizationGoalSetting struct {
	...
	OptimizationGoalTypes []enums.OptimizationGoalTypeEnum_OptimizationGoalType `protobuf:"varint,1,rep,packed,name=optimization_goal_types,json=optimizationGoalTypes,proto3,enum=google.ads.googleads.v5.enums.OptimizationGoalTypeEnum_OptimizationGoalType" json:"optimization_goal_types,omitempty"`
}

func (x *Campaign_OptimizationGoalSetting) Reset() {
	*x = Campaign_OptimizationGoalSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_OptimizationGoalSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 7}
}
...
type Campaign_LocalCampaignSetting struct {
	...
	LocationSourceType enums.LocationSourceTypeEnum_LocationSourceType `protobuf:"varint,1,opt,name=location_source_type,json=locationSourceType,proto3,enum=google.ads.googleads.v5.enums.LocationSourceTypeEnum_LocationSourceType" json:"location_source_type,omitempty"`
}

func (x *Campaign_LocalCampaignSetting) Reset() {
	*x = Campaign_LocalCampaignSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_LocalCampaignSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 8}
}
...
type Campaign_VanityPharma struct {
	...
	VanityPharmaText enums.VanityPharmaTextEnum_VanityPharmaText `protobuf:"varint,2,opt,name=vanity_pharma_text,json=vanityPharmaText,proto3,enum=google.ads.googleads.v5.enums.VanityPharmaTextEnum_VanityPharmaText" json:"vanity_pharma_text,omitempty"`
}

func (x *Campaign_VanityPharma) Reset() {
	*x = Campaign_VanityPharma{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_VanityPharma) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 9}
}
...
func (x *Campaign_SelectiveOptimization) Reset() {
	*x = Campaign_SelectiveOptimization{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_SelectiveOptimization) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP(), []int{0, 10}
}
...
var File_google_ads_googleads_v5_resources_campaign_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v5_resources_campaign_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x35, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x66, 0x72, 0x65, 0x71, 0x75,
	...
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x35, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x72,
	...
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x64, 0x76, 0x65, 0x72, 0x74,
	...
	0x64, 0x73, 0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x64, 0x76, 0x65,
	...
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x70, 0x70, 0x5f, 0x63, 0x61,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x72,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x61, 0x6d, 0x70,
	...
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x6f, 0x63, 0x61,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x39, 0x0a, 0x08, 0x43, 0x61, 0x6d, 0x70, 0x61,
	...
	0x76, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67,
	...
	0x2e, 0x76, 0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2e, 0x76, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x61, 0x6e,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2e, 0x76, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x54, 0x61, 0x72,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x65,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x54, 0x61, 0x72, 0x67,
	...
	,
	...
	0x65, 0x64, 0x73, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x5f, 0x6e,
	0x61, 0x6d, 0x65, 0x42, 0x10, 0x0a, 0x0e, 0x5f, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	0x5f, 0x63, 0x6f, 0x64, 0x65, 0x42, 0x19, 0x0a, 0x17, 0x5f, 0x75, 0x73, 0x65, 0x5f, 0x73, 0x75,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x50, 0x6f, 0x73,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x70, 0x70, 0x43, 0x61, 0x6d,
	...
	0x61, 0x70, 0x70, 0x5f, 0x69, 0x64, 0x1a, 0x8e, 0x02, 0x0a, 0x0f, 0x53, 0x68, 0x6f, 0x70, 0x70,
	...
	0x6b, 0x69, 0x6e, 0x67, 0x5f, 0x75, 0x72, 0x6c, 0x1a, 0xa0, 0x01, 0x0a, 0x17, 0x4f, 0x70, 0x74,
	0x69, 0x6d, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x47, 0x6f, 0x61, 0x6c, 0x53, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x12, 0x84, 0x01, 0x0a, 0x17, 0x6f, 0x70, 0x74, 0x69, 0x6d, 0x69, 0x7a,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x67, 0x6f, 0x61, 0x6c, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x4c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x35,
	...
	0x6f, 0x6e, 0x47, 0x6f, 0x61, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x73, 0x1a, 0x92, 0x01, 0x0a, 0x14,
	0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x53, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x12, 0x7a, 0x0a, 0x14, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x56, 0x61, 0x6e, 0x69, 0x74,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x56, 0x61, 0x6e,
	...
	,
	...
	0x65, 0x6e, 0x64, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x42, 0x13, 0x0a, 0x11, 0x5f, 0x66, 0x69, 0x6e,
	0x61, 0x6c, 0x5f, 0x75, 0x72, 0x6c, 0x5f, 0x73, 0x75, 0x66, 0x66, 0x69, 0x78, 0x42, 0x15, 0x0a,
	0x13, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6d, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73,
	0x63, 0x6f, 0x72, 0x65, 0x42, 0xfa, 0x01, 0x0a, 0x25, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x0d,
...
var (
	file_google_ads_googleads_v5_resources_campaign_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v5_resources_campaign_proto_rawDescData = file_google_ads_googleads_v5_resources_campaign_proto_rawDesc
)

func file_google_ads_googleads_v5_resources_campaign_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v5_resources_campaign_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v5_resources_campaign_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v5_resources_campaign_proto_rawDescData)
	})
	return file_google_ads_googleads_v5_resources_campaign_proto_rawDescData
}

var file_google_ads_googleads_v5_resources_campaign_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_google_ads_googleads_v5_resources_campaign_proto_goTypes = []interface{}{
	(*Campaign)(nil),                                                                     // 0: google.ads.googleads.v5.resources.Campaign
	(*Campaign_NetworkSettings)(nil),                                                     // 1: google.ads.googleads.v5.resources.Campaign.NetworkSettings
	(*Campaign_HotelSettingInfo)(nil),                                                    // 2: google.ads.googleads.v5.resources.Campaign.HotelSettingInfo
	(*Campaign_DynamicSearchAdsSetting)(nil),                                             // 3: google.ads.googleads.v5.resources.Campaign.DynamicSearchAdsSetting
	(*Campaign_GeoTargetTypeSetting)(nil),                                                // 4: google.ads.googleads.v5.resources.Campaign.GeoTargetTypeSetting
	(*Campaign_AppCampaignSetting)(nil),                                                  // 5: google.ads.googleads.v5.resources.Campaign.AppCampaignSetting
	(*Campaign_ShoppingSetting)(nil),                                                     // 6: google.ads.googleads.v5.resources.Campaign.ShoppingSetting
	(*Campaign_TrackingSetting)(nil),                                                     // 7: google.ads.googleads.v5.resources.Campaign.TrackingSetting
	(*Campaign_OptimizationGoalSetting)(nil),                                             // 8: google.ads.googleads.v5.resources.Campaign.OptimizationGoalSetting
	(*Campaign_LocalCampaignSetting)(nil),                                                // 9: google.ads.googleads.v5.resources.Campaign.LocalCampaignSetting
	(*Campaign_VanityPharma)(nil),                                                        // 10: google.ads.googleads.v5.resources.Campaign.VanityPharma
	(*Campaign_SelectiveOptimization)(nil),                                               // 11: google.ads.googleads.v5.resources.Campaign.SelectiveOptimization
	(enums.CampaignStatusEnum_CampaignStatus)(0),                                         // 12: google.ads.googleads.v5.enums.CampaignStatusEnum.CampaignStatus
	(enums.CampaignServingStatusEnum_CampaignServingStatus)(0),                           // 13: google.ads.googleads.v5.enums.CampaignServingStatusEnum.CampaignServingStatus
	(enums.AdServingOptimizationStatusEnum_AdServingOptimizationStatus)(0),               // 14: google.ads.googleads.v5.enums.AdServingOptimizationStatusEnum.AdServingOptimizationStatus
	(enums.AdvertisingChannelTypeEnum_AdvertisingChannelType)(0),                         // 15: google.ads.googleads.v5.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
	(enums.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType)(0),                   // 16: google.ads.googleads.v5.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType
	(*common.CustomParameter)(nil),                                                       // 17: google.ads.googleads.v5.common.CustomParameter
	(*common.RealTimeBiddingSetting)(nil),                                                // 18: google.ads.googleads.v5.common.RealTimeBiddingSetting
	(*common.TargetingSetting)(nil),                                                      // 19: google.ads.googleads.v5.common.TargetingSetting
	(enums.CampaignExperimentTypeEnum_CampaignExperimentType)(0),                         // 20: google.ads.googleads.v5.enums.CampaignExperimentTypeEnum.CampaignExperimentType
	(enums.BiddingStrategyTypeEnum_BiddingStrategyType)(0),                               // 21: google.ads.googleads.v5.enums.BiddingStrategyTypeEnum.BiddingStrategyType
	(*common.FrequencyCapEntry)(nil),                                                     // 22: google.ads.googleads.v5.common.FrequencyCapEntry
	(enums.BrandSafetySuitabilityEnum_BrandSafetySuitability)(0),                         // 23: google.ads.googleads.v5.enums.BrandSafetySuitabilityEnum.BrandSafetySuitability
	(enums.PaymentModeEnum_PaymentMode)(0),                                               // 24: google.ads.googleads.v5.enums.PaymentModeEnum.PaymentMode
	(*common.Commission)(nil),                                                            // 25: google.ads.googleads.v5.common.Commission
	(*common.ManualCpc)(nil),                                                             // 26: google.ads.googleads.v5.common.ManualCpc
	(*common.ManualCpm)(nil),                                                             // 27: google.ads.googleads.v5.common.ManualCpm
	(*common.ManualCpv)(nil),                                                             // 28: google.ads.googleads.v5.common.ManualCpv
	(*common.MaximizeConversions)(nil),                                                   // 29: google.ads.googleads.v5.common.MaximizeConversions
	(*common.MaximizeConversionValue)(nil),                                               // 30: google.ads.googleads.v5.common.MaximizeConversionValue
	(*common.TargetCpa)(nil),                                                             // 31: google.ads.googleads.v5.common.TargetCpa
	(*common.TargetImpressionShare)(nil),                                                 // 32: google.ads.googleads.v5.common.TargetImpressionShare
	(*common.TargetRoas)(nil),                                                            // 33: google.ads.googleads.v5.common.TargetRoas
	(*common.TargetSpend)(nil),                                                           // 34: google.ads.googleads.v5.common.TargetSpend
	(*common.PercentCpc)(nil),                                                            // 35: google.ads.googleads.v5.common.PercentCpc
	(*common.TargetCpm)(nil),                                                             // 36: google.ads.googleads.v5.common.TargetCpm
	(enums.PositiveGeoTargetTypeEnum_PositiveGeoTargetType)(0),                           // 37: google.ads.googleads.v5.enums.PositiveGeoTargetTypeEnum.PositiveGeoTargetType
	(enums.NegativeGeoTargetTypeEnum_NegativeGeoTargetType)(0),                           // 38: google.ads.googleads.v5.enums.NegativeGeoTargetTypeEnum.NegativeGeoTargetType
	(enums.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType)(0), // 39: google.ads.googleads.v5.enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType
	(enums.AppCampaignAppStoreEnum_AppCampaignAppStore)(0),                               // 40: google.ads.googleads.v5.enums.AppCampaignAppStoreEnum.AppCampaignAppStore
	(enums.OptimizationGoalTypeEnum_OptimizationGoalType)(0),                             // 41: google.ads.googleads.v5.enums.OptimizationGoalTypeEnum.OptimizationGoalType
	(enums.LocationSourceTypeEnum_LocationSourceType)(0),                                 // 42: google.ads.googleads.v5.enums.LocationSourceTypeEnum.LocationSourceType
	(enums.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode)(0),                 // 43: google.ads.googleads.v5.enums.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode
	(enums.VanityPharmaTextEnum_VanityPharmaText)(0),                                     // 44: google.ads.googleads.v5.enums.VanityPharmaTextEnum.VanityPharmaText
}
var file_google_ads_googleads_v5_resources_campaign_proto_depIdxs = []int32{
	12, // 0: google.ads.googleads.v5.resources.Campaign.status:type_name -> google.ads.googleads.v5.enums.CampaignStatusEnum.CampaignStatus
	13, // 1: google.ads.googleads.v5.resources.Campaign.serving_status:type_name -> google.ads.googleads.v5.enums.CampaignServingStatusEnum.CampaignServingStatus
	14, // 2: google.ads.googleads.v5.resources.Campaign.ad_serving_optimization_status:type_name -> google.ads.googleads.v5.enums.AdServingOptimizationStatusEnum.AdServingOptimizationStatus
	15, // 3: google.ads.googleads.v5.resources.Campaign.advertising_channel_type:type_name -> google.ads.googleads.v5.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
	16, // 4: google.ads.googleads.v5.resources.Campaign.advertising_channel_sub_type:type_name -> google.ads.googleads.v5.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType
	17, // 5: google.ads.googleads.v5.resources.Campaign.url_custom_parameters:type_name -> google.ads.googleads.v5.common.CustomParameter
	18, // 6: google.ads.googleads.v5.resources.Campaign.real_time_bidding_setting:type_name -> google.ads.googleads.v5.common.RealTimeBiddingSetting
	1,  // 7: google.ads.googleads.v5.resources.Campaign.network_settings:type_name -> google.ads.googleads.v5.resources.Campaign.NetworkSettings
	2,  // 8: google.ads.googleads.v5.resources.Campaign.hotel_setting:type_name -> google.ads.googleads.v5.resources.Campaign.HotelSettingInfo
	3,  // 9: google.ads.googleads.v5.resources.Campaign.dynamic_search_ads_setting:type_name -> google.ads.googleads.v5.resources.Campaign.DynamicSearchAdsSetting
	6,  // 10: google.ads.googleads.v5.resources.Campaign.shopping_setting:type_name -> google.ads.googleads.v5.resources.Campaign.ShoppingSetting
	19, // 11: google.ads.googleads.v5.resources.Campaign.targeting_setting:type_name -> google.ads.googleads.v5.common.TargetingSetting
	4,  // 12: google.ads.googleads.v5.resources.Campaign.geo_target_type_setting:type_name -> google.ads.googleads.v5.resources.Campaign.GeoTargetTypeSetting
	9,  // 13: google.ads.googleads.v5.resources.Campaign.local_campaign_setting:type_name -> google.ads.googleads.v5.resources.Campaign.LocalCampaignSetting
	5,  // 14: google.ads.googleads.v5.resources.Campaign.app_campaign_setting:type_name -> google.ads.googleads.v5.resources.Campaign.AppCampaignSetting
	20, // 15: google.ads.googleads.v5.resources.Campaign.experiment_type:type_name -> google.ads.googleads.v5.enums.CampaignExperimentTypeEnum.CampaignExperimentType
	21, // 16: google.ads.googleads.v5.resources.Campaign.bidding_strategy_type:type_name -> google.ads.googleads.v5.enums.BiddingStrategyTypeEnum.BiddingStrategyType
	22, // 17: google.ads.googleads.v5.resources.Campaign.frequency_caps:type_name -> google.ads.googleads.v5.common.FrequencyCapEntry
	23, // 18: google.ads.googleads.v5.resources.Campaign.video_brand_safety_suitability:type_name -> google.ads.googleads.v5.enums.BrandSafetySuitabilityEnum.BrandSafetySuitability
	10, // 19: google.ads.googleads.v5.resources.Campaign.vanity_pharma:type_name -> google.ads.googleads.v5.resources.Campaign.VanityPharma
	11, // 20: google.ads.googleads.v5.resources.Campaign.selective_optimization:type_name -> google.ads.googleads.v5.resources.Campaign.SelectiveOptimization
	8,  // 21: google.ads.googleads.v5.resources.Campaign.optimization_goal_setting:type_name -> google.ads.googleads.v5.resources.Campaign.OptimizationGoalSetting
	7,  // 22: google.ads.googleads.v5.resources.Campaign.tracking_setting:type_name -> google.ads.googleads.v5.resources.Campaign.TrackingSetting
	24, // 23: google.ads.googleads.v5.resources.Campaign.payment_mode:type_name -> google.ads.googleads.v5.enums.PaymentModeEnum.PaymentMode
	25, // 24: google.ads.googleads.v5.resources.Campaign.commission:type_name -> google.ads.googleads.v5.common.Commission
	26, // 25: google.ads.googleads.v5.resources.Campaign.manual_cpc:type_name -> google.ads.googleads.v5.common.ManualCpc
	27, // 26: google.ads.googleads.v5.resources.Campaign.manual_cpm:type_name -> google.ads.googleads.v5.common.ManualCpm
	28, // 27: google.ads.googleads.v5.resources.Campaign.manual_cpv:type_name -> google.ads.googleads.v5.common.ManualCpv
	29, // 28: google.ads.googleads.v5.resources.Campaign.maximize_conversions:type_name -> google.ads.googleads.v5.common.MaximizeConversions
	30, // 29: google.ads.googleads.v5.resources.Campaign.maximize_conversion_value:type_name -> google.ads.googleads.v5.common.MaximizeConversionValue
	31, // 30: google.ads.googleads.v5.resources.Campaign.target_cpa:type_name -> google.ads.googleads.v5.common.TargetCpa
	32, // 31: google.ads.googleads.v5.resources.Campaign.target_impression_share:type_name -> google.ads.googleads.v5.common.TargetImpressionShare
	33, // 32: google.ads.googleads.v5.resources.Campaign.target_roas:type_name -> google.ads.googleads.v5.common.TargetRoas
	34, // 33: google.ads.googleads.v5.resources.Campaign.target_spend:type_name -> google.ads.googleads.v5.common.TargetSpend
	35, // 34: google.ads.googleads.v5.resources.Campaign.percent_cpc:type_name -> google.ads.googleads.v5.common.PercentCpc
	36, // 35: google.ads.googleads.v5.resources.Campaign.target_cpm:type_name -> google.ads.googleads.v5.common.TargetCpm
	37, // 36: google.ads.googleads.v5.resources.Campaign.GeoTargetTypeSetting.positive_geo_target_type:type_name -> google.ads.googleads.v5.enums.PositiveGeoTargetTypeEnum.PositiveGeoTargetType
	38, // 37: google.ads.googleads.v5.resources.Campaign.GeoTargetTypeSetting.negative_geo_target_type:type_name -> google.ads.googleads.v5.enums.NegativeGeoTargetTypeEnum.NegativeGeoTargetType
	39, // 38: google.ads.googleads.v5.resources.Campaign.AppCampaignSetting.bidding_strategy_goal_type:type_name -> google.ads.googleads.v5.enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType
	40, // 39: google.ads.googleads.v5.resources.Campaign.AppCampaignSetting.app_store:type_name -> google.ads.googleads.v5.enums.AppCampaignAppStoreEnum.AppCampaignAppStore
	41, // 40: google.ads.googleads.v5.resources.Campaign.OptimizationGoalSetting.optimization_goal_types:type_name -> google.ads.googleads.v5.enums.OptimizationGoalTypeEnum.OptimizationGoalType
	42, // 41: google.ads.googleads.v5.resources.Campaign.LocalCampaignSetting.location_source_type:type_name -> google.ads.googleads.v5.enums.LocationSourceTypeEnum.LocationSourceType
	43, // 42: google.ads.googleads.v5.resources.Campaign.VanityPharma.vanity_pharma_display_url_mode:type_name -> google.ads.googleads.v5.enums.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode
	44, // 43: google.ads.googleads.v5.resources.Campaign.VanityPharma.vanity_pharma_text:type_name -> google.ads.googleads.v5.enums.VanityPharmaTextEnum.VanityPharmaText
...
func init() { file_google_ads_googleads_v5_resources_campaign_proto_init() }
func file_google_ads_googleads_v5_resources_campaign_proto_init() {
	if File_google_ads_googleads_v5_resources_campaign_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[5].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v5_resources_campaign_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v5_resources_campaign_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v5_resources_campaign_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v5_resources_campaign_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v5_resources_campaign_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v5_resources_campaign_proto = out.File
	file_google_ads_googleads_v5_resources_campaign_proto_rawDesc = nil
	file_google_ads_googleads_v5_resources_campaign_proto_goTypes = nil
	file_google_ads_googleads_v5_resources_campaign_proto_depIdxs = nil
}
