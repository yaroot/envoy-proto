...
func (x *FeedItemTarget) Reset() {
	*x = FeedItemTarget{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_feed_item_target_proto_msgTypes[0]
...
func (*FeedItemTarget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescGZIP(), []int{0}
}
...
type FeedItemTarget_Device struct {
	...
	Device enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice `protobuf:"varint,9,opt,name=device,proto3,enum=google.ads.googleads.v5.enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice,oneof"`
}
...
var File_google_ads_googleads_v5_resources_feed_item_target_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDesc = []byte{
	...
	0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x69, 0x74,
	...
	0x73, 0x2e, 0x76, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x49,
	...
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x46,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x41, 0x64, 0x53, 0x63,
...
var (
	file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescData = file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDesc
)

func file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescData)
	})
	return file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDescData
}
...
var file_google_ads_googleads_v5_resources_feed_item_target_proto_goTypes = []interface{}{
	...
	(*common.AdScheduleInfo)(nil),                            // 7: google.ads.googleads.v5.common.AdScheduleInfo
}
var file_google_ads_googleads_v5_resources_feed_item_target_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v5.resources.FeedItemTarget.feed_item:type_name -> google.protobuf.StringValue
	2,  // 1: google.ads.googleads.v5.resources.FeedItemTarget.feed_item_target_type:type_name -> google.ads.googleads.v5.enums.FeedItemTargetTypeEnum.FeedItemTargetType
	3,  // 2: google.ads.googleads.v5.resources.FeedItemTarget.feed_item_target_id:type_name -> google.protobuf.Int64Value
	4,  // 3: google.ads.googleads.v5.resources.FeedItemTarget.status:type_name -> google.ads.googleads.v5.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus
	1,  // 4: google.ads.googleads.v5.resources.FeedItemTarget.campaign:type_name -> google.protobuf.StringValue
	1,  // 5: google.ads.googleads.v5.resources.FeedItemTarget.ad_group:type_name -> google.protobuf.StringValue
	5,  // 6: google.ads.googleads.v5.resources.FeedItemTarget.keyword:type_name -> google.ads.googleads.v5.common.KeywordInfo
	1,  // 7: google.ads.googleads.v5.resources.FeedItemTarget.geo_target_constant:type_name -> google.protobuf.StringValue
	6,  // 8: google.ads.googleads.v5.resources.FeedItemTarget.device:type_name -> google.ads.googleads.v5.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice
	7,  // 9: google.ads.googleads.v5.resources.FeedItemTarget.ad_schedule:type_name -> google.ads.googleads.v5.common.AdScheduleInfo
...
func init() { file_google_ads_googleads_v5_resources_feed_item_target_proto_init() }
func file_google_ads_googleads_v5_resources_feed_item_target_proto_init() {
	if File_google_ads_googleads_v5_resources_feed_item_target_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v5_resources_feed_item_target_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v5_resources_feed_item_target_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v5_resources_feed_item_target_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v5_resources_feed_item_target_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v5_resources_feed_item_target_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v5_resources_feed_item_target_proto = out.File
	file_google_ads_googleads_v5_resources_feed_item_target_proto_rawDesc = nil
	file_google_ads_googleads_v5_resources_feed_item_target_proto_goTypes = nil
	file_google_ads_googleads_v5_resources_feed_item_target_proto_depIdxs = nil
}
