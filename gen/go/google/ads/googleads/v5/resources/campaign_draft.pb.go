...
func (x *CampaignDraft) Reset() {
	*x = CampaignDraft{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v5_resources_campaign_draft_proto_msgTypes[0]
...
func (*CampaignDraft) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v5_resources_campaign_draft_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDesc = []byte{
	...
	0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x39, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2f, 0x76, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x61, 0x6d, 0x70, 0x61,
...
var (
	file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescData = file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDesc
)

func file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescData)
	})
	return file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDescData
}
...
var file_google_ads_googleads_v5_resources_campaign_draft_proto_depIdxs = []int32{
	...
	2, // 1: google.ads.googleads.v5.resources.CampaignDraft.base_campaign:type_name -> google.protobuf.StringValue
	2, // 2: google.ads.googleads.v5.resources.CampaignDraft.name:type_name -> google.protobuf.StringValue
	2, // 3: google.ads.googleads.v5.resources.CampaignDraft.draft_campaign:type_name -> google.protobuf.StringValue
	3, // 4: google.ads.googleads.v5.resources.CampaignDraft.status:type_name -> google.ads.googleads.v5.enums.CampaignDraftStatusEnum.CampaignDraftStatus
	4, // 5: google.ads.googleads.v5.resources.CampaignDraft.has_experiment_running:type_name -> google.protobuf.BoolValue
	2, // 6: google.ads.googleads.v5.resources.CampaignDraft.long_running_operation:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v5_resources_campaign_draft_proto_init() }
func file_google_ads_googleads_v5_resources_campaign_draft_proto_init() {
	if File_google_ads_googleads_v5_resources_campaign_draft_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v5_resources_campaign_draft_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v5_resources_campaign_draft_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v5_resources_campaign_draft_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v5_resources_campaign_draft_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v5_resources_campaign_draft_proto = out.File
	file_google_ads_googleads_v5_resources_campaign_draft_proto_rawDesc = nil
	file_google_ads_googleads_v5_resources_campaign_draft_proto_goTypes = nil
	file_google_ads_googleads_v5_resources_campaign_draft_proto_depIdxs = nil
}
