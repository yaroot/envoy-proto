...
func (x *AdTextAsset) Reset() {
	*x = AdTextAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[0]
...
func (x *AdImageAsset) Reset() {
	*x = AdImageAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *AdVideoAsset) Reset() {
	*x = AdVideoAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *AdMediaBundleAsset) Reset() {
	*x = AdMediaBundleAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_google_ads_googleads_v2_common_ad_asset_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v2_common_ad_asset_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_common_ad_asset_proto_rawDescData = file_google_ads_googleads_v2_common_ad_asset_proto_rawDesc
)

func file_google_ads_googleads_v2_common_ad_asset_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_common_ad_asset_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_common_ad_asset_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_common_ad_asset_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_common_ad_asset_proto_rawDescData
}
...
var file_google_ads_googleads_v2_common_ad_asset_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v2.common.AdTextAsset.text:type_name -> google.protobuf.StringValue
	5, // 1: google.ads.googleads.v2.common.AdTextAsset.pinned_field:type_name -> google.ads.googleads.v2.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType
	4, // 2: google.ads.googleads.v2.common.AdImageAsset.asset:type_name -> google.protobuf.StringValue
	4, // 3: google.ads.googleads.v2.common.AdVideoAsset.asset:type_name -> google.protobuf.StringValue
	4, // 4: google.ads.googleads.v2.common.AdMediaBundleAsset.asset:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v2_common_ad_asset_proto_init() }
func file_google_ads_googleads_v2_common_ad_asset_proto_init() {
	if File_google_ads_googleads_v2_common_ad_asset_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_common_ad_asset_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v2_common_ad_asset_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_common_ad_asset_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_common_ad_asset_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_common_ad_asset_proto = out.File
	file_google_ads_googleads_v2_common_ad_asset_proto_rawDesc = nil
	file_google_ads_googleads_v2_common_ad_asset_proto_goTypes = nil
	file_google_ads_googleads_v2_common_ad_asset_proto_depIdxs = nil
}
