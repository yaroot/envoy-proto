...
func (x *YoutubeVideoAsset) Reset() {
	*x = YoutubeVideoAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[0]
...
func (*YoutubeVideoAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_common_asset_types_proto_rawDescGZIP(), []int{0}
}
...
func (x *MediaBundleAsset) Reset() {
	*x = MediaBundleAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaBundleAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_common_asset_types_proto_rawDescGZIP(), []int{1}
}
...
func (x *ImageAsset) Reset() {
	*x = ImageAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImageAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_common_asset_types_proto_rawDescGZIP(), []int{2}
}
...
func (x *ImageDimension) Reset() {
	*x = ImageDimension{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImageDimension) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_common_asset_types_proto_rawDescGZIP(), []int{3}
}
...
func (x *TextAsset) Reset() {
	*x = TextAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TextAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_common_asset_types_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v2_common_asset_types_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v2_common_asset_types_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_common_asset_types_proto_rawDescData = file_google_ads_googleads_v2_common_asset_types_proto_rawDesc
)

func file_google_ads_googleads_v2_common_asset_types_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_common_asset_types_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_common_asset_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_common_asset_types_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_common_asset_types_proto_rawDescData
}

var file_google_ads_googleads_v2_common_asset_types_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v2_common_asset_types_proto_goTypes = []interface{}{
	(*YoutubeVideoAsset)(nil),        // 0: google.ads.googleads.v2.common.YoutubeVideoAsset
	(*MediaBundleAsset)(nil),         // 1: google.ads.googleads.v2.common.MediaBundleAsset
	(*ImageAsset)(nil),               // 2: google.ads.googleads.v2.common.ImageAsset
	(*ImageDimension)(nil),           // 3: google.ads.googleads.v2.common.ImageDimension
	(*TextAsset)(nil),                // 4: google.ads.googleads.v2.common.TextAsset
	(*wrapperspb.StringValue)(nil),   // 5: google.protobuf.StringValue
	(*wrapperspb.BytesValue)(nil),    // 6: google.protobuf.BytesValue
	(*wrapperspb.Int64Value)(nil),    // 7: google.protobuf.Int64Value
	(enums.MimeTypeEnum_MimeType)(0), // 8: google.ads.googleads.v2.enums.MimeTypeEnum.MimeType
}
var file_google_ads_googleads_v2_common_asset_types_proto_depIdxs = []int32{
	5,  // 0: google.ads.googleads.v2.common.YoutubeVideoAsset.youtube_video_id:type_name -> google.protobuf.StringValue
	6,  // 1: google.ads.googleads.v2.common.MediaBundleAsset.data:type_name -> google.protobuf.BytesValue
	6,  // 2: google.ads.googleads.v2.common.ImageAsset.data:type_name -> google.protobuf.BytesValue
	7,  // 3: google.ads.googleads.v2.common.ImageAsset.file_size:type_name -> google.protobuf.Int64Value
	8,  // 4: google.ads.googleads.v2.common.ImageAsset.mime_type:type_name -> google.ads.googleads.v2.enums.MimeTypeEnum.MimeType
	3,  // 5: google.ads.googleads.v2.common.ImageAsset.full_size:type_name -> google.ads.googleads.v2.common.ImageDimension
	7,  // 6: google.ads.googleads.v2.common.ImageDimension.height_pixels:type_name -> google.protobuf.Int64Value
	7,  // 7: google.ads.googleads.v2.common.ImageDimension.width_pixels:type_name -> google.protobuf.Int64Value
	5,  // 8: google.ads.googleads.v2.common.ImageDimension.url:type_name -> google.protobuf.StringValue
	5,  // 9: google.ads.googleads.v2.common.TextAsset.text:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v2_common_asset_types_proto_init() }
func file_google_ads_googleads_v2_common_asset_types_proto_init() {
	if File_google_ads_googleads_v2_common_asset_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_common_asset_types_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_common_asset_types_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v2_common_asset_types_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_common_asset_types_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_common_asset_types_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_common_asset_types_proto = out.File
	file_google_ads_googleads_v2_common_asset_types_proto_rawDesc = nil
	file_google_ads_googleads_v2_common_asset_types_proto_goTypes = nil
	file_google_ads_googleads_v2_common_asset_types_proto_depIdxs = nil
}
