...
func (x *AdGroupSimulation) Reset() {
	*x = AdGroupSimulation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_resources_ad_group_simulation_proto_msgTypes[0]
...
func (*AdGroupSimulation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v2_resources_ad_group_simulation_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescData = file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDesc
)

func file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDescData
}

var file_google_ads_googleads_v2_resources_ad_group_simulation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v2_resources_ad_group_simulation_proto_goTypes = []interface{}{
	(*AdGroupSimulation)(nil),                                                // 0: google.ads.googleads.v2.resources.AdGroupSimulation
	...
	(*common.CpvBidSimulationPointList)(nil),                                 // 6: google.ads.googleads.v2.common.CpvBidSimulationPointList
	(*common.TargetCpaSimulationPointList)(nil),                              // 7: google.ads.googleads.v2.common.TargetCpaSimulationPointList
}
var file_google_ads_googleads_v2_resources_ad_group_simulation_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v2.resources.AdGroupSimulation.ad_group_id:type_name -> google.protobuf.Int64Value
	2, // 1: google.ads.googleads.v2.resources.AdGroupSimulation.type:type_name -> google.ads.googleads.v2.enums.SimulationTypeEnum.SimulationType
	3, // 2: google.ads.googleads.v2.resources.AdGroupSimulation.modification_method:type_name -> google.ads.googleads.v2.enums.SimulationModificationMethodEnum.SimulationModificationMethod
	4, // 3: google.ads.googleads.v2.resources.AdGroupSimulation.start_date:type_name -> google.protobuf.StringValue
	4, // 4: google.ads.googleads.v2.resources.AdGroupSimulation.end_date:type_name -> google.protobuf.StringValue
	5, // 5: google.ads.googleads.v2.resources.AdGroupSimulation.cpc_bid_point_list:type_name -> google.ads.googleads.v2.common.CpcBidSimulationPointList
	6, // 6: google.ads.googleads.v2.resources.AdGroupSimulation.cpv_bid_point_list:type_name -> google.ads.googleads.v2.common.CpvBidSimulationPointList
	7, // 7: google.ads.googleads.v2.resources.AdGroupSimulation.target_cpa_point_list:type_name -> google.ads.googleads.v2.common.TargetCpaSimulationPointList
...
func init() { file_google_ads_googleads_v2_resources_ad_group_simulation_proto_init() }
func file_google_ads_googleads_v2_resources_ad_group_simulation_proto_init() {
	if File_google_ads_googleads_v2_resources_ad_group_simulation_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_resources_ad_group_simulation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v2_resources_ad_group_simulation_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v2_resources_ad_group_simulation_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_resources_ad_group_simulation_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_resources_ad_group_simulation_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_resources_ad_group_simulation_proto = out.File
	file_google_ads_googleads_v2_resources_ad_group_simulation_proto_rawDesc = nil
	file_google_ads_googleads_v2_resources_ad_group_simulation_proto_goTypes = nil
	file_google_ads_googleads_v2_resources_ad_group_simulation_proto_depIdxs = nil
}
