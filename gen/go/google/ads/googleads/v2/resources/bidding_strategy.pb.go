...
func (x *BiddingStrategy) Reset() {
	*x = BiddingStrategy{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_resources_bidding_strategy_proto_msgTypes[0]
...
func (*BiddingStrategy) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v2_resources_bidding_strategy_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x2c, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x62, 0x69,
	...
	0x73, 0x2f, 0x76, 0x32, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x69, 0x64, 0x64, 0x69,
	...
	0x32, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x69, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x5f,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x69, 0x64,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6e,
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x54, 0x61, 0x72,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x14, 0x42, 0x69, 0x64,
...
var (
	file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescData = file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDesc
)

func file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDescData
}

var file_google_ads_googleads_v2_resources_bidding_strategy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v2_resources_bidding_strategy_proto_goTypes = []interface{}{
	(*BiddingStrategy)(nil),                                    // 0: google.ads.googleads.v2.resources.BiddingStrategy
	(*wrapperspb.Int64Value)(nil),                              // 1: google.protobuf.Int64Value
	(*wrapperspb.StringValue)(nil),                             // 2: google.protobuf.StringValue
	(enums.BiddingStrategyStatusEnum_BiddingStrategyStatus)(0), // 3: google.ads.googleads.v2.enums.BiddingStrategyStatusEnum.BiddingStrategyStatus
	(enums.BiddingStrategyTypeEnum_BiddingStrategyType)(0),     // 4: google.ads.googleads.v2.enums.BiddingStrategyTypeEnum.BiddingStrategyType
	(*common.EnhancedCpc)(nil),                                 // 5: google.ads.googleads.v2.common.EnhancedCpc
	(*common.PageOnePromoted)(nil),                             // 6: google.ads.googleads.v2.common.PageOnePromoted
	(*common.TargetCpa)(nil),                                   // 7: google.ads.googleads.v2.common.TargetCpa
	(*common.TargetImpressionShare)(nil),                       // 8: google.ads.googleads.v2.common.TargetImpressionShare
	(*common.TargetOutrankShare)(nil),                          // 9: google.ads.googleads.v2.common.TargetOutrankShare
	(*common.TargetRoas)(nil),                                  // 10: google.ads.googleads.v2.common.TargetRoas
	(*common.TargetSpend)(nil),                                 // 11: google.ads.googleads.v2.common.TargetSpend
}
var file_google_ads_googleads_v2_resources_bidding_strategy_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v2.resources.BiddingStrategy.id:type_name -> google.protobuf.Int64Value
	2,  // 1: google.ads.googleads.v2.resources.BiddingStrategy.name:type_name -> google.protobuf.StringValue
	3,  // 2: google.ads.googleads.v2.resources.BiddingStrategy.status:type_name -> google.ads.googleads.v2.enums.BiddingStrategyStatusEnum.BiddingStrategyStatus
	4,  // 3: google.ads.googleads.v2.resources.BiddingStrategy.type:type_name -> google.ads.googleads.v2.enums.BiddingStrategyTypeEnum.BiddingStrategyType
	1,  // 4: google.ads.googleads.v2.resources.BiddingStrategy.campaign_count:type_name -> google.protobuf.Int64Value
	1,  // 5: google.ads.googleads.v2.resources.BiddingStrategy.non_removed_campaign_count:type_name -> google.protobuf.Int64Value
	5,  // 6: google.ads.googleads.v2.resources.BiddingStrategy.enhanced_cpc:type_name -> google.ads.googleads.v2.common.EnhancedCpc
	6,  // 7: google.ads.googleads.v2.resources.BiddingStrategy.page_one_promoted:type_name -> google.ads.googleads.v2.common.PageOnePromoted
	7,  // 8: google.ads.googleads.v2.resources.BiddingStrategy.target_cpa:type_name -> google.ads.googleads.v2.common.TargetCpa
	8,  // 9: google.ads.googleads.v2.resources.BiddingStrategy.target_impression_share:type_name -> google.ads.googleads.v2.common.TargetImpressionShare
	9,  // 10: google.ads.googleads.v2.resources.BiddingStrategy.target_outrank_share:type_name -> google.ads.googleads.v2.common.TargetOutrankShare
	10, // 11: google.ads.googleads.v2.resources.BiddingStrategy.target_roas:type_name -> google.ads.googleads.v2.common.TargetRoas
	11, // 12: google.ads.googleads.v2.resources.BiddingStrategy.target_spend:type_name -> google.ads.googleads.v2.common.TargetSpend
...
func init() { file_google_ads_googleads_v2_resources_bidding_strategy_proto_init() }
func file_google_ads_googleads_v2_resources_bidding_strategy_proto_init() {
	if File_google_ads_googleads_v2_resources_bidding_strategy_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_resources_bidding_strategy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v2_resources_bidding_strategy_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v2_resources_bidding_strategy_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_resources_bidding_strategy_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_resources_bidding_strategy_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_resources_bidding_strategy_proto = out.File
	file_google_ads_googleads_v2_resources_bidding_strategy_proto_rawDesc = nil
	file_google_ads_googleads_v2_resources_bidding_strategy_proto_goTypes = nil
	file_google_ads_googleads_v2_resources_bidding_strategy_proto_depIdxs = nil
}
