...
func (x *KeywordPlan) Reset() {
	*x = KeywordPlan{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_resources_keyword_plan_proto_msgTypes[0]
...
func (*KeywordPlan) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanForecastPeriod) Reset() {
	*x = KeywordPlanForecastPeriod{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_resources_keyword_plan_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordPlanForecastPeriod) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v2_resources_keyword_plan_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x64, 0x61, 0x74, 0x65, 0x73, 0x2e,
...
var (
	file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescData = file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDesc
)

func file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDescData
}

var file_google_ads_googleads_v2_resources_keyword_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v2_resources_keyword_plan_proto_goTypes = []interface{}{
	(*KeywordPlan)(nil),               // 0: google.ads.googleads.v2.resources.KeywordPlan
	(*KeywordPlanForecastPeriod)(nil), // 1: google.ads.googleads.v2.resources.KeywordPlanForecastPeriod
	(*wrapperspb.Int64Value)(nil),     // 2: google.protobuf.Int64Value
	(*wrapperspb.StringValue)(nil),    // 3: google.protobuf.StringValue
	(enums.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval)(0), // 4: google.ads.googleads.v2.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval
	(*common.DateRange)(nil), // 5: google.ads.googleads.v2.common.DateRange
}
var file_google_ads_googleads_v2_resources_keyword_plan_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v2.resources.KeywordPlan.id:type_name -> google.protobuf.Int64Value
	3, // 1: google.ads.googleads.v2.resources.KeywordPlan.name:type_name -> google.protobuf.StringValue
	1, // 2: google.ads.googleads.v2.resources.KeywordPlan.forecast_period:type_name -> google.ads.googleads.v2.resources.KeywordPlanForecastPeriod
	4, // 3: google.ads.googleads.v2.resources.KeywordPlanForecastPeriod.date_interval:type_name -> google.ads.googleads.v2.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval
	5, // 4: google.ads.googleads.v2.resources.KeywordPlanForecastPeriod.date_range:type_name -> google.ads.googleads.v2.common.DateRange
...
func init() { file_google_ads_googleads_v2_resources_keyword_plan_proto_init() }
func file_google_ads_googleads_v2_resources_keyword_plan_proto_init() {
	if File_google_ads_googleads_v2_resources_keyword_plan_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_resources_keyword_plan_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_resources_keyword_plan_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v2_resources_keyword_plan_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v2_resources_keyword_plan_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_resources_keyword_plan_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_resources_keyword_plan_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_resources_keyword_plan_proto = out.File
	file_google_ads_googleads_v2_resources_keyword_plan_proto_rawDesc = nil
	file_google_ads_googleads_v2_resources_keyword_plan_proto_goTypes = nil
	file_google_ads_googleads_v2_resources_keyword_plan_proto_depIdxs = nil
}
