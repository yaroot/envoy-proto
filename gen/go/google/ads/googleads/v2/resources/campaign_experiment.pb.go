...
func (x *CampaignExperiment) Reset() {
	*x = CampaignExperiment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_resources_campaign_experiment_proto_msgTypes[0]
...
func (*CampaignExperiment) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v2_resources_campaign_experiment_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x17, 0x43, 0x61,
...
var (
	file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescData = file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDesc
)

func file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDescData
}

var file_google_ads_googleads_v2_resources_campaign_experiment_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v2_resources_campaign_experiment_proto_goTypes = []interface{}{
	(*CampaignExperiment)(nil),     // 0: google.ads.googleads.v2.resources.CampaignExperiment
	(*wrapperspb.Int64Value)(nil),  // 1: google.protobuf.Int64Value
	(*wrapperspb.StringValue)(nil), // 2: google.protobuf.StringValue
	(enums.CampaignExperimentTrafficSplitTypeEnum_CampaignExperimentTrafficSplitType)(0), // 3: google.ads.googleads.v2.enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
	(enums.CampaignExperimentStatusEnum_CampaignExperimentStatus)(0),                     // 4: google.ads.googleads.v2.enums.CampaignExperimentStatusEnum.CampaignExperimentStatus
}
var file_google_ads_googleads_v2_resources_campaign_experiment_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v2.resources.CampaignExperiment.id:type_name -> google.protobuf.Int64Value
	2,  // 1: google.ads.googleads.v2.resources.CampaignExperiment.campaign_draft:type_name -> google.protobuf.StringValue
	2,  // 2: google.ads.googleads.v2.resources.CampaignExperiment.name:type_name -> google.protobuf.StringValue
	2,  // 3: google.ads.googleads.v2.resources.CampaignExperiment.description:type_name -> google.protobuf.StringValue
	1,  // 4: google.ads.googleads.v2.resources.CampaignExperiment.traffic_split_percent:type_name -> google.protobuf.Int64Value
	3,  // 5: google.ads.googleads.v2.resources.CampaignExperiment.traffic_split_type:type_name -> google.ads.googleads.v2.enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
	2,  // 6: google.ads.googleads.v2.resources.CampaignExperiment.experiment_campaign:type_name -> google.protobuf.StringValue
	4,  // 7: google.ads.googleads.v2.resources.CampaignExperiment.status:type_name -> google.ads.googleads.v2.enums.CampaignExperimentStatusEnum.CampaignExperimentStatus
	2,  // 8: google.ads.googleads.v2.resources.CampaignExperiment.long_running_operation:type_name -> google.protobuf.StringValue
	2,  // 9: google.ads.googleads.v2.resources.CampaignExperiment.start_date:type_name -> google.protobuf.StringValue
	2,  // 10: google.ads.googleads.v2.resources.CampaignExperiment.end_date:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v2_resources_campaign_experiment_proto_init() }
func file_google_ads_googleads_v2_resources_campaign_experiment_proto_init() {
	if File_google_ads_googleads_v2_resources_campaign_experiment_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_resources_campaign_experiment_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v2_resources_campaign_experiment_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_resources_campaign_experiment_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_resources_campaign_experiment_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_resources_campaign_experiment_proto = out.File
	file_google_ads_googleads_v2_resources_campaign_experiment_proto_rawDesc = nil
	file_google_ads_googleads_v2_resources_campaign_experiment_proto_goTypes = nil
	file_google_ads_googleads_v2_resources_campaign_experiment_proto_depIdxs = nil
}
