...
func (x *GetAdRequest) Reset() {
	*x = GetAdRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[0]
...
func (*GetAdRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdsRequest) Reset() {
	*x = MutateAdsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdOperation) Reset() {
	*x = AdOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdsResponse) Reset() {
	*x = MutateAdsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdResult) Reset() {
	*x = MutateAdResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v2_services_ad_service_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x3d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x27, 0x12, 0x25, 0x2f, 0x76, 0x32, 0x2f, 0x7b,
	...
	0x28, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x7b,
	...
	0x76, 0x32, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x0e, 0x41, 0x64, 0x53,
...
var (
	file_google_ads_googleads_v2_services_ad_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_services_ad_service_proto_rawDescData = file_google_ads_googleads_v2_services_ad_service_proto_rawDesc
)

func file_google_ads_googleads_v2_services_ad_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_services_ad_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_services_ad_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_services_ad_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_services_ad_service_proto_rawDescData
}

var file_google_ads_googleads_v2_services_ad_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v2_services_ad_service_proto_goTypes = []interface{}{
	(*GetAdRequest)(nil),          // 0: google.ads.googleads.v2.services.GetAdRequest
	(*MutateAdsRequest)(nil),      // 1: google.ads.googleads.v2.services.MutateAdsRequest
	(*AdOperation)(nil),           // 2: google.ads.googleads.v2.services.AdOperation
	(*MutateAdsResponse)(nil),     // 3: google.ads.googleads.v2.services.MutateAdsResponse
	(*MutateAdResult)(nil),        // 4: google.ads.googleads.v2.services.MutateAdResult
	(*fieldmaskpb.FieldMask)(nil), // 5: google.protobuf.FieldMask
	(*resources.Ad)(nil),          // 6: google.ads.googleads.v2.resources.Ad
}
var file_google_ads_googleads_v2_services_ad_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v2.services.MutateAdsRequest.operations:type_name -> google.ads.googleads.v2.services.AdOperation
	5, // 1: google.ads.googleads.v2.services.AdOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v2.services.AdOperation.update:type_name -> google.ads.googleads.v2.resources.Ad
	4, // 3: google.ads.googleads.v2.services.MutateAdsResponse.results:type_name -> google.ads.googleads.v2.services.MutateAdResult
	0, // 4: google.ads.googleads.v2.services.AdService.GetAd:input_type -> google.ads.googleads.v2.services.GetAdRequest
	1, // 5: google.ads.googleads.v2.services.AdService.MutateAds:input_type -> google.ads.googleads.v2.services.MutateAdsRequest
	6, // 6: google.ads.googleads.v2.services.AdService.GetAd:output_type -> google.ads.googleads.v2.resources.Ad
	3, // 7: google.ads.googleads.v2.services.AdService.MutateAds:output_type -> google.ads.googleads.v2.services.MutateAdsResponse
...
func init() { file_google_ads_googleads_v2_services_ad_service_proto_init() }
func file_google_ads_googleads_v2_services_ad_service_proto_init() {
	if File_google_ads_googleads_v2_services_ad_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v2_services_ad_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_services_ad_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v2_services_ad_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_services_ad_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_services_ad_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_services_ad_service_proto = out.File
	file_google_ads_googleads_v2_services_ad_service_proto_rawDesc = nil
	file_google_ads_googleads_v2_services_ad_service_proto_goTypes = nil
	file_google_ads_googleads_v2_services_ad_service_proto_depIdxs = nil
}
