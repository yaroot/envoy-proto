...
func (x *GetAdGroupCriterionLabelRequest) Reset() {
	*x = GetAdGroupCriterionLabelRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[0]
...
func (*GetAdGroupCriterionLabelRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdGroupCriterionLabelsRequest) Reset() {
	*x = MutateAdGroupCriterionLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdGroupCriterionLabelOperation) Reset() {
	*x = AdGroupCriterionLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupCriterionLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriterionLabelsResponse) Reset() {
	*x = MutateAdGroupCriterionLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdGroupCriterionLabelResult) Reset() {
	*x = MutateAdGroupCriterionLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x40, 0x67, 0x6f, 0x6f,
	...
	0x50, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x3a, 0x12, 0x38, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x72, 0x65,
	...
	0x65, 0x22, 0x5f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x40, 0x22, 0x3b, 0x2f, 0x76, 0x32, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescData = file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDesc
)

func file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDescData
}

var file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_goTypes = []interface{}{
	(*GetAdGroupCriterionLabelRequest)(nil),      // 0: google.ads.googleads.v2.services.GetAdGroupCriterionLabelRequest
	(*MutateAdGroupCriterionLabelsRequest)(nil),  // 1: google.ads.googleads.v2.services.MutateAdGroupCriterionLabelsRequest
	(*AdGroupCriterionLabelOperation)(nil),       // 2: google.ads.googleads.v2.services.AdGroupCriterionLabelOperation
	(*MutateAdGroupCriterionLabelsResponse)(nil), // 3: google.ads.googleads.v2.services.MutateAdGroupCriterionLabelsResponse
	(*MutateAdGroupCriterionLabelResult)(nil),    // 4: google.ads.googleads.v2.services.MutateAdGroupCriterionLabelResult
	(*resources.AdGroupCriterionLabel)(nil),      // 5: google.ads.googleads.v2.resources.AdGroupCriterionLabel
	(*status.Status)(nil),                        // 6: google.rpc.Status
}
var file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v2.services.MutateAdGroupCriterionLabelsRequest.operations:type_name -> google.ads.googleads.v2.services.AdGroupCriterionLabelOperation
	5, // 1: google.ads.googleads.v2.services.AdGroupCriterionLabelOperation.create:type_name -> google.ads.googleads.v2.resources.AdGroupCriterionLabel
	6, // 2: google.ads.googleads.v2.services.MutateAdGroupCriterionLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v2.services.MutateAdGroupCriterionLabelsResponse.results:type_name -> google.ads.googleads.v2.services.MutateAdGroupCriterionLabelResult
	0, // 4: google.ads.googleads.v2.services.AdGroupCriterionLabelService.GetAdGroupCriterionLabel:input_type -> google.ads.googleads.v2.services.GetAdGroupCriterionLabelRequest
	1, // 5: google.ads.googleads.v2.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:input_type -> google.ads.googleads.v2.services.MutateAdGroupCriterionLabelsRequest
	5, // 6: google.ads.googleads.v2.services.AdGroupCriterionLabelService.GetAdGroupCriterionLabel:output_type -> google.ads.googleads.v2.resources.AdGroupCriterionLabel
	3, // 7: google.ads.googleads.v2.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:output_type -> google.ads.googleads.v2.services.MutateAdGroupCriterionLabelsResponse
...
func init() { file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_init() }
func file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_init() {
	if File_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto = out.File
	file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_goTypes = nil
	file_google_ads_googleads_v2_services_ad_group_criterion_label_service_proto_depIdxs = nil
}
