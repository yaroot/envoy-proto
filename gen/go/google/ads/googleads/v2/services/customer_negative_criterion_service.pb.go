...
func (x *GetCustomerNegativeCriterionRequest) Reset() {
	*x = GetCustomerNegativeCriterionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[0]
...
func (*GetCustomerNegativeCriterionRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerNegativeCriteriaRequest) Reset() {
	*x = MutateCustomerNegativeCriteriaRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerNegativeCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerNegativeCriterionOperation) Reset() {
	*x = CustomerNegativeCriterionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerNegativeCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerNegativeCriteriaResponse) Reset() {
	*x = MutateCustomerNegativeCriteriaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerNegativeCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerNegativeCriteriaResult) Reset() {
	*x = MutateCustomerNegativeCriteriaResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerNegativeCriteriaResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x43,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x42, 0x22, 0x3d, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescData = file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_goTypes = []interface{}{
	(*GetCustomerNegativeCriterionRequest)(nil),    // 0: google.ads.googleads.v2.services.GetCustomerNegativeCriterionRequest
	(*MutateCustomerNegativeCriteriaRequest)(nil),  // 1: google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest
	(*CustomerNegativeCriterionOperation)(nil),     // 2: google.ads.googleads.v2.services.CustomerNegativeCriterionOperation
	(*MutateCustomerNegativeCriteriaResponse)(nil), // 3: google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse
	(*MutateCustomerNegativeCriteriaResult)(nil),   // 4: google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResult
	(*resources.CustomerNegativeCriterion)(nil),    // 5: google.ads.googleads.v2.resources.CustomerNegativeCriterion
	(*status.Status)(nil),                          // 6: google.rpc.Status
}
var file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest.operations:type_name -> google.ads.googleads.v2.services.CustomerNegativeCriterionOperation
	5, // 1: google.ads.googleads.v2.services.CustomerNegativeCriterionOperation.create:type_name -> google.ads.googleads.v2.resources.CustomerNegativeCriterion
	6, // 2: google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse.results:type_name -> google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResult
	0, // 4: google.ads.googleads.v2.services.CustomerNegativeCriterionService.GetCustomerNegativeCriterion:input_type -> google.ads.googleads.v2.services.GetCustomerNegativeCriterionRequest
	1, // 5: google.ads.googleads.v2.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria:input_type -> google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest
	5, // 6: google.ads.googleads.v2.services.CustomerNegativeCriterionService.GetCustomerNegativeCriterion:output_type -> google.ads.googleads.v2.resources.CustomerNegativeCriterion
	3, // 7: google.ads.googleads.v2.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria:output_type -> google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse
...
func init() { file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_init() }
func file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_init() {
	if File_google_ads_googleads_v2_services_customer_negative_criterion_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_services_customer_negative_criterion_service_proto = out.File
	file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v2_services_customer_negative_criterion_service_proto_depIdxs = nil
}
