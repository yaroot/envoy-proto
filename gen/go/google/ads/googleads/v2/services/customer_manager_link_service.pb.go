...
func (x *GetCustomerManagerLinkRequest) Reset() {
	*x = GetCustomerManagerLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[0]
...
func (*GetCustomerManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerManagerLinkRequest) Reset() {
	*x = MutateCustomerManagerLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerManagerLinkOperation) Reset() {
	*x = CustomerManagerLinkOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *MutateCustomerManagerLinkResponse) Reset() {
	*x = MutateCustomerManagerLinkResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerManagerLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerManagerLinkResult) Reset() {
	*x = MutateCustomerManagerLinkResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerManagerLinkResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDesc = []byte{
	...
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x4c,
	0x69, 0x6e, 0x6b, 0x22, 0x4e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x38, 0x12, 0x36, 0x2f, 0x76, 0x32,
...
var (
	file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescData = file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDesc
)

func file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDescData
}

var file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v2_services_customer_manager_link_service_proto_goTypes = []interface{}{
	(*GetCustomerManagerLinkRequest)(nil),     // 0: google.ads.googleads.v2.services.GetCustomerManagerLinkRequest
	(*MutateCustomerManagerLinkRequest)(nil),  // 1: google.ads.googleads.v2.services.MutateCustomerManagerLinkRequest
...
var file_google_ads_googleads_v2_services_customer_manager_link_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v2.services.MutateCustomerManagerLinkRequest.operations:type_name -> google.ads.googleads.v2.services.CustomerManagerLinkOperation
	5, // 1: google.ads.googleads.v2.services.CustomerManagerLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v2.services.CustomerManagerLinkOperation.update:type_name -> google.ads.googleads.v2.resources.CustomerManagerLink
	4, // 3: google.ads.googleads.v2.services.MutateCustomerManagerLinkResponse.results:type_name -> google.ads.googleads.v2.services.MutateCustomerManagerLinkResult
	0, // 4: google.ads.googleads.v2.services.CustomerManagerLinkService.GetCustomerManagerLink:input_type -> google.ads.googleads.v2.services.GetCustomerManagerLinkRequest
	1, // 5: google.ads.googleads.v2.services.CustomerManagerLinkService.MutateCustomerManagerLink:input_type -> google.ads.googleads.v2.services.MutateCustomerManagerLinkRequest
	6, // 6: google.ads.googleads.v2.services.CustomerManagerLinkService.GetCustomerManagerLink:output_type -> google.ads.googleads.v2.resources.CustomerManagerLink
	3, // 7: google.ads.googleads.v2.services.CustomerManagerLinkService.MutateCustomerManagerLink:output_type -> google.ads.googleads.v2.services.MutateCustomerManagerLinkResponse
...
func init() { file_google_ads_googleads_v2_services_customer_manager_link_service_proto_init() }
func file_google_ads_googleads_v2_services_customer_manager_link_service_proto_init() {
	if File_google_ads_googleads_v2_services_customer_manager_link_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v2_services_customer_manager_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v2_services_customer_manager_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v2_services_customer_manager_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v2_services_customer_manager_link_service_proto = out.File
	file_google_ads_googleads_v2_services_customer_manager_link_service_proto_rawDesc = nil
	file_google_ads_googleads_v2_services_customer_manager_link_service_proto_goTypes = nil
	file_google_ads_googleads_v2_services_customer_manager_link_service_proto_depIdxs = nil
}
