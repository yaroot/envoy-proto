...
func (x *TopicConstant) Reset() {
	*x = TopicConstant{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_topic_constant_proto_msgTypes[0]
...
func (*TopicConstant) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v4_resources_topic_constant_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_resources_topic_constant_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescData = file_google_ads_googleads_v4_resources_topic_constant_proto_rawDesc
)

func file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_resources_topic_constant_proto_rawDescData
}
...
var file_google_ads_googleads_v4_resources_topic_constant_proto_depIdxs = []int32{
	...
	2, // 1: google.ads.googleads.v4.resources.TopicConstant.topic_constant_parent:type_name -> google.protobuf.StringValue
	2, // 2: google.ads.googleads.v4.resources.TopicConstant.path:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v4_resources_topic_constant_proto_init() }
func file_google_ads_googleads_v4_resources_topic_constant_proto_init() {
	if File_google_ads_googleads_v4_resources_topic_constant_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_resources_topic_constant_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_resources_topic_constant_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v4_resources_topic_constant_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_resources_topic_constant_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_resources_topic_constant_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_resources_topic_constant_proto = out.File
	file_google_ads_googleads_v4_resources_topic_constant_proto_rawDesc = nil
	file_google_ads_googleads_v4_resources_topic_constant_proto_goTypes = nil
	file_google_ads_googleads_v4_resources_topic_constant_proto_depIdxs = nil
}
