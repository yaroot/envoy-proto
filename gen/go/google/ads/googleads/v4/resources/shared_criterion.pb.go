...
func (x *SharedCriterion) Reset() {
	*x = SharedCriterion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_shared_criterion_proto_msgTypes[0]
...
func (*SharedCriterion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v4_resources_shared_criterion_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2f, 0x76, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x72, 0x69, 0x74,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4b,
	...
	0x73, 0x2e, 0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x6f, 0x62, 0x69,
...
var (
	file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescData = file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDesc
)

func file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDescData
}
...
var file_google_ads_googleads_v4_resources_shared_criterion_proto_goTypes = []interface{}{
	...
	(*common.YouTubeChannelInfo)(nil),          // 6: google.ads.googleads.v4.common.YouTubeChannelInfo
	(*common.PlacementInfo)(nil),               // 7: google.ads.googleads.v4.common.PlacementInfo
	(*common.MobileAppCategoryInfo)(nil),       // 8: google.ads.googleads.v4.common.MobileAppCategoryInfo
	(*common.MobileApplicationInfo)(nil),       // 9: google.ads.googleads.v4.common.MobileApplicationInfo
}
var file_google_ads_googleads_v4_resources_shared_criterion_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v4.resources.SharedCriterion.shared_set:type_name -> google.protobuf.StringValue
	2, // 1: google.ads.googleads.v4.resources.SharedCriterion.criterion_id:type_name -> google.protobuf.Int64Value
	3, // 2: google.ads.googleads.v4.resources.SharedCriterion.type:type_name -> google.ads.googleads.v4.enums.CriterionTypeEnum.CriterionType
	4, // 3: google.ads.googleads.v4.resources.SharedCriterion.keyword:type_name -> google.ads.googleads.v4.common.KeywordInfo
	5, // 4: google.ads.googleads.v4.resources.SharedCriterion.youtube_video:type_name -> google.ads.googleads.v4.common.YouTubeVideoInfo
	6, // 5: google.ads.googleads.v4.resources.SharedCriterion.youtube_channel:type_name -> google.ads.googleads.v4.common.YouTubeChannelInfo
	7, // 6: google.ads.googleads.v4.resources.SharedCriterion.placement:type_name -> google.ads.googleads.v4.common.PlacementInfo
	8, // 7: google.ads.googleads.v4.resources.SharedCriterion.mobile_app_category:type_name -> google.ads.googleads.v4.common.MobileAppCategoryInfo
	9, // 8: google.ads.googleads.v4.resources.SharedCriterion.mobile_application:type_name -> google.ads.googleads.v4.common.MobileApplicationInfo
...
func init() { file_google_ads_googleads_v4_resources_shared_criterion_proto_init() }
func file_google_ads_googleads_v4_resources_shared_criterion_proto_init() {
	if File_google_ads_googleads_v4_resources_shared_criterion_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_resources_shared_criterion_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v4_resources_shared_criterion_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v4_resources_shared_criterion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_resources_shared_criterion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_resources_shared_criterion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_resources_shared_criterion_proto = out.File
	file_google_ads_googleads_v4_resources_shared_criterion_proto_rawDesc = nil
	file_google_ads_googleads_v4_resources_shared_criterion_proto_goTypes = nil
	file_google_ads_googleads_v4_resources_shared_criterion_proto_depIdxs = nil
}
