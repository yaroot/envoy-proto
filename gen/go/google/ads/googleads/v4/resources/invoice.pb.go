...
type Invoice struct {
	...
	Type enums.InvoiceTypeEnum_InvoiceType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v4.enums.InvoiceTypeEnum_InvoiceType" json:"type,omitempty"`
...
func (x *Invoice) Reset() {
	*x = Invoice{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_invoice_proto_msgTypes[0]
...
func (*Invoice) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_invoice_proto_rawDescGZIP(), []int{0}
}
...
func (x *Invoice_AccountBudgetSummary) Reset() {
	*x = Invoice_AccountBudgetSummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_invoice_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Invoice_AccountBudgetSummary) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_invoice_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_google_ads_googleads_v4_resources_invoice_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_resources_invoice_proto_rawDesc = []byte{
	...
	0x76, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65,
	...
	0x2e, 0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x44, 0x61, 0x74, 0x65, 0x52,
	...
	0x64, 0x73, 0x2e, 0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x44, 0x61, 0x74,
...
var (
	file_google_ads_googleads_v4_resources_invoice_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_resources_invoice_proto_rawDescData = file_google_ads_googleads_v4_resources_invoice_proto_rawDesc
)

func file_google_ads_googleads_v4_resources_invoice_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_resources_invoice_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_resources_invoice_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_resources_invoice_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_resources_invoice_proto_rawDescData
}

var file_google_ads_googleads_v4_resources_invoice_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v4_resources_invoice_proto_goTypes = []interface{}{
	(*Invoice)(nil),                        // 0: google.ads.googleads.v4.resources.Invoice
	(*Invoice_AccountBudgetSummary)(nil),   // 1: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary
	(*wrapperspb.StringValue)(nil),         // 2: google.protobuf.StringValue
	(enums.InvoiceTypeEnum_InvoiceType)(0), // 3: google.ads.googleads.v4.enums.InvoiceTypeEnum.InvoiceType
	(*common.DateRange)(nil),               // 4: google.ads.googleads.v4.common.DateRange
	(*wrapperspb.Int64Value)(nil),          // 5: google.protobuf.Int64Value
}
var file_google_ads_googleads_v4_resources_invoice_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v4.resources.Invoice.id:type_name -> google.protobuf.StringValue
	3,  // 1: google.ads.googleads.v4.resources.Invoice.type:type_name -> google.ads.googleads.v4.enums.InvoiceTypeEnum.InvoiceType
	2,  // 2: google.ads.googleads.v4.resources.Invoice.billing_setup:type_name -> google.protobuf.StringValue
	2,  // 3: google.ads.googleads.v4.resources.Invoice.payments_account_id:type_name -> google.protobuf.StringValue
	2,  // 4: google.ads.googleads.v4.resources.Invoice.payments_profile_id:type_name -> google.protobuf.StringValue
	2,  // 5: google.ads.googleads.v4.resources.Invoice.issue_date:type_name -> google.protobuf.StringValue
	2,  // 6: google.ads.googleads.v4.resources.Invoice.due_date:type_name -> google.protobuf.StringValue
	4,  // 7: google.ads.googleads.v4.resources.Invoice.service_date_range:type_name -> google.ads.googleads.v4.common.DateRange
	2,  // 8: google.ads.googleads.v4.resources.Invoice.currency_code:type_name -> google.protobuf.StringValue
	5,  // 9: google.ads.googleads.v4.resources.Invoice.invoice_level_adjustments_micros:type_name -> google.protobuf.Int64Value
	5,  // 10: google.ads.googleads.v4.resources.Invoice.subtotal_amount_micros:type_name -> google.protobuf.Int64Value
	5,  // 11: google.ads.googleads.v4.resources.Invoice.tax_amount_micros:type_name -> google.protobuf.Int64Value
	5,  // 12: google.ads.googleads.v4.resources.Invoice.total_amount_micros:type_name -> google.protobuf.Int64Value
	2,  // 13: google.ads.googleads.v4.resources.Invoice.corrected_invoice:type_name -> google.protobuf.StringValue
	2,  // 14: google.ads.googleads.v4.resources.Invoice.replaced_invoices:type_name -> google.protobuf.StringValue
	2,  // 15: google.ads.googleads.v4.resources.Invoice.pdf_url:type_name -> google.protobuf.StringValue
	1,  // 16: google.ads.googleads.v4.resources.Invoice.account_budget_summaries:type_name -> google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary
	2,  // 17: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.customer:type_name -> google.protobuf.StringValue
	2,  // 18: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.customer_descriptive_name:type_name -> google.protobuf.StringValue
	2,  // 19: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.account_budget:type_name -> google.protobuf.StringValue
	2,  // 20: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.account_budget_name:type_name -> google.protobuf.StringValue
	2,  // 21: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.purchase_order_number:type_name -> google.protobuf.StringValue
	5,  // 22: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.subtotal_amount_micros:type_name -> google.protobuf.Int64Value
	5,  // 23: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.tax_amount_micros:type_name -> google.protobuf.Int64Value
	5,  // 24: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.total_amount_micros:type_name -> google.protobuf.Int64Value
	4,  // 25: google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary.billable_activity_date_range:type_name -> google.ads.googleads.v4.common.DateRange
...
func init() { file_google_ads_googleads_v4_resources_invoice_proto_init() }
func file_google_ads_googleads_v4_resources_invoice_proto_init() {
	if File_google_ads_googleads_v4_resources_invoice_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_resources_invoice_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_resources_invoice_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_resources_invoice_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v4_resources_invoice_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_resources_invoice_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_resources_invoice_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_resources_invoice_proto = out.File
	file_google_ads_googleads_v4_resources_invoice_proto_rawDesc = nil
	file_google_ads_googleads_v4_resources_invoice_proto_goTypes = nil
	file_google_ads_googleads_v4_resources_invoice_proto_depIdxs = nil
}
