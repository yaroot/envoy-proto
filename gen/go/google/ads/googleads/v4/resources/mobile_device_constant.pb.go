...
func (x *MobileDeviceConstant) Reset() {
	*x = MobileDeviceConstant{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_mobile_device_constant_proto_msgTypes[0]
...
func (*MobileDeviceConstant) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v4_resources_mobile_device_constant_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDesc = []byte{
	...
	0x76, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x44,
...
var (
	file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescData = file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDesc
)

func file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDescData
}
...
var file_google_ads_googleads_v4_resources_mobile_device_constant_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v4.resources.MobileDeviceConstant.id:type_name -> google.protobuf.Int64Value
	2, // 1: google.ads.googleads.v4.resources.MobileDeviceConstant.name:type_name -> google.protobuf.StringValue
	2, // 2: google.ads.googleads.v4.resources.MobileDeviceConstant.manufacturer_name:type_name -> google.protobuf.StringValue
	2, // 3: google.ads.googleads.v4.resources.MobileDeviceConstant.operating_system_name:type_name -> google.protobuf.StringValue
	3, // 4: google.ads.googleads.v4.resources.MobileDeviceConstant.type:type_name -> google.ads.googleads.v4.enums.MobileDeviceTypeEnum.MobileDeviceType
...
func init() { file_google_ads_googleads_v4_resources_mobile_device_constant_proto_init() }
func file_google_ads_googleads_v4_resources_mobile_device_constant_proto_init() {
	if File_google_ads_googleads_v4_resources_mobile_device_constant_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_resources_mobile_device_constant_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v4_resources_mobile_device_constant_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_resources_mobile_device_constant_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_resources_mobile_device_constant_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_resources_mobile_device_constant_proto = out.File
	file_google_ads_googleads_v4_resources_mobile_device_constant_proto_rawDesc = nil
	file_google_ads_googleads_v4_resources_mobile_device_constant_proto_goTypes = nil
	file_google_ads_googleads_v4_resources_mobile_device_constant_proto_depIdxs = nil
}
