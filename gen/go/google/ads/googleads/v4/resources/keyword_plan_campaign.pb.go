...
type KeywordPlanCampaign struct {
	...
	// This field is required and should not be empty when creating Keyword Plan
	// campaigns.
	KeywordPlanNetwork enums.KeywordPlanNetworkEnum_KeywordPlanNetwork `protobuf:"varint,6,opt,name=keyword_plan_network,json=keywordPlanNetwork,proto3,enum=google.ads.googleads.v4.enums.KeywordPlanNetworkEnum_KeywordPlanNetwork" json:"keyword_plan_network,omitempty"`
...
func (x *KeywordPlanCampaign) Reset() {
	*x = KeywordPlanCampaign{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_msgTypes[0]
...
func (*KeywordPlanCampaign) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanGeoTarget) Reset() {
	*x = KeywordPlanGeoTarget{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordPlanGeoTarget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v4_resources_keyword_plan_campaign_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescData = file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDesc
)

func file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDescData
}

var file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_goTypes = []interface{}{
	(*KeywordPlanCampaign)(nil),                          // 0: google.ads.googleads.v4.resources.KeywordPlanCampaign
	(*KeywordPlanGeoTarget)(nil),                         // 1: google.ads.googleads.v4.resources.KeywordPlanGeoTarget
	(*wrappers.StringValue)(nil),                         // 2: google.protobuf.StringValue
	(*wrappers.Int64Value)(nil),                          // 3: google.protobuf.Int64Value
	(enums.KeywordPlanNetworkEnum_KeywordPlanNetwork)(0), // 4: google.ads.googleads.v4.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
}
var file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v4.resources.KeywordPlanCampaign.keyword_plan:type_name -> google.protobuf.StringValue
	3, // 1: google.ads.googleads.v4.resources.KeywordPlanCampaign.id:type_name -> google.protobuf.Int64Value
	2, // 2: google.ads.googleads.v4.resources.KeywordPlanCampaign.name:type_name -> google.protobuf.StringValue
	2, // 3: google.ads.googleads.v4.resources.KeywordPlanCampaign.language_constants:type_name -> google.protobuf.StringValue
	4, // 4: google.ads.googleads.v4.resources.KeywordPlanCampaign.keyword_plan_network:type_name -> google.ads.googleads.v4.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	3, // 5: google.ads.googleads.v4.resources.KeywordPlanCampaign.cpc_bid_micros:type_name -> google.protobuf.Int64Value
	1, // 6: google.ads.googleads.v4.resources.KeywordPlanCampaign.geo_targets:type_name -> google.ads.googleads.v4.resources.KeywordPlanGeoTarget
	2, // 7: google.ads.googleads.v4.resources.KeywordPlanGeoTarget.geo_target_constant:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_init() }
func file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_init() {
	if File_google_ads_googleads_v4_resources_keyword_plan_campaign_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_resources_keyword_plan_campaign_proto = out.File
	file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_rawDesc = nil
	file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_goTypes = nil
	file_google_ads_googleads_v4_resources_keyword_plan_campaign_proto_depIdxs = nil
}
