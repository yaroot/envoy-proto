...
func (x *AdGroupBidModifier) Reset() {
	*x = AdGroupBidModifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_msgTypes[0]
...
func (*AdGroupBidModifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDesc = []byte{
	...
	0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x69, 0x64, 0x4d, 0x6f, 0x64, 0x69, 0x66,
	...
	0x73, 0x2e, 0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x48, 0x6f, 0x74, 0x65,
	...
	0x64, 0x73, 0x2e, 0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x48, 0x6f, 0x74,
	...
	0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x48, 0x6f, 0x74, 0x65, 0x6c, 0x43,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2e, 0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x72, 0x65,
...
var (
	file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescData = file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDesc
)

func file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDescData
}

var file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_goTypes = []interface{}{
	(*AdGroupBidModifier)(nil),                         // 0: google.ads.googleads.v4.resources.AdGroupBidModifier
	...
	(enums.BidModifierSourceEnum_BidModifierSource)(0), // 4: google.ads.googleads.v4.enums.BidModifierSourceEnum.BidModifierSource
	(*common.HotelDateSelectionTypeInfo)(nil),          // 5: google.ads.googleads.v4.common.HotelDateSelectionTypeInfo
	(*common.HotelAdvanceBookingWindowInfo)(nil),       // 6: google.ads.googleads.v4.common.HotelAdvanceBookingWindowInfo
	(*common.HotelLengthOfStayInfo)(nil),               // 7: google.ads.googleads.v4.common.HotelLengthOfStayInfo
	(*common.HotelCheckInDayInfo)(nil),                 // 8: google.ads.googleads.v4.common.HotelCheckInDayInfo
	(*common.DeviceInfo)(nil),                          // 9: google.ads.googleads.v4.common.DeviceInfo
	(*common.PreferredContentInfo)(nil),                // 10: google.ads.googleads.v4.common.PreferredContentInfo
}
var file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v4.resources.AdGroupBidModifier.ad_group:type_name -> google.protobuf.StringValue
	2,  // 1: google.ads.googleads.v4.resources.AdGroupBidModifier.criterion_id:type_name -> google.protobuf.Int64Value
	3,  // 2: google.ads.googleads.v4.resources.AdGroupBidModifier.bid_modifier:type_name -> google.protobuf.DoubleValue
	1,  // 3: google.ads.googleads.v4.resources.AdGroupBidModifier.base_ad_group:type_name -> google.protobuf.StringValue
	4,  // 4: google.ads.googleads.v4.resources.AdGroupBidModifier.bid_modifier_source:type_name -> google.ads.googleads.v4.enums.BidModifierSourceEnum.BidModifierSource
	5,  // 5: google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_date_selection_type:type_name -> google.ads.googleads.v4.common.HotelDateSelectionTypeInfo
	6,  // 6: google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_advance_booking_window:type_name -> google.ads.googleads.v4.common.HotelAdvanceBookingWindowInfo
	7,  // 7: google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_length_of_stay:type_name -> google.ads.googleads.v4.common.HotelLengthOfStayInfo
	8,  // 8: google.ads.googleads.v4.resources.AdGroupBidModifier.hotel_check_in_day:type_name -> google.ads.googleads.v4.common.HotelCheckInDayInfo
	9,  // 9: google.ads.googleads.v4.resources.AdGroupBidModifier.device:type_name -> google.ads.googleads.v4.common.DeviceInfo
	10, // 10: google.ads.googleads.v4.resources.AdGroupBidModifier.preferred_content:type_name -> google.ads.googleads.v4.common.PreferredContentInfo
...
func init() { file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_init() }
func file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_init() {
	if File_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto = out.File
	file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_rawDesc = nil
	file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_goTypes = nil
	file_google_ads_googleads_v4_resources_ad_group_bid_modifier_proto_depIdxs = nil
}
