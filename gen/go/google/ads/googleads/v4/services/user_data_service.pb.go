...
func (x *UploadUserDataRequest) Reset() {
	*x = UploadUserDataRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[0]
...
func (*UploadUserDataRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_user_data_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserDataOperation) Reset() {
	*x = UserDataOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserDataOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_user_data_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *UploadUserDataResponse) Reset() {
	*x = UploadUserDataResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var File_google_ads_googleads_v4_services_user_data_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_services_user_data_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x36, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x34, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6f, 0x66, 0x66,
	...
	0x76, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61,
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x97, 0x02, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61,
	...
	0x37, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x31, 0x22, 0x2c, 0x2f, 0x76, 0x34, 0x2f, 0x63, 0x75, 0x73,
	...
	0x72, 0x44, 0x61, 0x74, 0x61, 0x3a, 0x01, 0x2a, 0x1a, 0x45, 0xca, 0x41, 0x18, 0x67, 0x6f, 0x6f,
	...
	0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x34, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x14, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61,
...
var (
	file_google_ads_googleads_v4_services_user_data_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_services_user_data_service_proto_rawDescData = file_google_ads_googleads_v4_services_user_data_service_proto_rawDesc
)

func file_google_ads_googleads_v4_services_user_data_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_services_user_data_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_services_user_data_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_services_user_data_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_services_user_data_service_proto_rawDescData
}

var file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v4_services_user_data_service_proto_goTypes = []interface{}{
	(*UploadUserDataRequest)(nil),                // 0: google.ads.googleads.v4.services.UploadUserDataRequest
	(*UserDataOperation)(nil),                    // 1: google.ads.googleads.v4.services.UserDataOperation
...
var file_google_ads_googleads_v4_services_user_data_service_proto_depIdxs = []int32{
	...
	3, // 1: google.ads.googleads.v4.services.UploadUserDataRequest.customer_match_user_list_metadata:type_name -> google.ads.googleads.v4.common.CustomerMatchUserListMetadata
	4, // 2: google.ads.googleads.v4.services.UserDataOperation.create:type_name -> google.ads.googleads.v4.common.UserData
	4, // 3: google.ads.googleads.v4.services.UserDataOperation.remove:type_name -> google.ads.googleads.v4.common.UserData
	5, // 4: google.ads.googleads.v4.services.UploadUserDataResponse.upload_date_time:type_name -> google.protobuf.StringValue
	6, // 5: google.ads.googleads.v4.services.UploadUserDataResponse.received_operations_count:type_name -> google.protobuf.Int32Value
	0, // 6: google.ads.googleads.v4.services.UserDataService.UploadUserData:input_type -> google.ads.googleads.v4.services.UploadUserDataRequest
	2, // 7: google.ads.googleads.v4.services.UserDataService.UploadUserData:output_type -> google.ads.googleads.v4.services.UploadUserDataResponse
...
func init() { file_google_ads_googleads_v4_services_user_data_service_proto_init() }
func file_google_ads_googleads_v4_services_user_data_service_proto_init() {
	if File_google_ads_googleads_v4_services_user_data_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*UploadUserDataRequest_CustomerMatchUserListMetadata)(nil),
	}
	file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_services_user_data_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v4_services_user_data_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_services_user_data_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_services_user_data_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_services_user_data_service_proto = out.File
	file_google_ads_googleads_v4_services_user_data_service_proto_rawDesc = nil
	file_google_ads_googleads_v4_services_user_data_service_proto_goTypes = nil
	file_google_ads_googleads_v4_services_user_data_service_proto_depIdxs = nil
}
