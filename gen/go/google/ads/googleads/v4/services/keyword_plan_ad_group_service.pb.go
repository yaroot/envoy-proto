...
func (x *GetKeywordPlanAdGroupRequest) Reset() {
	*x = GetKeywordPlanAdGroupRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[0]
...
func (*GetKeywordPlanAdGroupRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateKeywordPlanAdGroupsRequest) Reset() {
	*x = MutateKeywordPlanAdGroupsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanAdGroupsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *KeywordPlanAdGroupOperation) Reset() {
	*x = KeywordPlanAdGroupOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordPlanAdGroupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanAdGroupsResponse) Reset() {
	*x = MutateKeywordPlanAdGroupsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanAdGroupsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateKeywordPlanAdGroupResult) Reset() {
	*x = MutateKeywordPlanAdGroupResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanAdGroupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4b, 0x65,
	...
	0x73, 0x2e, 0x76, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4b,
	0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x50, 0x6c, 0x61, 0x6e, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75,
	...
	0x75, 0x70, 0x22, 0x4d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x37, 0x12, 0x35, 0x2f, 0x76, 0x34, 0x2f,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1e, 0x4b, 0x65,
	0x79, 0x77, 0x6f, 0x72, 0x64, 0x50, 0x6c, 0x61, 0x6e, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70,
...
var (
	file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescData = file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDesc
)

func file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDescData
}

var file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_goTypes = []interface{}{
	(*GetKeywordPlanAdGroupRequest)(nil),      // 0: google.ads.googleads.v4.services.GetKeywordPlanAdGroupRequest
	(*MutateKeywordPlanAdGroupsRequest)(nil),  // 1: google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsRequest
	(*KeywordPlanAdGroupOperation)(nil),       // 2: google.ads.googleads.v4.services.KeywordPlanAdGroupOperation
	(*MutateKeywordPlanAdGroupsResponse)(nil), // 3: google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsResponse
	(*MutateKeywordPlanAdGroupResult)(nil),    // 4: google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResult
	(*fieldmaskpb.FieldMask)(nil),             // 5: google.protobuf.FieldMask
	(*resources.KeywordPlanAdGroup)(nil),      // 6: google.ads.googleads.v4.resources.KeywordPlanAdGroup
	(*status.Status)(nil),                     // 7: google.rpc.Status
}
var file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsRequest.operations:type_name -> google.ads.googleads.v4.services.KeywordPlanAdGroupOperation
	5, // 1: google.ads.googleads.v4.services.KeywordPlanAdGroupOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v4.services.KeywordPlanAdGroupOperation.create:type_name -> google.ads.googleads.v4.resources.KeywordPlanAdGroup
	6, // 3: google.ads.googleads.v4.services.KeywordPlanAdGroupOperation.update:type_name -> google.ads.googleads.v4.resources.KeywordPlanAdGroup
	7, // 4: google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsResponse.results:type_name -> google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResult
	0, // 6: google.ads.googleads.v4.services.KeywordPlanAdGroupService.GetKeywordPlanAdGroup:input_type -> google.ads.googleads.v4.services.GetKeywordPlanAdGroupRequest
	1, // 7: google.ads.googleads.v4.services.KeywordPlanAdGroupService.MutateKeywordPlanAdGroups:input_type -> google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsRequest
	6, // 8: google.ads.googleads.v4.services.KeywordPlanAdGroupService.GetKeywordPlanAdGroup:output_type -> google.ads.googleads.v4.resources.KeywordPlanAdGroup
	3, // 9: google.ads.googleads.v4.services.KeywordPlanAdGroupService.MutateKeywordPlanAdGroups:output_type -> google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsResponse
...
func init() { file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_init() }
func file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_init() {
	if File_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto = out.File
	file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_rawDesc = nil
	file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_goTypes = nil
	file_google_ads_googleads_v4_services_keyword_plan_ad_group_service_proto_depIdxs = nil
}
