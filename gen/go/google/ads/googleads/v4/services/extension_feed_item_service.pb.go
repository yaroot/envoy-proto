...
func (x *GetExtensionFeedItemRequest) Reset() {
	*x = GetExtensionFeedItemRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[0]
...
func (*GetExtensionFeedItemRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateExtensionFeedItemsRequest) Reset() {
	*x = MutateExtensionFeedItemsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExtensionFeedItemOperation) Reset() {
	*x = ExtensionFeedItemOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExtensionFeedItemOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateExtensionFeedItemsResponse) Reset() {
	*x = MutateExtensionFeedItemsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateExtensionFeedItemResult) Reset() {
	*x = MutateExtensionFeedItemResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v4_services_extension_feed_item_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDesc = []byte{
	...
	0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x6e,
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xbe, 0x04, 0x0a, 0x18, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73,
	...
	0x73, 0x2e, 0x76, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x45,
	0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d,
	0x22, 0x4c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x36, 0x12, 0x34, 0x2f, 0x76, 0x34, 0x2f, 0x7b, 0x72,
	...
	0x73, 0x65, 0x22, 0x5b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x3c, 0x22, 0x37, 0x2f, 0x76, 0x34, 0x2f,
	...
	0x64, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x42, 0x84, 0x02, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42,
	0x1d, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74,
	0x65, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var (
	file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescData = file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDesc
)

func file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDescData
}

var file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v4_services_extension_feed_item_service_proto_goTypes = []interface{}{
	(*GetExtensionFeedItemRequest)(nil),      // 0: google.ads.googleads.v4.services.GetExtensionFeedItemRequest
	(*MutateExtensionFeedItemsRequest)(nil),  // 1: google.ads.googleads.v4.services.MutateExtensionFeedItemsRequest
	(*ExtensionFeedItemOperation)(nil),       // 2: google.ads.googleads.v4.services.ExtensionFeedItemOperation
	(*MutateExtensionFeedItemsResponse)(nil), // 3: google.ads.googleads.v4.services.MutateExtensionFeedItemsResponse
	(*MutateExtensionFeedItemResult)(nil),    // 4: google.ads.googleads.v4.services.MutateExtensionFeedItemResult
	(*field_mask.FieldMask)(nil),             // 5: google.protobuf.FieldMask
	(*resources.ExtensionFeedItem)(nil),      // 6: google.ads.googleads.v4.resources.ExtensionFeedItem
	(*status.Status)(nil),                    // 7: google.rpc.Status
}
var file_google_ads_googleads_v4_services_extension_feed_item_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v4.services.MutateExtensionFeedItemsRequest.operations:type_name -> google.ads.googleads.v4.services.ExtensionFeedItemOperation
	5, // 1: google.ads.googleads.v4.services.ExtensionFeedItemOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v4.services.ExtensionFeedItemOperation.create:type_name -> google.ads.googleads.v4.resources.ExtensionFeedItem
	6, // 3: google.ads.googleads.v4.services.ExtensionFeedItemOperation.update:type_name -> google.ads.googleads.v4.resources.ExtensionFeedItem
	7, // 4: google.ads.googleads.v4.services.MutateExtensionFeedItemsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v4.services.MutateExtensionFeedItemsResponse.results:type_name -> google.ads.googleads.v4.services.MutateExtensionFeedItemResult
	0, // 6: google.ads.googleads.v4.services.ExtensionFeedItemService.GetExtensionFeedItem:input_type -> google.ads.googleads.v4.services.GetExtensionFeedItemRequest
	1, // 7: google.ads.googleads.v4.services.ExtensionFeedItemService.MutateExtensionFeedItems:input_type -> google.ads.googleads.v4.services.MutateExtensionFeedItemsRequest
	6, // 8: google.ads.googleads.v4.services.ExtensionFeedItemService.GetExtensionFeedItem:output_type -> google.ads.googleads.v4.resources.ExtensionFeedItem
	3, // 9: google.ads.googleads.v4.services.ExtensionFeedItemService.MutateExtensionFeedItems:output_type -> google.ads.googleads.v4.services.MutateExtensionFeedItemsResponse
...
func init() { file_google_ads_googleads_v4_services_extension_feed_item_service_proto_init() }
func file_google_ads_googleads_v4_services_extension_feed_item_service_proto_init() {
	if File_google_ads_googleads_v4_services_extension_feed_item_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v4_services_extension_feed_item_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_services_extension_feed_item_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_services_extension_feed_item_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_services_extension_feed_item_service_proto = out.File
	file_google_ads_googleads_v4_services_extension_feed_item_service_proto_rawDesc = nil
	file_google_ads_googleads_v4_services_extension_feed_item_service_proto_goTypes = nil
	file_google_ads_googleads_v4_services_extension_feed_item_service_proto_depIdxs = nil
}
