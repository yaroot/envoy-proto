...
type ListInvoicesRequest struct {
	...
	IssueMonth enums.MonthOfYearEnum_MonthOfYear `protobuf:"varint,4,opt,name=issue_month,json=issueMonth,proto3,enum=google.ads.googleads.v4.enums.MonthOfYearEnum_MonthOfYear" json:"issue_month,omitempty"`
}

func (x *ListInvoicesRequest) Reset() {
	*x = ListInvoicesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_invoice_service_proto_msgTypes[0]
...
func (*ListInvoicesRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_invoice_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListInvoicesResponse) Reset() {
	*x = ListInvoicesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_invoice_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListInvoicesResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_invoice_service_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v4_services_invoice_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_services_invoice_service_proto_rawDesc = []byte{
	...
	0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x31, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x5f,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x4f, 0x66, 0x59,
	...
	0x76, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4c, 0x69, 0x73, 0x74,
	...
	0x26, 0x2f, 0x76, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x7b,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x13, 0x49, 0x6e, 0x76, 0x6f,
...
var (
	file_google_ads_googleads_v4_services_invoice_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_services_invoice_service_proto_rawDescData = file_google_ads_googleads_v4_services_invoice_service_proto_rawDesc
)

func file_google_ads_googleads_v4_services_invoice_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_services_invoice_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_services_invoice_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_services_invoice_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_services_invoice_service_proto_rawDescData
}

var file_google_ads_googleads_v4_services_invoice_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v4_services_invoice_service_proto_goTypes = []interface{}{
	(*ListInvoicesRequest)(nil),            // 0: google.ads.googleads.v4.services.ListInvoicesRequest
	(*ListInvoicesResponse)(nil),           // 1: google.ads.googleads.v4.services.ListInvoicesResponse
	(enums.MonthOfYearEnum_MonthOfYear)(0), // 2: google.ads.googleads.v4.enums.MonthOfYearEnum.MonthOfYear
	(*resources.Invoice)(nil),              // 3: google.ads.googleads.v4.resources.Invoice
}
var file_google_ads_googleads_v4_services_invoice_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v4.services.ListInvoicesRequest.issue_month:type_name -> google.ads.googleads.v4.enums.MonthOfYearEnum.MonthOfYear
	3, // 1: google.ads.googleads.v4.services.ListInvoicesResponse.invoices:type_name -> google.ads.googleads.v4.resources.Invoice
	0, // 2: google.ads.googleads.v4.services.InvoiceService.ListInvoices:input_type -> google.ads.googleads.v4.services.ListInvoicesRequest
	1, // 3: google.ads.googleads.v4.services.InvoiceService.ListInvoices:output_type -> google.ads.googleads.v4.services.ListInvoicesResponse
...
func init() { file_google_ads_googleads_v4_services_invoice_service_proto_init() }
func file_google_ads_googleads_v4_services_invoice_service_proto_init() {
	if File_google_ads_googleads_v4_services_invoice_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_services_invoice_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_invoice_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_services_invoice_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v4_services_invoice_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_services_invoice_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_services_invoice_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_services_invoice_service_proto = out.File
	file_google_ads_googleads_v4_services_invoice_service_proto_rawDesc = nil
	file_google_ads_googleads_v4_services_invoice_service_proto_goTypes = nil
	file_google_ads_googleads_v4_services_invoice_service_proto_depIdxs = nil
}
