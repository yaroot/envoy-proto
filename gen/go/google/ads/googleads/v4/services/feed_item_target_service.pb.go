...
func (x *GetFeedItemTargetRequest) Reset() {
	*x = GetFeedItemTargetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[0]
...
func (*GetFeedItemTargetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateFeedItemTargetsRequest) Reset() {
	*x = MutateFeedItemTargetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedItemTargetOperation) Reset() {
	*x = FeedItemTargetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedItemTargetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedItemTargetsResponse) Reset() {
	*x = MutateFeedItemTargetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateFeedItemTargetResult) Reset() {
	*x = MutateFeedItemTargetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v4_services_feed_item_target_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDesc = []byte{
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xa3, 0x04, 0x0a, 0x15, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74,
	...
	0x02, 0x39, 0x22, 0x34, 0x2f, 0x76, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	...
	0x75, 0x74, 0x68, 0x2f, 0x61, 0x64, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x42, 0x81, 0x02, 0x0a, 0x24,
...
var (
	file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescData = file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDesc
)

func file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDescData
}

var file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v4_services_feed_item_target_service_proto_goTypes = []interface{}{
	(*GetFeedItemTargetRequest)(nil),      // 0: google.ads.googleads.v4.services.GetFeedItemTargetRequest
	(*MutateFeedItemTargetsRequest)(nil),  // 1: google.ads.googleads.v4.services.MutateFeedItemTargetsRequest
	(*FeedItemTargetOperation)(nil),       // 2: google.ads.googleads.v4.services.FeedItemTargetOperation
	(*MutateFeedItemTargetsResponse)(nil), // 3: google.ads.googleads.v4.services.MutateFeedItemTargetsResponse
	(*MutateFeedItemTargetResult)(nil),    // 4: google.ads.googleads.v4.services.MutateFeedItemTargetResult
	(*resources.FeedItemTarget)(nil),      // 5: google.ads.googleads.v4.resources.FeedItemTarget
}
var file_google_ads_googleads_v4_services_feed_item_target_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v4.services.MutateFeedItemTargetsRequest.operations:type_name -> google.ads.googleads.v4.services.FeedItemTargetOperation
	5, // 1: google.ads.googleads.v4.services.FeedItemTargetOperation.create:type_name -> google.ads.googleads.v4.resources.FeedItemTarget
	4, // 2: google.ads.googleads.v4.services.MutateFeedItemTargetsResponse.results:type_name -> google.ads.googleads.v4.services.MutateFeedItemTargetResult
	0, // 3: google.ads.googleads.v4.services.FeedItemTargetService.GetFeedItemTarget:input_type -> google.ads.googleads.v4.services.GetFeedItemTargetRequest
	1, // 4: google.ads.googleads.v4.services.FeedItemTargetService.MutateFeedItemTargets:input_type -> google.ads.googleads.v4.services.MutateFeedItemTargetsRequest
	5, // 5: google.ads.googleads.v4.services.FeedItemTargetService.GetFeedItemTarget:output_type -> google.ads.googleads.v4.resources.FeedItemTarget
	3, // 6: google.ads.googleads.v4.services.FeedItemTargetService.MutateFeedItemTargets:output_type -> google.ads.googleads.v4.services.MutateFeedItemTargetsResponse
...
func init() { file_google_ads_googleads_v4_services_feed_item_target_service_proto_init() }
func file_google_ads_googleads_v4_services_feed_item_target_service_proto_init() {
	if File_google_ads_googleads_v4_services_feed_item_target_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v4_services_feed_item_target_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v4_services_feed_item_target_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v4_services_feed_item_target_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v4_services_feed_item_target_service_proto = out.File
	file_google_ads_googleads_v4_services_feed_item_target_service_proto_rawDesc = nil
	file_google_ads_googleads_v4_services_feed_item_target_service_proto_goTypes = nil
	file_google_ads_googleads_v4_services_feed_item_target_service_proto_depIdxs = nil
}
