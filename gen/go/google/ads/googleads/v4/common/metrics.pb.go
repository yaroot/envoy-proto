...
type Metrics struct {
	...
	// feed performance.
	HotelEligibleImpressions *wrappers.Int64Value `protobuf:"bytes,130,opt,name=hotel_eligible_impressions,json=hotelEligibleImpressions,proto3" json:"hotel_eligible_impressions,omitempty"`
...
func (x *Metrics) GetHotelEligibleImpressions() *wrappers.Int64Value {
	if x != nil {
