...
func (x *CriterionCategoryAvailability) Reset() {
	*x = CriterionCategoryAvailability{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes[0]
...
func (*CriterionCategoryAvailability) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescGZIP(), []int{0}
}
...
func (x *CriterionCategoryChannelAvailability) Reset() {
	*x = CriterionCategoryChannelAvailability{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CriterionCategoryChannelAvailability) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescGZIP(), []int{1}
}
...
func (x *CriterionCategoryLocaleAvailability) Reset() {
	*x = CriterionCategoryLocaleAvailability{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CriterionCategoryLocaleAvailability) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v3_common_criterion_category_availability_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDesc = []byte{
	...
	0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x64, 0x76, 0x65, 0x72, 0x74, 0x69, 0x73,
	...
	0x73, 0x2e, 0x76, 0x33, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x69, 0x74,
	...
	0x2e, 0x76, 0x33, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x69, 0x74, 0x65,
	...
	0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x64, 0x76, 0x65, 0x72, 0x74, 0x69, 0x73,
...
var (
	file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescData = file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDesc
)

func file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescData)
	})
	return file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDescData
}

var file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v3_common_criterion_category_availability_proto_goTypes = []interface{}{
	(*CriterionCategoryAvailability)(nil),                                                            // 0: google.ads.googleads.v3.common.CriterionCategoryAvailability
	(*CriterionCategoryChannelAvailability)(nil),                                                     // 1: google.ads.googleads.v3.common.CriterionCategoryChannelAvailability
	(*CriterionCategoryLocaleAvailability)(nil),                                                      // 2: google.ads.googleads.v3.common.CriterionCategoryLocaleAvailability
...
var file_google_ads_googleads_v3_common_criterion_category_availability_proto_depIdxs = []int32{
	...
	2, // 1: google.ads.googleads.v3.common.CriterionCategoryAvailability.locale:type_name -> google.ads.googleads.v3.common.CriterionCategoryLocaleAvailability
	3, // 2: google.ads.googleads.v3.common.CriterionCategoryChannelAvailability.availability_mode:type_name -> google.ads.googleads.v3.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode
	4, // 3: google.ads.googleads.v3.common.CriterionCategoryChannelAvailability.advertising_channel_type:type_name -> google.ads.googleads.v3.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
	5, // 4: google.ads.googleads.v3.common.CriterionCategoryChannelAvailability.advertising_channel_sub_type:type_name -> google.ads.googleads.v3.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType
	6, // 5: google.ads.googleads.v3.common.CriterionCategoryChannelAvailability.include_default_channel_sub_type:type_name -> google.protobuf.BoolValue
	7, // 6: google.ads.googleads.v3.common.CriterionCategoryLocaleAvailability.availability_mode:type_name -> google.ads.googleads.v3.enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode
	8, // 7: google.ads.googleads.v3.common.CriterionCategoryLocaleAvailability.country_code:type_name -> google.protobuf.StringValue
	8, // 8: google.ads.googleads.v3.common.CriterionCategoryLocaleAvailability.language_code:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v3_common_criterion_category_availability_proto_init() }
func file_google_ads_googleads_v3_common_criterion_category_availability_proto_init() {
	if File_google_ads_googleads_v3_common_criterion_category_availability_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v3_common_criterion_category_availability_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v3_common_criterion_category_availability_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v3_common_criterion_category_availability_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v3_common_criterion_category_availability_proto = out.File
	file_google_ads_googleads_v3_common_criterion_category_availability_proto_rawDesc = nil
	file_google_ads_googleads_v3_common_criterion_category_availability_proto_goTypes = nil
	file_google_ads_googleads_v3_common_criterion_category_availability_proto_depIdxs = nil
}
