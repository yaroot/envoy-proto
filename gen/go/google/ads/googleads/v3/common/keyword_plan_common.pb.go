...
func (x *KeywordPlanHistoricalMetrics) Reset() {
	*x = KeywordPlanHistoricalMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_common_keyword_plan_common_proto_msgTypes[0]
...
func (*KeywordPlanHistoricalMetrics) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v3_common_keyword_plan_common_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x33, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x42, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x2f, 0x76, 0x33, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x33, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xca, 0x02, 0x1e, 0x47, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c,
	0x56, 0x33, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea, 0x02, 0x22, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41,
	0x64, 0x73, 0x3a, 0x3a, 0x56, 0x33, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescData = file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDesc
)

func file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescData)
	})
	return file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDescData
}

var file_google_ads_googleads_v3_common_keyword_plan_common_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v3_common_keyword_plan_common_proto_goTypes = []interface{}{
	(*KeywordPlanHistoricalMetrics)(nil),                                   // 0: google.ads.googleads.v3.common.KeywordPlanHistoricalMetrics
	(*wrappers.Int64Value)(nil),                                            // 1: google.protobuf.Int64Value
	(enums.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel)(0), // 2: google.ads.googleads.v3.enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel
}
var file_google_ads_googleads_v3_common_keyword_plan_common_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v3.common.KeywordPlanHistoricalMetrics.avg_monthly_searches:type_name -> google.protobuf.Int64Value
	2, // 1: google.ads.googleads.v3.common.KeywordPlanHistoricalMetrics.competition:type_name -> google.ads.googleads.v3.enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel
...
func init() { file_google_ads_googleads_v3_common_keyword_plan_common_proto_init() }
func file_google_ads_googleads_v3_common_keyword_plan_common_proto_init() {
	if File_google_ads_googleads_v3_common_keyword_plan_common_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v3_common_keyword_plan_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v3_common_keyword_plan_common_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v3_common_keyword_plan_common_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v3_common_keyword_plan_common_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v3_common_keyword_plan_common_proto = out.File
	file_google_ads_googleads_v3_common_keyword_plan_common_proto_rawDesc = nil
	file_google_ads_googleads_v3_common_keyword_plan_common_proto_goTypes = nil
	file_google_ads_googleads_v3_common_keyword_plan_common_proto_depIdxs = nil
}
