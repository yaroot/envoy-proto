...
func (x *MediaFile) Reset() {
	*x = MediaFile{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[0]
...
func (*MediaFile) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_media_file_proto_rawDescGZIP(), []int{0}
}
...
func (x *MediaImage) Reset() {
	*x = MediaImage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaImage) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_media_file_proto_rawDescGZIP(), []int{1}
}
...
func (x *MediaBundle) Reset() {
	*x = MediaBundle{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaBundle) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_media_file_proto_rawDescGZIP(), []int{2}
}
...
func (x *MediaAudio) Reset() {
	*x = MediaAudio{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaAudio) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_media_file_proto_rawDescGZIP(), []int{3}
}
...
func (x *MediaVideo) Reset() {
	*x = MediaVideo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaVideo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_media_file_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v3_resources_media_file_proto_rawDesc = []byte{
	...
	0x33, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4d, 0x65, 0x64, 0x69,
...
var (
	file_google_ads_googleads_v3_resources_media_file_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v3_resources_media_file_proto_rawDescData = file_google_ads_googleads_v3_resources_media_file_proto_rawDesc
)

func file_google_ads_googleads_v3_resources_media_file_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v3_resources_media_file_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v3_resources_media_file_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v3_resources_media_file_proto_rawDescData)
	})
	return file_google_ads_googleads_v3_resources_media_file_proto_rawDescData
}

var file_google_ads_googleads_v3_resources_media_file_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v3_resources_media_file_proto_goTypes = []interface{}{
	(*MediaFile)(nil),                  // 0: google.ads.googleads.v3.resources.MediaFile
	(*MediaImage)(nil),                 // 1: google.ads.googleads.v3.resources.MediaImage
	(*MediaBundle)(nil),                // 2: google.ads.googleads.v3.resources.MediaBundle
	(*MediaAudio)(nil),                 // 3: google.ads.googleads.v3.resources.MediaAudio
	(*MediaVideo)(nil),                 // 4: google.ads.googleads.v3.resources.MediaVideo
	(*wrapperspb.Int64Value)(nil),      // 5: google.protobuf.Int64Value
	(enums.MediaTypeEnum_MediaType)(0), // 6: google.ads.googleads.v3.enums.MediaTypeEnum.MediaType
	(enums.MimeTypeEnum_MimeType)(0),   // 7: google.ads.googleads.v3.enums.MimeTypeEnum.MimeType
	(*wrapperspb.StringValue)(nil),     // 8: google.protobuf.StringValue
	(*wrapperspb.BytesValue)(nil),      // 9: google.protobuf.BytesValue
}
var file_google_ads_googleads_v3_resources_media_file_proto_depIdxs = []int32{
	5,  // 0: google.ads.googleads.v3.resources.MediaFile.id:type_name -> google.protobuf.Int64Value
	6,  // 1: google.ads.googleads.v3.resources.MediaFile.type:type_name -> google.ads.googleads.v3.enums.MediaTypeEnum.MediaType
	7,  // 2: google.ads.googleads.v3.resources.MediaFile.mime_type:type_name -> google.ads.googleads.v3.enums.MimeTypeEnum.MimeType
	8,  // 3: google.ads.googleads.v3.resources.MediaFile.source_url:type_name -> google.protobuf.StringValue
	8,  // 4: google.ads.googleads.v3.resources.MediaFile.name:type_name -> google.protobuf.StringValue
	5,  // 5: google.ads.googleads.v3.resources.MediaFile.file_size:type_name -> google.protobuf.Int64Value
	1,  // 6: google.ads.googleads.v3.resources.MediaFile.image:type_name -> google.ads.googleads.v3.resources.MediaImage
	2,  // 7: google.ads.googleads.v3.resources.MediaFile.media_bundle:type_name -> google.ads.googleads.v3.resources.MediaBundle
	3,  // 8: google.ads.googleads.v3.resources.MediaFile.audio:type_name -> google.ads.googleads.v3.resources.MediaAudio
	4,  // 9: google.ads.googleads.v3.resources.MediaFile.video:type_name -> google.ads.googleads.v3.resources.MediaVideo
	9,  // 10: google.ads.googleads.v3.resources.MediaImage.data:type_name -> google.protobuf.BytesValue
	9,  // 11: google.ads.googleads.v3.resources.MediaBundle.data:type_name -> google.protobuf.BytesValue
	5,  // 12: google.ads.googleads.v3.resources.MediaAudio.ad_duration_millis:type_name -> google.protobuf.Int64Value
	5,  // 13: google.ads.googleads.v3.resources.MediaVideo.ad_duration_millis:type_name -> google.protobuf.Int64Value
	8,  // 14: google.ads.googleads.v3.resources.MediaVideo.youtube_video_id:type_name -> google.protobuf.StringValue
	8,  // 15: google.ads.googleads.v3.resources.MediaVideo.advertising_id_code:type_name -> google.protobuf.StringValue
	8,  // 16: google.ads.googleads.v3.resources.MediaVideo.isci_code:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v3_resources_media_file_proto_init() }
func file_google_ads_googleads_v3_resources_media_file_proto_init() {
	if File_google_ads_googleads_v3_resources_media_file_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v3_resources_media_file_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*MediaFile_Image)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v3_resources_media_file_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v3_resources_media_file_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v3_resources_media_file_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v3_resources_media_file_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v3_resources_media_file_proto = out.File
	file_google_ads_googleads_v3_resources_media_file_proto_rawDesc = nil
	file_google_ads_googleads_v3_resources_media_file_proto_goTypes = nil
	file_google_ads_googleads_v3_resources_media_file_proto_depIdxs = nil
}
