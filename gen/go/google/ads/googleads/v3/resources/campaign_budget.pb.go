...
func (x *CampaignBudget) Reset() {
	*x = CampaignBudget{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_campaign_budget_proto_msgTypes[0]
...
func (*CampaignBudget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDesc = []byte{
	...
	0x76, 0x33, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x3a, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x75, 0x64, 0x67,
	...
	0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x5f, 0x70,
	...
	0x73, 0x2f, 0x76, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x75, 0x64, 0x67, 0x65,
	...
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x75,
	...
	0x2e, 0x76, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x75,
	...
	0x73, 0x2e, 0x76, 0x33, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x13,
...
var (
	file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescData = file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDesc
)

func file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescData)
	})
	return file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDescData
}

var file_google_ads_googleads_v3_resources_campaign_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v3_resources_campaign_budget_proto_goTypes = []interface{}{
	(*CampaignBudget)(nil),                                   // 0: google.ads.googleads.v3.resources.CampaignBudget
	(*wrappers.Int64Value)(nil),                              // 1: google.protobuf.Int64Value
	(*wrappers.StringValue)(nil),                             // 2: google.protobuf.StringValue
	(enums.BudgetStatusEnum_BudgetStatus)(0),                 // 3: google.ads.googleads.v3.enums.BudgetStatusEnum.BudgetStatus
	(enums.BudgetDeliveryMethodEnum_BudgetDeliveryMethod)(0), // 4: google.ads.googleads.v3.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod
	(*wrappers.BoolValue)(nil),                               // 5: google.protobuf.BoolValue
	(enums.BudgetPeriodEnum_BudgetPeriod)(0),                 // 6: google.ads.googleads.v3.enums.BudgetPeriodEnum.BudgetPeriod
	(enums.BudgetTypeEnum_BudgetType)(0),                     // 7: google.ads.googleads.v3.enums.BudgetTypeEnum.BudgetType
}
var file_google_ads_googleads_v3_resources_campaign_budget_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v3.resources.CampaignBudget.id:type_name -> google.protobuf.Int64Value
	2,  // 1: google.ads.googleads.v3.resources.CampaignBudget.name:type_name -> google.protobuf.StringValue
	1,  // 2: google.ads.googleads.v3.resources.CampaignBudget.amount_micros:type_name -> google.protobuf.Int64Value
	1,  // 3: google.ads.googleads.v3.resources.CampaignBudget.total_amount_micros:type_name -> google.protobuf.Int64Value
	3,  // 4: google.ads.googleads.v3.resources.CampaignBudget.status:type_name -> google.ads.googleads.v3.enums.BudgetStatusEnum.BudgetStatus
	4,  // 5: google.ads.googleads.v3.resources.CampaignBudget.delivery_method:type_name -> google.ads.googleads.v3.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod
	5,  // 6: google.ads.googleads.v3.resources.CampaignBudget.explicitly_shared:type_name -> google.protobuf.BoolValue
	1,  // 7: google.ads.googleads.v3.resources.CampaignBudget.reference_count:type_name -> google.protobuf.Int64Value
	5,  // 8: google.ads.googleads.v3.resources.CampaignBudget.has_recommended_budget:type_name -> google.protobuf.BoolValue
	1,  // 9: google.ads.googleads.v3.resources.CampaignBudget.recommended_budget_amount_micros:type_name -> google.protobuf.Int64Value
	6,  // 10: google.ads.googleads.v3.resources.CampaignBudget.period:type_name -> google.ads.googleads.v3.enums.BudgetPeriodEnum.BudgetPeriod
	1,  // 11: google.ads.googleads.v3.resources.CampaignBudget.recommended_budget_estimated_change_weekly_clicks:type_name -> google.protobuf.Int64Value
	1,  // 12: google.ads.googleads.v3.resources.CampaignBudget.recommended_budget_estimated_change_weekly_cost_micros:type_name -> google.protobuf.Int64Value
	1,  // 13: google.ads.googleads.v3.resources.CampaignBudget.recommended_budget_estimated_change_weekly_interactions:type_name -> google.protobuf.Int64Value
	1,  // 14: google.ads.googleads.v3.resources.CampaignBudget.recommended_budget_estimated_change_weekly_views:type_name -> google.protobuf.Int64Value
	7,  // 15: google.ads.googleads.v3.resources.CampaignBudget.type:type_name -> google.ads.googleads.v3.enums.BudgetTypeEnum.BudgetType
...
func init() { file_google_ads_googleads_v3_resources_campaign_budget_proto_init() }
func file_google_ads_googleads_v3_resources_campaign_budget_proto_init() {
	if File_google_ads_googleads_v3_resources_campaign_budget_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v3_resources_campaign_budget_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v3_resources_campaign_budget_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v3_resources_campaign_budget_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v3_resources_campaign_budget_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v3_resources_campaign_budget_proto = out.File
	file_google_ads_googleads_v3_resources_campaign_budget_proto_rawDesc = nil
	file_google_ads_googleads_v3_resources_campaign_budget_proto_goTypes = nil
	file_google_ads_googleads_v3_resources_campaign_budget_proto_depIdxs = nil
}
