...
func (x *CustomerFeed) Reset() {
	*x = CustomerFeed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_customer_feed_proto_msgTypes[0]
...
func (*CustomerFeed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v3_resources_customer_feed_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescData = file_google_ads_googleads_v3_resources_customer_feed_proto_rawDesc
)

func file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescData)
	})
	return file_google_ads_googleads_v3_resources_customer_feed_proto_rawDescData
}
...
var file_google_ads_googleads_v3_resources_customer_feed_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v3.resources.CustomerFeed.feed:type_name -> google.protobuf.StringValue
	2, // 1: google.ads.googleads.v3.resources.CustomerFeed.placeholder_types:type_name -> google.ads.googleads.v3.enums.PlaceholderTypeEnum.PlaceholderType
	3, // 2: google.ads.googleads.v3.resources.CustomerFeed.matching_function:type_name -> google.ads.googleads.v3.common.MatchingFunction
	4, // 3: google.ads.googleads.v3.resources.CustomerFeed.status:type_name -> google.ads.googleads.v3.enums.FeedLinkStatusEnum.FeedLinkStatus
...
func init() { file_google_ads_googleads_v3_resources_customer_feed_proto_init() }
func file_google_ads_googleads_v3_resources_customer_feed_proto_init() {
	if File_google_ads_googleads_v3_resources_customer_feed_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v3_resources_customer_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v3_resources_customer_feed_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v3_resources_customer_feed_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v3_resources_customer_feed_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v3_resources_customer_feed_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v3_resources_customer_feed_proto = out.File
	file_google_ads_googleads_v3_resources_customer_feed_proto_rawDesc = nil
	file_google_ads_googleads_v3_resources_customer_feed_proto_goTypes = nil
	file_google_ads_googleads_v3_resources_customer_feed_proto_depIdxs = nil
}
