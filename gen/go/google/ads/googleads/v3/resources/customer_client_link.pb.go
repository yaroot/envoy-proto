...
func (x *CustomerClientLink) Reset() {
	*x = CustomerClientLink{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_customer_client_link_proto_msgTypes[0]
...
func (*CustomerClientLink) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x61, 0x6e, 0x61,
	...
	0x76, 0x33, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x17, 0x43, 0x75,
...
var (
	file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescData = file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDesc
)

func file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescData)
	})
	return file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDescData
}
...
var file_google_ads_googleads_v3_resources_customer_client_link_proto_depIdxs = []int32{
	...
	2, // 1: google.ads.googleads.v3.resources.CustomerClientLink.manager_link_id:type_name -> google.protobuf.Int64Value
	3, // 2: google.ads.googleads.v3.resources.CustomerClientLink.status:type_name -> google.ads.googleads.v3.enums.ManagerLinkStatusEnum.ManagerLinkStatus
	4, // 3: google.ads.googleads.v3.resources.CustomerClientLink.hidden:type_name -> google.protobuf.BoolValue
...
func init() { file_google_ads_googleads_v3_resources_customer_client_link_proto_init() }
func file_google_ads_googleads_v3_resources_customer_client_link_proto_init() {
	if File_google_ads_googleads_v3_resources_customer_client_link_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v3_resources_customer_client_link_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v3_resources_customer_client_link_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v3_resources_customer_client_link_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v3_resources_customer_client_link_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v3_resources_customer_client_link_proto = out.File
	file_google_ads_googleads_v3_resources_customer_client_link_proto_rawDesc = nil
	file_google_ads_googleads_v3_resources_customer_client_link_proto_goTypes = nil
	file_google_ads_googleads_v3_resources_customer_client_link_proto_depIdxs = nil
}
