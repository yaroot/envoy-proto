...
func (x *DistanceView) Reset() {
	*x = DistanceView{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v3_resources_distance_view_proto_msgTypes[0]
...
func (*DistanceView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v3_resources_distance_view_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v3_resources_distance_view_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x64, 0x69, 0x73, 0x74, 0x61, 0x6e,
	...
	0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x44, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
...
var (
	file_google_ads_googleads_v3_resources_distance_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v3_resources_distance_view_proto_rawDescData = file_google_ads_googleads_v3_resources_distance_view_proto_rawDesc
)

func file_google_ads_googleads_v3_resources_distance_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v3_resources_distance_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v3_resources_distance_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v3_resources_distance_view_proto_rawDescData)
	})
	return file_google_ads_googleads_v3_resources_distance_view_proto_rawDescData
}

var file_google_ads_googleads_v3_resources_distance_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v3_resources_distance_view_proto_goTypes = []interface{}{
	(*DistanceView)(nil),                         // 0: google.ads.googleads.v3.resources.DistanceView
	(enums.DistanceBucketEnum_DistanceBucket)(0), // 1: google.ads.googleads.v3.enums.DistanceBucketEnum.DistanceBucket
	(*wrappers.BoolValue)(nil),                   // 2: google.protobuf.BoolValue
}
var file_google_ads_googleads_v3_resources_distance_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v3.resources.DistanceView.distance_bucket:type_name -> google.ads.googleads.v3.enums.DistanceBucketEnum.DistanceBucket
	2, // 1: google.ads.googleads.v3.resources.DistanceView.metric_system:type_name -> google.protobuf.BoolValue
...
func init() { file_google_ads_googleads_v3_resources_distance_view_proto_init() }
func file_google_ads_googleads_v3_resources_distance_view_proto_init() {
	if File_google_ads_googleads_v3_resources_distance_view_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v3_resources_distance_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v3_resources_distance_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v3_resources_distance_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v3_resources_distance_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v3_resources_distance_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v3_resources_distance_view_proto = out.File
	file_google_ads_googleads_v3_resources_distance_view_proto_rawDesc = nil
	file_google_ads_googleads_v3_resources_distance_view_proto_goTypes = nil
	file_google_ads_googleads_v3_resources_distance_view_proto_depIdxs = nil
}
