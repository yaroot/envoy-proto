...
type OfflineUserDataJob struct {
	...
	Type enums.OfflineUserDataJobTypeEnum_OfflineUserDataJobType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v6.enums.OfflineUserDataJobTypeEnum_OfflineUserDataJobType" json:"type,omitempty"`
	// Output only. Status of the job.
	Status enums.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v6.enums.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus" json:"status,omitempty"`
	// Output only. Reason for the processing failure, if status is FAILED.
	FailureReason enums.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason `protobuf:"varint,6,opt,name=failure_reason,json=failureReason,proto3,enum=google.ads.googleads.v6.enums.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason" json:"failure_reason,omitempty"`
	// Metadata of the job.
	//
...
func (x *OfflineUserDataJob) Reset() {
	*x = OfflineUserDataJob{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_resources_offline_user_data_job_proto_msgTypes[0]
...
func (*OfflineUserDataJob) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v6_resources_offline_user_data_job_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x36, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x36, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4f, 0x66,
	...
	0x2e, 0x76, 0x36, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x17, 0x4f,
	0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x4a, 0x6f,
...
var (
	file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescData = file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDesc
)

func file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescData)
	})
	return file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDescData
}

var file_google_ads_googleads_v6_resources_offline_user_data_job_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v6_resources_offline_user_data_job_proto_goTypes = []interface{}{
	(*OfflineUserDataJob)(nil),                                                     // 0: google.ads.googleads.v6.resources.OfflineUserDataJob
	(enums.OfflineUserDataJobTypeEnum_OfflineUserDataJobType)(0),                   // 1: google.ads.googleads.v6.enums.OfflineUserDataJobTypeEnum.OfflineUserDataJobType
	(enums.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus)(0),               // 2: google.ads.googleads.v6.enums.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus
	(enums.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason)(0), // 3: google.ads.googleads.v6.enums.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason
	(*common.CustomerMatchUserListMetadata)(nil),                                   // 4: google.ads.googleads.v6.common.CustomerMatchUserListMetadata
	(*common.StoreSalesMetadata)(nil),                                              // 5: google.ads.googleads.v6.common.StoreSalesMetadata
}
var file_google_ads_googleads_v6_resources_offline_user_data_job_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v6.resources.OfflineUserDataJob.type:type_name -> google.ads.googleads.v6.enums.OfflineUserDataJobTypeEnum.OfflineUserDataJobType
	2, // 1: google.ads.googleads.v6.resources.OfflineUserDataJob.status:type_name -> google.ads.googleads.v6.enums.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus
	3, // 2: google.ads.googleads.v6.resources.OfflineUserDataJob.failure_reason:type_name -> google.ads.googleads.v6.enums.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason
	4, // 3: google.ads.googleads.v6.resources.OfflineUserDataJob.customer_match_user_list_metadata:type_name -> google.ads.googleads.v6.common.CustomerMatchUserListMetadata
	5, // 4: google.ads.googleads.v6.resources.OfflineUserDataJob.store_sales_metadata:type_name -> google.ads.googleads.v6.common.StoreSalesMetadata
...
func init() { file_google_ads_googleads_v6_resources_offline_user_data_job_proto_init() }
func file_google_ads_googleads_v6_resources_offline_user_data_job_proto_init() {
	if File_google_ads_googleads_v6_resources_offline_user_data_job_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v6_resources_offline_user_data_job_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v6_resources_offline_user_data_job_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v6_resources_offline_user_data_job_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v6_resources_offline_user_data_job_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v6_resources_offline_user_data_job_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v6_resources_offline_user_data_job_proto = out.File
	file_google_ads_googleads_v6_resources_offline_user_data_job_proto_rawDesc = nil
	file_google_ads_googleads_v6_resources_offline_user_data_job_proto_goTypes = nil
	file_google_ads_googleads_v6_resources_offline_user_data_job_proto_depIdxs = nil
}
