...
func (x *Customer) Reset() {
	*x = Customer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_resources_customer_proto_msgTypes[0]
...
func (*Customer) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_resources_customer_proto_rawDescGZIP(), []int{0}
}
...
func (x *CallReportingSetting) Reset() {
	*x = CallReportingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_resources_customer_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CallReportingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_resources_customer_proto_rawDescGZIP(), []int{1}
}
...
func (x *ConversionTrackingSetting) Reset() {
	*x = ConversionTrackingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_resources_customer_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConversionTrackingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_resources_customer_proto_rawDescGZIP(), []int{2}
}
...
func (x *RemarketingSetting) Reset() {
	*x = RemarketingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_resources_customer_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemarketingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_resources_customer_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v6_resources_customer_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v6_resources_customer_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x36, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f,
	...
	0x36, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x0d, 0x43, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v6_resources_customer_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v6_resources_customer_proto_rawDescData = file_google_ads_googleads_v6_resources_customer_proto_rawDesc
)

func file_google_ads_googleads_v6_resources_customer_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v6_resources_customer_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v6_resources_customer_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v6_resources_customer_proto_rawDescData)
	})
	return file_google_ads_googleads_v6_resources_customer_proto_rawDescData
}

var file_google_ads_googleads_v6_resources_customer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v6_resources_customer_proto_goTypes = []interface{}{
	(*Customer)(nil),                  // 0: google.ads.googleads.v6.resources.Customer
	(*CallReportingSetting)(nil),      // 1: google.ads.googleads.v6.resources.CallReportingSetting
	(*ConversionTrackingSetting)(nil), // 2: google.ads.googleads.v6.resources.ConversionTrackingSetting
	(*RemarketingSetting)(nil),        // 3: google.ads.googleads.v6.resources.RemarketingSetting
	(enums.CustomerPayPerConversionEligibilityFailureReasonEnum_CustomerPayPerConversionEligibilityFailureReason)(0), // 4: google.ads.googleads.v6.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason
}
var file_google_ads_googleads_v6_resources_customer_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v6.resources.Customer.call_reporting_setting:type_name -> google.ads.googleads.v6.resources.CallReportingSetting
	2, // 1: google.ads.googleads.v6.resources.Customer.conversion_tracking_setting:type_name -> google.ads.googleads.v6.resources.ConversionTrackingSetting
	3, // 2: google.ads.googleads.v6.resources.Customer.remarketing_setting:type_name -> google.ads.googleads.v6.resources.RemarketingSetting
	4, // 3: google.ads.googleads.v6.resources.Customer.pay_per_conversion_eligibility_failure_reasons:type_name -> google.ads.googleads.v6.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason
...
func init() { file_google_ads_googleads_v6_resources_customer_proto_init() }
func file_google_ads_googleads_v6_resources_customer_proto_init() {
	if File_google_ads_googleads_v6_resources_customer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v6_resources_customer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_resources_customer_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_resources_customer_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_resources_customer_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v6_resources_customer_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v6_resources_customer_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v6_resources_customer_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v6_resources_customer_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v6_resources_customer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v6_resources_customer_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v6_resources_customer_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v6_resources_customer_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v6_resources_customer_proto = out.File
	file_google_ads_googleads_v6_resources_customer_proto_rawDesc = nil
	file_google_ads_googleads_v6_resources_customer_proto_goTypes = nil
	file_google_ads_googleads_v6_resources_customer_proto_depIdxs = nil
}
