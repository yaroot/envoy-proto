...
func (x *GetCustomerUserAccessRequest) Reset() {
	*x = GetCustomerUserAccessRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[0]
...
func (*GetCustomerUserAccessRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerUserAccessRequest) Reset() {
	*x = MutateCustomerUserAccessRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerUserAccessRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerUserAccessOperation) Reset() {
	*x = CustomerUserAccessOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerUserAccessOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerUserAccessResponse) Reset() {
	*x = MutateCustomerUserAccessResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerUserAccessResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerUserAccessResult) Reset() {
	*x = MutateCustomerUserAccessResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerUserAccessResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v6_services_customer_user_access_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDesc = []byte{
	...
	0x76, 0x36, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1e, 0x43, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescData = file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDesc
)

func file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDescData
}

var file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v6_services_customer_user_access_service_proto_goTypes = []interface{}{
	(*GetCustomerUserAccessRequest)(nil),     // 0: google.ads.googleads.v6.services.GetCustomerUserAccessRequest
	(*MutateCustomerUserAccessRequest)(nil),  // 1: google.ads.googleads.v6.services.MutateCustomerUserAccessRequest
	(*CustomerUserAccessOperation)(nil),      // 2: google.ads.googleads.v6.services.CustomerUserAccessOperation
	(*MutateCustomerUserAccessResponse)(nil), // 3: google.ads.googleads.v6.services.MutateCustomerUserAccessResponse
	(*MutateCustomerUserAccessResult)(nil),   // 4: google.ads.googleads.v6.services.MutateCustomerUserAccessResult
	(*field_mask.FieldMask)(nil),             // 5: google.protobuf.FieldMask
	(*resources.CustomerUserAccess)(nil),     // 6: google.ads.googleads.v6.resources.CustomerUserAccess
}
var file_google_ads_googleads_v6_services_customer_user_access_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v6.services.MutateCustomerUserAccessRequest.operation:type_name -> google.ads.googleads.v6.services.CustomerUserAccessOperation
	5, // 1: google.ads.googleads.v6.services.CustomerUserAccessOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v6.services.CustomerUserAccessOperation.update:type_name -> google.ads.googleads.v6.resources.CustomerUserAccess
	4, // 3: google.ads.googleads.v6.services.MutateCustomerUserAccessResponse.result:type_name -> google.ads.googleads.v6.services.MutateCustomerUserAccessResult
	0, // 4: google.ads.googleads.v6.services.CustomerUserAccessService.GetCustomerUserAccess:input_type -> google.ads.googleads.v6.services.GetCustomerUserAccessRequest
	1, // 5: google.ads.googleads.v6.services.CustomerUserAccessService.MutateCustomerUserAccess:input_type -> google.ads.googleads.v6.services.MutateCustomerUserAccessRequest
	6, // 6: google.ads.googleads.v6.services.CustomerUserAccessService.GetCustomerUserAccess:output_type -> google.ads.googleads.v6.resources.CustomerUserAccess
	3, // 7: google.ads.googleads.v6.services.CustomerUserAccessService.MutateCustomerUserAccess:output_type -> google.ads.googleads.v6.services.MutateCustomerUserAccessResponse
...
func init() { file_google_ads_googleads_v6_services_customer_user_access_service_proto_init() }
func file_google_ads_googleads_v6_services_customer_user_access_service_proto_init() {
	if File_google_ads_googleads_v6_services_customer_user_access_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v6_services_customer_user_access_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v6_services_customer_user_access_service_proto_goTypes,
	...
	File_google_ads_googleads_v6_services_customer_user_access_service_proto = out.File
	file_google_ads_googleads_v6_services_customer_user_access_service_proto_rawDesc = nil
	file_google_ads_googleads_v6_services_customer_user_access_service_proto_goTypes = nil
	file_google_ads_googleads_v6_services_customer_user_access_service_proto_depIdxs = nil
}
