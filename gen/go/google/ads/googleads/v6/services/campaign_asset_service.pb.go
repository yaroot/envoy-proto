...
func (x *GetCampaignAssetRequest) Reset() {
	*x = GetCampaignAssetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[0]
...
func (*GetCampaignAssetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignAssetsRequest) Reset() {
	*x = MutateCampaignAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignAssetOperation) Reset() {
	*x = CampaignAssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignAssetsResponse) Reset() {
	*x = MutateCampaignAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignAssetResult) Reset() {
	*x = MutateCampaignAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v6_services_campaign_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x74, 0x22, 0x48, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x32, 0x12, 0x30, 0x2f, 0x76, 0x36,
	...
	0x64, 0x73, 0x2e, 0x76, 0x36, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x19,
...
var (
	file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescData = file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v6_services_campaign_asset_service_proto_goTypes = []interface{}{
	(*GetCampaignAssetRequest)(nil),      // 0: google.ads.googleads.v6.services.GetCampaignAssetRequest
	(*MutateCampaignAssetsRequest)(nil),  // 1: google.ads.googleads.v6.services.MutateCampaignAssetsRequest
	(*CampaignAssetOperation)(nil),       // 2: google.ads.googleads.v6.services.CampaignAssetOperation
	(*MutateCampaignAssetsResponse)(nil), // 3: google.ads.googleads.v6.services.MutateCampaignAssetsResponse
	(*MutateCampaignAssetResult)(nil),    // 4: google.ads.googleads.v6.services.MutateCampaignAssetResult
	(*resources.CampaignAsset)(nil),      // 5: google.ads.googleads.v6.resources.CampaignAsset
	(*status.Status)(nil),                // 6: google.rpc.Status
}
var file_google_ads_googleads_v6_services_campaign_asset_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v6.services.MutateCampaignAssetsRequest.operations:type_name -> google.ads.googleads.v6.services.CampaignAssetOperation
	5, // 1: google.ads.googleads.v6.services.CampaignAssetOperation.create:type_name -> google.ads.googleads.v6.resources.CampaignAsset
	6, // 2: google.ads.googleads.v6.services.MutateCampaignAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v6.services.MutateCampaignAssetsResponse.results:type_name -> google.ads.googleads.v6.services.MutateCampaignAssetResult
	0, // 4: google.ads.googleads.v6.services.CampaignAssetService.GetCampaignAsset:input_type -> google.ads.googleads.v6.services.GetCampaignAssetRequest
	1, // 5: google.ads.googleads.v6.services.CampaignAssetService.MutateCampaignAssets:input_type -> google.ads.googleads.v6.services.MutateCampaignAssetsRequest
	5, // 6: google.ads.googleads.v6.services.CampaignAssetService.GetCampaignAsset:output_type -> google.ads.googleads.v6.resources.CampaignAsset
	3, // 7: google.ads.googleads.v6.services.CampaignAssetService.MutateCampaignAssets:output_type -> google.ads.googleads.v6.services.MutateCampaignAssetsResponse
...
func init() { file_google_ads_googleads_v6_services_campaign_asset_service_proto_init() }
func file_google_ads_googleads_v6_services_campaign_asset_service_proto_init() {
	if File_google_ads_googleads_v6_services_campaign_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v6_services_campaign_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v6_services_campaign_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v6_services_campaign_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v6_services_campaign_asset_service_proto = out.File
	file_google_ads_googleads_v6_services_campaign_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v6_services_campaign_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v6_services_campaign_asset_service_proto_depIdxs = nil
}
