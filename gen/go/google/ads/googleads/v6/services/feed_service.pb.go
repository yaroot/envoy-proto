...
func (x *GetFeedRequest) Reset() {
	*x = GetFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[0]
...
func (*GetFeedRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_feed_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateFeedsRequest) Reset() {
	*x = MutateFeedsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_feed_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedOperation) Reset() {
	*x = FeedOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_feed_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedsResponse) Reset() {
	*x = MutateFeedsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_feed_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateFeedResult) Reset() {
	*x = MutateFeedResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_feed_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v6_services_feed_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v6_services_feed_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x4e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2f, 0x22, 0x2a, 0x2f, 0x76, 0x36, 0x2f,
...
var (
	file_google_ads_googleads_v6_services_feed_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v6_services_feed_service_proto_rawDescData = file_google_ads_googleads_v6_services_feed_service_proto_rawDesc
)

func file_google_ads_googleads_v6_services_feed_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v6_services_feed_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v6_services_feed_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v6_services_feed_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v6_services_feed_service_proto_rawDescData
}

var file_google_ads_googleads_v6_services_feed_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v6_services_feed_service_proto_goTypes = []interface{}{
	(*GetFeedRequest)(nil),                                 // 0: google.ads.googleads.v6.services.GetFeedRequest
	(*MutateFeedsRequest)(nil),                             // 1: google.ads.googleads.v6.services.MutateFeedsRequest
	(*FeedOperation)(nil),                                  // 2: google.ads.googleads.v6.services.FeedOperation
	(*MutateFeedsResponse)(nil),                            // 3: google.ads.googleads.v6.services.MutateFeedsResponse
	(*MutateFeedResult)(nil),                               // 4: google.ads.googleads.v6.services.MutateFeedResult
	...
	(*resources.Feed)(nil),                                 // 7: google.ads.googleads.v6.resources.Feed
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v6_services_feed_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v6.services.MutateFeedsRequest.operations:type_name -> google.ads.googleads.v6.services.FeedOperation
	5,  // 1: google.ads.googleads.v6.services.MutateFeedsRequest.response_content_type:type_name -> google.ads.googleads.v6.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v6.services.FeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v6.services.FeedOperation.create:type_name -> google.ads.googleads.v6.resources.Feed
	7,  // 4: google.ads.googleads.v6.services.FeedOperation.update:type_name -> google.ads.googleads.v6.resources.Feed
	8,  // 5: google.ads.googleads.v6.services.MutateFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v6.services.MutateFeedsResponse.results:type_name -> google.ads.googleads.v6.services.MutateFeedResult
	7,  // 7: google.ads.googleads.v6.services.MutateFeedResult.feed:type_name -> google.ads.googleads.v6.resources.Feed
	0,  // 8: google.ads.googleads.v6.services.FeedService.GetFeed:input_type -> google.ads.googleads.v6.services.GetFeedRequest
	1,  // 9: google.ads.googleads.v6.services.FeedService.MutateFeeds:input_type -> google.ads.googleads.v6.services.MutateFeedsRequest
	7,  // 10: google.ads.googleads.v6.services.FeedService.GetFeed:output_type -> google.ads.googleads.v6.resources.Feed
	3,  // 11: google.ads.googleads.v6.services.FeedService.MutateFeeds:output_type -> google.ads.googleads.v6.services.MutateFeedsResponse
...
func init() { file_google_ads_googleads_v6_services_feed_service_proto_init() }
func file_google_ads_googleads_v6_services_feed_service_proto_init() {
	if File_google_ads_googleads_v6_services_feed_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v6_services_feed_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v6_services_feed_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v6_services_feed_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v6_services_feed_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v6_services_feed_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v6_services_feed_service_proto = out.File
	file_google_ads_googleads_v6_services_feed_service_proto_rawDesc = nil
	file_google_ads_googleads_v6_services_feed_service_proto_goTypes = nil
	file_google_ads_googleads_v6_services_feed_service_proto_depIdxs = nil
}
