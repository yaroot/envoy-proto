...
var file_envoy_service_auth_v4alpha_external_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0xc9, 0x01, 0x0a, 0x0e, 0x4f, 0x6b, 0x48, 0x74, 0x74, 0x70, 0x52,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x52, 0x10,
...
var file_envoy_service_auth_v4alpha_external_auth_proto_depIdxs = []int32{
	...
	7, // 4: envoy.service.auth.v4alpha.CheckResponse.status:type_name -> google.rpc.Status
	1, // 5: envoy.service.auth.v4alpha.CheckResponse.denied_response:type_name -> envoy.service.auth.v4alpha.DeniedHttpResponse
	2, // 6: envoy.service.auth.v4alpha.CheckResponse.ok_response:type_name -> envoy.service.auth.v4alpha.OkHttpResponse
	8, // 7: envoy.service.auth.v4alpha.CheckResponse.dynamic_metadata:type_name -> google.protobuf.Struct
	0, // 8: envoy.service.auth.v4alpha.Authorization.Check:input_type -> envoy.service.auth.v4alpha.CheckRequest
	3, // 9: envoy.service.auth.v4alpha.Authorization.Check:output_type -> envoy.service.auth.v4alpha.CheckResponse
